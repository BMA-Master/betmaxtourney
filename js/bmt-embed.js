var BMT=(function(l){"use strict";class f{constructor(){this._theme="dark",this._motif="brand",this._lang="en",this._listeners=new Set,this._observer=null,this._initialized=!1}init(){if(this._initialized)return this;const e=document.getElementById("app");return e?(this._readFromApp(e),this._observeApp(e),this._initialized=!0,this):(document.readyState==="loading"&&document.addEventListener("DOMContentLoaded",()=>this.init(),{once:!0}),this)}_readFromApp(e){this._theme=e.getAttribute("data-sync-theme")||"dark",this._motif=e.getAttribute("data-sync-motif")||"brand",this._lang=e.getAttribute("data-sync-lang")||"en"}_observeApp(e){this._observer||(this._observer=new MutationObserver(t=>{let a=!1;for(const i of t){if(i.attributeName==="data-sync-theme"){const o=e.getAttribute("data-sync-theme")||"dark";o!==this._theme&&(this._theme=o,a=!0)}if(i.attributeName==="data-sync-motif"){const o=e.getAttribute("data-sync-motif")||"brand";o!==this._motif&&(this._motif=o,a=!0)}if(i.attributeName==="data-sync-lang"){const o=e.getAttribute("data-sync-lang")||"en";o!==this._lang&&(this._lang=o,a=!0)}}a&&this._notify()}),this._observer.observe(e,{attributes:!0,attributeFilter:["data-sync-theme","data-sync-motif","data-sync-lang"]}))}_notify(){for(const e of this._listeners)try{e(this)}catch(t){console.warn("[BMAThemeResolver] Listener error:",t)}}get theme(){return this._theme}get motif(){return this._motif}get lang(){return this._lang}get isDark(){return this._theme==="dark"}subscribe(e){return this._listeners.add(e),()=>this._listeners.delete(e)}}const d=new f().init();function b(){return`
    *, *::before, *::after {
...
/*  Neodigm JuiceBar End  */
        ...
        .tc-badge[data-game-mode="SET_IT_AND_FORGET_IT"]::after { background-image: var(--game-mode-oneshot); }
        ...
        .tc-badge[data-game-mode="TIERED_FORMAT"]::after        { background-image: var(--game-mode-streaks); }
        ...
        .tc-title {
          margin: 0;
          font-size: 18px;         /* fixed to preserve the 2-line height reserve */
        ...
        .tc-stats {
          ...
          gap: 4px;
          /* Horizontal padding matches .tc-meta (14px) so the first stat's
  ...
  `,document.head.appendChild(r)}async function u(r,e={}){const t={apiBase:e.apiBase||g.apiBase,appBase:e.appBase||g.appBase,limit:e.limit||g.limit,rows:e.rows||null},a=typeof r=="string"?document.querySelector(r):r;if(a){w(),a.classList.add("bmt-grid"),a.innerHTML='<div class="bmt-state">Loading tournaments…</div>';try{const i=t.rows||await x(t.apiBase),o=c=>String(c||"").toUpperCase()==="UPCOMING"?0:1,s=i.filter(c=>String(c.status||"").toUpperCase()!=="COMPLETED").sort((c,h)=>o(c.status)-o(h.status));a.innerHTML="";const n=s.slice(0,t.limit);n.forEach(c=>a.appendChild(k(c,t))),n.length||(a.innerHTML='<div class="bmt-state">No tournaments right now — check back soon.</div>')}catch(i){a.innerHTML='<div class="bmt-state">Couldn’t load tournaments.</div>',console.error("[bmt-embed] mount failed:",i)}}}function m(){document.querySelectorAll("[data-bmt-tournaments]").forEach(r=>{u(r,{apiBase:r.getAttribute("data-bmt-api")||void 0,appBase:r.getAttribute("data-bmt-app")||void 0,limit:parseInt(r.getAttribute("data-bmt-limit"),10)||void 0})})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",m):m(),typeof window<"u"&&(window.BMT={mountTournaments:u});const S={mountTournaments:u};return l.default=S,l.mountTournaments=u,Object.defineProperties(l,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}}),l})({});
