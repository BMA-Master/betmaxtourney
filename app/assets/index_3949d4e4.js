...
`;document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{document.body.insertAdjacentHTML("beforeend",Ac)}):document.body.insertAdjacentHTML("beforeend",Ac);window.deferredPWAPrompt=null;window.addEventListener("beforeinstallprompt",e=>{console.log("[Global] beforeinstallprompt event fired"),e.preventDefault(),window.deferredPWAPrompt=e,window.dispatchEvent(new CustomEvent("pwa-installable"))});window.addEventListener("appinstalled",()=>{console.log("[Global] appinstalled event fired"),window.deferredPWAPrompt=null,window.dispatchEvent(new CustomEvent("pwa-installed"))});const pn=ph(Zy);pn.config.devtools=!1;pn.use(mh());pn.use(za);pn.mount("#app");(function(){const t=document.documentElement,r=()=>{const s=window.visualViewport&&window.visualViewport.height||window.innerHeight;t.style.setProperty("--vvh",s+"px")};r(),window.visualViewport&&(window.visualViewport.addEventListener("resize",r,{passive:!0}),window.visualViewport.addEventListener("scroll",r,{passive:!0})),window.addEventListener("resize",r,{passive:!0}),window.addEventListener("orientationchange",r,{passive:!0})})();(function(){if(!/[?&]debug=vvh\b/.test(window.location.search+window.location.hash))return;const t=document.createElement("div");t.style.cssText="position:fixed;left:-9999px;top:0;width:1px;height:100vh;pointer-events:none;";const r=document.createElement("div");r.style.cssText="position:fixed;left:-9999px;top:0;width:1px;height:100dvh;pointer-events:none;";const s=document.createElement("div");s.style.cssText="position:fixed;left:-9999px;top:0;width:1px;height:100svh;pointer-events:none;",document.body.append(t,r,s);const a=document.createElement("div");a.id="vvh-debug-overlay",a.style.cssText=`
