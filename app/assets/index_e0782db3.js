...
<pre data-n55-theme="warning" style="padding: 7px 0 4px 0; height: 34px; background-color: #161616"></pre>
    ...
    `}}customElements.define("bma-match-status",vg);const yg='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><polyline points="12 7 12 12 15 14"/></svg>',wg='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="5 12 10 17 19 7"/></svg>',xg='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><line x1="6" y1="6" x2="18" y2="18"/><line x1="18" y1="6" x2="6" y2="18"/></svg>',Tg='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/></svg>';class ds extends HTMLElement{static currentlyExpanded=null;constructor(){super(),this.attachShadow({mode:"open"}),this.expanded=!1}static get observedAttributes(){return["data-rank","data-username","data-user-guid","data-tournament-dollars","data-starting-dollars","data-total-betslips","data-total-payout","data-combined-betslips","data-user-matches","data-badge-class","data-is-current-user","data-unqualified","data-sync-theme"]}get rank(){return this.getAttribute("data-rank")||""}get username(){return this.getAttribute("data-username")||"Unknown"}get userGuid(){return this.getAttribute("data-user-guid")||""}get tournamentDollars(){return this.getAttribute("data-tournament-dollars")||"0"}get startingDollars(){return this.getAttribute("data-starting-dollars")||"0"}get totalBetslips(){return this.getAttribute("data-total-betslips")||"0"}get totalPayout(){return this.getAttribute("data-total-payout")||"0"}get combinedBetslips(){const t=this.getAttribute("data-combined-betslips");if(!t)return[];try{return JSON.parse(t)}catch(s){return console.error("[bma-leaderboard-card] Error parsing combined_betslips:",s),[]}}get userMatches(){const t=this.getAttribute("data-user-matches");if(!t)return[];try{return JSON.parse(t)}catch(s){return console.error("[bma-leaderboard-card] Error parsing user_matches:",s),[]}}get badgeClass(){return this.getAttribute("data-badge-class")||""}get isCurrentUser(){return this.getAttribute("data-is-current-user")==="true"}get unqualified(){return this.getAttribute("data-unqualified")==="true"}get theme(){return this.getAttribute("data-sync-theme")||"dark"}connectedCallback(){this._unsub=ke.subscribe(()=>{this.render()}),this.render(),this.attachEventListeners()}disconnectedCallback(){this._unsub&&this._unsub()}attributeChangedCallback(t,s,a){s!==a&&(this.render(),this.attachEventListeners())}toggleExpanded(){ds.currentlyExpanded&&ds.currentlyExpanded!==this&&ds.currentlyExpanded.collapse(),this.expanded=!this.expanded;const t=this.shadowRoot.querySelector(".leaderboard-card__details"),s=this.shadowRoot.querySelector(".expand-icon");this.expanded?(t.classList.add("open"),s.classList.add("expanded"),ds.currentlyExpanded=this):(t.classList.remove("open"),s.classList.remove("expanded"),ds.currentlyExpanded===this&&(ds.currentlyExpanded=null))}collapse(){this.expanded=!1;const t=this.shadowRoot.querySelector(".leaderboard-card__details"),s=this.shadowRoot.querySelector(".expand-icon");t&&t.classList.remove("open"),s&&s.classList.remove("expanded")}attachEventListeners(){const t=this.shadowRoot.querySelector(".expand-icon");t&&t.addEventListener("click",s=>{s.stopPropagation(),this.toggleExpanded()})}getBetStats(){const t=this.combinedBetslips;let s=0,a=0,r=0,n=0,o=0;return t.forEach(i=>{const l=i.bet||[];if(l.length===0)return;const c=l[0];Object.keys(c).filter(u=>u!=="short_title").forEach(u=>{const p=c[u];!p||typeof p!="object"||(p.reconciled===!0?parseFloat(p.payout||0)>0?s++:a++:(r++,n+=parseFloat(p.stake||p.wager||0),o+=parseFloat(p.payout||0)))})}),{wins:s,losses:a,pending:r,total:s+a+r,pendingStakes:n,pendingMaxPayout:o}}renderBetsTable(){const t=this.combinedBetslips,s=this.userMatches,a=this.isCurrentUser;if(!t||t.length===0)return'<p class="no-bets">No bets available</p>';const r=t.filter(l=>{const c=l.bet||[];if(c.length===0)return!1;if(a)return!0;const d=c[0],u=Object.keys(d).filter(p=>p!=="short_title")[0];return d[u]?.reconciled===!0});if(r.length===0){if(!a){const l=t.reduce((c,d)=>{const u=(d.bet||[])[0];if(!u)return c;const p=Object.keys(u).filter(f=>f!=="short_title");return c+p.filter(f=>u[f]?.reconciled!==!0).length},0);if(l>0)return`<p class="no-bets no-bets--hidden">
                    ...
                    </p>`}return'<p class="no-bets">No reconciled bets</p>'}const n={};s.forEach(l=>{const c=l.guid||l.id||l.odds_id;c&&(n[c]=l)});const o={};r.forEach(l=>{const c=l.coreMatches__guid||l.match_guid||l.odds_id||"unknown";o[c]||(o[c]={bets:[],matchTitle:"Unknown Match",sportKey:"default"});const d=n[c];if(d){o[c].matchTitle=d.short_title||d.title||"Unknown Match";const u=d.sport_id,p=Ge.find(f=>f.key===u);o[c].sportKey=p?.group||"default"}o[c].bets.push(l)});let i="";if(Object.keys(o).forEach(l=>{const c=o[l],d=c.sportKey||"default",u=c.matchTitle||"Unknown Match",p=c.bets.length;i+=`
            ...
            `,c.bets.forEach(f=>{const b=f.bet||[];if(b.length===0)return;const v=b[0];Object.keys(v).filter(m=>m!=="short_title").forEach(m=>{const h=v[m];if(!h||typeof h!="object")return;const _=(h.type||"").toUpperCase(),S=parseFloat(h.stake||h.wager||0),g=parseFloat(h.payout||0),w=parseInt(h.odds,10),x=Number.isFinite(w)?w>0?`+${w}`:`${w}`:"—",T=h.reconciled===!0,E=g-S,C=.01;let $,O,F,K,U;T?g>S+C?($="won",O="Won",F=wg,K=`+TD$ ${E.toFixed(2)}`,U="Profit"):g<S-C?($="lost",O="Lost",F=xg,K=`-TD$ ${S.toFixed(2)}`,U="Lost"):($="push",O="Push",F=Tg,K=`TD$ ${S.toFixed(2)}`,U="Returned"):($="pending",O="Pending",F=yg,K=E>0?`+TD$ ${E.toFixed(2)}`:"TD$ 0.00",U="To win"),i+=`<div class="bet-item ${$}">
                        <div class="bet-item__pill">
                            <span class="bet-item__pill-dot"></span>
                            <span class="bet-item__pill-icon">${F}</span>
                        ...
                        <div class="bet-item__body">
                            ...
                            <div class="bet-item__footer">
                                <div class="bet-item__hero">${K}</div>
        ...
        `}}customElements.define("bma-leaderboard-card",ds);class yu{static isPayout(t){if(!t?.Bet||!t?.Match)return console.error("[CoreBetSlip.isPayout] Invalid bet object - missing Bet or Match data"),!1;const{type:s,scope:a}=t.Bet,{home_team_id:r,home_team_score:n,away_team_id:o,away_team_score:i}=t.Match,l=s?.toUpperCase()||"",c=parseFloat(n)||0,d=parseFloat(i)||0;if(c===0&&d===0)return console.warn("[CoreBetSlip.isPayout] Invalid scores - both teams have 0 points"),!1;switch(console.log(`[CoreBetSlip.isPayout] Evaluating ${l} bet:`,{home:`${r} (${c})`,away:`${o} (${d})`,scope:a}),l){case"MONEY":return this._evaluateMoneyline(a.team_id,r,o,c,d);case"SPREAD":return this._evaluateSpread(a.team_id,a.point,r,o,c,d);case"TOTAL":return this._evaluateTotal(a.over,a.under,c,d);case"PROP":return console.warn("[CoreBetSlip.isPayout] PROP bet evaluation not implemented"),!1;case"PARLAY":return console.warn("[CoreBetSlip.isPayout] PARLAY bet evaluation not implemented"),!1;default:return console.warn("[CoreBetSlip.isPayout] Unknown bet type:",l),!1}}static _evaluateMoneyline(t,s,a,r,n){const o=t===s,i=t===a;if(!o&&!i)return console.warn("[CoreBetSlip.isPayout] Betted team does not match home or away team"),!1;const l=r>n,c=n>r;if(r===n)return console.log("[CoreBetSlip.isPayout] MONEY - PUSH (tie game)"),!1;const u=o&&l||i&&c;return console.log(`[CoreBetSlip.isPayout] MONEY - ${u?"WON":"LOST"}`),u}static _evaluateSpread(t,s,a,r,n,o){const i=t===a,l=t===r;if(!i&&!l)return console.warn("[CoreBetSlip.isPayout] Betted team does not match home or away team"),!1;const c=parseFloat(s)||0;let d=n,u=o;i?d=n+c:u=o+c;const p=d>u,f=u>d;if(d===u)return console.log("[CoreBetSlip.isPayout] SPREAD - PUSH (exact spread)"),!1;const v=i&&p||l&&f;return console.log(`[CoreBetSlip.isPayout] SPREAD (${c>0?"+":""}${c}) - ${v?"WON":"LOST"}`),v}static _evaluateTotal(t,s,a,r){const n=a+r,o=t&&t!=="";if(!o&&!(s&&s!==""))return console.warn("[CoreBetSlip.isPayout] No over/under value specified"),!1;const l=parseFloat(o?t:s);if(n===l)return console.log("[CoreBetSlip.isPayout] TOTAL - PUSH (exact line)"),!1;let c=!1;return o?(c=n>l,console.log(`[CoreBetSlip.isPayout] TOTAL OVER ${l} (actual: ${n}) - ${c?"WON":"LOST"}`)):(c=n<l,console.log(`[CoreBetSlip.isPayout] TOTAL UNDER ${l} (actual: ${n}) - ${c?"WON":"LOST"}`)),c}static calcPayout(t){if(!t?.Bet)return console.error("[CoreBetSlip] Invalid bet object - missing Bet data"),0;const{type:s,odds:a,stake:r}=t.Bet,n=s?.toUpperCase()||"",o=parseFloat(a)||0,i=parseFloat(r)||0;if(i<=0)return console.warn("[CoreBetSlip] Invalid stake amount:",i),0;if(o===0)return console.warn("[CoreBetSlip] Invalid odds value:",o),0;let l=0;switch(n){case"SPREAD":l=this.calcAmericanOddsPayout(o,i),console.log("[CoreBetSlip] SPREAD payout calculated:",{odds:o,stake:i,payout:l});break;case"MONEY":l=this.calcAmericanOddsPayout(o,i),console.log("[CoreBetSlip] MONEY payout calculated:",{odds:o,stake:i,payout:l});break;case"TOTAL":l=this.calcAmericanOddsPayout(o,i),console.log("[CoreBetSlip] TOTAL payout calculated:",{odds:o,stake:i,payout:l});break;case"PROP":l=this.calcAmericanOddsPayout(o,i),console.log("[CoreBetSlip] PROP payout calculated:",{odds:o,stake:i,payout:l});break;case"PARLAY":l=this.calcAmericanOddsPayout(o,i),console.log("[CoreBetSlip] PARLAY payout calculated (single odds):",{odds:o,stake:i,payout:l});break;default:console.warn("[CoreBetSlip] Unknown bet type:",n),l=0;break}return parseFloat(l.toFixed(2))}static calcAmericanOddsPayout(t,s){let a=0;return t>0?a=s*(t/100):t<0?a=s/(Math.abs(t)/100):a=0,s+a}static americanToDecimal(t){return t>0?t/100+1:t<0?100/Math.abs(t)+1:1}static calcImpliedProbability(t){return t>0?100/(t+100)*100:t<0?Math.abs(t)/(Math.abs(t)+100)*100:0}}function cl(e){return e!==null&&typeof e=="object"&&"constructor"in e&&e.constructor===Object}function Wo(e={},t={}){const s=["__proto__","constructor","prototype"];Object.keys(t).filter(a=>s.indexOf(a)<0).forEach(a=>{typeof e[a]>"u"?e[a]=t[a]:cl(t[a])&&cl(e[a])&&Object.keys(t[a]).length>0&&Wo(e[a],t[a])})}const wu={body:{},addEventListener(){},removeEventListener(){},activeElement:{blur(){},nodeName:""},querySelector(){return null},querySelectorAll(){return[]},getElementById(){return null},createEvent(){return{initEvent(){}}},createElement(){return{children:[],childNodes:[],style:{},setAttribute(){},getElementsByTagName(){return[]}}},createElementNS(){return{}},importNode(){return null},location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""}};function Nt(){const e=typeof document<"u"?document:{};return Wo(e,wu),e}const Sg={document:wu,navigator:{userAgent:""},location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""},history:{replaceState(){},pushState(){},go(){},back(){}},CustomEvent:function(){return this},addEventListener(){},removeEventListener(){},getComputedStyle(){return{getPropertyValue(){return""}}},Image(){},Date(){},screen:{},setTimeout(){},clearTimeout(){},matchMedia(){return{}},requestAnimationFrame(e){return typeof setTimeout>"u"?(e(),null):setTimeout(e,0)},cancelAnimationFrame(e){typeof setTimeout>"u"||clearTimeout(e)}};function st(){const e=typeof window<"u"?window:{};return Wo(e,Sg),e}function Eg(e=""){return e.trim().split(" ").filter(t=>!!t.trim())}function kg(e){const t=e;Object.keys(t).forEach(s=>{try{t[s]=null}catch{}try{delete t[s]}catch{}})}function xu(e,t=0){return setTimeout(e,t)}function Ur(){return Date.now()}function Ag(e){const t=st();let s;return t.getComputedStyle&&(s=t.getComputedStyle(e,null)),!s&&e.currentStyle&&(s=e.currentStyle),s||(s=e.style),s}function Pg(e,t="x"){const s=st();let a,r,n;const o=Ag(e);return s.WebKitCSSMatrix?(r=o.transform||o.webkitTransform,r.split(",").length>6&&(r=r.split(", ").map(i=>i.replace(",",".")).join(", ")),n=new s.WebKitCSSMatrix(r==="none"?"":r)):(n=o.MozTransform||o.OTransform||o.MsTransform||o.msTransform||o.transform||o.getPropertyValue("transform").replace("translate(","matrix(1, 0, 0, 1,"),a=n.toString().split(",")),t==="x"&&(s.WebKitCSSMatrix?r=n.m41:a.length===16?r=parseFloat(a[12]):r=parseFloat(a[4])),t==="y"&&(s.WebKitCSSMatrix?r=n.m42:a.length===16?r=parseFloat(a[13]):r=parseFloat(a[5])),r||0}function Fa(e){return typeof e=="object"&&e!==null&&e.constructor&&Object.prototype.toString.call(e).slice(8,-1)==="Object"}function Cg(e){return typeof window<"u"&&typeof window.HTMLElement<"u"?e instanceof HTMLElement:e&&(e.nodeType===1||e.nodeType===11)}function ot(...e){const t=Object(e[0]);for(let s=1;s<e.length;s+=1){const a=e[s];if(a!=null&&!Cg(a)){const r=Object.keys(Object(a)).filter(n=>n!=="__proto__"&&n!=="constructor"&&n!=="prototype");for(let n=0,o=r.length;n<o;n+=1){const i=r[n],l=Object.getOwnPropertyDescriptor(a,i);l!==void 0&&l.enumerable&&(Fa(t[i])&&Fa(a[i])?a[i].__swiper__?t[i]=a[i]:ot(t[i],a[i]):!Fa(t[i])&&Fa(a[i])?(t[i]={},a[i].__swiper__?t[i]=a[i]:ot(t[i],a[i])):t[i]=a[i])}}}return t}function Is(e,t,s){e.style.setProperty(t,s)}function Tu({swiper:e,targetPosition:t,side:s}){const a=st(),r=-e.translate;let n=null,o;const i=e.params.speed;e.wrapperEl.style.scrollSnapType="none",a.cancelAnimationFrame(e.cssModeFrameID);const l=t>r?"next":"prev",c=(u,p)=>l==="next"&&u>=p||l==="prev"&&u<=p,d=()=>{o=new Date().getTime(),n===null&&(n=o);const u=Math.max(Math.min((o-n)/i,1),0),p=.5-Math.cos(u*Math.PI)/2;let f=r+p*(t-r);if(c(f,t)&&(f=t),e.wrapperEl.scrollTo({[s]:f}),c(f,t)){e.wrapperEl.style.overflow="hidden",e.wrapperEl.style.scrollSnapType="",setTimeout(()=>{e.wrapperEl.style.overflow="",e.wrapperEl.scrollTo({[s]:f})}),a.cancelAnimationFrame(e.cssModeFrameID);return}e.cssModeFrameID=a.requestAnimationFrame(d)};d()}function Rt(e,t=""){const s=st(),a=[...e.children];return s.HTMLSlotElement&&e instanceof HTMLSlotElement&&a.push(...e.assignedElements()),t?a.filter(r=>r.matches(t)):a}function Og(e,t){const s=[t];for(;s.length>0;){const a=s.shift();if(e===a)return!0;s.push(...a.children,...a.shadowRoot?a.shadowRoot.children:[],...a.assignedElements?a.assignedElements():[])}}function $g(e,t){const s=st();let a=t.contains(e);return!a&&s.HTMLSlotElement&&t instanceof HTMLSlotElement&&(a=[...t.assignedElements()].includes(e),a||(a=Og(e,t))),a}function qr(e){try{console.warn(e);return}catch{}}function Vr(e,t=[]){const s=document.createElement(e);return s.classList.add(...Array.isArray(t)?t:Eg(t)),s}function Lg(e,t){const s=[];for(;e.previousElementSibling;){const a=e.previousElementSibling;t?a.matches(t)&&s.push(a):s.push(a),e=a}return s}function Mg(e,t){const s=[];for(;e.nextElementSibling;){const a=e.nextElementSibling;t?a.matches(t)&&s.push(a):s.push(a),e=a}return s}function us(e,t){return st().getComputedStyle(e,null).getPropertyValue(t)}function Gr(e){let t=e,s;if(t){for(s=0;(t=t.previousSibling)!==null;)t.nodeType===1&&(s+=1);return s}}function Su(e,t){const s=[];let a=e.parentElement;for(;a;)t?a.matches(t)&&s.push(a):s.push(a),a=a.parentElement;return s}function xo(e,t,s){const a=st();return e[t==="width"?"offsetWidth":"offsetHeight"]+parseFloat(a.getComputedStyle(e,null).getPropertyValue(t==="width"?"margin-right":"margin-top"))+parseFloat(a.getComputedStyle(e,null).getPropertyValue(t==="width"?"margin-left":"margin-bottom"))}function Ht(e){return(Array.isArray(e)?e:[e]).filter(t=>!!t)}function dl(e,t=""){typeof trustedTypes<"u"?e.innerHTML=trustedTypes.createPolicy("html",{createHTML:s=>s}).createHTML(t):e.innerHTML=t}let Bn;function Rg(){const e=st(),t=Nt();return{smoothScroll:t.documentElement&&t.documentElement.style&&"scrollBehavior"in t.documentElement.style,touch:!!("ontouchstart"in e||e.DocumentTouch&&t instanceof e.DocumentTouch)}}function Eu(){return Bn||(Bn=Rg()),Bn}let Fn;function Dg({userAgent:e}={}){const t=Eu(),s=st(),a=s.navigator.platform,r=e||s.navigator.userAgent,n={ios:!1,android:!1},o=s.screen.width,i=s.screen.height,l=r.match(/(Android);?[\s\/]+([\d.]+)?/);let c=r.match(/(iPad)(?!\1).*OS\s([\d_]+)/);const d=r.match(/(iPod)(.*OS\s([\d_]+))?/),u=!c&&r.match(/(iPhone\sOS|iOS)\s([\d_]+)/),p=a==="Win32";let f=a==="MacIntel";const b=["1024x1366","1366x1024","834x1194","1194x834","834x1112","1112x834","768x1024","1024x768","820x1180","1180x820","810x1080","1080x810"];return!c&&f&&t.touch&&b.indexOf(`${o}x${i}`)>=0&&(c=r.match(/(Version)\/([\d.]+)/),c||(c=[0,1,"13_0_0"]),f=!1),l&&!p&&(n.os="android",n.android=!0),(c||u||d)&&(n.os="ios",n.ios=!0),n}function ku(e={}){return Fn||(Fn=Dg(e)),Fn}let zn;function Ng(){const e=st(),t=ku();let s=!1;function a(){const i=e.navigator.userAgent.toLowerCase();return i.indexOf("safari")>=0&&i.indexOf("chrome")<0&&i.indexOf("android")<0}if(a()){const i=String(e.navigator.userAgent);if(i.includes("Version/")){const[l,c]=i.split("Version/")[1].split(" ")[0].split(".").map(d=>Number(d));s=l<16||l===16&&c<2}}const r=/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(e.navigator.userAgent),n=a(),o=n||r&&t.ios;return{isSafari:s||n,needPerspectiveFix:s,need3dFix:o,isWebView:r}}function Au(){return zn||(zn=Ng()),zn}function Ig({swiper:e,on:t,emit:s}){const a=st();let r=null,n=null;const o=()=>{!e||e.destroyed||!e.initialized||(s("beforeResize"),s("resize"))},i=()=>{!e||e.destroyed||!e.initialized||(r=new ResizeObserver(d=>{n=a.requestAnimationFrame(()=>{const{width:u,height:p}=e;let f=u,b=p;d.forEach(({contentBoxSize:v,contentRect:y,target:m})=>{m&&m!==e.el||(f=y?y.width:(v[0]||v).inlineSize,b=y?y.height:(v[0]||v).blockSize)}),(f!==u||b!==p)&&o()})}),r.observe(e.el))},l=()=>{n&&a.cancelAnimationFrame(n),r&&r.unobserve&&e.el&&(r.unobserve(e.el),r=null)},c=()=>{!e||e.destroyed||!e.initialized||s("orientationchange")};t("init",()=>{if(e.params.resizeObserver&&typeof a.ResizeObserver<"u"){i();return}a.addEventListener("resize",o),a.addEventListener("orientationchange",c)}),t("destroy",()=>{l(),a.removeEventListener("resize",o),a.removeEventListener("orientationchange",c)})}function Bg({swiper:e,extendParams:t,on:s,emit:a}){const r=[],n=st(),o=(c,d={})=>{const u=n.MutationObserver||n.WebkitMutationObserver,p=new u(f=>{if(e.__preventObserver__)return;if(f.length===1){a("observerUpdate",f[0]);return}const b=function(){a("observerUpdate",f[0])};n.requestAnimationFrame?n.requestAnimationFrame(b):n.setTimeout(b,0)});p.observe(c,{attributes:typeof d.attributes>"u"?!0:d.attributes,childList:e.isElement||(typeof d.childList>"u"?!0:d).childList,characterData:typeof d.characterData>"u"?!0:d.characterData}),r.push(p)},i=()=>{if(e.params.observer){if(e.params.observeParents){const c=Su(e.hostEl);for(let d=0;d<c.length;d+=1)o(c[d])}o(e.hostEl,{childList:e.params.observeSlideChildren}),o(e.wrapperEl,{attributes:!1})}},l=()=>{r.forEach(c=>{c.disconnect()}),r.splice(0,r.length)};t({observer:!1,observeParents:!1,observeSlideChildren:!1}),s("init",i),s("destroy",l)}var Fg={on(e,t,s){const a=this;if(!a.eventsListeners||a.destroyed||typeof t!="function")return a;const r=s?"unshift":"push";return e.split(" ").forEach(n=>{a.eventsListeners[n]||(a.eventsListeners[n]=[]),a.eventsListeners[n][r](t)}),a},once(e,t,s){const a=this;if(!a.eventsListeners||a.destroyed||typeof t!="function")return a;function r(...n){a.off(e,r),r.__emitterProxy&&delete r.__emitterProxy,t.apply(a,n)}return r.__emitterProxy=t,a.on(e,r,s)},onAny(e,t){const s=this;if(!s.eventsListeners||s.destroyed||typeof e!="function")return s;const a=t?"unshift":"push";return s.eventsAnyListeners.indexOf(e)<0&&s.eventsAnyListeners[a](e),s},offAny(e){const t=this;if(!t.eventsListeners||t.destroyed||!t.eventsAnyListeners)return t;const s=t.eventsAnyListeners.indexOf(e);return s>=0&&t.eventsAnyListeners.splice(s,1),t},off(e,t){const s=this;return!s.eventsListeners||s.destroyed||!s.eventsListeners||e.split(" ").forEach(a=>{typeof t>"u"?s.eventsListeners[a]=[]:s.eventsListeners[a]&&s.eventsListeners[a].forEach((r,n)=>{(r===t||r.__emitterProxy&&r.__emitterProxy===t)&&s.eventsListeners[a].splice(n,1)})}),s},emit(...e){const t=this;if(!t.eventsListeners||t.destroyed||!t.eventsListeners)return t;let s,a,r;return typeof e[0]=="string"||Array.isArray(e[0])?(s=e[0],a=e.slice(1,e.length),r=t):(s=e[0].events,a=e[0].data,r=e[0].context||t),a.unshift(r),(Array.isArray(s)?s:s.split(" ")).forEach(o=>{t.eventsAnyListeners&&t.eventsAnyListeners.length&&t.eventsAnyListeners.forEach(i=>{i.apply(r,[o,...a])}),t.eventsListeners&&t.eventsListeners[o]&&t.eventsListeners[o].forEach(i=>{i.apply(r,a)})}),t}};function zg(){const e=this;let t,s;const a=e.el;typeof e.params.width<"u"&&e.params.width!==null?t=e.params.width:t=a.clientWidth,typeof e.params.height<"u"&&e.params.height!==null?s=e.params.height:s=a.clientHeight,!(t===0&&e.isHorizontal()||s===0&&e.isVertical())&&(t=t-parseInt(us(a,"padding-left")||0,10)-parseInt(us(a,"padding-right")||0,10),s=s-parseInt(us(a,"padding-top")||0,10)-parseInt(us(a,"padding-bottom")||0,10),Number.isNaN(t)&&(t=0),Number.isNaN(s)&&(s=0),Object.assign(e,{width:t,height:s,size:e.isHorizontal()?t:s}))}function Hg(){const e=this;function t(C,$){return parseFloat(C.getPropertyValue(e.getDirectionLabel($))||0)}const s=e.params,{wrapperEl:a,slidesEl:r,rtlTranslate:n,wrongRTL:o}=e,i=e.virtual&&s.virtual.enabled,l=i?e.virtual.slides.length:e.slides.length,c=Rt(r,`.${e.params.slideClass}, swiper-slide`),d=i?e.virtual.slides.length:c.length;let u=[];const p=[],f=[];let b=s.slidesOffsetBefore;typeof b=="function"&&(b=s.slidesOffsetBefore.call(e));let v=s.slidesOffsetAfter;typeof v=="function"&&(v=s.slidesOffsetAfter.call(e));const y=e.snapGrid.length,m=e.slidesGrid.length,h=e.size-b-v;let _=s.spaceBetween,S=-b,g=0,w=0;if(typeof h>"u")return;typeof _=="string"&&_.indexOf("%")>=0?_=parseFloat(_.replace("%",""))/100*h:typeof _=="string"&&(_=parseFloat(_)),e.virtualSize=-_-b-v,c.forEach(C=>{n?C.style.marginLeft="":C.style.marginRight="",C.style.marginBottom="",C.style.marginTop=""}),s.centeredSlides&&s.cssMode&&(Is(a,"--swiper-centered-offset-before",""),Is(a,"--swiper-centered-offset-after","")),s.cssMode&&(Is(a,"--swiper-slides-offset-before",`${b}px`),Is(a,"--swiper-slides-offset-after",`${v}px`));const x=s.grid&&s.grid.rows>1&&e.grid;x?e.grid.initSlides(c):e.grid&&e.grid.unsetSlides();let T;const E=s.slidesPerView==="auto"&&s.breakpoints&&Object.keys(s.breakpoints).filter(C=>typeof s.breakpoints[C].slidesPerView<"u").length>0;for(let C=0;C<d;C+=1){T=0;const $=c[C];if(!($&&(x&&e.grid.updateSlide(C,$,c),us($,"display")==="none"))){if(i&&s.slidesPerView==="auto")s.virtual.slidesPerViewAutoSlideSize&&(T=s.virtual.slidesPerViewAutoSlideSize),T&&$&&(s.roundLengths&&(T=Math.floor(T)),$.style[e.getDirectionLabel("width")]=`${T}px`);else if(s.slidesPerView==="auto"){E&&($.style[e.getDirectionLabel("width")]="");const O=getComputedStyle($),F=$.style.transform,K=$.style.webkitTransform;if(F&&($.style.transform="none"),K&&($.style.webkitTransform="none"),s.roundLengths)T=e.isHorizontal()?xo($,"width"):xo($,"height");else{const U=t(O,"width"),ae=t(O,"padding-left"),W=t(O,"padding-right"),G=t(O,"margin-left"),re=t(O,"margin-right"),te=O.getPropertyValue("box-sizing");if(te&&te==="border-box")T=U+G+re;else{const{clientWidth:N,offsetWidth:V}=$;T=U+ae+W+G+re+(V-N)}}F&&($.style.transform=F),K&&($.style.webkitTransform=K),s.roundLengths&&(T=Math.floor(T))}else T=(h-(s.slidesPerView-1)*_)/s.slidesPerView,s.roundLengths&&(T=Math.floor(T)),$&&($.style[e.getDirectionLabel("width")]=`${T}px`);$&&($.swiperSlideSize=T),f.push(T),s.centeredSlides?(S=S+T/2+g/2+_,g===0&&C!==0&&(S=S-h/2-_),C===0&&(S=S-h/2-_),Math.abs(S)<1/1e3&&(S=0),s.roundLengths&&(S=Math.floor(S)),w%s.slidesPerGroup===0&&u.push(S),p.push(S)):(s.roundLengths&&(S=Math.floor(S)),(w-Math.min(e.params.slidesPerGroupSkip,w))%e.params.slidesPerGroup===0&&u.push(S),p.push(S),S=S+T+_),e.virtualSize+=T+_,g=T,w+=1}}if(e.virtualSize=Math.max(e.virtualSize,h)+v,n&&o&&(s.effect==="slide"||s.effect==="coverflow")&&(a.style.width=`${e.virtualSize+_}px`),s.setWrapperSize&&(a.style[e.getDirectionLabel("width")]=`${e.virtualSize+_}px`),x&&e.grid.updateWrapperSize(T,u),!s.centeredSlides){const C=s.slidesPerView!=="auto"&&s.slidesPerView%1!==0,$=s.snapToSlideEdge&&!s.loop&&(s.slidesPerView==="auto"||C);let O=u.length;if($){let K;if(s.slidesPerView==="auto"){K=1;let U=0;for(let ae=f.length-1;ae>=0&&(U+=f[ae]+(ae<f.length-1?_:0),U<=h);ae-=1)K=f.length-ae}else K=Math.floor(s.slidesPerView);O=Math.max(d-K,0)}const F=[];for(let K=0;K<u.length;K+=1){let U=u[K];s.roundLengths&&(U=Math.floor(U)),$?K<=O&&F.push(U):u[K]<=e.virtualSize-h&&F.push(U)}u=F,Math.floor(e.virtualSize-h)-Math.floor(u[u.length-1])>1&&($||u.push(e.virtualSize-h))}if(i&&s.loop){const C=f[0]+_;if(s.slidesPerGroup>1){const $=Math.ceil((e.virtual.slidesBefore+e.virtual.slidesAfter)/s.slidesPerGroup),O=C*s.slidesPerGroup;for(let F=0;F<$;F+=1)u.push(u[u.length-1]+O)}for(let $=0;$<e.virtual.slidesBefore+e.virtual.slidesAfter;$+=1)s.slidesPerGroup===1&&u.push(u[u.length-1]+C),p.push(p[p.length-1]+C),e.virtualSize+=C}if(u.length===0&&(u=[0]),_!==0){const C=e.isHorizontal()&&n?"marginLeft":e.getDirectionLabel("marginRight");c.filter(($,O)=>!s.cssMode||s.loop?!0:O!==c.length-1).forEach($=>{$.style[C]=`${_}px`})}if(s.centeredSlides&&s.centeredSlidesBounds){let C=0;f.forEach(O=>{C+=O+(_||0)}),C-=_;const $=C>h?C-h:0;u=u.map(O=>O<=0?-b:O>$?$+v:O)}if(s.centerInsufficientSlides){let C=0;if(f.forEach($=>{C+=$+(_||0)}),C-=_,C<h){const $=(h-C)/2;u.forEach((O,F)=>{u[F]=O-$}),p.forEach((O,F)=>{p[F]=O+$})}}if(Object.assign(e,{slides:c,snapGrid:u,slidesGrid:p,slidesSizesGrid:f}),s.centeredSlides&&s.cssMode&&!s.centeredSlidesBounds){Is(a,"--swiper-centered-offset-before",`${-u[0]}px`),Is(a,"--swiper-centered-offset-after",`${e.size/2-f[f.length-1]/2}px`);const C=-e.snapGrid[0],$=-e.slidesGrid[0];e.snapGrid=e.snapGrid.map(O=>O+C),e.slidesGrid=e.slidesGrid.map(O=>O+$)}if(d!==l&&e.emit("slidesLengthChange"),u.length!==y&&(e.params.watchOverflow&&e.checkOverflow(),e.emit("snapGridLengthChange")),p.length!==m&&e.emit("slidesGridLengthChange"),s.watchSlidesProgress&&e.updateSlidesOffset(),e.emit("slidesUpdated"),!i&&!s.cssMode&&(s.effect==="slide"||s.effect==="fade")){const C=`${s.containerModifierClass}backface-hidden`,$=e.el.classList.contains(C);d<=s.maxBackfaceHiddenSlides?$||e.el.classList.add(C):$&&e.el.classList.remove(C)}}function jg(e){const t=this,s=[],a=t.virtual&&t.params.virtual.enabled;let r=0,n;typeof e=="number"?t.setTransition(e):e===!0&&t.setTransition(t.params.speed);const o=i=>a?t.slides[t.getSlideIndexByData(i)]:t.slides[i];if(t.params.slidesPerView!=="auto"&&t.params.slidesPerView>1)if(t.params.centeredSlides)(t.visibleSlides||[]).forEach(i=>{s.push(i)});else for(n=0;n<Math.ceil(t.params.slidesPerView);n+=1){const i=t.activeIndex+n;if(i>t.slides.length&&!a)break;s.push(o(i))}else s.push(o(t.activeIndex));for(n=0;n<s.length;n+=1)if(typeof s[n]<"u"){const i=s[n].offsetHeight;r=i>r?i:r}(r||r===0)&&(t.wrapperEl.style.height=`${r}px`)}function Ug(){const e=this,t=e.slides,s=e.isElement?e.isHorizontal()?e.wrapperEl.offsetLeft:e.wrapperEl.offsetTop:0;for(let a=0;a<t.length;a+=1)t[a].swiperSlideOffset=(e.isHorizontal()?t[a].offsetLeft:t[a].offsetTop)-s-e.cssOverflowAdjustment()}const ul=(e,t,s)=>{t&&!e.classList.contains(s)?e.classList.add(s):!t&&e.classList.contains(s)&&e.classList.remove(s)};function qg(e=this&&this.translate||0){const t=this,s=t.params,{slides:a,rtlTranslate:r,snapGrid:n}=t;if(a.length===0)return;typeof a[0].swiperSlideOffset>"u"&&t.updateSlidesOffset();let o=-e;r&&(o=e),t.visibleSlidesIndexes=[],t.visibleSlides=[];let i=s.spaceBetween;typeof i=="string"&&i.indexOf("%")>=0?i=parseFloat(i.replace("%",""))/100*t.size:typeof i=="string"&&(i=parseFloat(i));for(let l=0;l<a.length;l+=1){const c=a[l];let d=c.swiperSlideOffset;s.cssMode&&s.centeredSlides&&(d-=a[0].swiperSlideOffset);const u=(o+(s.centeredSlides?t.minTranslate():0)-d)/(c.swiperSlideSize+i),p=(o-n[0]+(s.centeredSlides?t.minTranslate():0)-d)/(c.swiperSlideSize+i),f=-(o-d),b=f+t.slidesSizesGrid[l],v=f>=0&&f<=t.size-t.slidesSizesGrid[l],y=f>=0&&f<t.size-1||b>1&&b<=t.size||f<=0&&b>=t.size;y&&(t.visibleSlides.push(c),t.visibleSlidesIndexes.push(l)),ul(c,y,s.slideVisibleClass),ul(c,v,s.slideFullyVisibleClass),c.progress=r?-u:u,c.originalProgress=r?-p:p}}function Vg(e){const t=this;if(typeof e>"u"){const d=t.rtlTranslate?-1:1;e=t&&t.translate&&t.translate*d||0}const s=t.params,a=t.maxTranslate()-t.minTranslate();let{progress:r,isBeginning:n,isEnd:o,progressLoop:i}=t;const l=n,c=o;if(a===0)r=0,n=!0,o=!0;else{r=(e-t.minTranslate())/a;const d=Math.abs(e-t.minTranslate())<1,u=Math.abs(e-t.maxTranslate())<1;n=d||r<=0,o=u||r>=1,d&&(r=0),u&&(r=1)}if(s.loop){const d=t.getSlideIndexByData(0),u=t.getSlideIndexByData(t.slides.length-1),p=t.slidesGrid[d],f=t.slidesGrid[u],b=t.slidesGrid[t.slidesGrid.length-1],v=Math.abs(e);v>=p?i=(v-p)/b:i=(v+b-f)/b,i>1&&(i-=1)}Object.assign(t,{progress:r,progressLoop:i,isBeginning:n,isEnd:o}),(s.watchSlidesProgress||s.centeredSlides&&s.autoHeight)&&t.updateSlidesProgress(e),n&&!l&&t.emit("reachBeginning toEdge"),o&&!c&&t.emit("reachEnd toEdge"),(l&&!n||c&&!o)&&t.emit("fromEdge"),t.emit("progress",r)}const Hn=(e,t,s)=>{t&&!e.classList.contains(s)?e.classList.add(s):!t&&e.classList.contains(s)&&e.classList.remove(s)};function Gg(){const e=this,{slides:t,params:s,slidesEl:a,activeIndex:r}=e,n=e.virtual&&s.virtual.enabled,o=e.grid&&s.grid&&s.grid.rows>1,i=u=>Rt(a,`.${s.slideClass}${u}, swiper-slide${u}`)[0];let l,c,d;if(n)if(s.loop){let u=r-e.virtual.slidesBefore;u<0&&(u=e.virtual.slides.length+u),u>=e.virtual.slides.length&&(u-=e.virtual.slides.length),l=i(`[data-swiper-slide-index="${u}"]`)}else l=i(`[data-swiper-slide-index="${r}"]`);else o?(l=t.find(u=>u.column===r),d=t.find(u=>u.column===r+1),c=t.find(u=>u.column===r-1)):l=t[r];l&&(o||(d=Mg(l,`.${s.slideClass}, swiper-slide`)[0],s.loop&&!d&&(d=t[0]),c=Lg(l,`.${s.slideClass}, swiper-slide`)[0],s.loop&&!c===0&&(c=t[t.length-1]))),t.forEach(u=>{Hn(u,u===l,s.slideActiveClass),Hn(u,u===d,s.slideNextClass),Hn(u,u===c,s.slidePrevClass)}),e.emitSlidesClasses()}const Or=(e,t)=>{if(!e||e.destroyed||!e.params)return;const s=()=>e.isElement?"swiper-slide":`.${e.params.slideClass}`,a=t.closest(s());if(a){let r=a.querySelector(`.${e.params.lazyPreloaderClass}`);!r&&e.isElement&&(a.shadowRoot?r=a.shadowRoot.querySelector(`.${e.params.lazyPreloaderClass}`):requestAnimationFrame(()=>{a.shadowRoot&&(r=a.shadowRoot.querySelector(`.${e.params.lazyPreloaderClass}`),r&&!r.lazyPreloaderManaged&&r.remove())})),r&&!r.lazyPreloaderManaged&&r.remove()}},jn=(e,t)=>{if(!e.slides[t])return;const s=e.slides[t].querySelector('[loading="lazy"]');s&&s.removeAttribute("loading")},To=e=>{if(!e||e.destroyed||!e.params)return;let t=e.params.lazyPreloadPrevNext;const s=e.slides.length;if(!s||!t||t<0)return;t=Math.min(t,s);const a=e.params.slidesPerView==="auto"?e.slidesPerViewDynamic():Math.ceil(e.params.slidesPerView),r=e.activeIndex;if(e.params.grid&&e.params.grid.rows>1){const o=r,i=[o-t];i.push(...Array.from({length:t}).map((l,c)=>o+a+c)),e.slides.forEach((l,c)=>{i.includes(l.column)&&jn(e,c)});return}const n=r+a-1;if(e.params.rewind||e.params.loop)for(let o=r-t;o<=n+t;o+=1){const i=(o%s+s)%s;(i<r||i>n)&&jn(e,i)}else for(let o=Math.max(r-t,0);o<=Math.min(n+t,s-1);o+=1)o!==r&&(o>n||o<r)&&jn(e,o)};function Kg(e){const{slidesGrid:t,params:s}=e,a=e.rtlTranslate?e.translate:-e.translate;let r;for(let n=0;n<t.length;n+=1)typeof t[n+1]<"u"?a>=t[n]&&a<t[n+1]-(t[n+1]-t[n])/2?r=n:a>=t[n]&&a<t[n+1]&&(r=n+1):a>=t[n]&&(r=n);return s.normalizeSlideIndex&&(r<0||typeof r>"u")&&(r=0),r}function Yg(e){const t=this,s=t.rtlTranslate?t.translate:-t.translate,{snapGrid:a,params:r,activeIndex:n,realIndex:o,snapIndex:i}=t;let l=e,c;const d=f=>{let b=f-t.virtual.slidesBefore;return b<0&&(b=t.virtual.slides.length+b),b>=t.virtual.slides.length&&(b-=t.virtual.slides.length),b};if(typeof l>"u"&&(l=Kg(t)),a.indexOf(s)>=0)c=a.indexOf(s);else{const f=Math.min(r.slidesPerGroupSkip,l);c=f+Math.floor((l-f)/r.slidesPerGroup)}if(c>=a.length&&(c=a.length-1),l===n&&!t.params.loop){c!==i&&(t.snapIndex=c,t.emit("snapIndexChange"));return}if(l===n&&t.params.loop&&t.virtual&&t.params.virtual.enabled){t.realIndex=d(l);return}const u=t.grid&&r.grid&&r.grid.rows>1;let p;if(t.virtual&&r.virtual.enabled)r.loop?p=d(l):p=l;else if(u){const f=t.slides.find(v=>v.column===l);let b=parseInt(f.getAttribute("data-swiper-slide-index"),10);Number.isNaN(b)&&(b=Math.max(t.slides.indexOf(f),0)),p=Math.floor(b/r.grid.rows)}else if(t.slides[l]){const f=t.slides[l].getAttribute("data-swiper-slide-index");f?p=parseInt(f,10):p=l}else p=l;Object.assign(t,{previousSnapIndex:i,snapIndex:c,previousRealIndex:o,realIndex:p,previousIndex:n,activeIndex:l}),t.initialized&&To(t),t.emit("activeIndexChange"),t.emit("snapIndexChange"),(t.initialized||t.params.runCallbacksOnInit)&&(o!==p&&t.emit("realIndexChange"),t.emit("slideChange"))}function Wg(e,t){const s=this,a=s.params;let r=e.closest(`.${a.slideClass}, swiper-slide`);!r&&s.isElement&&t&&t.length>1&&t.includes(e)&&[...t.slice(t.indexOf(e)+1,t.length)].forEach(i=>{!r&&i.matches&&i.matches(`.${a.slideClass}, swiper-slide`)&&(r=i)});let n=!1,o;if(r){for(let i=0;i<s.slides.length;i+=1)if(s.slides[i]===r){n=!0,o=i;break}}if(r&&n)s.clickedSlide=r,s.virtual&&s.params.virtual.enabled?s.clickedIndex=parseInt(r.getAttribute("data-swiper-slide-index"),10):s.clickedIndex=o;else{s.clickedSlide=void 0,s.clickedIndex=void 0;return}a.slideToClickedSlide&&s.clickedIndex!==void 0&&s.clickedIndex!==s.activeIndex&&s.slideToClickedSlide()}var Jg={updateSize:zg,updateSlides:Hg,updateAutoHeight:jg,updateSlidesOffset:Ug,updateSlidesProgress:qg,updateProgress:Vg,updateSlidesClasses:Gg,updateActiveIndex:Yg,updateClickedSlide:Wg};function Xg(e=this.isHorizontal()?"x":"y"){const t=this,{params:s,rtlTranslate:a,translate:r,wrapperEl:n}=t;if(s.virtualTranslate)return a?-r:r;if(s.cssMode)return r;let o=Pg(n,e);return o+=t.cssOverflowAdjustment(),a&&(o=-o),o||0}function Qg(e,t){const s=this,{rtlTranslate:a,params:r,wrapperEl:n,progress:o}=s;let i=0,l=0;const c=0;s.isHorizontal()?i=a?-e:e:l=e,r.roundLengths&&(i=Math.floor(i),l=Math.floor(l)),s.previousTranslate=s.translate,s.translate=s.isHorizontal()?i:l,r.cssMode?n[s.isHorizontal()?"scrollLeft":"scrollTop"]=s.isHorizontal()?-i:-l:r.virtualTranslate||(s.isHorizontal()?i-=s.cssOverflowAdjustment():l-=s.cssOverflowAdjustment(),n.style.transform=`translate3d(${i}px, ${l}px, ${c}px)`);let d;const u=s.maxTranslate()-s.minTranslate();u===0?d=0:d=(e-s.minTranslate())/u,d!==o&&s.updateProgress(e),s.emit("setTranslate",s.translate,t)}function Zg(){return-this.snapGrid[0]}function eb(){return-this.snapGrid[this.snapGrid.length-1]}function tb(e=0,t=this.params.speed,s=!0,a=!0,r){const n=this,{params:o,wrapperEl:i}=n;if(n.animating&&o.preventInteractionOnTransition)return!1;const l=n.minTranslate(),c=n.maxTranslate();let d;if(a&&e>l?d=l:a&&e<c?d=c:d=e,n.updateProgress(d),o.cssMode){const u=n.isHorizontal();if(t===0)i[u?"scrollLeft":"scrollTop"]=-d;else{if(!n.support.smoothScroll)return Tu({swiper:n,targetPosition:-d,side:u?"left":"top"}),!0;i.scrollTo({[u?"left":"top"]:-d,behavior:"smooth"})}return!0}return t===0?(n.setTransition(0),n.setTranslate(d),s&&(n.emit("beforeTransitionStart",t,r),n.emit("transitionEnd"))):(n.setTransition(t),n.setTranslate(d),s&&(n.emit("beforeTransitionStart",t,r),n.emit("transitionStart")),n.animating||(n.animating=!0,n.onTranslateToWrapperTransitionEnd||(n.onTranslateToWrapperTransitionEnd=function(p){!n||n.destroyed||p.target===this&&(n.wrapperEl.removeEventListener("transitionend",n.onTranslateToWrapperTransitionEnd),n.onTranslateToWrapperTransitionEnd=null,delete n.onTranslateToWrapperTransitionEnd,n.animating=!1,s&&n.emit("transitionEnd"))}),n.wrapperEl.addEventListener("transitionend",n.onTranslateToWrapperTransitionEnd))),!0}var sb={getTranslate:Xg,setTranslate:Qg,minTranslate:Zg,maxTranslate:eb,translateTo:tb};function ab(e,t){const s=this;s.params.cssMode||(s.wrapperEl.style.transitionDuration=`${e}ms`,s.wrapperEl.style.transitionDelay=e===0?"0ms":""),s.emit("setTransition",e,t)}function Pu({swiper:e,runCallbacks:t,direction:s,step:a}){const{activeIndex:r,previousIndex:n}=e;let o=s;o||(r>n?o="next":r<n?o="prev":o="reset"),e.emit(`transition${a}`),t&&o==="reset"?e.emit(`slideResetTransition${a}`):t&&r!==n&&(e.emit(`slideChangeTransition${a}`),o==="next"?e.emit(`slideNextTransition${a}`):e.emit(`slidePrevTransition${a}`))}function rb(e=!0,t){const s=this,{params:a}=s;a.cssMode||(a.autoHeight&&s.updateAutoHeight(),Pu({swiper:s,runCallbacks:e,direction:t,step:"Start"}))}function nb(e=!0,t){const s=this,{params:a}=s;s.animating=!1,!a.cssMode&&(s.setTransition(0),Pu({swiper:s,runCallbacks:e,direction:t,step:"End"}))}var ob={setTransition:ab,transitionStart:rb,transitionEnd:nb};function ib(e=0,t,s=!0,a,r){typeof e=="string"&&(e=parseInt(e,10));const n=this;let o=e;o<0&&(o=0);const{params:i,snapGrid:l,slidesGrid:c,previousIndex:d,activeIndex:u,rtlTranslate:p,wrapperEl:f,enabled:b}=n;if(!b&&!a&&!r||n.destroyed||n.animating&&i.preventInteractionOnTransition)return!1;typeof t>"u"&&(t=n.params.speed);const v=Math.min(n.params.slidesPerGroupSkip,o);let y=v+Math.floor((o-v)/n.params.slidesPerGroup);y>=l.length&&(y=l.length-1);const m=-l[y];if(i.normalizeSlideIndex)for(let x=0;x<c.length;x+=1){const T=-Math.floor(m*100),E=Math.floor(c[x]*100),C=Math.floor(c[x+1]*100);typeof c[x+1]<"u"?T>=E&&T<C-(C-E)/2?o=x:T>=E&&T<C&&(o=x+1):T>=E&&(o=x)}if(n.initialized&&o!==u&&(!n.allowSlideNext&&(p?m>n.translate&&m>n.minTranslate():m<n.translate&&m<n.minTranslate())||!n.allowSlidePrev&&m>n.translate&&m>n.maxTranslate()&&(u||0)!==o))return!1;o!==(d||0)&&s&&n.emit("beforeSlideChangeStart"),n.updateProgress(m);let h;o>u?h="next":o<u?h="prev":h="reset";const _=n.virtual&&n.params.virtual.enabled;if(!(_&&r)&&(p&&-m===n.translate||!p&&m===n.translate))return n.updateActiveIndex(o),i.autoHeight&&n.updateAutoHeight(),n.updateSlidesClasses(),i.effect!=="slide"&&n.setTranslate(m),h!=="reset"&&(n.transitionStart(s,h),n.transitionEnd(s,h)),!1;if(i.cssMode){const x=n.isHorizontal(),T=p?m:-m;if(t===0)_&&(n.wrapperEl.style.scrollSnapType="none",n._immediateVirtual=!0),_&&!n._cssModeVirtualInitialSet&&n.params.initialSlide>0?(n._cssModeVirtualInitialSet=!0,requestAnimationFrame(()=>{f[x?"scrollLeft":"scrollTop"]=T})):f[x?"scrollLeft":"scrollTop"]=T,_&&requestAnimationFrame(()=>{n.wrapperEl.style.scrollSnapType="",n._immediateVirtual=!1});else{if(!n.support.smoothScroll)return Tu({swiper:n,targetPosition:T,side:x?"left":"top"}),!0;f.scrollTo({[x?"left":"top"]:T,behavior:"smooth"})}return!0}const w=Au().isSafari;return _&&!r&&w&&n.isElement&&n.virtual.update(!1,!1,o),n.setTransition(t),n.setTranslate(m),n.updateActiveIndex(o),n.updateSlidesClasses(),n.emit("beforeTransitionStart",t,a),n.transitionStart(s,h),t===0?n.transitionEnd(s,h):n.animating||(n.animating=!0,n.onSlideToWrapperTransitionEnd||(n.onSlideToWrapperTransitionEnd=function(T){!n||n.destroyed||T.target===this&&(n.wrapperEl.removeEventListener("transitionend",n.onSlideToWrapperTransitionEnd),n.onSlideToWrapperTransitionEnd=null,delete n.onSlideToWrapperTransitionEnd,n.transitionEnd(s,h))}),n.wrapperEl.addEventListener("transitionend",n.onSlideToWrapperTransitionEnd)),!0}function lb(e=0,t,s=!0,a){typeof e=="string"&&(e=parseInt(e,10));const r=this;if(r.destroyed)return;typeof t>"u"&&(t=r.params.speed);const n=r.grid&&r.params.grid&&r.params.grid.rows>1;let o=e;if(r.params.loop)if(r.virtual&&r.params.virtual.enabled)o=o+r.virtual.slidesBefore;else{let i;if(n){const v=o*r.params.grid.rows;i=r.slides.find(y=>y.getAttribute("data-swiper-slide-index")*1===v).column}else i=r.getSlideIndexByData(o);const l=n?Math.ceil(r.slides.length/r.params.grid.rows):r.slides.length,{centeredSlides:c,slidesOffsetBefore:d,slidesOffsetAfter:u}=r.params,p=c||!!d||!!u;let f=r.params.slidesPerView;f==="auto"?f=r.slidesPerViewDynamic():(f=Math.ceil(parseFloat(r.params.slidesPerView,10)),p&&f%2===0&&(f=f+1));let b=l-i<f;if(p&&(b=b||i<Math.ceil(f/2)),a&&p&&r.params.slidesPerView!=="auto"&&!n&&(b=!1),b){const v=p?i<r.activeIndex?"prev":"next":i-r.activeIndex-1<r.params.slidesPerView?"next":"prev";r.loopFix({direction:v,slideTo:!0,activeSlideIndex:v==="next"?i+1:i-l+1,slideRealIndex:v==="next"?r.realIndex:void 0})}if(n){const v=o*r.params.grid.rows;o=r.slides.find(y=>y.getAttribute("data-swiper-slide-index")*1===v).column}else o=r.getSlideIndexByData(o)}return requestAnimationFrame(()=>{r.slideTo(o,t,s,a)}),r}function cb(e,t=!0,s){const a=this,{enabled:r,params:n,animating:o}=a;if(!r||a.destroyed)return a;typeof e>"u"&&(e=a.params.speed);let i=n.slidesPerGroup;n.slidesPerView==="auto"&&n.slidesPerGroup===1&&n.slidesPerGroupAuto&&(i=Math.max(a.slidesPerViewDynamic("current",!0),1));const l=a.activeIndex<n.slidesPerGroupSkip?1:i,c=a.virtual&&n.virtual.enabled;if(n.loop){if(o&&!c&&n.loopPreventsSliding)return!1;if(a.loopFix({direction:"next"}),a._clientLeft=a.wrapperEl.clientLeft,a.activeIndex===a.slides.length-1&&n.cssMode)return requestAnimationFrame(()=>{a.slideTo(a.activeIndex+l,e,t,s)}),!0}return n.rewind&&a.isEnd?a.slideTo(0,e,t,s):a.slideTo(a.activeIndex+l,e,t,s)}function db(e,t=!0,s){const a=this,{params:r,snapGrid:n,slidesGrid:o,rtlTranslate:i,enabled:l,animating:c}=a;if(!l||a.destroyed)return a;typeof e>"u"&&(e=a.params.speed);const d=a.virtual&&r.virtual.enabled;if(r.loop){if(c&&!d&&r.loopPreventsSliding)return!1;a.loopFix({direction:"prev"}),a._clientLeft=a.wrapperEl.clientLeft}const u=i?a.translate:-a.translate;function p(h){return h<0?-Math.floor(Math.abs(h)):Math.floor(h)}const f=p(u),b=n.map(h=>p(h)),v=r.freeMode&&r.freeMode.enabled;let y=n[b.indexOf(f)-1];if(typeof y>"u"&&(r.cssMode||v)){let h;n.forEach((_,S)=>{f>=_&&(h=S)}),typeof h<"u"&&(y=v?n[h]:n[h>0?h-1:h])}let m=0;if(typeof y<"u"&&(m=o.indexOf(y),m<0&&(m=a.activeIndex-1),r.slidesPerView==="auto"&&r.slidesPerGroup===1&&r.slidesPerGroupAuto&&(m=m-a.slidesPerViewDynamic("previous",!0)+1,m=Math.max(m,0))),r.rewind&&a.isBeginning){const h=a.params.virtual&&a.params.virtual.enabled&&a.virtual?a.virtual.slides.length-1:a.slides.length-1;return a.slideTo(h,e,t,s)}else if(r.loop&&a.activeIndex===0&&r.cssMode)return requestAnimationFrame(()=>{a.slideTo(m,e,t,s)}),!0;return a.slideTo(m,e,t,s)}function ub(e,t=!0,s){const a=this;if(!a.destroyed)return typeof e>"u"&&(e=a.params.speed),a.slideTo(a.activeIndex,e,t,s)}function pb(e,t=!0,s,a=.5){const r=this;if(r.destroyed)return;typeof e>"u"&&(e=r.params.speed);let n=r.activeIndex;const o=Math.min(r.params.slidesPerGroupSkip,n),i=o+Math.floor((n-o)/r.params.slidesPerGroup),l=r.rtlTranslate?r.translate:-r.translate;if(l>=r.snapGrid[i]){const c=r.snapGrid[i],d=r.snapGrid[i+1];l-c>(d-c)*a&&(n+=r.params.slidesPerGroup)}else{const c=r.snapGrid[i-1],d=r.snapGrid[i];l-c<=(d-c)*a&&(n-=r.params.slidesPerGroup)}return n=Math.max(n,0),n=Math.min(n,r.slidesGrid.length-1),r.slideTo(n,e,t,s)}function fb(){const e=this;if(e.destroyed)return;const{params:t,slidesEl:s}=e,a=t.slidesPerView==="auto"?e.slidesPerViewDynamic():t.slidesPerView;let r=e.getSlideIndexWhenGrid(e.clickedIndex),n;const o=e.isElement?"swiper-slide":`.${t.slideClass}`,i=e.grid&&e.params.grid&&e.params.grid.rows>1;if(t.loop){if(e.animating)return;n=parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"),10),t.centeredSlides?e.slideToLoop(n):r>(i?(e.slides.length-a)/2-(e.params.grid.rows-1):e.slides.length-a)?(e.loopFix(),r=e.getSlideIndex(Rt(s,`${o}[data-swiper-slide-index="${n}"]`)[0]),xu(()=>{e.slideTo(r)})):e.slideTo(r)}else e.slideTo(r)}var hb={slideTo:ib,slideToLoop:lb,slideNext:cb,slidePrev:db,slideReset:ub,slideToClosest:pb,slideToClickedSlide:fb};function mb(e,t){const s=this,{params:a,slidesEl:r}=s;if(!a.loop||s.virtual&&s.params.virtual.enabled)return;const n=()=>{Rt(r,`.${a.slideClass}, swiper-slide`).forEach((b,v)=>{b.setAttribute("data-swiper-slide-index",v)})},o=()=>{const f=Rt(r,`.${a.slideBlankClass}`);f.forEach(b=>{b.remove()}),f.length>0&&(s.recalcSlides(),s.updateSlides())},i=s.grid&&a.grid&&a.grid.rows>1;a.loopAddBlankSlides&&(a.slidesPerGroup>1||i)&&o();const l=a.slidesPerGroup*(i?a.grid.rows:1),c=s.slides.length%l!==0,d=i&&s.slides.length%a.grid.rows!==0,u=f=>{for(let b=0;b<f;b+=1){const v=s.isElement?Vr("swiper-slide",[a.slideBlankClass]):Vr("div",[a.slideClass,a.slideBlankClass]);s.slidesEl.append(v)}};if(c){if(a.loopAddBlankSlides){const f=l-s.slides.length%l;u(f),s.recalcSlides(),s.updateSlides()}else qr("Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)");n()}else if(d){if(a.loopAddBlankSlides){const f=a.grid.rows-s.slides.length%a.grid.rows;u(f),s.recalcSlides(),s.updateSlides()}else qr("Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)");n()}else n();const p=a.centeredSlides||!!a.slidesOffsetBefore||!!a.slidesOffsetAfter;s.loopFix({slideRealIndex:e,direction:p?void 0:"next",initial:t})}function gb({slideRealIndex:e,slideTo:t=!0,direction:s,setTranslate:a,activeSlideIndex:r,initial:n,byController:o,byMousewheel:i}={}){const l=this;if(!l.params.loop)return;l.emit("beforeLoopFix");const{slides:c,allowSlidePrev:d,allowSlideNext:u,slidesEl:p,params:f}=l,{centeredSlides:b,slidesOffsetBefore:v,slidesOffsetAfter:y,initialSlide:m}=f,h=b||!!v||!!y;if(l.allowSlidePrev=!0,l.allowSlideNext=!0,l.virtual&&f.virtual.enabled){t&&(!h&&l.snapIndex===0?l.slideTo(l.virtual.slides.length,0,!1,!0):h&&l.snapIndex<f.slidesPerView?l.slideTo(l.virtual.slides.length+l.snapIndex,0,!1,!0):l.snapIndex===l.snapGrid.length-1&&l.slideTo(l.virtual.slidesBefore,0,!1,!0)),l.allowSlidePrev=d,l.allowSlideNext=u,l.emit("loopFix");return}let _=f.slidesPerView;_==="auto"?_=l.slidesPerViewDynamic():(_=Math.ceil(parseFloat(f.slidesPerView,10)),h&&_%2===0&&(_=_+1));const S=f.slidesPerGroupAuto?_:f.slidesPerGroup;let g=h?Math.max(S,Math.ceil(_/2)):S;g%S!==0&&(g+=S-g%S),g+=f.loopAdditionalSlides,l.loopedSlides=g;const w=l.grid&&f.grid&&f.grid.rows>1;c.length<_+g||l.params.effect==="cards"&&c.length<_+g*2?qr("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters"):w&&f.grid.fill==="row"&&qr("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");const x=[],T=[],E=w?Math.ceil(c.length/f.grid.rows):c.length,C=n&&E-m<_&&!h;let $=C?m:l.activeIndex;typeof r>"u"?r=l.getSlideIndex(c.find(G=>G.classList.contains(f.slideActiveClass))):$=r;const O=s==="next"||!s,F=s==="prev"||!s;let K=0,U=0;const W=(w?c[r].column:r)+(h&&typeof a>"u"?-_/2+.5:0);if(W<g){K=Math.max(g-W,S);for(let G=0;G<g-W;G+=1){const re=G-Math.floor(G/E)*E;if(w){const te=E-re-1;for(let N=c.length-1;N>=0;N-=1)c[N].column===te&&x.push(N)}else x.push(E-re-1)}}else if(W+_>E-g){U=Math.max(W-(E-g*2),S),C&&(U=Math.max(U,_-E+m+1));for(let G=0;G<U;G+=1){const re=G-Math.floor(G/E)*E;w?c.forEach((te,N)=>{te.column===re&&T.push(N)}):T.push(re)}}if(l.__preventObserver__=!0,requestAnimationFrame(()=>{l.__preventObserver__=!1}),l.params.effect==="cards"&&c.length<_+g*2&&(T.includes(r)&&T.splice(T.indexOf(r),1),x.includes(r)&&x.splice(x.indexOf(r),1)),F&&x.forEach(G=>{c[G].swiperLoopMoveDOM=!0,p.prepend(c[G]),c[G].swiperLoopMoveDOM=!1}),O&&T.forEach(G=>{c[G].swiperLoopMoveDOM=!0,p.append(c[G]),c[G].swiperLoopMoveDOM=!1}),l.recalcSlides(),f.slidesPerView==="auto"?l.updateSlides():w&&(x.length>0&&F||T.length>0&&O)&&l.slides.forEach((G,re)=>{l.grid.updateSlide(re,G,l.slides)}),f.watchSlidesProgress&&l.updateSlidesOffset(),t){if(x.length>0&&F){if(typeof e>"u"){const G=l.slidesGrid[$],te=l.slidesGrid[$+K]-G;i?l.setTranslate(l.translate-te):(l.slideTo($+Math.ceil(K),0,!1,!0),a&&(l.touchEventsData.startTranslate=l.touchEventsData.startTranslate-te,l.touchEventsData.currentTranslate=l.touchEventsData.currentTranslate-te))}else if(a){const G=w?x.length/f.grid.rows:x.length;l.slideTo(l.activeIndex+G,0,!1,!0),l.touchEventsData.currentTranslate=l.translate}}else if(T.length>0&&O)if(typeof e>"u"){const G=l.slidesGrid[$],te=l.slidesGrid[$-U]-G;i?l.setTranslate(l.translate-te):(l.slideTo($-U,0,!1,!0),a&&(l.touchEventsData.startTranslate=l.touchEventsData.startTranslate-te,l.touchEventsData.currentTranslate=l.touchEventsData.currentTranslate-te))}else{const G=w?T.length/f.grid.rows:T.length;l.slideTo(l.activeIndex-G,0,!1,!0)}}if(l.allowSlidePrev=d,l.allowSlideNext=u,l.controller&&l.controller.control&&!o){const G={slideRealIndex:e,direction:s,setTranslate:a,activeSlideIndex:r,byController:!0};Array.isArray(l.controller.control)?l.controller.control.forEach(re=>{!re.destroyed&&re.params.loop&&re.loopFix({...G,slideTo:re.params.slidesPerView===f.slidesPerView?t:!1})}):l.controller.control instanceof l.constructor&&l.controller.control.params.loop&&l.controller.control.loopFix({...G,slideTo:l.controller.control.params.slidesPerView===f.slidesPerView?t:!1})}l.emit("loopFix")}function bb(){const e=this,{params:t,slidesEl:s}=e;if(!t.loop||!s||e.virtual&&e.params.virtual.enabled)return;e.recalcSlides();const a=[];e.slides.forEach(r=>{const n=typeof r.swiperSlideIndex>"u"?r.getAttribute("data-swiper-slide-index")*1:r.swiperSlideIndex;a[n]=r}),e.slides.forEach(r=>{r.removeAttribute("data-swiper-slide-index")}),a.forEach(r=>{s.append(r)}),e.recalcSlides(),e.slideTo(e.realIndex,0)}var _b={loopCreate:mb,loopFix:gb,loopDestroy:bb};function vb(e){const t=this;if(!t.params.simulateTouch||t.params.watchOverflow&&t.isLocked||t.params.cssMode)return;const s=t.params.touchEventsTarget==="container"?t.el:t.wrapperEl;t.isElement&&(t.__preventObserver__=!0),s.style.cursor="move",s.style.cursor=e?"grabbing":"grab",t.isElement&&requestAnimationFrame(()=>{t.__preventObserver__=!1})}function yb(){const e=this;e.params.watchOverflow&&e.isLocked||e.params.cssMode||(e.isElement&&(e.__preventObserver__=!0),e[e.params.touchEventsTarget==="container"?"el":"wrapperEl"].style.cursor="",e.isElement&&requestAnimationFrame(()=>{e.__preventObserver__=!1}))}var wb={setGrabCursor:vb,unsetGrabCursor:yb};function xb(e,t=this){function s(a){if(!a||a===Nt()||a===st())return null;a.assignedSlot&&(a=a.assignedSlot);const r=a.closest(e);return!r&&!a.getRootNode?null:r||s(a.getRootNode().host)}return s(t)}function pl(e,t,s){const a=st(),{params:r}=e,n=r.edgeSwipeDetection,o=r.edgeSwipeThreshold;return n&&(s<=o||s>=a.innerWidth-o)?n==="prevent"?(t.preventDefault(),!0):!1:!0}function Tb(e){const t=this,s=Nt();let a=e;a.originalEvent&&(a=a.originalEvent);const r=t.touchEventsData;if(a.type==="pointerdown"){if(r.pointerId!==null&&r.pointerId!==a.pointerId)return;r.pointerId=a.pointerId}else a.type==="touchstart"&&a.targetTouches.length===1&&(r.touchId=a.targetTouches[0].identifier);if(a.type==="touchstart"){pl(t,a,a.targetTouches[0].pageX);return}const{params:n,touches:o,enabled:i}=t;if(!i||!n.simulateTouch&&a.pointerType==="mouse"||t.animating&&n.preventInteractionOnTransition)return;!t.animating&&n.cssMode&&n.loop&&t.loopFix();let l=a.target;if(n.touchEventsTarget==="wrapper"&&!$g(l,t.wrapperEl)||"which"in a&&a.which===3||"button"in a&&a.button>0||r.isTouched&&r.isMoved)return;const c=!!n.noSwipingClass&&n.noSwipingClass!=="",d=a.composedPath?a.composedPath():a.path;c&&a.target&&a.target.shadowRoot&&d&&(l=d[0]);const u=n.noSwipingSelector?n.noSwipingSelector:`.${n.noSwipingClass}`,p=!!(a.target&&a.target.shadowRoot);if(n.noSwiping&&(p?xb(u,l):l.closest(u))){t.allowClick=!0;return}if(n.swipeHandler&&!l.closest(n.swipeHandler))return;o.currentX=a.pageX,o.currentY=a.pageY;const f=o.currentX,b=o.currentY;if(!pl(t,a,f))return;Object.assign(r,{isTouched:!0,isMoved:!1,allowTouchCallbacks:!0,isScrolling:void 0,startMoving:void 0}),o.startX=f,o.startY=b,r.touchStartTime=Ur(),t.allowClick=!0,t.updateSize(),t.swipeDirection=void 0,n.threshold>0&&(r.allowThresholdMove=!1);let v=!0;l.matches(r.focusableElements)&&(v=!1,l.nodeName==="SELECT"&&(r.isTouched=!1)),s.activeElement&&s.activeElement.matches(r.focusableElements)&&s.activeElement!==l&&(a.pointerType==="mouse"||a.pointerType!=="mouse"&&!l.matches(r.focusableElements))&&s.activeElement.blur();const y=v&&t.allowTouchMove&&n.touchStartPreventDefault;(n.touchStartForcePreventDefault||y)&&!l.isContentEditable&&a.preventDefault(),n.freeMode&&n.freeMode.enabled&&t.freeMode&&t.animating&&!n.cssMode&&t.freeMode.onTouchStart(),t.emit("touchStart",a)}function Sb(e){const t=Nt(),s=this,a=s.touchEventsData,{params:r,touches:n,rtlTranslate:o,enabled:i}=s;if(!i||!r.simulateTouch&&e.pointerType==="mouse")return;let l=e;if(l.originalEvent&&(l=l.originalEvent),l.type==="pointermove"&&(a.touchId!==null||l.pointerId!==a.pointerId))return;let c;if(l.type==="touchmove"){if(c=[...l.changedTouches].find(g=>g.identifier===a.touchId),!c||c.identifier!==a.touchId)return}else c=l;if(!a.isTouched){a.startMoving&&a.isScrolling&&s.emit("touchMoveOpposite",l);return}const d=c.pageX,u=c.pageY;if(l.preventedByNestedSwiper){n.startX=d,n.startY=u;return}if(!s.allowTouchMove){l.target.matches(a.focusableElements)||(s.allowClick=!1),a.isTouched&&(Object.assign(n,{startX:d,startY:u,currentX:d,currentY:u}),a.touchStartTime=Ur());return}if(r.touchReleaseOnEdges&&!r.loop)if(s.isVertical()){if(u<n.startY&&s.translate<=s.maxTranslate()||u>n.startY&&s.translate>=s.minTranslate()){a.isTouched=!1,a.isMoved=!1;return}}else{if(o&&(d>n.startX&&-s.translate<=s.maxTranslate()||d<n.startX&&-s.translate>=s.minTranslate()))return;if(!o&&(d<n.startX&&s.translate<=s.maxTranslate()||d>n.startX&&s.translate>=s.minTranslate()))return}if(t.activeElement&&t.activeElement.matches(a.focusableElements)&&t.activeElement!==l.target&&l.pointerType!=="mouse"&&t.activeElement.blur(),t.activeElement&&l.target===t.activeElement&&l.target.matches(a.focusableElements)){a.isMoved=!0,s.allowClick=!1;return}a.allowTouchCallbacks&&s.emit("touchMove",l),n.previousX=n.currentX,n.previousY=n.currentY,n.currentX=d,n.currentY=u;const p=n.currentX-n.startX,f=n.currentY-n.startY;if(s.params.threshold&&Math.sqrt(p**2+f**2)<s.params.threshold)return;if(typeof a.isScrolling>"u"){let g;s.isHorizontal()&&n.currentY===n.startY||s.isVertical()&&n.currentX===n.startX?a.isScrolling=!1:p*p+f*f>=25&&(g=Math.atan2(Math.abs(f),Math.abs(p))*180/Math.PI,a.isScrolling=s.isHorizontal()?g>r.touchAngle:90-g>r.touchAngle)}if(a.isScrolling&&s.emit("touchMoveOpposite",l),typeof a.startMoving>"u"&&(n.currentX!==n.startX||n.currentY!==n.startY)&&(a.startMoving=!0),a.isScrolling||l.type==="touchmove"&&a.preventTouchMoveFromPointerMove){a.isTouched=!1;return}if(!a.startMoving)return;s.allowClick=!1,!r.cssMode&&l.cancelable&&l.preventDefault(),r.touchMoveStopPropagation&&!r.nested&&l.stopPropagation();let b=s.isHorizontal()?p:f,v=s.isHorizontal()?n.currentX-n.previousX:n.currentY-n.previousY;r.oneWayMovement&&(b=Math.abs(b)*(o?1:-1),v=Math.abs(v)*(o?1:-1)),n.diff=b,b*=r.touchRatio,o&&(b=-b,v=-v);const y=s.touchesDirection;s.swipeDirection=b>0?"prev":"next",s.touchesDirection=v>0?"prev":"next";const m=s.params.loop&&!r.cssMode,h=s.touchesDirection==="next"&&s.allowSlideNext||s.touchesDirection==="prev"&&s.allowSlidePrev;if(!a.isMoved){if(m&&h&&s.loopFix({direction:s.swipeDirection}),a.startTranslate=s.getTranslate(),s.setTransition(0),s.animating){const g=new window.CustomEvent("transitionend",{bubbles:!0,cancelable:!0,detail:{bySwiperTouchMove:!0}});s.wrapperEl.dispatchEvent(g)}a.allowMomentumBounce=!1,r.grabCursor&&(s.allowSlideNext===!0||s.allowSlidePrev===!0)&&s.setGrabCursor(!0),s.emit("sliderFirstMove",l)}if(new Date().getTime(),r._loopSwapReset!==!1&&a.isMoved&&a.allowThresholdMove&&y!==s.touchesDirection&&m&&h&&Math.abs(b)>=1){Object.assign(n,{startX:d,startY:u,currentX:d,currentY:u,startTranslate:a.currentTranslate}),a.loopSwapReset=!0,a.startTranslate=a.currentTranslate;return}s.emit("sliderMove",l),a.isMoved=!0,a.currentTranslate=b+a.startTranslate;let _=!0,S=r.resistanceRatio;if(r.touchReleaseOnEdges&&(S=0),b>0?(m&&h&&a.allowThresholdMove&&a.currentTranslate>(r.centeredSlides?s.minTranslate()-s.slidesSizesGrid[s.activeIndex+1]-(r.slidesPerView!=="auto"&&s.slides.length-r.slidesPerView>=2?s.slidesSizesGrid[s.activeIndex+1]+s.params.spaceBetween:0)-s.params.spaceBetween:s.minTranslate())&&s.loopFix({direction:"prev",setTranslate:!0,activeSlideIndex:0}),a.currentTranslate>s.minTranslate()&&(_=!1,r.resistance&&(a.currentTranslate=s.minTranslate()-1+(-s.minTranslate()+a.startTranslate+b)**S))):b<0&&(m&&h&&a.allowThresholdMove&&a.currentTranslate<(r.centeredSlides?s.maxTranslate()+s.slidesSizesGrid[s.slidesSizesGrid.length-1]+s.params.spaceBetween+(r.slidesPerView!=="auto"&&s.slides.length-r.slidesPerView>=2?s.slidesSizesGrid[s.slidesSizesGrid.length-1]+s.params.spaceBetween:0):s.maxTranslate())&&s.loopFix({direction:"next",setTranslate:!0,activeSlideIndex:s.slides.length-(r.slidesPerView==="auto"?s.slidesPerViewDynamic():Math.ceil(parseFloat(r.slidesPerView,10)))}),a.currentTranslate<s.maxTranslate()&&(_=!1,r.resistance&&(a.currentTranslate=s.maxTranslate()+1-(s.maxTranslate()-a.startTranslate-b)**S))),_&&(l.preventedByNestedSwiper=!0),!s.allowSlideNext&&s.swipeDirection==="next"&&a.currentTranslate<a.startTranslate&&(a.currentTranslate=a.startTranslate),!s.allowSlidePrev&&s.swipeDirection==="prev"&&a.currentTranslate>a.startTranslate&&(a.currentTranslate=a.startTranslate),!s.allowSlidePrev&&!s.allowSlideNext&&(a.currentTranslate=a.startTranslate),r.threshold>0)if(Math.abs(b)>r.threshold||a.allowThresholdMove){if(!a.allowThresholdMove){a.allowThresholdMove=!0,n.startX=n.currentX,n.startY=n.currentY,a.currentTranslate=a.startTranslate,n.diff=s.isHorizontal()?n.currentX-n.startX:n.currentY-n.startY;return}}else{a.currentTranslate=a.startTranslate;return}!r.followFinger||r.cssMode||((r.freeMode&&r.freeMode.enabled&&s.freeMode||r.watchSlidesProgress)&&(s.updateActiveIndex(),s.updateSlidesClasses()),r.freeMode&&r.freeMode.enabled&&s.freeMode&&s.freeMode.onTouchMove(),s.updateProgress(a.currentTranslate),s.setTranslate(a.currentTranslate))}function Eb(e){const t=this,s=t.touchEventsData;let a=e;a.originalEvent&&(a=a.originalEvent);let r;if(a.type==="touchend"||a.type==="touchcancel"){if(r=[...a.changedTouches].find(g=>g.identifier===s.touchId),!r||r.identifier!==s.touchId)return}else{if(s.touchId!==null||a.pointerId!==s.pointerId)return;r=a}if(["pointercancel","pointerout","pointerleave","contextmenu"].includes(a.type)&&!(["pointercancel","contextmenu"].includes(a.type)&&(t.browser.isSafari||t.browser.isWebView)))return;s.pointerId=null,s.touchId=null;const{params:o,touches:i,rtlTranslate:l,slidesGrid:c,enabled:d}=t;if(!d||!o.simulateTouch&&a.pointerType==="mouse")return;if(s.allowTouchCallbacks&&t.emit("touchEnd",a),s.allowTouchCallbacks=!1,!s.isTouched){s.isMoved&&o.grabCursor&&t.setGrabCursor(!1),s.isMoved=!1,s.startMoving=!1;return}o.grabCursor&&s.isMoved&&s.isTouched&&(t.allowSlideNext===!0||t.allowSlidePrev===!0)&&t.setGrabCursor(!1);const u=Ur(),p=u-s.touchStartTime;if(t.allowClick){const g=a.path||a.composedPath&&a.composedPath();t.updateClickedSlide(g&&g[0]||a.target,g),t.emit("tap click",a),p<300&&u-s.lastClickTime<300&&t.emit("doubleTap doubleClick",a)}if(s.lastClickTime=Ur(),xu(()=>{t.destroyed||(t.allowClick=!0)}),!s.isTouched||!s.isMoved||!t.swipeDirection||i.diff===0&&!s.loopSwapReset||s.currentTranslate===s.startTranslate&&!s.loopSwapReset){s.isTouched=!1,s.isMoved=!1,s.startMoving=!1;return}s.isTouched=!1,s.isMoved=!1,s.startMoving=!1;let f;if(o.followFinger?f=l?t.translate:-t.translate:f=-s.currentTranslate,o.cssMode)return;if(o.freeMode&&o.freeMode.enabled){t.freeMode.onTouchEnd({currentPos:f});return}const b=f>=-t.maxTranslate()&&!t.params.loop;let v=0,y=t.slidesSizesGrid[0];for(let g=0;g<c.length;g+=g<o.slidesPerGroupSkip?1:o.slidesPerGroup){const w=g<o.slidesPerGroupSkip-1?1:o.slidesPerGroup;typeof c[g+w]<"u"?(b||f>=c[g]&&f<c[g+w])&&(v=g,y=c[g+w]-c[g]):(b||f>=c[g])&&(v=g,y=c[c.length-1]-c[c.length-2])}let m=null,h=null;o.rewind&&(t.isBeginning?h=o.virtual&&o.virtual.enabled&&t.virtual?t.virtual.slides.length-1:t.slides.length-1:t.isEnd&&(m=0));const _=(f-c[v])/y,S=v<o.slidesPerGroupSkip-1?1:o.slidesPerGroup;if(p>o.longSwipesMs){if(!o.longSwipes){t.slideTo(t.activeIndex);return}t.swipeDirection==="next"&&(_>=o.longSwipesRatio?t.slideTo(o.rewind&&t.isEnd?m:v+S):t.slideTo(v)),t.swipeDirection==="prev"&&(_>1-o.longSwipesRatio?t.slideTo(v+S):h!==null&&_<0&&Math.abs(_)>o.longSwipesRatio?t.slideTo(h):t.slideTo(v))}else{if(!o.shortSwipes){t.slideTo(t.activeIndex);return}t.navigation&&(a.target===t.navigation.nextEl||a.target===t.navigation.prevEl)?a.target===t.navigation.nextEl?t.slideTo(v+S):t.slideTo(v):(t.swipeDirection==="next"&&t.slideTo(m!==null?m:v+S),t.swipeDirection==="prev"&&t.slideTo(h!==null?h:v))}}function fl(){const e=this,{params:t,el:s}=e;if(s&&s.offsetWidth===0)return;t.breakpoints&&e.setBreakpoint();const{allowSlideNext:a,allowSlidePrev:r,snapGrid:n}=e,o=e.virtual&&e.params.virtual.enabled;e.allowSlideNext=!0,e.allowSlidePrev=!0,e.updateSize(),e.updateSlides(),e.updateSlidesClasses();const i=o&&t.loop;(t.slidesPerView==="auto"||t.slidesPerView>1)&&e.isEnd&&!e.isBeginning&&!e.params.centeredSlides&&!i?e.slideTo(e.slides.length-1,0,!1,!0):e.params.loop&&!o?e.slideToLoop(e.realIndex,0,!1,!0):e.slideTo(e.activeIndex,0,!1,!0),e.autoplay&&e.autoplay.running&&e.autoplay.paused&&(clearTimeout(e.autoplay.resizeTimeout),e.autoplay.resizeTimeout=setTimeout(()=>{e.autoplay&&e.autoplay.running&&e.autoplay.paused&&e.autoplay.resume()},500)),e.allowSlidePrev=r,e.allowSlideNext=a,e.params.watchOverflow&&n!==e.snapGrid&&e.checkOverflow()}function kb(e){const t=this;t.enabled&&(t.allowClick||(t.params.preventClicks&&e.preventDefault(),t.params.preventClicksPropagation&&t.animating&&(e.stopPropagation(),e.stopImmediatePropagation())))}function Ab(){const e=this,{wrapperEl:t,rtlTranslate:s,enabled:a}=e;if(!a)return;e.previousTranslate=e.translate,e.isHorizontal()?e.translate=-t.scrollLeft:e.translate=-t.scrollTop,e.translate===0&&(e.translate=0),e.updateActiveIndex(),e.updateSlidesClasses();let r;const n=e.maxTranslate()-e.minTranslate();n===0?r=0:r=(e.translate-e.minTranslate())/n,r!==e.progress&&e.updateProgress(s?-e.translate:e.translate),e.emit("setTranslate",e.translate,!1)}function Pb(e){const t=this;Or(t,e.target),!(t.params.cssMode||t.params.slidesPerView!=="auto"&&!t.params.autoHeight)&&t.update()}function Cb(){const e=this;e.documentTouchHandlerProceeded||(e.documentTouchHandlerProceeded=!0,e.params.touchReleaseOnEdges&&(e.el.style.touchAction="auto"))}const Cu=(e,t)=>{const s=Nt(),{params:a,el:r,wrapperEl:n,device:o}=e,i=!!a.nested,l=t==="on"?"addEventListener":"removeEventListener",c=t;!r||typeof r=="string"||(s[l]("touchstart",e.onDocumentTouchStart,{passive:!1,capture:i}),r[l]("touchstart",e.onTouchStart,{passive:!1}),r[l]("pointerdown",e.onTouchStart,{passive:!1}),s[l]("touchmove",e.onTouchMove,{passive:!1,capture:i}),s[l]("pointermove",e.onTouchMove,{passive:!1,capture:i}),s[l]("touchend",e.onTouchEnd,{passive:!0}),s[l]("pointerup",e.onTouchEnd,{passive:!0}),s[l]("pointercancel",e.onTouchEnd,{passive:!0}),s[l]("touchcancel",e.onTouchEnd,{passive:!0}),s[l]("pointerout",e.onTouchEnd,{passive:!0}),s[l]("pointerleave",e.onTouchEnd,{passive:!0}),s[l]("contextmenu",e.onTouchEnd,{passive:!0}),(a.preventClicks||a.preventClicksPropagation)&&r[l]("click",e.onClick,!0),a.cssMode&&n[l]("scroll",e.onScroll),a.updateOnWindowResize?e[c](o.ios||o.android?"resize orientationchange observerUpdate":"resize observerUpdate",fl,!0):e[c]("observerUpdate",fl,!0),r[l]("load",e.onLoad,{capture:!0}))};function Ob(){const e=this,{params:t}=e;e.onTouchStart=Tb.bind(e),e.onTouchMove=Sb.bind(e),e.onTouchEnd=Eb.bind(e),e.onDocumentTouchStart=Cb.bind(e),t.cssMode&&(e.onScroll=Ab.bind(e)),e.onClick=kb.bind(e),e.onLoad=Pb.bind(e),Cu(e,"on")}function $b(){Cu(this,"off")}var Lb={attachEvents:Ob,detachEvents:$b};const hl=(e,t)=>e.grid&&t.grid&&t.grid.rows>1;function Mb(){const e=this,{realIndex:t,initialized:s,params:a,el:r}=e,n=a.breakpoints;if(!n||n&&Object.keys(n).length===0)return;const o=Nt(),i=a.breakpointsBase==="window"||!a.breakpointsBase?a.breakpointsBase:"container",l=["window","container"].includes(a.breakpointsBase)||!a.breakpointsBase?e.el:o.querySelector(a.breakpointsBase),c=e.getBreakpoint(n,i,l);if(!c||e.currentBreakpoint===c)return;const u=(c in n?n[c]:void 0)||e.originalParams,p=hl(e,a),f=hl(e,u),b=e.params.grabCursor,v=u.grabCursor,y=a.enabled;p&&!f?(r.classList.remove(`${a.containerModifierClass}grid`,`${a.containerModifierClass}grid-column`),e.emitContainerClasses()):!p&&f&&(r.classList.add(`${a.containerModifierClass}grid`),(u.grid.fill&&u.grid.fill==="column"||!u.grid.fill&&a.grid.fill==="column")&&r.classList.add(`${a.containerModifierClass}grid-column`),e.emitContainerClasses()),b&&!v?e.unsetGrabCursor():!b&&v&&e.setGrabCursor(),["navigation","pagination","scrollbar"].forEach(w=>{if(typeof u[w]>"u")return;const x=a[w]&&a[w].enabled,T=u[w]&&u[w].enabled;x&&!T&&e[w].disable(),!x&&T&&e[w].enable()});const m=u.direction&&u.direction!==a.direction,h=a.loop&&(u.slidesPerView!==a.slidesPerView||m),_=a.loop;m&&s&&e.changeDirection(),ot(e.params,u);const S=e.params.enabled,g=e.params.loop;Object.assign(e,{allowTouchMove:e.params.allowTouchMove,allowSlideNext:e.params.allowSlideNext,allowSlidePrev:e.params.allowSlidePrev}),y&&!S?e.disable():!y&&S&&e.enable(),e.currentBreakpoint=c,e.emit("_beforeBreakpoint",u),s&&(h?(e.loopDestroy(),e.loopCreate(t),e.updateSlides()):!_&&g?(e.loopCreate(t),e.updateSlides()):_&&!g&&e.loopDestroy()),e.emit("breakpoint",u)}function Rb(e,t="window",s){if(!e||t==="container"&&!s)return;let a=!1;const r=st(),n=t==="window"?r.innerHeight:s.clientHeight,o=Object.keys(e).map(i=>{if(typeof i=="string"&&i.indexOf("@")===0){const l=parseFloat(i.substr(1));return{value:n*l,point:i}}return{value:i,point:i}});o.sort((i,l)=>parseInt(i.value,10)-parseInt(l.value,10));for(let i=0;i<o.length;i+=1){const{point:l,value:c}=o[i];t==="window"?r.matchMedia(`(min-width: ${c}px)`).matches&&(a=l):c<=s.clientWidth&&(a=l)}return a||"max"}var Db={setBreakpoint:Mb,getBreakpoint:Rb};function Nb(e,t){const s=[];return e.forEach(a=>{typeof a=="object"?Object.keys(a).forEach(r=>{a[r]&&s.push(t+r)}):typeof a=="string"&&s.push(t+a)}),s}function Ib(){const e=this,{classNames:t,params:s,rtl:a,el:r,device:n}=e,o=Nb(["initialized",s.direction,{"free-mode":e.params.freeMode&&s.freeMode.enabled},{autoheight:s.autoHeight},{rtl:a},{grid:s.grid&&s.grid.rows>1},{"grid-column":s.grid&&s.grid.rows>1&&s.grid.fill==="column"},{android:n.android},{ios:n.ios},{"css-mode":s.cssMode},{centered:s.cssMode&&s.centeredSlides},{"watch-progress":s.watchSlidesProgress}],s.containerModifierClass);t.push(...o),r.classList.add(...t),e.emitContainerClasses()}function Bb(){const e=this,{el:t,classNames:s}=e;!t||typeof t=="string"||(t.classList.remove(...s),e.emitContainerClasses())}var Fb={addClasses:Ib,removeClasses:Bb};function zb(){const e=this,{isLocked:t,params:s}=e,{slidesOffsetBefore:a}=s;if(a){const r=e.slides.length-1,n=e.slidesGrid[r]+e.slidesSizesGrid[r]+a*2;e.isLocked=e.size>n}else e.isLocked=e.snapGrid.length===1;s.allowSlideNext===!0&&(e.allowSlideNext=!e.isLocked),s.allowSlidePrev===!0&&(e.allowSlidePrev=!e.isLocked),t&&t!==e.isLocked&&(e.isEnd=!1),t!==e.isLocked&&e.emit(e.isLocked?"lock":"unlock")}var Hb={checkOverflow:zb},ml={init:!0,direction:"horizontal",oneWayMovement:!1,swiperElementNodeName:"SWIPER-CONTAINER",touchEventsTarget:"wrapper",initialSlide:0,speed:300,cssMode:!1,updateOnWindowResize:!0,resizeObserver:!0,nested:!1,createElements:!1,eventsPrefix:"swiper",enabled:!0,focusableElements:"input, select, option, textarea, button, video, label",width:null,height:null,preventInteractionOnTransition:!1,userAgent:null,url:null,edgeSwipeDetection:!1,edgeSwipeThreshold:20,autoHeight:!1,setWrapperSize:!1,virtualTranslate:!1,effect:"slide",breakpoints:void 0,breakpointsBase:"window",spaceBetween:0,slidesPerView:1,slidesPerGroup:1,slidesPerGroupSkip:0,slidesPerGroupAuto:!1,centeredSlides:!1,centeredSlidesBounds:!1,slidesOffsetBefore:0,slidesOffsetAfter:0,normalizeSlideIndex:!0,centerInsufficientSlides:!1,snapToSlideEdge:!1,watchOverflow:!0,roundLengths:!1,touchRatio:1,touchAngle:45,simulateTouch:!0,shortSwipes:!0,longSwipes:!0,longSwipesRatio:.5,longSwipesMs:300,followFinger:!0,allowTouchMove:!0,threshold:5,touchMoveStopPropagation:!1,touchStartPreventDefault:!0,touchStartForcePreventDefault:!1,touchReleaseOnEdges:!1,uniqueNavElements:!0,resistance:!0,resistanceRatio:.85,watchSlidesProgress:!1,grabCursor:!1,preventClicks:!0,preventClicksPropagation:!0,slideToClickedSlide:!1,loop:!1,loopAddBlankSlides:!0,loopAdditionalSlides:0,loopPreventsSliding:!0,rewind:!1,allowSlidePrev:!0,allowSlideNext:!0,swipeHandler:null,noSwiping:!0,noSwipingClass:"swiper-no-swiping",noSwipingSelector:null,passiveListeners:!0,maxBackfaceHiddenSlides:10,containerModifierClass:"swiper-",slideClass:"swiper-slide",slideBlankClass:"swiper-slide-blank",slideActiveClass:"swiper-slide-active",slideVisibleClass:"swiper-slide-visible",slideFullyVisibleClass:"swiper-slide-fully-visible",slideNextClass:"swiper-slide-next",slidePrevClass:"swiper-slide-prev",wrapperClass:"swiper-wrapper",lazyPreloaderClass:"swiper-lazy-preloader",lazyPreloadPrevNext:0,runCallbacksOnInit:!0,_emitClasses:!1};function jb(e,t){return function(a={}){const r=Object.keys(a)[0],n=a[r];if(typeof n!="object"||n===null){ot(t,a);return}if(e[r]===!0&&(e[r]={enabled:!0}),r==="navigation"&&e[r]&&e[r].enabled&&!e[r].prevEl&&!e[r].nextEl&&(e[r].auto=!0),["pagination","scrollbar"].indexOf(r)>=0&&e[r]&&e[r].enabled&&!e[r].el&&(e[r].auto=!0),!(r in e&&"enabled"in n)){ot(t,a);return}typeof e[r]=="object"&&!("enabled"in e[r])&&(e[r].enabled=!0),e[r]||(e[r]={enabled:!1}),ot(t,a)}}const Un={eventsEmitter:Fg,update:Jg,translate:sb,transition:ob,slide:hb,loop:_b,grabCursor:wb,events:Lb,breakpoints:Db,checkOverflow:Hb,classes:Fb},qn={};class ht{constructor(...t){let s,a;t.length===1&&t[0].constructor&&Object.prototype.toString.call(t[0]).slice(8,-1)==="Object"?a=t[0]:[s,a]=t,a||(a={}),a=ot({},a),s&&!a.el&&(a.el=s);const r=Nt();if(a.el&&typeof a.el=="string"&&r.querySelectorAll(a.el).length>1){const l=[];return r.querySelectorAll(a.el).forEach(c=>{const d=ot({},a,{el:c});l.push(new ht(d))}),l}const n=this;n.__swiper__=!0,n.support=Eu(),n.device=ku({userAgent:a.userAgent}),n.browser=Au(),n.eventsListeners={},n.eventsAnyListeners=[],n.modules=[...n.__modules__],a.modules&&Array.isArray(a.modules)&&a.modules.forEach(l=>{typeof l=="function"&&n.modules.indexOf(l)<0&&n.modules.push(l)});const o={};n.modules.forEach(l=>{l({params:a,swiper:n,extendParams:jb(a,o),on:n.on.bind(n),once:n.once.bind(n),off:n.off.bind(n),emit:n.emit.bind(n)})});const i=ot({},ml,o);return n.params=ot({},i,qn,a),n.originalParams=ot({},n.params),n.passedParams=ot({},a),n.params&&n.params.on&&Object.keys(n.params.on).forEach(l=>{n.on(l,n.params.on[l])}),n.params&&n.params.onAny&&n.onAny(n.params.onAny),Object.assign(n,{enabled:n.params.enabled,el:s,classNames:[],slides:[],slidesGrid:[],snapGrid:[],slidesSizesGrid:[],isHorizontal(){return n.params.direction==="horizontal"},isVertical(){return n.params.direction==="vertical"},activeIndex:0,realIndex:0,isBeginning:!0,isEnd:!1,translate:0,previousTranslate:0,progress:0,velocity:0,animating:!1,cssOverflowAdjustment(){return Math.trunc(this.translate/2**23)*2**23},allowSlideNext:n.params.allowSlideNext,allowSlidePrev:n.params.allowSlidePrev,touchEventsData:{isTouched:void 0,isMoved:void 0,allowTouchCallbacks:void 0,touchStartTime:void 0,isScrolling:void 0,currentTranslate:void 0,startTranslate:void 0,allowThresholdMove:void 0,focusableElements:n.params.focusableElements,lastClickTime:0,clickTimeout:void 0,velocities:[],allowMomentumBounce:void 0,startMoving:void 0,pointerId:null,touchId:null},allowClick:!0,allowTouchMove:n.params.allowTouchMove,touches:{startX:0,startY:0,currentX:0,currentY:0,diff:0},imagesToLoad:[],imagesLoaded:0}),n.emit("_swiper"),n.params.init&&n.init(),n}getDirectionLabel(t){return this.isHorizontal()?t:{width:"height","margin-top":"margin-left","margin-bottom ":"margin-right","margin-left":"margin-top","margin-right":"margin-bottom","padding-left":"padding-top","padding-right":"padding-bottom",marginRight:"marginBottom"}[t]}getSlideIndex(t){const{slidesEl:s,params:a}=this,r=Rt(s,`.${a.slideClass}, swiper-slide`),n=Gr(r[0]);return Gr(t)-n}getSlideIndexByData(t){return this.getSlideIndex(this.slides.find(s=>s.getAttribute("data-swiper-slide-index")*1===t))}getSlideIndexWhenGrid(t){return this.grid&&this.params.grid&&this.params.grid.rows>1&&(this.params.grid.fill==="column"?t=Math.floor(t/this.params.grid.rows):this.params.grid.fill==="row"&&(t=t%Math.ceil(this.slides.length/this.params.grid.rows))),t}recalcSlides(){const t=this,{slidesEl:s,params:a}=t;t.slides=Rt(s,`.${a.slideClass}, swiper-slide`)}enable(){const t=this;t.enabled||(t.enabled=!0,t.params.grabCursor&&t.setGrabCursor(),t.emit("enable"))}disable(){const t=this;t.enabled&&(t.enabled=!1,t.params.grabCursor&&t.unsetGrabCursor(),t.emit("disable"))}setProgress(t,s){const a=this;t=Math.min(Math.max(t,0),1);const r=a.minTranslate(),o=(a.maxTranslate()-r)*t+r;a.translateTo(o,typeof s>"u"?0:s),a.updateActiveIndex(),a.updateSlidesClasses()}emitContainerClasses(){const t=this;if(!t.params._emitClasses||!t.el)return;const s=t.el.className.split(" ").filter(a=>a.indexOf("swiper")===0||a.indexOf(t.params.containerModifierClass)===0);t.emit("_containerClasses",s.join(" "))}getSlideClasses(t){const s=this;return s.destroyed?"":t.className.split(" ").filter(a=>a.indexOf("swiper-slide")===0||a.indexOf(s.params.slideClass)===0).join(" ")}emitSlidesClasses(){const t=this;if(!t.params._emitClasses||!t.el)return;const s=[];t.slides.forEach(a=>{const r=t.getSlideClasses(a);s.push({slideEl:a,classNames:r}),t.emit("_slideClass",a,r)}),t.emit("_slideClasses",s)}slidesPerViewDynamic(t="current",s=!1){const a=this,{params:r,slides:n,slidesGrid:o,slidesSizesGrid:i,size:l,activeIndex:c}=a;let d=1;if(typeof r.slidesPerView=="number")return r.slidesPerView;if(r.centeredSlides){let u=n[c]?Math.ceil(n[c].swiperSlideSize):0,p;for(let f=c+1;f<n.length;f+=1)n[f]&&!p&&(u+=Math.ceil(n[f].swiperSlideSize),d+=1,u>l&&(p=!0));for(let f=c-1;f>=0;f-=1)n[f]&&!p&&(u+=n[f].swiperSlideSize,d+=1,u>l&&(p=!0))}else if(t==="current")for(let u=c+1;u<n.length;u+=1)(s?o[u]+i[u]-o[c]<l:o[u]-o[c]<l)&&(d+=1);else for(let u=c-1;u>=0;u-=1)o[c]-o[u]<l&&(d+=1);return d}update(){const t=this;if(!t||t.destroyed)return;const{snapGrid:s,params:a}=t;a.breakpoints&&t.setBreakpoint(),[...t.el.querySelectorAll('[loading="lazy"]')].forEach(o=>{o.complete&&Or(t,o)}),t.updateSize(),t.updateSlides(),t.updateProgress(),t.updateSlidesClasses();function r(){const o=t.rtlTranslate?t.translate*-1:t.translate,i=Math.min(Math.max(o,t.maxTranslate()),t.minTranslate());t.setTranslate(i),t.updateActiveIndex(),t.updateSlidesClasses()}let n;if(a.freeMode&&a.freeMode.enabled&&!a.cssMode)r(),a.autoHeight&&t.updateAutoHeight();else{if((a.slidesPerView==="auto"||a.slidesPerView>1)&&t.isEnd&&!a.centeredSlides){const o=t.virtual&&a.virtual.enabled?t.virtual.slides:t.slides;n=t.slideTo(o.length-1,0,!1,!0)}else n=t.slideTo(t.activeIndex,0,!1,!0);n||r()}a.watchOverflow&&s!==t.snapGrid&&t.checkOverflow(),t.emit("update")}changeDirection(t,s=!0){const a=this,r=a.params.direction;return t||(t=r==="horizontal"?"vertical":"horizontal"),t===r||t!=="horizontal"&&t!=="vertical"||(a.el.classList.remove(`${a.params.containerModifierClass}${r}`),a.el.classList.add(`${a.params.containerModifierClass}${t}`),a.emitContainerClasses(),a.params.direction=t,a.slides.forEach(n=>{t==="vertical"?n.style.width="":n.style.height=""}),a.emit("changeDirection"),s&&a.update()),a}changeLanguageDirection(t){const s=this;s.rtl&&t==="rtl"||!s.rtl&&t==="ltr"||(s.rtl=t==="rtl",s.rtlTranslate=s.params.direction==="horizontal"&&s.rtl,s.rtl?(s.el.classList.add(`${s.params.containerModifierClass}rtl`),s.el.dir="rtl"):(s.el.classList.remove(`${s.params.containerModifierClass}rtl`),s.el.dir="ltr"),s.update())}mount(t){const s=this;if(s.mounted)return!0;let a=t||s.params.el;if(typeof a=="string"&&(a=document.querySelector(a)),!a)return!1;a.swiper=s,a.parentNode&&a.parentNode.host&&a.parentNode.host.nodeName===s.params.swiperElementNodeName.toUpperCase()&&(s.isElement=!0);const r=()=>`.${(s.params.wrapperClass||"").trim().split(" ").join(".")}`;let o=a&&a.shadowRoot&&a.shadowRoot.querySelector?a.shadowRoot.querySelector(r()):Rt(a,r())[0];return!o&&s.params.createElements&&(o=Vr("div",s.params.wrapperClass),a.append(o),Rt(a,`.${s.params.slideClass}`).forEach(i=>{o.append(i)})),Object.assign(s,{el:a,wrapperEl:o,slidesEl:s.isElement&&!a.parentNode.host.slideSlots?a.parentNode.host:o,hostEl:s.isElement?a.parentNode.host:a,mounted:!0,rtl:a.dir.toLowerCase()==="rtl"||us(a,"direction")==="rtl",rtlTranslate:s.params.direction==="horizontal"&&(a.dir.toLowerCase()==="rtl"||us(a,"direction")==="rtl"),wrongRTL:us(o,"display")==="-webkit-box"}),!0}init(t){const s=this;if(s.initialized||s.mount(t)===!1)return s;s.emit("beforeInit"),s.params.breakpoints&&s.setBreakpoint(),s.addClasses(),s.updateSize(),s.updateSlides(),s.params.watchOverflow&&s.checkOverflow(),s.params.grabCursor&&s.enabled&&s.setGrabCursor(),s.params.loop&&s.virtual&&s.params.virtual.enabled?s.slideTo(s.params.initialSlide+s.virtual.slidesBefore,0,s.params.runCallbacksOnInit,!1,!0):s.slideTo(s.params.initialSlide,0,s.params.runCallbacksOnInit,!1,!0),s.params.loop&&s.loopCreate(void 0,!0),s.attachEvents();const r=[...s.el.querySelectorAll('[loading="lazy"]')];return s.isElement&&r.push(...s.hostEl.querySelectorAll('[loading="lazy"]')),r.forEach(n=>{n.complete?Or(s,n):n.addEventListener("load",o=>{Or(s,o.target)})}),To(s),s.initialized=!0,To(s),s.emit("init"),s.emit("afterInit"),s}destroy(t=!0,s=!0){const a=this,{params:r,el:n,wrapperEl:o,slides:i}=a;return typeof a.params>"u"||a.destroyed||(a.emit("beforeDestroy"),a.initialized=!1,a.detachEvents(),r.loop&&a.loopDestroy(),s&&(a.removeClasses(),n&&typeof n!="string"&&n.removeAttribute("style"),o&&o.removeAttribute("style"),i&&i.length&&i.forEach(l=>{l.classList.remove(r.slideVisibleClass,r.slideFullyVisibleClass,r.slideActiveClass,r.slideNextClass,r.slidePrevClass),l.removeAttribute("style"),l.removeAttribute("data-swiper-slide-index")})),a.emit("destroy"),Object.keys(a.eventsListeners).forEach(l=>{a.off(l)}),t!==!1&&(a.el&&typeof a.el!="string"&&(a.el.swiper=null),kg(a)),a.destroyed=!0),null}static extendDefaults(t){ot(qn,t)}static get extendedDefaults(){return qn}static get defaults(){return ml}static installModule(t){ht.prototype.__modules__||(ht.prototype.__modules__=[]);const s=ht.prototype.__modules__;typeof t=="function"&&s.indexOf(t)<0&&s.push(t)}static use(t){return Array.isArray(t)?(t.forEach(s=>ht.installModule(s)),ht):(ht.installModule(t),ht)}}Object.keys(Un).forEach(e=>{Object.keys(Un[e]).forEach(t=>{ht.prototype[t]=Un[e][t]})});ht.use([Ig,Bg]);function Ub(e,t,s,a){return e.params.createElements&&Object.keys(a).forEach(r=>{if(!s[r]&&s.auto===!0){let n=Rt(e.el,`.${a[r]}`)[0];n||(n=Vr("div",a[r]),n.className=a[r],e.el.append(n)),s[r]=n,t[r]=n}}),s}function ta(e=""){return`.${e.trim().replace(/([\.:!+\/()[\]#>~*^$|=,'"@{}\\])/g,"\\$1").replace(/ /g,".")}`}function qb({swiper:e,extendParams:t,on:s,emit:a}){const r="swiper-pagination";t({pagination:{el:null,bulletElement:"span",clickable:!1,hideOnClick:!1,renderBullet:null,renderProgressbar:null,renderFraction:null,renderCustom:null,progressbarOpposite:!1,type:"bullets",dynamicBullets:!1,dynamicMainBullets:1,formatFractionCurrent:m=>m,formatFractionTotal:m=>m,bulletClass:`${r}-bullet`,bulletActiveClass:`${r}-bullet-active`,modifierClass:`${r}-`,currentClass:`${r}-current`,totalClass:`${r}-total`,hiddenClass:`${r}-hidden`,progressbarFillClass:`${r}-progressbar-fill`,progressbarOppositeClass:`${r}-progressbar-opposite`,clickableClass:`${r}-clickable`,lockClass:`${r}-lock`,horizontalClass:`${r}-horizontal`,verticalClass:`${r}-vertical`,paginationDisabledClass:`${r}-disabled`}}),e.pagination={el:null,bullets:[]};let n,o=0;function i(){return!e.params.pagination.el||!e.pagination.el||Array.isArray(e.pagination.el)&&e.pagination.el.length===0}function l(m,h){const{bulletActiveClass:_}=e.params.pagination;m&&(m=m[`${h==="prev"?"previous":"next"}ElementSibling`],m&&(m.classList.add(`${_}-${h}`),m=m[`${h==="prev"?"previous":"next"}ElementSibling`],m&&m.classList.add(`${_}-${h}-${h}`)))}function c(m,h,_){if(m=m%_,h=h%_,h===m+1)return"next";if(h===m-1)return"previous"}function d(m){const h=m.target.closest(ta(e.params.pagination.bulletClass));if(!h)return;m.preventDefault();const _=Gr(h)*e.params.slidesPerGroup;if(e.params.loop){if(e.realIndex===_)return;const S=c(e.realIndex,_,e.slides.length);S==="next"?e.slideNext():S==="previous"?e.slidePrev():e.slideToLoop(_)}else e.slideTo(_)}function u(){const m=e.rtl,h=e.params.pagination;if(i())return;let _=e.pagination.el;_=Ht(_);let S,g;const w=e.virtual&&e.params.virtual.enabled?e.virtual.slides.length:e.slides.length,x=e.params.loop?Math.ceil(w/e.params.slidesPerGroup):e.snapGrid.length;if(e.params.loop?(g=e.previousRealIndex||0,S=e.params.slidesPerGroup>1?Math.floor(e.realIndex/e.params.slidesPerGroup):e.realIndex):typeof e.snapIndex<"u"?(S=e.snapIndex,g=e.previousSnapIndex):(g=e.previousIndex||0,S=e.activeIndex||0),h.type==="bullets"&&e.pagination.bullets&&e.pagination.bullets.length>0){const T=e.pagination.bullets;let E,C,$;if(h.dynamicBullets&&(n=xo(T[0],e.isHorizontal()?"width":"height"),_.forEach(O=>{O.style[e.isHorizontal()?"width":"height"]=`${n*(h.dynamicMainBullets+4)}px`}),h.dynamicMainBullets>1&&g!==void 0&&(o+=S-(g||0),o>h.dynamicMainBullets-1?o=h.dynamicMainBullets-1:o<0&&(o=0)),E=Math.max(S-o,0),C=E+(Math.min(T.length,h.dynamicMainBullets)-1),$=(C+E)/2),T.forEach(O=>{const F=[...["","-next","-next-next","-prev","-prev-prev","-main"].map(K=>`${h.bulletActiveClass}${K}`)].map(K=>typeof K=="string"&&K.includes(" ")?K.split(" "):K).flat();O.classList.remove(...F)}),_.length>1)T.forEach(O=>{const F=Gr(O);F===S?O.classList.add(...h.bulletActiveClass.split(" ")):e.isElement&&O.setAttribute("part","bullet"),h.dynamicBullets&&(F>=E&&F<=C&&O.classList.add(...`${h.bulletActiveClass}-main`.split(" ")),F===E&&l(O,"prev"),F===C&&l(O,"next"))});else{const O=T[S];if(O&&O.classList.add(...h.bulletActiveClass.split(" ")),e.isElement&&T.forEach((F,K)=>{F.setAttribute("part",K===S?"bullet-active":"bullet")}),h.dynamicBullets){const F=T[E],K=T[C];for(let U=E;U<=C;U+=1)T[U]&&T[U].classList.add(...`${h.bulletActiveClass}-main`.split(" "));l(F,"prev"),l(K,"next")}}if(h.dynamicBullets){const O=Math.min(T.length,h.dynamicMainBullets+4),F=(n*O-n)/2-$*n,K=m?"right":"left";T.forEach(U=>{U.style[e.isHorizontal()?K:"top"]=`${F}px`})}}_.forEach((T,E)=>{if(h.type==="fraction"&&(T.querySelectorAll(ta(h.currentClass)).forEach(C=>{C.textContent=h.formatFractionCurrent(S+1)}),T.querySelectorAll(ta(h.totalClass)).forEach(C=>{C.textContent=h.formatFractionTotal(x)})),h.type==="progressbar"){let C;h.progressbarOpposite?C=e.isHorizontal()?"vertical":"horizontal":C=e.isHorizontal()?"horizontal":"vertical";const $=(S+1)/x;let O=1,F=1;C==="horizontal"?O=$:F=$,T.querySelectorAll(ta(h.progressbarFillClass)).forEach(K=>{K.style.transform=`translate3d(0,0,0) scaleX(${O}) scaleY(${F})`,K.style.transitionDuration=`${e.params.speed}ms`})}h.type==="custom"&&h.renderCustom?(dl(T,h.renderCustom(e,S+1,x)),E===0&&a("paginationRender",T)):(E===0&&a("paginationRender",T),a("paginationUpdate",T)),e.params.watchOverflow&&e.enabled&&T.classList[e.isLocked?"add":"remove"](h.lockClass)})}function p(){const m=e.params.pagination;if(i())return;const h=e.virtual&&e.params.virtual.enabled?e.virtual.slides.length:e.grid&&e.params.grid.rows>1?e.slides.length/Math.ceil(e.params.grid.rows):e.slides.length;let _=e.pagination.el;_=Ht(_);let S="";if(m.type==="bullets"){let g=e.params.loop?Math.ceil(h/e.params.slidesPerGroup):e.snapGrid.length;e.params.freeMode&&e.params.freeMode.enabled&&g>h&&(g=h);for(let w=0;w<g;w+=1)m.renderBullet?S+=m.renderBullet.call(e,w,m.bulletClass):S+=`<${m.bulletElement} ${e.isElement?'part="bullet"':""} class="${m.bulletClass}"></${m.bulletElement}>`}m.type==="fraction"&&(m.renderFraction?S=m.renderFraction.call(e,m.currentClass,m.totalClass):S=`<span class="${m.currentClass}"></span> / <span class="${m.totalClass}"></span>`),m.type==="progressbar"&&(m.renderProgressbar?S=m.renderProgressbar.call(e,m.progressbarFillClass):S=`<span class="${m.progressbarFillClass}"></span>`),e.pagination.bullets=[],_.forEach(g=>{m.type!=="custom"&&dl(g,S||""),m.type==="bullets"&&e.pagination.bullets.push(...g.querySelectorAll(ta(m.bulletClass)))}),m.type!=="custom"&&a("paginationRender",_[0])}function f(){e.params.pagination=Ub(e,e.originalParams.pagination,e.params.pagination,{el:"swiper-pagination"});const m=e.params.pagination;if(!m.el)return;let h;typeof m.el=="string"&&e.isElement&&(h=e.el.querySelector(m.el)),!h&&typeof m.el=="string"&&(h=[...document.querySelectorAll(m.el)]),h||(h=m.el),!(!h||h.length===0)&&(e.params.uniqueNavElements&&typeof m.el=="string"&&Array.isArray(h)&&h.length>1&&(h=[...e.el.querySelectorAll(m.el)],h.length>1&&(h=h.find(_=>Su(_,".swiper")[0]===e.el))),Array.isArray(h)&&h.length===1&&(h=h[0]),Object.assign(e.pagination,{el:h}),h=Ht(h),h.forEach(_=>{m.type==="bullets"&&m.clickable&&_.classList.add(...(m.clickableClass||"").split(" ")),_.classList.add(m.modifierClass+m.type),_.classList.add(e.isHorizontal()?m.horizontalClass:m.verticalClass),m.type==="bullets"&&m.dynamicBullets&&(_.classList.add(`${m.modifierClass}${m.type}-dynamic`),o=0,m.dynamicMainBullets<1&&(m.dynamicMainBullets=1)),m.type==="progressbar"&&m.progressbarOpposite&&_.classList.add(m.progressbarOppositeClass),m.clickable&&_.addEventListener("click",d),e.enabled||_.classList.add(m.lockClass)}))}function b(){const m=e.params.pagination;if(i())return;let h=e.pagination.el;h&&(h=Ht(h),h.forEach(_=>{_.classList.remove(m.hiddenClass),_.classList.remove(m.modifierClass+m.type),_.classList.remove(e.isHorizontal()?m.horizontalClass:m.verticalClass),m.clickable&&(_.classList.remove(...(m.clickableClass||"").split(" ")),_.removeEventListener("click",d))})),e.pagination.bullets&&e.pagination.bullets.forEach(_=>_.classList.remove(...m.bulletActiveClass.split(" ")))}s("changeDirection",()=>{if(!e.pagination||!e.pagination.el)return;const m=e.params.pagination;let{el:h}=e.pagination;h=Ht(h),h.forEach(_=>{_.classList.remove(m.horizontalClass,m.verticalClass),_.classList.add(e.isHorizontal()?m.horizontalClass:m.verticalClass)})}),s("init",()=>{e.params.pagination.enabled===!1?y():(f(),p(),u())}),s("activeIndexChange",()=>{typeof e.snapIndex>"u"&&u()}),s("snapIndexChange",()=>{u()}),s("snapGridLengthChange",()=>{p(),u()}),s("destroy",()=>{b()}),s("enable disable",()=>{let{el:m}=e.pagination;m&&(m=Ht(m),m.forEach(h=>h.classList[e.enabled?"remove":"add"](e.params.pagination.lockClass)))}),s("lock unlock",()=>{u()}),s("click",(m,h)=>{const _=h.target,S=Ht(e.pagination.el);if(e.params.pagination.el&&e.params.pagination.hideOnClick&&S&&S.length>0&&!_.classList.contains(e.params.pagination.bulletClass)){if(e.navigation&&(e.navigation.nextEl&&_===e.navigation.nextEl||e.navigation.prevEl&&_===e.navigation.prevEl))return;const g=S[0].classList.contains(e.params.pagination.hiddenClass);a(g===!0?"paginationShow":"paginationHide"),S.forEach(w=>w.classList.toggle(e.params.pagination.hiddenClass))}});const v=()=>{e.el.classList.remove(e.params.pagination.paginationDisabledClass);let{el:m}=e.pagination;m&&(m=Ht(m),m.forEach(h=>h.classList.remove(e.params.pagination.paginationDisabledClass))),f(),p(),u()},y=()=>{e.el.classList.add(e.params.pagination.paginationDisabledClass);let{el:m}=e.pagination;m&&(m=Ht(m),m.forEach(h=>h.classList.add(e.params.pagination.paginationDisabledClass))),b()};Object.assign(e.pagination,{enable:v,disable:y,render:p,update:u,init:f,destroy:b})}function Vb({swiper:e,extendParams:t,on:s,emit:a,params:r}){e.autoplay={running:!1,paused:!1,timeLeft:0},t({autoplay:{enabled:!1,delay:3e3,waitForTransition:!0,disableOnInteraction:!1,stopOnLastSlide:!1,reverseDirection:!1,pauseOnMouseEnter:!1}});let n,o,i=r&&r.autoplay?r.autoplay.delay:3e3,l=r&&r.autoplay?r.autoplay.delay:3e3,c,d=new Date().getTime(),u,p,f,b,v,y;function m(W){!e||e.destroyed||!e.wrapperEl||W.target===e.wrapperEl&&(e.wrapperEl.removeEventListener("transitionend",m),!(y||W.detail&&W.detail.bySwiperTouchMove)&&E())}const h=()=>{if(e.destroyed||!e.autoplay.running)return;e.autoplay.paused?u=!0:u&&(l=c,u=!1);const W=e.autoplay.paused?c:d+l-new Date().getTime();e.autoplay.timeLeft=W,a("autoplayTimeLeft",W,W/i),o=requestAnimationFrame(()=>{h()})},_=()=>{let W;return e.virtual&&e.params.virtual.enabled?W=e.slides.find(re=>re.classList.contains("swiper-slide-active")):W=e.slides[e.activeIndex],W?parseInt(W.getAttribute("data-swiper-autoplay"),10):void 0},S=()=>{let W=e.params.autoplay.delay;const G=_();return!Number.isNaN(G)&&G>0&&(W=G),W},g=W=>{if(e.destroyed||!e.autoplay.running)return;cancelAnimationFrame(o),h();let G=W;typeof G>"u"&&(G=S(),i=G,l=G),c=G;const re=e.params.speed,te=()=>{!e||e.destroyed||(e.params.autoplay.reverseDirection?!e.isBeginning||e.params.loop||e.params.rewind?(e.slidePrev(re,!0,!0),a("autoplay")):e.params.autoplay.stopOnLastSlide||(e.slideTo(e.slides.length-1,re,!0,!0),a("autoplay")):!e.isEnd||e.params.loop||e.params.rewind?(e.slideNext(re,!0,!0),a("autoplay")):e.params.autoplay.stopOnLastSlide||(e.slideTo(0,re,!0,!0),a("autoplay")),e.params.cssMode&&(d=new Date().getTime(),requestAnimationFrame(()=>{g()})))};return G>0?(clearTimeout(n),n=setTimeout(()=>{te()},G)):requestAnimationFrame(()=>{te()}),G},w=()=>{d=new Date().getTime(),e.autoplay.running=!0,g(),a("autoplayStart")},x=()=>{e.autoplay.running=!1,clearTimeout(n),cancelAnimationFrame(o),a("autoplayStop")},T=(W,G)=>{if(e.destroyed||!e.autoplay.running)return;clearTimeout(n),W||(v=!0);const re=()=>{a("autoplayPause"),e.params.autoplay.waitForTransition?e.wrapperEl.addEventListener("transitionend",m):E()};if(e.autoplay.paused=!0,G){re();return}c=(c||e.params.autoplay.delay)-(new Date().getTime()-d),!(e.isEnd&&c<0&&!e.params.loop)&&(c<0&&(c=0),re())},E=()=>{e.isEnd&&c<0&&!e.params.loop||e.destroyed||!e.autoplay.running||(d=new Date().getTime(),v?(v=!1,g(c)):g(),e.autoplay.paused=!1,a("autoplayResume"))},C=()=>{if(e.destroyed||!e.autoplay.running)return;const W=Nt();W.visibilityState==="hidden"&&(v=!0,T(!0)),W.visibilityState==="visible"&&E()},$=W=>{W.pointerType==="mouse"&&(v=!0,y=!0,!(e.animating||e.autoplay.paused)&&T(!0))},O=W=>{W.pointerType==="mouse"&&(y=!1,e.autoplay.paused&&E())},F=()=>{e.params.autoplay.pauseOnMouseEnter&&(e.el.addEventListener("pointerenter",$),e.el.addEventListener("pointerleave",O))},K=()=>{e.el&&typeof e.el!="string"&&(e.el.removeEventListener("pointerenter",$),e.el.removeEventListener("pointerleave",O))},U=()=>{Nt().addEventListener("visibilitychange",C)},ae=()=>{Nt().removeEventListener("visibilitychange",C)};s("init",()=>{e.params.autoplay.enabled&&(F(),U(),w())}),s("destroy",()=>{K(),ae(),e.autoplay.running&&x()}),s("_freeModeStaticRelease",()=>{(f||v)&&E()}),s("_freeModeNoMomentumRelease",()=>{e.params.autoplay.disableOnInteraction?x():T(!0,!0)}),s("beforeTransitionStart",(W,G,re)=>{e.destroyed||!e.autoplay.running||(re||!e.params.autoplay.disableOnInteraction?T(!0,!0):x())}),s("sliderFirstMove",()=>{if(!(e.destroyed||!e.autoplay.running)){if(e.params.autoplay.disableOnInteraction){x();return}p=!0,f=!1,v=!1,b=setTimeout(()=>{v=!0,f=!0,T(!0)},200)}}),s("touchEnd",()=>{if(!(e.destroyed||!e.autoplay.running||!p)){if(clearTimeout(b),clearTimeout(n),e.params.autoplay.disableOnInteraction){f=!1,p=!1;return}f&&e.params.cssMode&&E(),f=!1,p=!1}}),s("slideChange",()=>{e.destroyed||!e.autoplay.running||e.autoplay.paused&&(c=S(),i=S())}),Object.assign(e.autoplay,{start:w,stop:x,pause:T,resume:E})}const Gb={class:"home-layout"},Kb={class:"sticky-header-group"},Yb=["data-user-name"],Wb={class:"home-tabs",id:"home-tabs--id"},Jb={class:"home-tab home-tab--active","data-home-tab":"lobby"},Xb={width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",style:{"vertical-align":"-3px","margin-right":"4px"}},Qb={class:"home-tab","data-home-tab":"active"},Zb={width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",style:{"vertical-align":"-3px","margin-right":"4px"}},e0={__name:"home_route",setup(e){const t=ut(),s=be();window.CoreBetSlip=yu,document.addEventListener("click",c=>{const d=c.target;if(d&&d.dataset?.promotionTopic){const u={timestamp:Date.now(),heroImg:d.dataset.promotionHeroImg||"",caption:d.dataset.promotionCaption||"",tagline:d.dataset.promotionTagline||"",toast:d.dataset.promotionToast||"",topic:d.dataset.promotionTopic||"",topicToken:d.dataset.promotionTopicToken||"",marquee:d.dataset.promotionMarquee||""};console.log("[home_route] Publishing PROMOTION__CLICK:",u),le.publish(s.hierTopics.PROMOTION__CLICK,JSON.stringify(u))}d&&d.dataset?.publishRouteHome&&(d.dataset.publishRouteHome.startsWith("ROUTE.HOME.SODAPOP_PLAY.")&&document.querySelectorAll(".play-cntr .dash-nav__btn").forEach(p=>{p.classList.toggle("dash-nav__btn--active",p===d)}),le.publish(d.dataset.publishRouteHome,`{"ts": ${Date.now()} }`)),d&&d.dataset?.sodapopClose&&neodigmSodaPop&&neodigmSodaPop.close()});const a=(c,d=!1,u="cards",p={})=>{const f=document.querySelector(".tournaments-grid");if(!f)return;f.innerHTML="",f.style.animation="none",f.offsetHeight,f.style.animation="panel-enter 0.3s ease-out both",f.classList.toggle("tournaments-grid--list",u==="list");const b=document.getElementById("app"),v=b?.getAttribute("data-sync-theme")||"dark",y=b?.getAttribute("data-sync-lang")||"en",m=b?.getAttribute("data-sync-motif")||"brand",h=(g="")=>g.toLowerCase().replace(/\b\w/g,w=>w.toUpperCase()),_=g=>{const w=document.createElement("bma-tournament-list-card");return w.setAttribute("data-bma-tourn-guid",g.guid||""),w.setAttribute("data-bma-tourn-caption",g.caption||""),w.setAttribute("data-bma-tourn-tagline",g.tagline||""),w.setAttribute("data-bma-tourn-status",g.status||""),w.setAttribute("data-bma-tourn-class",g.status||""),w.setAttribute("data-bma-tourn-game-type",g.class||"DEFAULT"),w.setAttribute("data-bma-tourn-sports_allowed",Array.isArray(g.sports_allowed)?JSON.stringify(g.sports_allowed):""),w.setAttribute("data-bma-tourn-entities",g.entities?JSON.stringify(g.entities):""),w.setAttribute("data-bma-tourn-entry_fee",g.entry_fee||"0"),w.setAttribute("data-bma-tourn-tournament_dollars",g.tournament_dollars||"0"),w.setAttribute("data-bma-tourn-matches",g.matches_expanded?.length||"0"),w.setAttribute("data-bma-tourn-tags",Array.isArray(g.tags)?JSON.stringify(g.tags):"[]"),w.setAttribute("data-bma-tourn-window_start_time",g.window_start_time||""),w.setAttribute("data-bma-tourn-window_end_time",g.window_end_time||""),w.setAttribute("data-sync-theme",v),w},S=g=>{const w=document.createElement("article"),x=g.status||"DRAFT";w.className=`tournament-item tournament-status-${x.toLowerCase()}`;const T=document.createElement("bma-tournament-card");return T.setAttribute("data-bma-tourn-id",g.id||""),T.setAttribute("data-bma-tourn-guid",g.guid||""),T.setAttribute("data-bma-tourn-caption",g.caption||""),T.setAttribute("data-bma-tourn-tagline",g.tagline||""),T.setAttribute("data-bma-tourn-window_start_time",g.window_start_time||""),T.setAttribute("data-bma-tourn-window_end_time",g.window_end_time||""),T.setAttribute("data-bma-tourn-sports_allowed",Array.isArray(g.sports_allowed)?JSON.stringify(g.sports_allowed):g.sports_allowed||""),T.setAttribute("data-bma-tourn-entities",g.entities?JSON.stringify(g.entities):""),T.setAttribute("data-bma-tourn-tournament_dollars",g.tournament_dollars||""),T.setAttribute("data-bma-tourn-prize_distro",Array.isArray(g.prize_distro)?JSON.stringify(g.prize_distro):g.prize_distro||""),T.setAttribute("data-bma-tourn-matches",Array.isArray(g.matches_guids)?JSON.stringify(g.matches_guids):g.matches_guids||""),T.setAttribute("data-bma-tourn-matches_expanded",Array.isArray(g.matches_expanded)?JSON.stringify(g.matches_expanded):g.matches_expanded||""),T.setAttribute("data-bma-tourn-entry_fee",g.entry_fee||""),T.setAttribute("data-bma-tourn-rake",g.rake||""),T.setAttribute("data-bma-tourn-tags",Array.isArray(g.tags)?JSON.stringify(g.tags):g.tags||""),T.setAttribute("data-bma-tourn-comments",g.comments||""),T.setAttribute("data-bma-tourn-class",g.status||""),T.setAttribute("data-bma-tourn-game-type",g.class||"DEFAULT"),T.setAttribute("data-bma-tourn-status",g.status||""),T.setAttribute("data-sync-theme",v),T.setAttribute("data-sync-lang",y),T.setAttribute("data-sync-motif",m),T.setAttribute("data-n55-size","medium"),T.setAttribute("data-n55-enchanted-cta-ambient","none"),T.setAttribute("data-tourn-custom-css",""),T.setAttribute("data-tourn-trophy","0"),T.setAttribute("data-bma-tourn-focus",""),T.setAttribute("data-bma-tourn-wait","false"),w.appendChild(T),w};if(d){c.forEach(w=>{if(w.type==="stats"){const N=document.createElement("div");N.className="tournament-category tournament-category--stats",N.innerHTML=w.html||"",f.appendChild(N);return}const x=document.createElement("div");x.className="tournament-category";const T=document.createElement("header");T.className="tournament-category-header";const E=document.createElement("div");E.className="category-title-line";const C=document.createElement("h2");if(C.className="category-title",C.textContent=h(w.title),E.appendChild(C),w.tournaments){const N=document.createElement("span");N.className="category-subtext",N.textContent=w.tournaments.length,E.appendChild(N)}const{tab:$="lobby",subStatus:O="all",sort:F="default",result:K="all",odds:U="all"}=p,W=w.title.toLowerCase().includes("completed"),G=!W&&$==="my",re=(N,V,z)=>`<option value="${N}"${z?" selected":""}>${V}</option>`;let te="";if($==="lobby"?te=`
          ...
          `:$==="my"&&G?te=`
            ...
            <select class="category-dropdown" data-filter-type="subStatus">
              ${re("all","Status: All",O==="all")}
              ${re("active","Status: Active",O==="active")}
              ${re("upcoming","Status: Upcoming",O==="upcoming")}
            </select>
            <select class="category-dropdown" data-filter-type="odds">
              ${re("all","Odds: All",U==="all")}
              ${re("available","Odds: Available",U==="available")}
              ${re("none","Odds: Not Available",U==="none")}
            </select>
          `:($==="my"&&W||$==="completed")&&(te=`
            <select class="category-dropdown" data-filter-type="result">
              ${re("all","Result: All",K==="all")}
              ${re("trophy","Result: Won Trophy",K==="trophy")}
              ${re("no_trophy","Result: No Trophy",K==="no_trophy")}
            </select>
          `),T.appendChild(E),te){const N=document.createElement("button");N.className="category-filter-toggle",N.setAttribute("aria-label","Toggle filters"),N.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M10 18h4v-2h-4v2zM3 6v2h18V6H3zm3 7h12v-2H6v2z"/></svg> Filters <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" class="filter-chevron"><path d="M7 10l5 5 5-5z"/></svg>';const V=document.createElement("div");V.className="category-controls";const z=localStorage.getItem("bma_view_mode")||"cards",A=document.createElement("span");A.className="category-view-btns",A.innerHTML=`
          ...
          `,V.appendChild(N),V.appendChild(A),T.appendChild(V)}if(te){const N=document.createElement("div");if(N.className="category-filter-row",N.style.display=window._bmaFilterRowOpen?"":"none",N.innerHTML=te,T.appendChild(N),window._bmaFilterRowOpen){const V=T.querySelector(".category-filter-toggle");V&&V.classList.add("category-filter-toggle--open")}}if(x.appendChild(T),f.appendChild(x),w.tournaments.length===0){const N=w.emptyMessage||"No tournaments available",V=w.emptySubtext||"Check back later for new tournaments",z=w.emptyMessage?'<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="rgba(255,255,255,0.15)" style="margin-bottom: 16px;"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>':'<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="rgba(255,255,255,0.12)" style="margin-bottom: 12px;"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>',A=document.createElement("div");A.className="tournaments-empty",A.style.cssText="grid-column: 1 / -1; text-align: center; padding: 48px 24px; animation: motion-fade-through-enter 210ms cubic-bezier(0.4, 0, 0.2, 1) both;",A.innerHTML=`
            ${z}
          ...
          `,x.appendChild(A)}else{const N=document.createElement("div");if(N.className="card-rail",w.tournaments.forEach((V,z)=>{const A=u==="list"?_(V):S(V);A.style.animation="motion-slide-up-enter 300ms cubic-bezier(0.4, 0, 0.2, 1) both",A.style.animationDelay=`${Math.min(z*50,300)}ms`,N.appendChild(A)}),x.appendChild(N),w.tournaments.length>1){const V=document.createElement("div");V.className="card-rail__dots";for(let z=0;z<w.tournaments.length;z++){const A=document.createElement("span");A.className=`card-rail__dot${z===0?" card-rail__dot--active":""}`,V.appendChild(A)}x.appendChild(V)}if(w.tournaments.length>1){const V=document.createElement("button");V.className="card-rail__arrow card-rail__arrow--prev",V.setAttribute("aria-label","Previous card"),V.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/></svg>',V.style.opacity="0";const z=document.createElement("button");z.className="card-rail__arrow card-rail__arrow--next",z.setAttribute("aria-label","Next card"),z.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>',x.appendChild(V),x.appendChild(z);const A=x.querySelector(".card-rail__dots");N.addEventListener("scroll",()=>{const L=N.scrollLeft,B=N.firstElementChild?.offsetWidth||1,I=Math.round(L/(B+12));A&&A.querySelectorAll(".card-rail__dot").forEach((X,D)=>{X.classList.toggle("card-rail__dot--active",D===I)}),V.style.opacity=L<=10?"0":"";const q=N.scrollWidth-N.clientWidth;z.style.opacity=L>=q-10?"0":""},{passive:!0}),V.addEventListener("click",()=>{const L=N.firstElementChild?.offsetWidth||300;N.scrollBy({left:-(L+12),behavior:"smooth"})}),z.addEventListener("click",()=>{const L=N.firstElementChild?.offsetWidth||300;N.scrollBy({left:L+12,behavior:"smooth"})})}}});const g=f.dataset.filterContext;if(g!=="lobby"&&g!=="private"&&f.querySelectorAll("bma-tournament-card, bma-tournament-list-card").length===0){let w="No tournaments available",x="Check back later for new tournaments";g==="my"?(w="You haven't joined any tournaments yet",x="Head to the lobby to find tournaments"):g==="completed"&&(w="No completed tournaments yet",x="Tournaments will appear here once they finish");const T=document.createElement("div");T.className="tournaments-empty",T.style.cssText="grid-column: 1 / -1; text-align: center; padding: 48px 24px; animation: motion-fade-through-enter 210ms cubic-bezier(0.4, 0, 0.2, 1) both;",T.innerHTML=`
        ...
        `;const t=this.shadowRoot.getElementById("guide-modes-rail"),s=this.shadowRoot.querySelectorAll("#guide-modes-dots .modes-dot"),a=this.shadowRoot.getElementById("guide-modes-prev"),r=this.shadowRoot.getElementById("guide-modes-next");if(t&&s.length){const n=()=>(t.firstElementChild?.offsetWidth||300)+12;t.addEventListener("scroll",()=>{const o=Math.round(t.scrollLeft/n());s.forEach((i,l)=>i.classList.toggle("modes-dot--active",l===o))},{passive:!0}),s.forEach((o,i)=>{o.addEventListener("click",()=>{t.scrollTo({left:i*n(),behavior:"smooth"})})}),a&&a.addEventListener("click",()=>{t.scrollBy({left:-n(),behavior:"smooth"})}),r&&r.addEventListener("click",()=>{t.scrollBy({left:n(),behavior:"smooth"})})}}}customElements.define("bma-profile-guide",f_);const h_={class:"profile-layout"},m_={class:"profile-shell"},g_={class:"profile-sidebar"},b_=["data-active-section"],__={class:"profile-content"},v_={class:"profile-panel"},y_={class:"profile-panel"},w_={class:"profile-panel"},x_={class:"profile-panel profile-panel--account-desktop"},T_={class:"account-panel"},S_={class:"mobile-account-bar"},E_={__name:"profile_route",setup(e){const t=ut(),s=be(),a=Ke("overview"),r=Ke(!1),n=()=>{t.push({name:"home_route"})},o=u=>{a.value=u.detail?.section||"overview"},i=u=>{const p=u.detail?.contestGuid;p&&(window._pendingTournGuid=p,t.push({name:"home_route"}))},l=()=>{const u=s.appSession?.session_user||{},p=u.guid,b=(s.coreTourn.length>0?s.coreTourn[s.coreTourn.length-1].data:[]).filter(O=>(O.entities?.guids||[]).includes(p)),v=b.filter(O=>["LOCKED","UPCOMING"].includes(O.status||O.class)),y=b.filter(O=>(O.status||O.class)==="COMPLETED");let m=0,h=0,_=0;b.forEach(O=>{(Array.isArray(O.tags)?O.tags:[]).forEach(K=>{if(!K||typeof K!="object")return;const U=(K.entity_guid===p?K.badge:null)||(typeof K[p]=="string"?K[p]:null);typeof U=="string"&&U.startsWith("--badge__ribbon--")&&(U==="--badge__ribbon--gold"?m++:U==="--badge__ribbon--silver"?h++:U==="--badge__ribbon--bronze"&&_++)})});const S={};b.forEach(O=>{(O.sports_allowed||[]).forEach(F=>{const U=Ge.find(ae=>ae.key===F.key)?.group||"Other";S[U]=(S[U]||0)+1})});let g="",w="",x=0;Object.entries(S).forEach(([O,F])=>{F>x&&(x=F,g=O,w=O)});const T=xe._betStatsCache?.stats||null;let E="—",C="";if(T){const O=T.wins+T.losses;O>0&&(E=Math.round(T.wins/O*100)+"%",C=`${T.wins}-${T.losses}`)}const $=[...b].sort((O,F)=>new Date(F.status_time||0)-new Date(O.status_time||0)).slice(0,20).map(O=>{let F=null;(Array.isArray(O.tags)?O.tags:[]).forEach(W=>{if(!W||typeof W!="object")return;const G=(W.entity_guid===p?W.badge:null)||(typeof W[p]=="string"?W[p]:null);G==="--badge__ribbon--gold"?F=1:G==="--badge__ribbon--silver"?F=2:G==="--badge__ribbon--bronze"&&(F=3)});const U=O.sports_allowed?.[0]?.key||"",ae=Ge.find(W=>W.key===U);return{id:O.guid,name:O.caption||"Tournament",sport:ae?.title||"",sports:[U],status:O.status||O.class||"",placement:F,startTime:O.window_start_time}});return{username:u.userName||u.name||"Player",email:u.email||"",activeCount:v.length,playedCount:y.length,trophyCount:m+h+_,gold:m,silver:h,bronze:_,firstPlace:m,favSport:g,favGroup:w,winRate:E,record:C,recentContests:$}},c=()=>{const u=l(),p=document.querySelector("bma-profile-hero");p&&(p.setAttribute("data-username",u.username),p.setAttribute("data-email",u.email),p.setAttribute("data-active-count",String(u.activeCount)),p.setAttribute("data-played-count",String(u.playedCount)),p.setAttribute("data-trophy-count",String(u.trophyCount)));const f=document.querySelector("bma-profile-stats");f&&(f.setAttribute("data-played",String(u.playedCount)),f.setAttribute("data-first-place",String(u.firstPlace)),f.setAttribute("data-trophies",String(u.trophyCount)),f.setAttribute("data-favorite-sport",u.favSport),f.setAttribute("data-favorite-sport-group",u.favGroup),f.setAttribute("data-win-rate",u.winRate),f.setAttribute("data-win-loss-record",u.record));const b=document.querySelector("bma-profile-history");b&&b.setAttribute("data-contests",JSON.stringify(u.recentContests));const v=document.getElementById("profile-trophy-pack");v&&(v.innerHTML=`
      ...
      `)};let d=null;return _t(async()=>{if(!s.appSession.session_user.authenticated){t.push({name:"signin_route"});return}c();const u=s.appSession?.session_user?.guid;u&&xe._ensureBetStatsCache(u).then(p=>{p&&c()}),d=le.subscribe(s.hierTopics.ROUTE__HOME_HYDRATE,()=>{c()})}),Ws(()=>{d&&le.unsubscribe(d)}),(u,p)=>(Le(),Ie("main",h_,[H("div",{class:"profile-header"},[H("button",{class:"profile-header__back",onClick:n,"aria-label":"Back"},[...p[7]||(p[7]=[H("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.5","stroke-linecap":"round","stroke-linejoin":"round"},[H("polyline",{points:"15 18 9 12 15 6"})],-1)])]),p[8]||(p[8]=H("h1",{class:"profile-header__title"},"My Profile",-1))]),p[18]||(p[18]=H("bma-profile-hero",null,null,-1)),H("div",m_,[H("aside",g_,[H("bma-profile-nav",{"data-active-section":a.value,onSectionChange:o},null,40,b_)]),H("div",__,[na(H("section",v_,[...p[9]||(p[9]=[H("div",{id:"profile-trophy-pack",class:"trophy-pack"},null,-1),H("bma-profile-stats",null,null,-1)])],512),[[Ia,a.value==="overview"]]),na(H("section",y_,[H("bma-profile-history",{onContestClick:i},null,32)],512),[[Ia,a.value==="contests"]]),na(H("section",w_,[...p[10]||(p[10]=[H("bma-profile-guide",null,null,-1)])],512),[[Ia,a.value==="guide"]]),na(H("section",x_,[H("div",T_,[H("button",{class:"account-btn",onClick:p[0]||(p[0]=f=>lt(le).publish("ROUTE.HOME.USER_PROFILE.RESET_PASSWORD",JSON.stringify({ts:Date.now()})))},[...p[11]||(p[11]=[H("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor"},[H("path",{d:"M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"})],-1),Mt(" Change Password ",-1)])]),H("button",{class:"account-btn account-btn--signout",onClick:p[1]||(p[1]=f=>lt(le).publish("ROUTE.HOME.USER_PROFILE.SIGNOUT",JSON.stringify({ts:Date.now()})))},[...p[12]||(p[12]=[H("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor"},[H("path",{d:"M17 7l-1.41 1.41L18.17 11H8v2h10.17l-2.58 2.58L17 17l5-5zM4 5h8V3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8v-2H4V5z"})],-1),Mt(" Sign Out ",-1)])])])],512),[[Ia,a.value==="account"]])])]),H("div",S_,[r.value?(Le(),Ie("div",{key:0,class:"mobile-account-scrim",onClick:p[2]||(p[2]=f=>r.value=!1)})):_i("",!0),r.value?(Le(),Ie("div",{key:1,class:"mobile-account-bar__panel",onClick:p[5]||(p[5]=$a(()=>{},["stop"]))},[H("button",{class:"account-btn",onClick:p[3]||(p[3]=f=>lt(le).publish("ROUTE.HOME.USER_PROFILE.RESET_PASSWORD",JSON.stringify({ts:Date.now()})))},[...p[13]||(p[13]=[H("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor"},[H("path",{d:"M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"})],-1),Mt(" Change Password ",-1)])]),H("button",{class:"account-btn account-btn--signout",onClick:p[4]||(p[4]=f=>lt(le).publish("ROUTE.HOME.USER_PROFILE.SIGNOUT",JSON.stringify({ts:Date.now()})))},[...p[14]||(p[14]=[H("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor"},[H("path",{d:"M17 7l-1.41 1.41L18.17 11H8v2h10.17l-2.58 2.58L17 17l5-5zM4 5h8V3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8v-2H4V5z"})],-1),Mt(" Sign Out ",-1)])])])):_i("",!0),H("div",{class:"mobile-account-bar__trigger",onClick:p[6]||(p[6]=f=>r.value=!r.value)},[p[16]||(p[16]=H("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"currentColor"},[H("path",{d:"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"})],-1)),p[17]||(p[17]=H("span",null,"Account",-1)),(Le(),Ie("svg",{class:Qt(["mobile-account-bar__chevron",r.value?"mobile-account-bar__chevron--open":""]),viewBox:"0 0 24 24",fill:"currentColor"},[...p[15]||(p[15]=[H("path",{d:"M7 10l5 5 5-5z"},null,-1)])],2))])])]))}};class k_ extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}static get observedAttributes(){return["data-username","data-rank","data-trophies","data-td-dollars"]}connectedCallback(){this._unsub=ke.subscribe(()=>this.render()),this.render()}disconnectedCallback(){this._unsub&&this._unsub()}attributeChangedCallback(t,s,a){this.shadowRoot&&s!==a&&this.render()}render(){const t=this.getAttribute("data-username")||"Player",s=this.getAttribute("data-rank")||"—",a=this.getAttribute("data-trophies")||"0",r=parseFloat(this.getAttribute("data-td-dollars")||"0"),n=r>=1e3?`${Math.round(r/100)/10}K`:Math.round(r).toLocaleString(),o=t.charAt(0).toUpperCase();this.shadowRoot.innerHTML=`
        ...
        `}}customElements.define("bma-tournament-list-card",F_);const $r=`
...
`.trim();typeof window<"u"&&(window.EMPTY_BETSLIP_HTML=$r);const xe={updateTDBalance(e,t){const s=document.querySelector(e);if(!s)return;t%1!==0?s.textContent=t.toFixed(2):neodigmUtils.countTo(e,t)},updateSummaryAndDashboard(e,t,s,a=null,r=0){const n=document.querySelector("#summary-balance"),o=document.querySelector("#summary-stake"),i=document.querySelector("#summary-payout");n&&(this.updateTDBalance("#summary-balance",e),e<0?n.classList.add("summary-cell__red"):n.classList.remove("summary-cell__red")),o&&(o.textContent=t.toFixed(2)),i&&(i.textContent=s.toFixed(2),s<0?i.classList.add("summary-cell__red"):i.classList.remove("summary-cell__red"));const l=document.getElementById("dashboard-td-balance"),c=document.getElementById("dashboard-td-pending");if(l){let d="";if(a){const p=a.tournament_dollars||0,f=e-p;f>0?d=`<span style="display: block; color: var(--status-upcoming-text, #00E676); font-size: 0.6em; margin-top: 2px;">(+${f.toLocaleString()})</span>`:f<0&&(d=`<span style="display: block; color: var(--status-locked-text, #F7C60D); font-size: 0.6em; margin-top: 2px;">(${f.toLocaleString()})</span>`)}const u=e<0?"#FF5252":"#00E676";l.innerHTML=`<span style="color: ${u};">TD$ ${e.toLocaleString()}</span>${d}`}if(c){const d=r||s||0;let u="";d>0&&(u=`<span style="display: block; color: var(--status-upcoming-text, #00E676); font-size: 0.6em; margin-top: 2px;">(→${d.toLocaleString()})</span>`),c.innerHTML=`TD$ ${t.toLocaleString()}${u}`}if(a&&a.tournament_dollars){const d=a.tournament_dollars,u=document.querySelector(".dash-stat__gauge-fill--balance");if(u){const f=Math.max(e/d*100,0);u.style.width=`${f}%`}const p=document.querySelector(".dash-stat__gauge-fill--pending");if(p){const f=Math.min(t/d*100,100);p.style.width=`${f}%`}}this.updateBetSlipToggleSummary()},updateBetSlipToggleSummary(){const e=document.getElementById("bet-grid-toggle-count"),t=document.querySelector(".bet-grid__toggle-container");if(!e||!t)return;const s=document.querySelectorAll(".bet-grid__slip-BETSLIP-content bma-bet-entry").length;e.textContent=s,t.classList.toggle("bet-grid__toggle-container--has-bets",s>0);const a=document.getElementById("bet-slip-tab-slip-badge");a&&(a.textContent=s,a.style.visibility=s>0?"visible":"hidden");const r=document.getElementById("bet-slip-tab-mybets-badge");if(r){const n=document.querySelectorAll(".bet-grid__slip-MYBETS bma-bet-existing").length;r.textContent=n,r.style.visibility=n>0?"visible":"hidden"}},_globalLBCache:{},async prefetchGlobalLeaderboard(e="ALL"){const s=this._globalLBCache[e];if(s?.data&&Date.now()-s.ts<3e5)return s.data;if(s?.inflight)return null;this._globalLBCache[e]={data:s?.data||null,ts:s?.ts||0,inflight:!0};try{const a=await Ae.fetchAllTimeLeaderboard(e,100,"td");return this._globalLBCache[e]={data:a,ts:Date.now(),inflight:!1},console.log(`[appEvents] All-time leaderboard prefetched [${e}]:`,a?.count||0,"rows, last_updated:",a?.last_updated),a}catch(a){return console.warn(`[appEvents] All-time leaderboard prefetch failed [${e}]:`,a),this._globalLBCache[e]&&(this._globalLBCache[e].inflight=!1),null}},_betStatsCache:{stats:null,ts:0,inflight:!1},async _ensureBetStatsCache(e){const s=Date.now();if(this._betStatsCache.stats&&s-this._betStatsCache.ts<3e5)return this._betStatsCache.stats;if(this._betStatsCache.inflight)return null;this._betStatsCache.inflight=!0;try{const r=(await Ae.fetchBetSlips(e))?.rows||[];let n=0,o=0,i=0;return r.forEach(l=>{(l.bet||[]).forEach(d=>{Object.keys(d).forEach(u=>{if(u==="short_title")return;const p=d[u];!p||typeof p!="object"||(p.reconciled===!0?parseFloat(p.payout||0)>0?n++:o++:i++)})})}),this._betStatsCache={stats:{wins:n,losses:o,pending:i},ts:s,inflight:!1},this._betStatsCache.stats}catch(a){return console.warn("[app_events] fetchBetSlips failed for stats panel",a),this._betStatsCache.inflight=!1,null}},buildStatsPanel(e,t,s=null){if(!t||!e||e.length===0)return"";const a=e.filter(b=>(b.entities?.guids||[]).includes(t)),r=a.filter(b=>(b.status||b.class)==="COMPLETED").length;let n=0,o=0;a.forEach(b=>{(Array.isArray(b.tags)?b.tags:[]).forEach(y=>{if(!y||typeof y!="object")return;const m=(y.entity_guid===t?y.badge:null)||(typeof y[t]=="string"?y[t]:null);typeof m=="string"&&m.startsWith("--badge__ribbon--")&&(o++,m==="--badge__ribbon--gold"&&n++)})});const i={};a.forEach(b=>{(Array.isArray(b.sports_allowed)?b.sports_allowed:[]).forEach(y=>{const h=Ge.find(_=>_.key===y.key)?.group||"Other";i[h]=(i[h]||0)+1})});let l="—",c="",d=0;Object.entries(i).forEach(([b,v])=>{v>d&&(d=v,l=b,c=b)});let u="—",p="Pending";if(s){const b=s.wins+s.losses;b>0?(u=`${Math.round(s.wins/b*100)}%`,p=`${s.wins}-${s.losses}`):(u="—",p="No settled bets")}const f=c?`<bma-sport-icon data-sport-group="${c.toLowerCase()}"></bma-sport-icon>`:"";return`
        ...
        `},categorizeTournaments(e,t,s,a,r={}){const n=[],{subStatus:o="all",sort:i="default",result:l="all",odds:c="all"}=r,d=x=>(x.entities?.guids||[]).includes(a),u=x=>x.status==="UPCOMING"||x.class==="UPCOMING",p=x=>x.status==="LOCKED"||x.class==="LOCKED",f=x=>u(x)||p(x),b=x=>x.status==="COMPLETED"||x.class==="COMPLETED",v=x=>Array.isArray(x.matches_expanded)&&x.matches_expanded.length>0,y=(x,T)=>(x.sports_allowed||[]).some(E=>E.key===T),m=x=>Ge.find(T=>T.key===x)?.title||x,h=x=>{const T=x.tags||[];for(const E of T)if(!(typeof E!="object"||!E)&&(E.entity_guid===a&&E.badge||E[a]))return!0;return!1},_=x=>{if(i==="default")return x;const T=[...x];switch(i){case"starting_soon":T.sort((E,C)=>new Date(E.window_start_time||0)-new Date(C.window_start_time||0));break;case"most_entrants":T.sort((E,C)=>(C.entities?.guids?.length||0)-(E.entities?.guids?.length||0));break;case"fewest_spots":T.sort((E,C)=>{const $=(E.entities?.max||0)-(E.entities?.guids?.length||0),O=(C.entities?.max||0)-(C.entities?.guids?.length||0);return $-O});break;case"recently_active":T.sort((E,C)=>new Date(C.status_time||0)-new Date(E.status_time||0));break;case"newest":T.sort((E,C)=>new Date(C.status_time||0)-new Date(E.status_time||0));break;case"td_high":T.sort((E,C)=>parseFloat(C.tournament_dollars||0)-parseFloat(E.tournament_dollars||0));break;case"td_low":T.sort((E,C)=>parseFloat(E.tournament_dollars||0)-parseFloat(C.tournament_dollars||0));break}return T},S=x=>l==="all"?x:l==="trophy"?x.filter(T=>h(T)):l==="no_trophy"?x.filter(T=>!h(T)):x;let g=e,w="";if(s==="multi"?(g=e.filter(x=>(x.sports_allowed?.length||0)>1),w="Multi-Sport "):s!=="all"&&(g=e.filter(x=>y(x,s)),w=m(s)+" "),t==="lobby"){let x=g;if(o==="open"?x=g.filter(T=>u(T)):o==="locked"?x=g.filter(T=>p(T)):o==="completed"&&(x=g.filter(T=>b(T))),o==="all"){const T=_(x.filter($=>u($)&&!d($)));n.push({title:`Open Entry ${w}Tournaments`,tournaments:T});const E=_(x.filter($=>p($)&&!d($)));E.length>0&&n.push({title:`In Progress - Entry Closed ${w}Tournaments`,tournaments:E});const C=_(x.filter($=>b($))).slice(0,20);C.length>0&&n.push({title:`Recently Completed ${w}Tournaments`,tournaments:C})}else{const T=_(x),E={open:"Open",locked:"In Progress",completed:"Completed"};T.length>0&&n.push({title:`${E[o]} ${w}Tournaments`,tournaments:T})}}else if(t==="my"){const x=g.filter(O=>d(O));let T=x.filter(O=>f(O));o==="active"?T=T.filter(O=>p(O)):o==="upcoming"&&(T=T.filter(O=>u(O))),c==="available"?T=T.filter(O=>v(O)):c==="none"&&(T=T.filter(O=>!v(O)));const E=_(T);n.push({title:`Your Active ${w}Tournaments`,tournaments:E});const C=S(x.filter(O=>b(O))),$=_(C);$.length>0&&n.push({title:`Your Completed ${w}Tournaments`,tournaments:$})}else if(t==="completed"){const x=_(S(g.filter(E=>d(E)&&b(E))));x.length>0&&n.push({title:`Your Completed ${w}Tournaments`,tournaments:x});const T=_(g.filter(E=>!d(E)&&b(E)));T.length>0&&n.push({title:`Other Completed ${w}Tournaments`,tournaments:T})}else t==="private"?n.push({title:"Private Contests",tournaments:[],emptyMessage:"Private Contests Coming Soon",emptySubtext:"Create and join private contests with friends — feature in development"}):n.push({title:"Tournaments",tournaments:e});return n},updateTournamentDashboard(e){if(!e)return;console.log("[Dashboard Update] Starting dashboard update for:",e.caption);const t=be();t.appSession?.session_user?.guid;const s=e.tournament_dollars||1e4;let a=0,r=0,n=0;if(t.coreBetSlip&&t.coreBetSlip.length>0){const y=t.coreBetSlip[t.coreBetSlip.length-1].data.filter(m=>m.tournament_guid===e.guid);console.log("[Dashboard Update] Found",y.length,"existing bets for this tournament"),y.forEach(m=>{(m.bet||[]).forEach(_=>{Object.keys(_).filter(g=>g!=="short_title").forEach(g=>{const w=_[g];w&&(w.stake&&(a+=parseFloat(w.stake)),w.reconciled===!0&&w.payout>0&&(r+=parseFloat(w.payout)))})})})}const o=document.querySelector("#summary-stake");if(o){const v=parseFloat(o.textContent)||0;n=Math.max(0,v-a),console.log("[Dashboard Update] Summary total stakes:",v,"Pending:",n)}const i=a+n,l=s-a-n+r;console.log("[Dashboard Update] TD$:",s,"Committed:",a,"Pending:",n,"Payouts:",r,"=> Balance:",l);const c=document.getElementById("dashboard-td-balance");if(c){const v=l-s;let y="";v>0?y=`<span style="display: block; color: var(--status-upcoming-text, #00E676); font-size: 0.6em; margin-top: 2px;">(+${v.toLocaleString()})</span>`:v<0&&(y=`<span style="display: block; color: var(--status-locked-text, #F7C60D); font-size: 0.6em; margin-top: 2px;">(${v.toLocaleString()})</span>`);const m=l<0?"#FF5252":"#00E676";c.innerHTML=`<span style="color: ${m};">TD$ ${l.toLocaleString()}</span>${y}`}const d=document.getElementById("dashboard-td-pending"),u=document.querySelector(".dash-stat__gauge-fill--pending");if(d){const v=n>0?n:i,y=r||0;let m="";if(y>0&&(m=` <span style="color: var(--status-upcoming-text, #00E676); font-size: 0.7em;">(→${y.toLocaleString()})</span>`),d.innerHTML=`TD$ ${v.toLocaleString()}${m}`,u){const h=Math.min(v/s*100,100);u.style.width=`${h}%`}}const p=document.querySelector(".dash-stat__gauge-fill--balance");if(p){const v=Math.max(l/s*100,0);p.style.width=`${v}%`}const f=document.querySelector(".dash-stat__gauge-fill--participants");if(f&&e){const v=e.entities?.guids?.length||0,y=e.entities?.max||100,m=v/y*100;f.style.width=`${m}%`}const b=document.getElementById("game-mode-progress");if(b&&typeof window.GameMode<"u"){const v=e.class||"DEFAULT",y=window.GameMode.get(v),m=t.coreBetSlip.length>0?t.coreBetSlip[t.coreBetSlip.length-1].data.filter(_=>_.coreTournaments__guid===e.guid||_.tournament_guid===e.guid):[],h=y.getProgressUI(m,e);if(h.type!=="NONE"){const _=h.typesStatus?h.typesStatus.map(g=>g.placed?`<span style="display: inline-flex; align-items: center; gap: 5px; padding: 4px 12px; border-radius: 9999px; background: rgba(0, 230, 118, 0.12); box-shadow: inset 0 0 0 1px rgba(0, 230, 118, 0.35); color: #00E676; font-size: 0.72rem; font-weight: 700; letter-spacing: 0.3px;">
            ...
            </div>`})(),b=r.tags||[],y=b.some(I=>I.override_last_match_close===!0)?"+":"",m=b.some(I=>I.match_inprogress_lock===!0),h=b.some(I=>I.override_last_match_close===!0);let _="Bet Max Tourney",S=null,g="";if(typeof window.GameMode<"u"){const I=window.GameMode.get(r.class||"DEFAULT"),q=I.getEffectiveRules(r);if(S=I.getBadge(),_=I.label,q.stakeRule==="SPEND_ALL"&&(g+='<div class="info-detail-row"><span>Stake Rule</span><span style="color: var(--status-locked-text, #F7C60D);">Spend entire starting TD$ amount</span></div>'),q.requiredBetTypes.length>0){const X=q.requiredBetTypes.map(D=>D==="SPREAD"?"Spread":D==="MONEY"?"Money Line":"Over/Under").join(", ");g+=`<div class="info-detail-row"><span>Required Bets</span><span style="color: var(--status-upcoming-text, #00E676);">${X}</span></div>`}q.oneBetPerMatchPerType&&(g+='<div class="info-detail-row"><span>Bet Limit</span><span>One per match per type</span></div>')}const w=(()=>{const q=(r.tags||[]).find(P=>P.badge_gold!==void 0||P.badge_silver!==void 0||P.badge_bronze!==void 0);if(!q)return null;const X=q.badge_gold||0,D=q.badge_silver||0,k=q.badge_bronze||0;return X===0&&D===0&&k===0?null:{gold:X,silver:D,bronze:k}})();r.status==="LOCKED"||r.status==="UPCOMING"||r.status,r.status==="LOCKED"||r.status==="UPCOMING"||r.status==="COMPLETED"||r.status;const x=r.matches_expanded?.length||0,T=x===0?"TBD":`${x}${y}`;`${Number(r.tournament_dollars||0).toLocaleString()}${u}${p}${T}`;const E=r.status==="LOCKED"?"In Progress":r.status==="UPCOMING"?"Open":r.status,C=r.status==="LOCKED"?"var(--status-locked-text, #F7C60D)":r.status==="UPCOMING"?"var(--status-upcoming-text, #00E676)":"var(--status-completed-text, #CD5659)",$=`
        ...
        `:`<div class="info-empty-state">
            ...
            <p>No trophies configured for this tournament</p>
                ...
                </div>`;let I=0,q=0,X=0;const D=new Date;r.matches_expanded.forEach(Y=>{let ie=null;try{ie=typeof Y.scoreboard_data=="string"?JSON.parse(Y.scoreboard_data):Y.scoreboard_data}catch{}ie?.time_remaining?ie.time_remaining.toLowerCase()==="final"?I++:q++:new Date(Y.scheduled_at)<D?I++:X++});const k=q>0?"live":"upcoming",P=[];I>0&&P.push(`<span class="match-filter-btn${k==="final"?" match-filter--active":""}" data-filter="final">${I} Final</span>`),q>0&&P.push(`<span class="match-filter-btn match-filter-btn--live${k==="live"?" match-filter--active":""}" data-filter="live">${q} Live</span>`),X>0&&P.push(`<span class="match-filter-btn match-filter-btn--upcoming${k==="upcoming"?" match-filter--active":""}" data-filter="upcoming">${X} Upcoming</span>`);const M=P.length>0?`<div class="match-filter-bar">${P.join("")}</div>`:"",j=new Date,Q=r.matches_expanded.map(Y=>{const ie=Y.scoreboard_data?typeof Y.scoreboard_data=="string"?Y.scoreboard_data:JSON.stringify(Y.scoreboard_data):"";let J="upcoming",se=null;try{se=typeof Y.scoreboard_data=="string"?JSON.parse(Y.scoreboard_data):Y.scoreboard_data}catch{}se?.time_remaining?J=se.time_remaining.toLowerCase()==="final"?"final":"live":J=new Date(Y.scheduled_at)<j?"final":"upcoming";const ee=J!==k;return`<bma-match-status
                    data-match-guid="${Y.guid||Y.odds_id||Y.id||""}"
                    data-match-title="${Y.short_title||Y.title||"Match"}"
                    data-match-scheduled-at="${Y.scheduled_at||""}"
                    data-match-home-team="${Y.home_team_id||"Home"}"
                    data-match-away-team="${Y.away_team_id||"Away"}"
                    data-match-home-score="${Y.home_team_score!==null&&Y.home_team_score!==void 0?Y.home_team_score:""}"
                    data-match-away-score="${Y.away_team_score!==null&&Y.away_team_score!==void 0?Y.away_team_score:""}"
                    data-match-scoreboard="${ie.replace(/"/g,"&quot;")}"
                    data-match-sport-id="${Y.sport_id||""}"
                    data-match-status="${J}"
            ...
            `})(),U=r.status==="UPCOMING"?"Accepting new players. Place bets before each match starts.":r.status==="LOCKED"?"No new entrants. Joined players can still bet on matches that haven't started yet.":r.status==="COMPLETED"?"All matches settled. Final standings locked in.":"",ae=`
            ...
            <div class="info-pack info-pack--padded">
                <div class="info-progress-status">
                    <div class="info-progress-status__row">
                        ...
                        <span class="info-progress-status__value" style="color: ${C};">${E}</span>
                    </div>
        ...
        `;n.innerHTML=`
            <div class="info-wrap">
                ...
                <div class="info-pack">
                    ...
                    <div class="info-tab-panel" data-info-panel="trophies" style="display: none;">${F}</div>
                    <div class="info-tab-panel" data-info-panel="matches" style="display: none;">${K}</div>
                </div>
            </div>
        `;const A=n.querySelector("[data-info-legend-toggle]");A&&A.addEventListener("click",()=>{const q=A.closest(".info-legend").classList.toggle("info-legend--open");A.setAttribute("aria-expanded",String(q))}),n.querySelectorAll(".info-tab").forEach(I=>{I.addEventListener("click",()=>{n.querySelectorAll(".info-tab").forEach(X=>X.classList.remove("info-tab--active")),I.classList.add("info-tab--active");const q=I.dataset.infoTab;n.querySelectorAll(".info-tab-panel").forEach(X=>{X.style.display=X.dataset.infoPanel===q?"":"none"})})});const L=n.querySelector('[data-info-panel="matches"]');L&&L.addEventListener("click",I=>{const q=I.target.closest(".match-filter-btn");q&&(L.querySelectorAll(".match-filter-btn").forEach(X=>X.classList.remove("match-filter--active")),q.classList.add("match-filter--active"),L.querySelectorAll("bma-match-status").forEach(X=>{X.style.display=X.dataset.matchStatus===q.dataset.filter?"":"none"}))});const B=document.getElementById("pop-play__caro-info-summary2--id");B&&(B.innerHTML="");const R=document.getElementById("pop-play__caro-info-list--id");R&&(R.innerHTML="")},async populateLeaderboard(){const e=be(),s=document.querySelector(".play-cntr")?.dataset?.currentTournGuid,a=e.appSession?.session_user?.guid;if(!s){console.warn("[appEvents] Cannot populate leaderboard: no tournament GUID");return}const r=document.getElementById("pop-play__caro-leaderboard--id");if(!r)return;let n=document.getElementById("leaderboard-loading-banner");n||(n=document.createElement("neodigm-juicebar"),n.id="leaderboard-loading-banner",n.setAttribute("role","progressbar"),n.setAttribute("data-n55-theme","warning"),n.setAttribute("data-n55-size","small"),n.innerHTML="<div></div>",n.style.cssText=`
                width: 100%;
                margin: 6px;
            `,r.parentNode.insertBefore(n,r)),n.style.visibility="visible";try{const o=await Ae.fetchLeaderboard(s),i=o?.data||o?.rows;if(i&&i.length>0){const c=e.coreTourn[e.coreTourn.length-1]?.data.find(U=>U.guid===s),d=c?.class||"DEFAULT_FORMAT",u=window.GameMode?.get?.(d),p=u?.rankLeaderboard?u.rankLeaderboard(i.map(U=>{const ae=typeof U.combined_betslips=="string"?(()=>{try{return JSON.parse(U.combined_betslips)}catch{return[]}})():U.combined_betslips||[];return{...U,bets:ae,timestamp:U.created_at||U.updated_at||0}}),c):i,f=parseFloat(c?.tournament_dollars||0),b=U=>{if(d!=="DEFAULT_FORMAT"||f<=0)return!0;let ae=0;return(U.bets||[]).forEach(W=>{(W.bet||[]).forEach(G=>{Object.keys(G).forEach(re=>{re!=="short_title"&&(ae+=parseFloat(G[re]?.stake||0))})})}),ae>=f-.01},y=(()=>{if(d!=="DEFAULT_FORMAT")return"";const ae=(c?.tags||[]).find(R=>R.badge_gold!==void 0||R.badge_silver!==void 0||R.badge_bronze!==void 0);if(!ae)return"";const W=ae.badge_gold||0,G=ae.badge_silver||0,re=ae.badge_bronze||0;if(W===0&&G===0&&re===0)return"";const N=p.some(R=>(R.bets||[]).some(I=>(I.bet||[]).some(q=>Object.keys(q).some(X=>X!=="short_title"&&q[X]?.reconciled===!0))))?p.filter(b):[],V=R=>{if(!R)return'<span class="podium-slot__empty">Open</span>';const I=R.user_guid===a;return`<span class="podium-slot__name${I?" podium-slot__name--you":""}">${R.username||"Unknown"}${I?' <span class="podium-slot__you">YOU</span>':""}</span>`},z=Array.from({length:W},(R,I)=>V(N[I])).join(""),A=Array.from({length:G},(R,I)=>V(N[W+I])).join(""),L=Array.from({length:re},(R,I)=>V(N[W+G+I])).join(""),B=c?.status==="COMPLETED"?"":"Waiting for bets to settle";return`
                        <div class="leaderboard-podium">
                            <div class="leaderboard-podium__title">Trophy Preview</div>
                            <div class="leaderboard-podium__pack">
                                ${G>0?`<div class="podium-slot podium-slot--silver">
                            ...
                            ${B?`<div class="leaderboard-podium__label">${B}</div>`:""}
                        </div>
                    `})(),S=`
                ...
                `,g=(U,ae,W=!1)=>{let G="";if(c?.tags&&Array.isArray(c.tags)){const A=c.tags.find(L=>!!(typeof L=="object"&&L!==null&&(L.entity_guid===U.user_guid&&L.badge&&L.badge.startsWith("--badge__ribbon--")||L[U.user_guid]&&L[U.user_guid].startsWith("--badge__ribbon--"))));if(A){const L=A.badge||A[U.user_guid];L==="--badge__ribbon--gold"?G="badge-trophy--gold":L==="--badge__ribbon--silver"?G="badge-trophy--silver":L==="--badge__ribbon--bronze"&&(G="badge-trophy--bronze")}}const re=U.combined_betslips?typeof U.combined_betslips=="string"?U.combined_betslips:JSON.stringify(U.combined_betslips):"[]";let te="[]";if(U.combined_betslips&&c?.matches_expanded){const A=typeof U.combined_betslips=="string"?JSON.parse(U.combined_betslips):U.combined_betslips,L=[...new Set(A.map(R=>R.coreMatches__guid||R.match_guid||R.odds_id).filter(Boolean))],B=c.matches_expanded.filter(R=>{const I=R.guid||R.id||R.odds_id;return L.includes(I)});te=JSON.stringify(B)}const N=parseFloat(U.calculated_tournament_dollars||0),V=parseInt(U.total_betslips||0),z=N===0&&V===0?c?.tournament_dollars||0:U.calculated_tournament_dollars||0;return`
                ...
                `:"")+w.map((U,ae)=>g(U,ae+1,!1)).join(""),C=x.length>0?`
                    ...
                    ${x.map(U=>g(U,"—",!0)).join("")}
                `:"";r.innerHTML=y+S+E+C,requestAnimationFrame(()=>{r.querySelectorAll("bma-leaderboard-card").forEach((U,ae)=>{U.style.animation="motion-slide-up-enter 300ms cubic-bezier(0.4, 0, 0.2, 1) both",U.style.animationDelay=`${Math.min(ae*60,400)}ms`})}),r.querySelectorAll(".leaderboard-tab").forEach(U=>{U.addEventListener("click",()=>{const ae=U.dataset.lbTab;r.querySelectorAll(".leaderboard-tab").forEach(W=>W.classList.remove("leaderboard-tab--active")),U.classList.add("leaderboard-tab--active"),r.querySelectorAll("[data-lb-panel]").forEach(W=>{W.style.display=W.dataset.lbPanel===ae?"":"none"})})});const $=w.findIndex(U=>U.user_guid===a),O=c?.entities?.guids?.length||p.length,F=$>=0?$+1:"—",K=document.getElementById("dashboard-rank");if(K){const U=F==="—"?"—":`${F}/${O}`;K.innerHTML=`<span class="tourn-dashboard__rank-text">${U}</span><span style="display: block; font-size: 0.6em; margin-top: 2px; visibility: hidden;">(0)</span>`}}else r.innerHTML=`
            ...
            `;let d={subStatus:a,sort:r,result:n};c.addEventListener("click",u=>{const p=u.target.closest(".filter-chip");if(!p||p.classList.contains("filter-chip--disabled"))return;const f=p.dataset.filterType,b=p.dataset.filterVal;d[f]=b,c.querySelectorAll(`[data-filter-type="${f}"]`).forEach(v=>v.classList.remove("filter-chip--active")),p.classList.add("filter-chip--active")}),document.getElementById("filter-reset-btn")?.addEventListener("click",()=>{const u=l[s]||l.lobby;d={...u},Object.keys(u).forEach(p=>{c.querySelectorAll(`[data-filter-type="${p}"]`).forEach(f=>f.classList.remove("filter-chip--active")),c.querySelector(`[data-filter-type="${p}"][data-filter-val="${u[p]}"]`)?.classList.add("filter-chip--active")})}),document.getElementById("filter-apply-btn")?.addEventListener("click",()=>{neodigmSodaPop.close(),t&&t(d)})}),neodigmSodaPop.autoOpen("sodapop_filters")},bindAppListeners(e){le.subscribe("APP",(w,x)=>{console.warn("~~ sub all APP | "+w+"|"+x)}),le.subscribe("WC",(w,x)=>{console.warn("~~ sub all WC  | "+w+"|"+x)}),le.subscribe("ROUTE",(w,x)=>{console.warn("~~ sub all ROUTE  | "+w+"|"+x)});let t="lobby",s="all",a="all",r="default",n="all",o="all",i=localStorage.getItem("bma_view_mode")||"cards";const l=()=>{s="all";const w=document.querySelector("bma-app-head-sports");w&&w.setAttribute("data-selected-chip","all")},c=()=>{const w=document.getElementById("filter-bar__count--id");if(!w)return;let x=0;a!=="all"&&x++,r!=="default"&&x++,n!=="all"&&x++,w.textContent=x,w.style.display=x>0?"":"none"},d=()=>{document.querySelectorAll(".home-tab").forEach(T=>T.classList.remove("home-tab--active"));const x=t==="my"?document.querySelector('[data-home-tab="active"]'):document.querySelector('[data-home-tab="lobby"]');x&&x.classList.add("home-tab--active")},u=()=>{a="all",r="default",n="all",o="all"};document.addEventListener("click",w=>{const x=w.target.closest(".category-filter-toggle");if(x){const C=x.closest(".tournament-category-header")?.querySelector(".category-filter-row");if(C){const $=C.style.display!=="none";C.style.display=$?"none":"",x.classList.toggle("category-filter-toggle--open",!$),window._bmaFilterRowOpen=!$}return}const T=w.target.closest("[data-view-mode]");if(T){const E=T.dataset.viewMode;if(E===i)return;i=E,localStorage.setItem("bma_view_mode",E);const $=T.closest(".tournament-category-header")?.closest(".tournament-category"),O=$?[...document.querySelectorAll(".tournament-category")].indexOf($):-1;document.querySelectorAll("[data-view-mode]").forEach(F=>F.classList.remove("view-toggle__btn--active")),document.querySelectorAll(`[data-view-mode="${E}"]`).forEach(F=>F.classList.add("view-toggle__btn--active")),le.publish(e.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"VIEW_MODE_CHANGE"})),O>=0&&requestAnimationFrame(()=>{const F=document.querySelectorAll(".tournament-category");F[O]&&F[O].scrollIntoView({behavior:"smooth",block:"start"})})}}),document.addEventListener("click",w=>{const x=w.target.closest("[data-home-tab]");if(!x)return;const E=x.dataset.homeTab==="active"?"my":"lobby";if(E===t)return;t=E,l(),u(),c(),document.querySelectorAll(".home-tab").forEach($=>$.classList.remove("home-tab--active")),x.classList.add("home-tab--active");const C=document.querySelector("bma-app-head-mid");C&&C.setAttribute("data-selected-tab","head_mid_lobby"),le.publish(e.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"HOME_TAB_CHANGE"}))}),document.addEventListener("change",w=>{const x=w.target.closest(".category-dropdown");if(!x)return;const T=x.dataset.filterType,E=x.value;T==="subStatus"?a=E:T==="sort"?r=E:T==="result"?n=E:T==="odds"&&(o=E),c(),le.publish(e.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"DROPDOWN_FILTER_CHANGE"}))}),le.subscribe(e.hierTopics.COREBETSLIP,(w,x)=>{JSON.parse(x);let T=16;switch(w){case e.hierTopics.COREBETSLIP__BET:T=5,Ys.shootConfetti(),console.log("~~~  |  "+w+" | ",x);const E=document.querySelector("[data-bets-valid]");E&&(E.dataset.betsValid="false");const C=document.querySelector("neodigm-sodapop");C&&C.setAttribute("data-wait","true");const $=document.querySelectorAll(".bet-grid__slip-BETSLIP-content bma-bet-entry");if($.length===0){console.warn("[app_events] No bets to submit"),C&&C.setAttribute("data-wait","false"),typeof neodigmToast<"u"&&neodigmToast.q("No bets to submit","warning");break}const O=document.querySelector(".play-cntr"),F=O?.dataset?.currentTournGuid,K=e.appSession?.session_user?.guid;if(!F||!K){console.error("[app_events] Missing tournament or user GUID"),C&&C.setAttribute("data-wait","false"),typeof neodigmToast<"u"&&neodigmToast.q("Missing tournament or user data","danger");break}const U=Array.from($).map(A=>{const L=A.getAttribute("data-content-team-points"),B=A.getAttribute("data-content-odds"),R=A.getAttribute("data-stake")||"0",I=A.getAttribute("data-content-type"),q=A.getAttribute("data-payout")||"0",X=A.getAttribute("data-match-guid")||"",D={};return D[L]={type:I,stake:parseFloat(R),odds:parseFloat(B),payout:parseFloat(q),reconciled:!1},{acctEntity__guid:K,coreTournaments__guid:F,coreMatches__guid:X,bet:[D],status:"PENDING"}});console.log("[app_events] Submitting bet slips:",U);const ae=O?.dataset?.gameType||"DEFAULT";if(typeof window.GameMode<"u"){const A=window.GameMode.get(ae),B=[...e.coreBetSlip.length>0?e.coreBetSlip[e.coreBetSlip.length-1].data.filter(X=>X.coreTournaments__guid===F):[],...U],I=(e.coreTourn.length>0?e.coreTourn[e.coreTourn.length-1]:null)?.data.find(X=>X.guid===F),q=A.validateBetSlip(B,I,0);if(!q.valid){console.log("[app_events] Game mode validation failed:",q.errors),typeof neodigmToast<"u"&&q.errors.forEach(D=>neodigmToast.q(D,"warning",4e3)),C&&C.setAttribute("data-wait","false");const X=document.querySelector("[data-publish-betslip]");X&&delete X.dataset.processing;break}}Ae.postBetSlips(U).then(A=>{console.log("[app_events] Bet slips posted successfully:",A);const L=U.reduce((B,R)=>{const I=R.bet[0],q=Object.keys(I)[0];return B+(I[q]?.stake||0)},0);typeof neodigmToast<"u"&&neodigmToast.q(`Bets placed successfully!|Total Stake: TD$ ${L.toFixed(2)}`,"success"),Ae.fetchBetSlips(K,F).then(B=>{if(B?.rows){const R={timestamp:Date.now(),source:"API",data:B.rows};e.pushcoreBetSlip(R),console.log("[app_events] Refreshed bet slips in store:",B.rows.length,"items")}xe.refreshPlayPopupUI(F,B),C&&C.setAttribute("data-wait","false")}).catch(B=>{console.error("[app_events] Error fetching fresh bet slips:",B);const R=document.querySelector("[data-publish-betslip]");R&&delete R.dataset.processing,E&&(E.dataset.betsValid="true"),C&&C.setAttribute("data-wait","false"),typeof neodigmToast<"u"&&neodigmToast.q("Bets placed but failed to refresh|Please close and reopen","warning")})}).catch(A=>{console.error("[app_events] Error posting bet slips:",A);const L=document.querySelector("[data-publish-betslip]");L&&delete L.dataset.processing,E&&(E.dataset.betsValid="true"),typeof neodigmToast<"u"&&neodigmToast.q("Failed to place bets|Please try again","danger"),C&&C.setAttribute("data-wait","false")});break;case e.hierTopics.COREBETSLIP__SPREAD:break;case e.hierTopics.COREBETSLIP__MONEY:break;case e.hierTopics.COREBETSLIP__TOTAL:break;case e.hierTopics.COREBETSLIP__CLOSE:T=24;break;case e.hierTopics.COREBETSLIP__TDSYNC:if(document.querySelector("#summary-balance")&&x){x=JSON.parse(x);const L=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;if(e.coreBetSlip[0]?.data&&L){const B=e.coreBetSlip[0].data.filter(j=>j.coreTournaments__guid===L),R=[],I=[],q=[];B.forEach(j=>{const Q=j.bet||[];if(Q.length===0)return;const Y=Q[0];Object.keys(Y).filter(J=>J!=="short_title").forEach(J=>{const se=Y[J],ee=se?.reconciled!==!1,ce=parseFloat(se?.payout||0);ee?ce===0?I.push(j):q.push(j):R.push(j)})});const X=ft.search(R,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0,D=ft.search(I,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0,k=X+D,P=ft.search(q,"sum([].bet[].* | [].payout | map(&to_number(@), @)) || `0`")||0,M=x.tournament_dollars-k+P;xe.updateTDBalance("#summary-balance",M)}else xe.updateTDBalance("#summary-balance",x.tournament_dollars)}break;case e.hierTopics.COREBETSLIP__INTERSYNC:let G=0,re=0,te=0;if(e.coreBetSlip.length>0){const L=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;if(L){const R=e.coreBetSlip[e.coreBetSlip.length-1].data.filter(P=>P.coreTournaments__guid===L),I=[],q=[],X=[];R.forEach(P=>{const M=P.bet||[];if(M.length===0)return;const j=M[0];Object.keys(j).filter(Y=>Y!=="short_title").forEach(Y=>{const ie=j[Y],J=ie?.reconciled!==!1,se=parseFloat(ie?.payout||0);J?se===0?q.push(P):X.push(P):I.push(P)})}),G=ft.search(I,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0,re=ft.search(X,"sum([].bet[].* | [].payout | map(&to_number(@), @)) || `0`")||0;const D=ft.search(q,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0,k=ft.search(X,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0;te=D+k}}let N=!0,V=0;const z=document.querySelector("[data-bets-valid]");if(z&&x){x=JSON.parse(x),x.pending_stake_sum=0,x.pending_payout_sum=0,x.bets.length||(N=!1),x.bets.forEach(X=>{X.stake=Number(X.stake),X.stake>0?x.pending_stake_sum+=X.stake:N=!1}),document.querySelectorAll(".bet-grid__slip-BETSLIP-content bma-bet-entry").forEach(X=>{const D=parseFloat(X.getAttribute("data-payout")||"0");x.pending_payout_sum+=D});const L=G+x.pending_stake_sum,B=re+x.pending_payout_sum;V=parseFloat((x.tournament_dollars-L-te+re).toFixed(2));const I=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;let q=null;I&&e.coreTourn.length>0&&(q=e.coreTourn[e.coreTourn.length-1]?.data?.find(D=>D.guid===I)),xe.updateSummaryAndDashboard(V,L,B,q,x.pending_payout_sum||0),(x.tournament_dollars<0||V<0)&&(N=!1),z.dataset.betsValid=N}break}T&&neodigmWired4Sound&&neodigmWired4Sound.sound(T,"QUITE").vibrate()});const p=()=>{const x=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;let T=0;x&&e.coreTourn.length>0&&(T=e.coreTourn[e.coreTourn.length-1].data.find($=>$.guid===x)?.tournament_dollars||0),le.publish(e.hierTopics.COREBETSLIP__TDSYNC,JSON.stringify({tournament_dollars:T,timestamp:Date.now()}))},f=()=>{const x=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;let T=0;x&&e.coreTourn.length>0&&(T=e.coreTourn[e.coreTourn.length-1].data.find(W=>W.guid===x)?.tournament_dollars||0);let E=0,C=0,$=0,O=0;if(e.coreBetSlip.length>0&&x){const ae=e.coreBetSlip[e.coreBetSlip.length-1].data.filter(z=>z.coreTournaments__guid===x);console.log("[app_events] Filtered bets for tournament:",x,"found:",ae.length),console.log("[app_events] Using latest bet slip data index:",e.coreBetSlip.length-1),console.log("[app_events] First bet sample:",ae[0]);const W=[],G=[],re=[];ae.forEach(z=>{const A=z.bet||[];if(A.length===0)return;const L=A[0];Object.keys(L).filter(R=>R!=="short_title").forEach(R=>{const I=L[R],q=I?.reconciled!==!1,X=parseFloat(I?.payout||0);q?X===0?G.push(z):re.push(z):W.push(z)})}),console.log("[app_events] Bet categories:",{unreconciled:W.length,reconciledZero:G.length,reconciledNonZero:re.length});const te=ft.search(W,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0,N=ft.search(G,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0,V=ft.search(re,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0;$=N+V,C=ft.search(re,"sum([].bet[].* | [].payout | map(&to_number(@), @)) || `0`")||0,O=ft.search(W,"sum([].bet[].* | [].payout | map(&to_number(@), @)) || `0`")||0,E=te,console.log("[app_events] Balance calculation:",{unreconciledStakes:te,lostBetStakes:N,wonBetStakes:V,allReconciledStakes:$,displayedStake:E,reconciledPayouts:C,tournamentDollars:T,calculatedBalance:T-E-$+C})}else console.warn("[app_events] No bet data found in Pinia store or missing tournamentGuid");const F=T-E-$+C;let K=null;x&&e.coreTourn.length>0&&(K=e.coreTourn[e.coreTourn.length-1].data.find(ae=>ae.guid===x)),xe.updateSummaryAndDashboard(F,E,C,K,O)};le.subscribe(e.hierTopics.SODAPOP__HYDRATE__COREBETSLIP,(w,x)=>{const E=JSON.parse(x)?.rows||[],C=document.querySelector(".bet-grid__slip-MYBETS");if(!C)return;if(C.innerHTML="",E.length===0){C.innerHTML='<p style="color: var(--app-core-color--gray-6__dark--brand, #969696); text-align: center; padding: 20px;">No active bets</p>';const K=document.querySelector(".bet-grid__slip");K&&K.setAttribute("data-active-bet-tab","BETSLIP"),p();return}E.forEach(K=>{if((K.bet||[]).length===0)return;const ae=document.createElement("bma-bet-existing");ae.setAttribute("data-corebetslip",JSON.stringify(K)),C.appendChild(ae)});const $=document.querySelector(".bet-grid__slip");$&&$.setAttribute("data-active-bet-tab","MYBETS"),be().appCLIFeatures?.features?.disable_existing_bet_btn?.state===!0&&xe.disableExistingBetButtons(),setTimeout(()=>{console.log("[app_events] Calling updateSummaryFromExistingBets after HYDRATE, bet count:",E.length),console.log("[app_events] Pinia store bet count:",e.coreBetSlip[0]?.data?.length||0),f()},200)}),document.addEventListener("click",w=>{const x=w.target;if(x&&x.classList.contains("bet-slip-tab")){const T=x.dataset.betTab,E=document.querySelector(".bet-grid__slip");T&&E&&(E.setAttribute("data-active-bet-tab",T),neodigmWired4Sound&&neodigmWired4Sound.sound(3),console.log("[app_events] Switched to bet tab:",T))}if(x&&x.dataset.publishBetslip){if(document.querySelector("[data-bets-valid]")?.dataset?.betsValid!=="true"){console.warn("[app_events] Cannot submit - bets invalid or button disabled");return}if(x.dataset.processing==="true"){console.warn("[app_events] Bet submission already in progress");return}x.dataset.processing="true";const E=x.dataset.publishBetslip;le.publish(E,JSON.stringify({timestamp:Date.now()}))}});const b=()=>{const x=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;let T=0;x&&e.coreTourn.length>0&&(T=e.coreTourn[e.coreTourn.length-1].data.find(F=>F.guid===x)?.tournament_dollars||0);const E=document.querySelectorAll(".bet-grid__slip-BETSLIP-content bma-bet-entry"),C=Array.from(E).map($=>({teamPoints:$.getAttribute("data-content-team-points"),odds:$.getAttribute("data-content-odds"),stake:$.getAttribute("data-stake")||"0",type:$.getAttribute("data-content-type"),abbreviatedTitle:$.getAttribute("data-abbreviated-title"),scheduledAt:$.getAttribute("data-scheduled-at")}));le.publish(e.hierTopics.COREBETSLIP__INTERSYNC,JSON.stringify({tournament_dollars:T,bets:C,timestamp:Date.now()}))},v=(w,x)=>{const T=JSON.parse(x),E=document.querySelector(".bet-grid__slip-BETSLIP-content");if(!E){console.error("[app_events] Bet slip container not found");return}const C=E.querySelector(".bet-slip__empty");C&&C.remove();let $="";T.type==="total"?$=T.team==="over"?"Over":"Under":T.team==="home"?$=T.homeTeam:T.team==="away"&&($=T.awayTeam);let O=$;if(T.point)if(T.type==="spread"){const G=parseFloat(T.point)>0?`+${T.point}`:T.point;O=`${$} ${G}`}else T.type==="total"&&(O=`${$} ${T.point}`);const F=document.createElement("bma-bet-entry");F.setAttribute("data-content-team-points",O),F.setAttribute("data-content-odds",T.price||"0"),F.setAttribute("data-content-stake-text","0"),F.setAttribute("data-content-type",T.type||""),F.setAttribute("data-abbreviated-title",T.abbreviatedTitle||`${T.homeTeam} vs ${T.awayTeam}`),F.setAttribute("data-scheduled-at",T.scheduledAt||""),F.setAttribute("data-match-guid",T.matchGuid||""),F.setAttribute("data-home-team",T.homeTeam||""),F.setAttribute("data-away-team",T.awayTeam||""),F.setAttribute("data-bet-team",$||"");const U=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;if(U&&e.coreTourn.length>0){const re=e.coreTourn[e.coreTourn.length-1].data.find(te=>te.guid===U);if(re?.sports_allowed&&re.sports_allowed.length>0){const te=re.sports_allowed[0];F.setAttribute("data-sport-key",te.key||"");const N=Ge.find(V=>V.key===te.key);F.setAttribute("data-sport-group",N?.group||"")}}E.appendChild(F),console.log("[app_events] Bet entry appended to container:",F,"Container children:",E.children.length),setTimeout(()=>{m(F)},0);const ae=document.querySelector(".bet-grid__slip");ae&&(ae.setAttribute("data-active-bet-tab","BETSLIP"),console.log("[app_events] Switched to BETSLIP tab"));const W=E.querySelectorAll("bma-bet-entry").length;W>=3?requestAnimationFrame(()=>{setTimeout(()=>{const G=document.querySelector(".bet-grid__slip");G&&(console.log("[app_events] Scrolling parent to bottom - bet count:",W,"scrollHeight:",G.scrollHeight,"current scrollTop:",G.scrollTop),G.scrollTo({top:G.scrollHeight,behavior:"smooth"}),setTimeout(()=>{console.log("[app_events] After scroll - scrollTop:",G.scrollTop)},500))},150)}):console.log("[app_events] Skipping scroll - only",W,"bet cards (need 3+)"),setTimeout(()=>{b()},200),console.log("[app_events] Created bet entry:",{teamPoints:O,odds:T.price,type:T.type})};le.subscribe(e.hierTopics.COREBETSLIP__SPREAD,(w,x)=>{v(w,x),y()}),le.subscribe(e.hierTopics.COREBETSLIP__MONEY,(w,x)=>{v(w,x),y()}),le.subscribe(e.hierTopics.COREBETSLIP__TOTAL,(w,x)=>{v(w,x),y()});function y(){const w=window.matchMedia("(orientation: portrait)").matches,x=window.matchMedia("(max-width: 768px)").matches;if(w||x){const T=document.querySelector(".bet-grid__select"),E=document.querySelector(".bet-grid__slip"),C=document.querySelector(".bet-grid__toggle-text");T&&E&&C&&(T.classList.add("collapsed"),E.classList.remove("collapsed"),C.textContent="Close Bet Slip",console.log("[app_events] Bet slip expanded on portrait mode"))}}const m=w=>{const x={sport:{key:w.getAttribute("data-sport-key")||"",group:w.getAttribute("data-sport-group")||""},Match:{scheduled_at:w.getAttribute("data-scheduled-at")||"",home_team_id:w.getAttribute("data-home-team")||"",home_team_score:"",away_team_id:w.getAttribute("data-away-team")||"",away_team_score:""},Bet:{scope:{team_id:w.getAttribute("data-bet-team")||"",over:"",under:""},type:w.getAttribute("data-content-type")||"",odds:w.getAttribute("data-content-odds")||"0",stake:w.getAttribute("data-stake")||"0"}},T=yu.calcPayout(x);w.setAttribute("data-payout",T.toString()),console.log("[app_events] Payout calculated:",{stake:x.Bet.stake,odds:x.Bet.odds,payout:T})};new MutationObserver(w=>{w.forEach(x=>{x.type==="attributes"&&x.attributeName==="data-stake"&&x.target.tagName==="BMA-BET-ENTRY"&&(console.log("[app_events] Stake changed:",x.target.getAttribute("data-stake")),m(x.target),clearTimeout(window.betSlipStakeTimeout),window.betSlipStakeTimeout=setTimeout(()=>{b()},300))})}).observe(document.body,{attributes:!0,attributeFilter:["data-stake"],subtree:!0}),console.log("[app_events] MutationObserver for stake changes initialized"),document.addEventListener("bma-bet-entry-remove",w=>{console.log("[app_events] Removing bet entry:",w.detail);const x=w.target,T=w.detail;x.remove(),setTimeout(()=>{const O=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;if(O){const F=be(),K=F.coreTourn[F.coreTourn.length-1];if(K&&K.data){const U=K.data.find(ae=>ae.guid===O);U&&xe.updateTournamentDashboard(U)}}},100),document.querySelectorAll("bma-bet-match-card").forEach($=>{($.shadowRoot?.querySelectorAll(".btn")||[]).forEach(F=>{const K=F.dataset.betType,U=F.dataset.price,ae=K===T.type,W=U===T.odds;ae&&W&&F.classList.contains("btn--active")&&(F.classList.remove("btn--active"),console.log("[app_events] Deactivated button via X removal:",{btnType:K,btnPrice:U}))})});const C=document.querySelector(".bet-grid__slip-BETSLIP-content");C&&C.children.length===0&&(C.innerHTML=$r),setTimeout(()=>{b()},100)}),le.subscribe(e.hierTopics.CANVAS__HYDRATE__STATUS,(w,x)=>{const T=JSON.parse(x);T&&T.guid&&neodigmUtils&&neodigmUtils.shake(`[data-bma-tourn-guid="${T.guid}"]`)}),le.subscribe(e.hierTopics.WC__APP__FOOT,(w,x)=>{JSON.parse(x);let T=16;switch(w){case e.hierTopics.WC__APP__FOOT__ALL_SPORTS:le.publish(e.hierTopics.WC__APP__HEAD_MID__HEAD_MID_LOBBY,JSON.stringify({tab:"ALL_SPORTS",timestamp:Date.now()}));break;case e.hierTopics.WC__APP__FOOT__MY_TOURNEYS:t="private",l(),u(),c(),d(),le.publish(e.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"FILTER_CHANGE"}));break;case e.hierTopics.WC__APP__FOOT__LEADERBOARD:le.publish(e.hierTopics.WC__APP__HEAD_MID__HEAD_MID_LEADERBOARD,JSON.stringify({tab:"LEADERBOARD",timestamp:Date.now()}));break;case e.hierTopics.WC__APP__FOOT__MY_PROFILE:neodigmSodaPop&&neodigmSodaPop.close(),window.location.hash="#/profile_route";break}neodigmWired4Sound&&neodigmWired4Sound.sound(T).vibrate()}),le.subscribe(e.hierTopics.WC__APP__HEAD_SPORTS,(w,x)=>{const T=JSON.parse(x);let E=16;w=="WC.APP.HEAD_SPORTS.PREV"||w=="WC.APP.HEAD_SPORTS.NEXT"||w=="WC.APP.HEAD_SPORTS.HEAD_SPORTS_DRAG_START"?E=3:(s=T.key||"all",console.log(`[app_events] Sports filter changed to: ${s} (${T.group})`),c(),le.publish(e.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"SPORT_FILTER_CHANGE"}))),E&&neodigmWired4Sound&&neodigmWired4Sound.sound(E).vibrate()}),le.subscribe(e.hierTopics.WC__APP__HEAD_MID,(w,x)=>{JSON.parse(x);let T=16;switch(w){case"WC.APP.HEAD_MID.HEAD_MID_LOBBY":t="lobby",l(),u(),c(),d(),le.publish(e.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"FILTER_CHANGE"}));break;case"WC.APP.HEAD_MID.HEAD_MID_MY":t="private",l(),u(),c(),d(),le.publish(e.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"FILTER_CHANGE"}));break;case"WC.APP.HEAD_MID.HEAD_MID_COMPLETED":t="completed",l(),u(),c(),le.publish(e.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"FILTER_CHANGE"}));break;case"WC.APP.HEAD_MID.HEAD_MID_LEADERBOARD":T=16,neodigmSodaPop&&neodigmSodaPop.close(),window.location.hash="#/top_players_route";break;case"WC.APP.HEAD_MID.HEAD_MID_SQUAD":le.publish(e.hierTopics.WC__APP__HEAD_TOP__USER_PROFILE,JSON.stringify({tab:"USER_PROFILE",timestamp:Date.now()}));break}T&&neodigmWired4Sound&&neodigmWired4Sound.sound(T).vibrate()}),le.subscribe(e.hierTopics.ROUTE__HOME__USER_PROFILE,async(w,x)=>{JSON.parse(x);let T=16;switch(w){case"ROUTE.HOME.USER_PROFILE.INSTALL_PWA":const E=window.deferredPWAPrompt;if(!E){console.log("No install prompt available"),typeof neodigmToast<"u"&&neodigmToast.q("PWA install not available","warning");return}try{E.prompt();const{outcome:$}=await E.userChoice;$==="accepted"?(console.log("PWA installed successfully"),window.deferredPWAPrompt=null,typeof neodigmToast<"u"&&neodigmToast.q("App installed successfully!","success"),T=8,neodigmSodaPop&&neodigmSodaPop.close()):(console.log("PWA install declined"),typeof neodigmToast<"u"&&neodigmToast.q("Install cancelled","night"))}catch($){console.error("PWA install error:",$),typeof neodigmToast<"u"&&neodigmToast.q("Install failed","danger")}break;case"ROUTE.HOME.USER_PROFILE.TOGGLE_THEME":(()=>{const O=e.appCLIFeatures.features.theme.state==="dark"?"light":"dark";e.setFeaturePersistPub("theme",{state:O});const F=document.getElementById("app");F&&F.setAttribute("data-sync-theme",O),document.body.setAttribute("data-sync-theme",O)})(),neodigmSodaPop&&neodigmSodaPop.close();break;case"ROUTE.HOME.USER_PROFILE.RESET_PASSWORD":_a.push({name:"resethash_route"}),neodigmSodaPop&&neodigmSodaPop.close();break;case"ROUTE.HOME.USER_PROFILE.SIGNOUT":_a.push({name:"signout_route"}),neodigmSodaPop&&neodigmSodaPop.close();break}T&&neodigmWired4Sound&&neodigmWired4Sound.sound(T).vibrate()});const _=w=>{document.querySelectorAll(".play-section").forEach(T=>{T.style.display="none",T.classList.remove("play-section--active")});const x=document.getElementById(`play-section-${w}`);x&&(x.style.display="",x.classList.add("play-section--active"))},S=(w,x)=>{const T=w.split(".").pop(),E=document.querySelectorAll(".play-cntr .dash-nav__btn"),$=document.querySelector(".play-cntr")?.closest("neodigm-sodapop");_(T),E.forEach(O=>{const F=O.dataset.publishRouteHome?.split(".").pop()||"";O.classList.toggle("dash-nav__btn--active",F===T)}),typeof neodigmWired4Sound<"u"&&neodigmWired4Sound.sound(3),$&&($.style.overflow=T==="PLAY"?"hidden":"auto")};le.subscribe("ROUTE.HOME.SODAPOP_PLAY.INFO",S);let g=null;le.subscribe("ROUTE.HOME.SODAPOP_PLAY.LEADERBOARD",(w,x)=>{if(S(w),g){console.log("[appEvents] Leaderboard refresh debounced (cooling down)");return}g=setTimeout(()=>{g=null},2e3),console.log("[appEvents] Refreshing leaderboard data"),xe.populateLeaderboard()}),le.subscribe("ROUTE.HOME.SODAPOP_PLAY.PLAY",(w,x)=>{JSON.parse(x);const T=document.getElementById("btn-join__play--id");if(!T){console.warn("[app_events] PLAY button not found");return}const E=T.dataset.requiresJoin==="true",C=T.textContent.trim().toLowerCase();if(console.log("[app_events] PLAY button clicked - text:",C,"requiresJoin:",E),E&&C==="join"){const O=document.querySelector(".play-cntr")?.dataset?.currentTournGuid,F=be();if(!O){console.error("[app_events] No tournament GUID found");return}console.log("[app_events] Executing JOIN for tournament:",O),le.publish(F.hierTopics.WC__TOURN_ACTION,JSON.stringify({action:"JOIN",tournamentGuid:O,timestamp:Date.now()})),T.textContent="Play",T.dataset.requiresJoin="false",setTimeout(()=>{S(w),console.log("[app_events] JOIN triggered, advancing carousel to PLAY page")},500)}else S(w),console.log("[app_events] Advancing carousel to PLAY page")}),le.subscribe(e.hierTopics.WC__APP__HEAD_TOP,(w,x)=>{JSON.parse(x);let T=10;switch(w){case"WC.APP.HEAD_TOP.USER_PROFILE":T=0,neodigmSodaPop&&neodigmSodaPop.close(),window.location.hash="#/profile_route";break;case"WC.APP.HEAD_TOP.LOGO":const E=e.appSession.session_app.version,C=new Date().getFullYear();E&&neodigmToast&&neodigmToast.q(`${E} 4/20/2026, 10:35:57 AM|© ${C} Bet Max Action`,"night");break;case"WC.APP.HEAD_TOP.CREATE_CONTEST":le.publish(e.hierTopics.WC__APP__FOOT__MY_TOURNEYS,JSON.stringify({tab:"MY_TOURNEYS",timestamp:Date.now()}));break}T&&neodigmWired4Sound&&neodigmWired4Sound.sound(T).vibrate()}),le.subscribe(e.hierTopics.WC__TOURN_ACTION,(w,x)=>{const T=JSON.parse(x);let E=0;switch(T?.action){case"JOIN":E=512;break;case"PLAY":E=8;break;case"INFO":E=8;break}if(E){const C=T?.tournamentGuid,$=T?.action;console.log("[app_events] Navigating to play_route:",C,$),setTimeout(()=>{_a.push({name:"play_route",query:{guid:C,action:$}})},E)}}),le.subscribe(e.hierTopics.WC__TOURN_ACTION,(w,x)=>{const T=JSON.parse(x);let E=16;switch(T?.action){case"FOCUS":E=3;break;case"SPORT_ICON":E=10;break;case"JOIN":E=5;break;case"PLAY":E=16;break}E&&neodigmWired4Sound&&neodigmWired4Sound.sound(E).vibrate()}),le.subscribe(e.hierTopics.WC__TOURN_ACTION,(w,x)=>{const T=JSON.parse(x);let E=0,C="night";switch(neodigmOpt&&neodigmOpt.EVENT_SOUNDS&&(neodigmOpt.EVENT_SOUNDS=!1),T?.tournamentStatus){case"UPCOMING":C="success";break;case"LOCKED":C="warning";break;case"COMPLETED":C="danger";break}switch(T?.action){case"SPORT_ICON":T?.sportTitle==T?.sportDescription?E=T?.sportTitle:E=T?.sportTitle+"|"+T?.sportDescription;break}E&&neodigmToast&&neodigmToast.q(E,C)}),le.subscribe(e.hierTopics.WC__TOURN_ACTION,async(w,x)=>{const T=JSON.parse(x);if(T?.action==="JOIN"){const C=be().appSession?.session_user?.guid;if(!C){console.error("No entity guid found in session"),typeof neodigmToast<"u"&&neodigmToast.q("Please sign in to join tournaments","warning");return}const $=document.querySelector(`bma-tournament-card[data-bma-tourn-guid="${T.tournamentGuid}"]`);$&&($.setAttribute("data-bma-tourn-wait","true"),Ys.shootConfetti());const O={acctEntityGuid:C,tournamentGuid:T.tournamentGuid};try{const F={method:"POST",body:JSON.stringify(O),headers:Ae.genHeaders()};console.log("Posting to:",Ae.API_baseURI+"/m5t/"+Ae.API_ver+"/coreTournaments/join",O);const U=await(await fetch(Ae.API_baseURI+"/m5t/"+Ae.API_ver+"/coreTournaments/join",F)).json();if(console.log("Join response:",U),U.ok)typeof neodigmToast<"u"&&neodigmToast.q("Successfully joined tournament!","success"),setTimeout(()=>{const ae=document.querySelector(`bma-tournament-card[data-bma-tourn-guid="${T.tournamentGuid}"]`);if(ae){ae.setAttribute("data-bma-tourn-wait","false");const W=ae.getAttribute("data-bma-tourn-entities");if(W)try{const G=JSON.parse(W);G.guids.includes(C)||(G.guids.push(C),ae.setAttribute("data-bma-tourn-entities",JSON.stringify(G)))}catch(G){console.error("Failed to parse entities:",G)}}},3e3);else{const ae=U?.message||"Failed to join tournament";typeof neodigmToast<"u"&&neodigmToast.q(ae,"danger");const W=document.querySelector(`bma-tournament-card[data-bma-tourn-guid="${T.tournamentGuid}"]`);W&&W.setAttribute("data-bma-tourn-wait","false")}}catch(F){console.error("Join tournament error:",F),typeof neodigmToast<"u"&&neodigmToast.q("Network error joining tournament","danger"),typeof neodigmUtils<"u"&&neodigmUtils.hardReload()}}}),le.subscribe(e.hierTopics.ROUTE__HOME_ONMOUNT,async(w,x)=>{console.log("[app_events] ROUTE__HOME_ONMOUNT event received");const T=be();if(t="lobby",s="all",a="all",r="default",n="all",o="all",T.coreTourn.length>0){console.log("[app_events] coreTourn already populated, hydrating from existing data"),le.publish(T.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"REMOUNT"}));return}try{const E=await Ae.fetchTournaments();console.log("[app_events] Tournaments fetched:",E),E?.rows&&Array.isArray(E.rows)?(T.pushCoreTourn({timestamp:Date.now(),source:"API",data:E.rows}),console.log("[app_events] Pushed to coreTourn, length:",T.coreTourn.length),le.publish(T.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now()}))):console.warn("[app_events] Invalid API response format:",E)}catch(E){console.error("[app_events] Error fetching tournaments:",E),typeof neodigmToast<"u"&&neodigmToast.q("Please Sign In","success")}}),le.subscribe(e.hierTopics.PROMOTION__LOAD,async(w,x)=>{console.log("[app_events] PROMOTION__LOAD event received");try{const T=await Ae.fetchPromotions();if(console.log("[app_events] Promotions fetched:",T),T?.ok&&T?.data&&Array.isArray(T.data)){const E=T.data.filter($=>$.class==="banner"&&$.status==="LIVE");console.log("[app_events] Banner promotions:",E);const C=document.querySelector(".featured-swiper .swiper-wrapper");if(!C){console.warn("[app_events] Swiper wrapper not found");return}if(C.innerHTML="",E.forEach(($,O)=>{const F=document.createElement("div");F.className="swiper-slide";const K=document.createElement("div");K.className=`featured-card featured-card--${O+1}`;const U=$.hero_img?encodeURI($.hero_img):"";K.style.backgroundImage=`url("${U}")`,K.setAttribute("data-promotion-hero-img",$.hero_img||""),K.setAttribute("data-promotion-caption",$.caption||""),K.setAttribute("data-promotion-tagline",$.tagline||""),K.setAttribute("data-promotion-toast",$.toast||""),K.setAttribute("data-promotion-topic",$.topic?.topic||""),K.setAttribute("data-promotion-topic-token",$.topic?.token||""),K.setAttribute("data-promotion-marquee",$.maquee||""),F.appendChild(K),C.appendChild(F)}),console.log("[app_events] Created",E.length,"promotion slides"),window.featuredSwiper&&window.featuredSwiper.update(),E.length===1){const $=document.querySelector(".featured-swiper .swiper-wrapper");$&&($.style.justifyContent="center")}}}catch(T){console.error("[app_events] Error fetching promotions:",T)}}),le.subscribe(e.hierTopics.PROMOTION__CLICK,(w,x)=>{console.log("[app_events] PROMOTION__CLICK event received");try{const T=JSON.parse(x);console.log("[app_events] Promotion clicked:",T),T.toast&&typeof neodigmToast<"u"&&neodigmToast.q(T.toast,"success"),typeof neodigmSodaPop<"u"&&(neodigmSodaPop.setOnAfterOpen(()=>{const E=document.querySelector(".l-promotion #promoHero");E&&T.heroImg&&(E.src=T.heroImg);const C=document.querySelector(".l-promotion #promCaption");C&&T.caption&&(C.textContent=T.caption);const $=document.querySelector(".l-promotion #promoTagline");return $&&T.tagline&&(/<[^>]+>/.test(T.tagline)?$.innerHTML=T.tagline:$.textContent=T.tagline),!0},"sodapop_promotion"),neodigmSodaPop.autoOpen("sodapop_promotion"))}catch(T){console.error("[app_events] Error handling promotion click:",T)}}),le.subscribe(e.hierTopics.ROUTE__HOME_HYDRATE,(w,x)=>{console.log("[app_events] ROUTE__HOME_HYDRATE event received");const T=be();if(T.coreTourn.length===0){console.warn("[app_events] No tournament data in coreTourn array");return}const E=T.coreTourn[T.coreTourn.length-1],C=T.coreTourn.length>1?T.coreTourn[T.coreTourn.length-2]:null;console.log("[app_events] Hydrating with latest data:",E);const $=[];if(C){const ae=E.data,W=C.data;ae.forEach(G=>{const re=W.find(te=>te.guid===G.guid);re&&re.status!==G.status&&(console.log(`[app_events] Status changed for tournament ${G.guid}: ${re.status} -> ${G.status}`),$.push(G.guid))})}const O=T.appSession?.session_user?.guid,F=[...E.data].sort((ae,W)=>{const G=ae.status||ae.class,re=W.status||W.class,te=ae.entities?.guids||[],N=W.entities?.guids||[],V=te.includes(O),z=N.includes(O),A=(P,M)=>{const j=new Date(P.status_time||0).getTime();return new Date(M.status_time||0).getTime()-j},L=G==="LOCKED"&&V,B=re==="LOCKED"&&z;if(L&&!B)return-1;if(!L&&B)return 1;if(L&&B)return A(ae,W);const R=G==="UPCOMING",I=re==="UPCOMING";if(R&&!I)return-1;if(!R&&I)return 1;if(R&&I)return A(ae,W);const q=G==="COMPLETED"&&V,X=re==="COMPLETED"&&z;if(q&&!X)return-1;if(!q&&X)return 1;if(q&&X)return A(ae,W);const D=G==="COMPLETED"&&!V,k=re==="COMPLETED"&&!z;return D&&!k?1:!D&&k?-1:A(ae,W)}),K=xe.categorizeTournaments(F,t,s,O,{subStatus:a,sort:r,result:n});if(console.log(`[app_events] Categorized into ${K.length} categories for filter: ${t}/${s} sub:${a} sort:${r} result:${n}`),window._homeRouteRenderCards&&typeof window._homeRouteRenderCards=="function"){const ae=document.querySelector(".tournaments-grid");ae&&(ae.dataset.filterContext=t),window._homeRouteRenderCards(K,!0,i,{tab:t,subStatus:a,sort:r,result:n,odds:o});const W=F.filter(z=>{const A=z.status||z.class,L=z.entities?.guids||[];return(A==="LOCKED"||A==="UPCOMING")&&L.includes(O)}).length,G=F.reduce((z,A)=>{const L=A.status||A.class,B=A.entities?.guids||[];return(L==="LOCKED"||L==="UPCOMING")&&B.includes(O)?z+parseFloat(A.tournament_dollars||0):z},0),re=document.querySelector("bma-app-foot");re&&re.setAttribute("data-active-count",String(W));const te=document.querySelector("bma-app-head-mid");te&&te.setAttribute("data-active-count",String(W));const N=document.querySelector("bma-app-head-top");N&&(N.setAttribute("data-active-count",String(W)),N.setAttribute("data-td-dollars",String(G)));const V=document.getElementById("home-tab-active-badge");if(V&&(V.textContent=W,V.style.visibility=W>0?"visible":"hidden"),$.length>0){const z=E.data;$.forEach(A=>{const L=z.find(B=>B.guid===A);if(L){const B=Math.floor(Math.random()*2e3)+1e3;setTimeout(()=>{le.publish(T.hierTopics.CANVAS__HYDRATE__STATUS,JSON.stringify({guid:A,status:L.status,timestamp:Date.now()}))},B)}})}}else console.warn("[app_events] window._homeRouteRenderCards not available");const U=document.getElementById("bma-scores-banner--id");if(U){const ae=new Set,W=[];for(const G of E.data){const re=Array.isArray(G.matches_expanded)?G.matches_expanded:[];for(const te of re){const N=te.guid||te.id||te.odds_id;!N||ae.has(N)||(ae.add(N),W.push(te))}}U.setAttribute("data-matches",JSON.stringify(W))}xe.prefetchGlobalLeaderboard()}),le.subscribe(e.hierTopics.SSE__CORE__TOURN_SYNC,(w,x)=>{console.log("[app_events] SSE__CORE__TOURN_SYNC event received:",x);const T=be();try{const E=JSON.parse(x);console.log("[app_events] SSE tournament sync data:",E);const C=JSON.parse(E.msg);if(console.log("[app_events] Parsed tournaments array:",C),!Array.isArray(C)){console.warn("[app_events] SSE msg is not an array:",C);return}T.pushCoreTourn({timestamp:Date.now(),source:"SSE",data:C}),console.log("[app_events] Pushed SSE data to coreTourn, length:",T.coreTourn.length),le.publish(T.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"SSE"})),document.querySelector(".play-cntr")&&(console.log("[SSE] Play route is active, triggering real-time update"),xe.hydratePlayPopup())}catch(E){console.error("[app_events] Error processing SSE tournament sync:",E)}}),setTimeout(function(){neodigmSodaPop&&neodigmMarquee&&neodigmEnchantedCTA&&(neodigmSodaPop.setOnAfterOpen(function(){setTimeout(()=>{},1e3),neodigmMetronome.init().pause(800),neodigmEnchantedCTA.init(),neodigmCarousel.init()}),neodigmSodaPop.setOnAfterOpen(function(){setTimeout(()=>{NeodigmClaire.showCanv("neodigm-sodapop",.5).setTheme(["warning","success"]).initCanvOn("neodigm-sodapop").waxOn("neodigm-sodapop");const w=document.querySelector("#caption__my-profile");w&&(w.textContent="My Profile");const x=document.getElementById("profile-trophy-username");x&&(x.textContent=e.appSession?.session_user?.userName||e.appSession?.session_user?.name||"");const T=e.appSession?.session_user?.guid;if(console.log("[app_events] User GUID:",T),console.log("[app_events] coreTourn length:",e.coreTourn.length),!T||e.coreTourn.length===0){console.warn("[app_events] Missing user GUID or tournament data");return}const C=e.coreTourn[e.coreTourn.length-1].data;console.log("[app_events] Processing tournaments:",C.length);const $=U=>{const ae=document.getElementById("profile-stats-panel");ae&&(ae.innerHTML=xe.buildStatsPanel(C,T,U))};$(xe._betStatsCache?.stats||null),xe._ensureBetStatsCache(T).then(U=>{U&&$(U)});let O=0,F=0,K=0;C.forEach((U,ae)=>{if(!U.tags||!Array.isArray(U.tags)){console.log(`[app_events] Tournament ${ae} has no tags or tags not an array`);return}U.tags.forEach((W,G)=>{if(typeof W=="object"&&W!==null){let re=null;W.entity_guid===T&&W.badge?re=W.badge:W[T]&&(re=W[T]),re==="--badge__ribbon--gold"?O++:re==="--badge__ribbon--silver"?F++:re==="--badge__ribbon--bronze"&&K++}})}),setTimeout(()=>{let U=document.querySelectorAll(".badge-counter");if(U.length===0){const ae=document.querySelector("neodigm-sodapop");ae&&(U=ae.querySelectorAll(".badge-counter"))}U.length>=3?(U[0].textContent=F,U[1].textContent=O,U[2].textContent=K,console.log("[app_events] Updated UI counters successfully")):console.warn("[app_events] Not enough counter elements found")},500),setTimeout(()=>{const U=document.querySelector("#profile-tournaments-list");if(!U||!T||e.coreTourn.length===0)return;const G=e.coreTourn[e.coreTourn.length-1].data.filter(V=>{try{return(typeof V.entities=="string"?JSON.parse(V.entities):V.entities)?.guids?.includes(T)}catch{return!1}}),re={LOCKED:0,UPCOMING:1,COMPLETED:2};G.sort((V,z)=>{const A=re[V.status]??3,L=re[z.status]??3;return A!==L?A-L:new Date(z.status_time||0)-new Date(V.status_time||0)});const te=V=>{let z=G;if(V==="active"?z=G.filter(A=>A.status==="LOCKED"||A.status==="UPCOMING"):V==="completed"&&(z=G.filter(A=>A.status==="COMPLETED")),z.length===0){U.innerHTML='<div class="profile-tournaments__empty">No tournaments found</div>';return}U.innerHTML=z.map(A=>{const L=A.entities?JSON.stringify(A.entities).replace(/"/g,"&quot;"):"",B=A.tags?JSON.stringify(A.tags).replace(/"/g,"&quot;"):"[]",R=A.sports_allowed?JSON.stringify(A.sports_allowed).replace(/"/g,"&quot;"):"[]";return`<bma-tournament-list-card
                                        ...
                                        data-bma-tourn-sports_allowed="${R}"
                                        ...
                                        data-bma-tourn-tags="${B}"
                                        data-bma-tourn-window_start_time="${A.window_start_time||""}"
                                        data-bma-tourn-window_end_time="${A.window_end_time||""}"
                                        data-sync-theme="dark"
                                    ></bma-tournament-list-card>`}).join(""),requestAnimationFrame(()=>{U.querySelectorAll("bma-tournament-list-card").forEach((A,L)=>{A.style.animation="motion-slide-up-enter 300ms cubic-bezier(0.4, 0, 0.2, 1) both",A.style.animationDelay=`${Math.min(L*60,400)}ms`})})};te("all");const N=document.querySelector(".profile-tournaments__filters");N&&N.addEventListener("click",V=>{const z=V.target.closest(".profile-tourn-filter");z&&(N.querySelectorAll(".profile-tourn-filter").forEach(A=>A.classList.remove("profile-tourn-filter--active")),z.classList.add("profile-tourn-filter--active"),te(z.dataset.filter))})},600)},1e3)},"sodapop_my_profile"))},3e3),window._renderTopPlayers=async function(w="ALL"){const x=be(),T=document.getElementById("global-leaderboard-container");if(T){T.innerHTML=`<div style="display: flex; flex-direction: column; align-items: center; gap: 24px; padding: 60px 24px;">
                        ...
                        <div style="display: block; height: 8px; width: 80%; max-width: 400px; background-color: #242424; overflow: hidden; border-radius: 4px;">
                            <div style="height: 100%; background-color: var(--neodigm-theme-brand-alt, #F7C60D); animation: juicebar_linear 1s infinite ease-in-out; transform-origin: 0% 50%;"></div>
                    ...
                    </div>`;try{let E;const C=xe._globalLBCache[w];C?.data&&Date.now()-C.ts<300*1e3?(console.log(`[Global Leaderboard] Using prefetched cache [${w}]`),E=C.data):(console.log(`[Global Leaderboard] Cache miss [${w}], fetching fresh`),E=await Ae.fetchAllTimeLeaderboard(w,100,"td"),xe._globalLBCache[w]={data:E,ts:Date.now(),inflight:!1});const $=E?.data||[],O=E?.last_updated||null,F=x.coreTourn.length>0?x.coreTourn[x.coreTourn.length-1].data:[];if(!$.length){T.innerHTML='<div class="leaderboard-empty"><p>No leaderboard data yet.</p></div>',myContainer&&(myContainer.innerHTML='<div class="leaderboard-empty"><p>No tournament data yet.</p></div>');return}const K=T,U=x.appSession?.session_user?.guid,ae={};$.forEach(B=>{const R=B.user_guid;ae[R]={username:B.username||"Unknown",user_guid:R,totalTDWon:parseFloat(B.total_payout||0),totalPayout:parseFloat(B.total_payout||0),totalBets:parseInt(B.total_betslips||0),tournamentsPlayed:parseInt(B.tournaments_joined||0),tournamentsWon:parseInt(B.tournaments_won||0),totalTD:parseFloat(B.total_td_dollars||0),gold:0,silver:0,bronze:0,sports:new Set}}),F.forEach(B=>{!B.tags||!Array.isArray(B.tags)||B.tags.forEach(R=>{if(typeof R!="object"||!R)return;let I=null,q=null;if(R.entity_guid&&R.badge){if(R.entity_guid==="SYSTEM")return;I=R.entity_guid,q=R.badge}else{const D=Object.keys(R);for(const k of D){const P=R[k];if(typeof P=="string"&&P.startsWith("--badge__ribbon--")){I=k,q=P;break}}}if(!I||!q)return;ae[I]||(ae[I]={username:I.substring(0,8),user_guid:I,totalTDWon:0,totalPayout:0,totalBets:0,tournamentsPlayed:0,tournamentsWon:0,totalTD:0,gold:0,silver:0,bronze:0,sports:new Set});const X=ae[I];q==="--badge__ribbon--gold"?X.gold++:q==="--badge__ribbon--silver"?X.silver++:q==="--badge__ribbon--bronze"&&X.bronze++})});const W=Object.values(ae).filter(B=>B.username!=="Unknown");if(O){const B=Math.round((Date.now()-new Date(O).getTime())/6e4),R=B<1?"just now":B===1?"1 minute ago":`${B} minutes ago`;console.log(`[Global Leaderboard] Server last updated ${R}`)}const G=W.filter(B=>B.gold+B.silver+B.bronze>0),re=new Set;W.forEach(B=>B.sports.forEach(R=>re.add(R)));const te={basketball_nba:"NBA",basketball_ncaab:"NCAAB",football_nfl:"NFL",football_ncaaf:"NCAAF",icehockey_nhl:"NHL",hockey_nhl:"NHL",baseball_mlb:"MLB",soccer_mls:"MLS",soccer_epl:"EPL",soccer_uefa:"UEFA",mma_ufc:"UFC",boxing:"BOXING"},N=[{id:"overall",label:"Overall"},{id:"earnings",label:"TD$ Won"}];let V="all";const z=(B,R)=>{let I=[...W],q;B==="overall"&&(I=I.filter(J=>J.gold+J.silver+J.bronze>0)),B==="bysport"&&R&&R!=="all"&&(I=I.filter(J=>J.sports.has(R)));const X=K.querySelector(".glb__note");switch(X&&X.remove(),B){case"overall":I.sort((J,se)=>se.gold*100+se.silver*10+se.bronze-(J.gold*100+J.silver*10+J.bronze)||se.totalPayout-J.totalPayout||se.totalBets-J.totalBets),q=(J,se,ee,ce,ne)=>`
                                        <div class="glb__row">
                                            <span class="glb__row-left">
                                                <span class="glb__rank ${se<3?"glb__rank--top3":""}">#${se+1}</span>
                                                <span class="glb__avatar" style="background: ${ce};">${ee}</span>
                                        ...
                                        </div>`;break;case"earnings":I=I.filter(J=>J.totalTDWon>0),I.sort((J,se)=>se.totalTDWon-J.totalTDWon),q=(J,se,ee,ce,ne)=>`
                                        <div class="glb__row">
                                            <span class="glb__row-left">
                                                <span class="glb__rank ${se<3?"glb__rank--top3":""}">#${se+1}</span>
                                                <span class="glb__avatar" style="background: ${ce};">${ee}</span>
                                        ...
                                        </div>`;break;case"bysport":I.sort((J,se)=>se.totalPayout-J.totalPayout||se.totalBets-J.totalBets),q=(J,se,ee,ce,ne)=>`
                                        <div class="glb__row">
                                            <span class="glb__row-left">
                                                <span class="glb__rank ${se<3?"glb__rank--top3":""}">#${se+1}</span>
                                                <span class="glb__avatar" style="background: ${ce};">${ee}</span>
                                        ...
                                        </div>`;break}const D=K.querySelector(".glb__list");if(!D)return;if(I.length===0){const J=B==="earnings"?"No TD$ won from reconciled bets yet":B==="bysport"?"No players found for this sport":"No leaderboard data available";D.innerHTML=`<div class="leaderboard-empty"><p>${J}</p></div>`;return}const k=["#2a3a2e","#3a3528","#3a2a2a","#2a303a","#332a3a","#2a3836","#3a2e28","#2e3234"],P=J=>k[J.charCodeAt(0)%k.length];let M="";if(B==="overall"&&I.length>=3){const J=(se,ee,ce,ne,de)=>{const ue=I[se],fe=ue.user_guid===U;return`<div style="display: flex; flex-direction: column; align-items: center; flex: 1; max-width: 140px;">
                                        <div style="width: ${ee===1?80:ee===2?64:56}px; height: ${ee===1?80:ee===2?64:56}px; background-image: var(${ne}); background-size: contain; background-repeat: no-repeat; background-position: center; margin-bottom: 6px;"></div>
                                        ...
                                        <div style="width: 100%; height: ${ce}px; background: linear-gradient(180deg, ${de}33 0%, ${de}0D 100%); border-top: 3px solid ${de}80; border-radius: 4px 4px 0 0; display: flex; align-items: center; justify-content: center;">
                                            <span style="font-size: 1.2rem; font-weight: 800; color: ${de};">${ee===1?"1st":ee===2?"2nd":"3rd"}</span>
                                        </div>
                                    </div>`};M=`
                                ...
                                `}const j='<div class="info-section__title">Rankings</div>',Q='<div style="text-align: center; padding: 10px 16px; margin: 8px 16px; font-size: 0.78rem; color: var(--status-locked-text, #F7C60D); font-weight: 600; background: rgba(247, 198, 13, 0.08); border-radius: 8px; box-shadow: inset 0 0 0 1px rgba(247, 198, 13, 0.2);"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" style="vertical-align: -2px; margin-right: 6px;"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>Ranked by trophies — Gold weighted highest, then Silver, then Bronze</div>',Y='<div style="text-align: center; padding: 10px 16px; margin: 8px 16px; font-size: 0.78rem; color: var(--status-upcoming-text, #00E676); font-weight: 600; background: rgba(0, 230, 118, 0.08); border-radius: 8px; box-shadow: inset 0 0 0 1px rgba(0, 230, 118, 0.2);"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" style="vertical-align: -2px; margin-right: 6px;"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>Ranked by total TD$ payouts from completed bets — does not include pending bets</div>';if(B==="bysport"&&!K.querySelector(".glb__note")){const se=document.createElement("div");se.className="glb__note",se.style.cssText="text-align: center; padding: 10px 16px; margin: 8px 16px; font-size: 0.78rem; color: var(--status-locked-text, #F7C60D); font-weight: 600; background: rgba(247, 198, 13, 0.08); border-radius: 8px; box-shadow: inset 0 0 0 1px rgba(247, 198, 13, 0.2);",se.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" style="vertical-align: -2px; margin-right: 6px;"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>Ranked by TD$ won in tournaments featuring this sport';const ee=K.querySelector(".glb__sport-filters");ee&&ee.parentNode.insertBefore(se,ee)}let ie="";if(B==="earnings"&&I.length>=3){const J=(se,ee,ce,ne)=>{const de=I[se],ue=de.user_guid===U;return`<div style="display: flex; flex-direction: column; align-items: center; flex: 1; max-width: 140px;">
                                        <div style="width: ${ee===1?80:ee===2?64:56}px; height: ${ee===1?80:ee===2?64:56}px; margin-bottom: 6px;">
                                        ...
                                        <div style="width: 100%; height: ${ce}px; background: linear-gradient(180deg, rgba(0, 230, 118, 0.15) 0%, rgba(0, 230, 118, 0.03) 100%); border-top: 3px solid rgba(0, 230, 118, 0.4); border-radius: 4px 4px 0 0; display: flex; align-items: center; justify-content: center;">
                                            <span style="font-size: 1.2rem; font-weight: 800; color: var(--status-upcoming-text, #00E676);">${ee===1?"1st":ee===2?"2nd":"3rd"}</span>
                                        </div>
                                    </div>`};ie=`
                                    <div style="display: flex; align-items: flex-end; justify-content: center; gap: 8px; padding: 20px 12px 0;">
                                        ${J(1,2,70,"#00E676")}
                                ...
                                `}if(B==="overall")D.innerHTML=M+Q+j+I.map((J,se)=>{const ee=(J.username||"?")[0].toUpperCase(),ce=P(J.username),ne=J.user_guid===U;return q(J,se,ee,ce,ne)}).join("");else if(B==="earnings"){const J='<div class="info-section__title">TD$ Won</div>';D.innerHTML=ie+Y+J+I.map((se,ee)=>{const ce=(se.username||"?")[0].toUpperCase(),ne=P(se.username),de=se.user_guid===U;return q(se,ee,ce,ne,de)}).join("")}else if(B==="bysport"){let J="";if(I.length>=3){const ee=(ce,ne,de)=>{const ue=I[ce],fe=ue.user_guid===U,we=P(ue.username),_e=(ue.username||"?")[0].toUpperCase();return`<div style="display: flex; flex-direction: column; align-items: center; flex: 1; max-width: 140px;">
                                    ...
                                    `}const se='<div class="info-section__title">Rankings</div>';D.innerHTML=J+se+I.map((ee,ce)=>{const ne=(ee.username||"?")[0].toUpperCase(),de=P(ee.username),ue=ee.user_guid===U;return q(ee,ce,ne,de,ue)}).join("")}requestAnimationFrame(()=>{D.querySelectorAll(".glb__card, .info-row").forEach((J,se)=>{J.style.animation="motion-slide-up-enter 300ms cubic-bezier(0.4, 0, 0.2, 1) both",J.style.animationDelay=`${Math.min(se*50,400)}ms`})})},A=[...re].map(B=>{const R=te[B]||B.replace(/^[a-z]+_/,"").toUpperCase(),I=Ge.find(X=>X.key===B),q=I?I.group:"default";return`<button class="glb__sport-chip" data-sport="${B}">
                                <bma-sport-icon sport="${B}" data-sport-group="${q}" style="width: 18px; height: 18px; pointer-events: none;"></bma-sport-icon>
                                <span style="color: var(--status-locked-text, #F7C60D); pointer-events: none;">${R}</span>
                            </button>`}).join("");K.innerHTML=`
                            <div class="glb__tabs" style="animation: motion-fade-enter 150ms cubic-bezier(0.4,0,0.2,1) both;">
                                ${N.map((B,R)=>`
                                    <button class="glb__tab ${R===0?"glb__tab--active":""}" data-tab="${B.id}">${B.label}</button>
                                `).join("")}
                            </div>
...
`:""},this._extScope=A,this._scope=new s.Scope({parent:A}),this._nodes=[new v]}toString(){return this._root.render(this.opts)}name(A){return this._scope.name(A)}scopeName(A){return this._extScope.name(A)}scopeValue(A,L){const B=this._extScope.value(A,L);return(this._values[B.prefix]||(this._values[B.prefix]=new Set)).add(B),B}getScopeValue(A,L){return this._extScope.getValue(A,L)}scopeRefs(A){return this._extScope.scopeRefs(A,this._values)}scopeCode(){return this._extScope.scopeCode(this._values)}_def(A,L,B,R){const I=this._scope.toName(L);return B!==void 0&&R&&(this._constants[I.str]=B),this._leafNode(new o(A,I,B)),I}const(A,L,B){return this._def(s.varKinds.const,A,L,B)}let(A,L,B){return this._def(s.varKinds.let,A,L,B)}var(A,L,B){return this._def(s.varKinds.var,A,L,B)}assign(A,L,B){return this._leafNode(new i(A,L,B))}add(A,L){return this._leafNode(new l(A,e.operators.ADD,L))}code(A){return typeof A=="function"?A():A!==t.nil&&this._leafNode(new p(A)),this}object(...A){const L=["{"];for(const[B,R]of A)L.length>1&&L.push(","),L.push(B),(B!==R||this.opts.es5)&&(L.push(":"),(0,t.addCodeArg)(L,R));return L.push("}"),new t._Code(L)}if(A,L,B){if(this._blockNode(new m(A)),L&&B)this.code(L).else().code(B).endIf();else if(L)this.code(L).endIf();else if(B)throw new Error('CodeGen: "else" body without "then" body');return this}elseIf(A){return this._elseNode(new m(A))}else(){return this._elseNode(new y)}endIf(){return this._endBlockNode(m,y)}_for(A,L){return this._blockNode(A),L&&this.code(L).endFor(),this}for(A,L){return this._for(new _(A),L)}forRange(A,L,B,R,I=this.opts.es5?s.varKinds.var:s.varKinds.let){const q=this._scope.toName(A);return this._for(new S(I,q,L,B),()=>R(q))}forOf(A,L,B,R=s.varKinds.const){const I=this._scope.toName(A);if(this.opts.es5){const q=L instanceof t.Name?L:this.var("_arr",L);return this.forRange("_i",0,(0,t._)`${q}.length`,X=>{this.var(I,(0,t._)`${q}[${X}]`),B(I)})}return this._for(new g("of",R,I,L),()=>B(I))}forIn(A,L,B,R=this.opts.es5?s.varKinds.var:s.varKinds.const){if(this.opts.ownProperties)return this.forOf(A,(0,t._)`Object.keys(${L})`,B);const I=this._scope.toName(A);return this._for(new g("in",R,I,L),()=>B(I))}endFor(){return this._endBlockNode(h)}label(A){return this._leafNode(new c(A))}break(A){return this._leafNode(new d(A))}return(A){const L=new x;if(this._blockNode(L),this.code(A),L.nodes.length!==1)throw new Error('CodeGen: "return" should have one node');return this._endBlockNode(x)}try(A,L,B){if(!L&&!B)throw new Error('CodeGen: "try" without "catch" and "finally"');const R=new T;if(this._blockNode(R),this.code(A),L){const I=this.name("e");this._currNode=R.catch=new E(I),L(I)}return B&&(this._currNode=R.finally=new C,this.code(B)),this._endBlockNode(E,C)}throw(A){return this._leafNode(new u(A))}block(A,L){return this._blockStarts.push(this._nodes.length),A&&this.code(A).endBlock(L),this}endBlock(A){const L=this._blockStarts.pop();if(L===void 0)throw new Error("CodeGen: not in self-balancing block");const B=this._nodes.length-L;if(B<0||A!==void 0&&B!==A)throw new Error(`CodeGen: wrong number of nodes: ${B} vs ${A} expected`);return this._nodes.length=L,this}func(A,L=t.nil,B,R){return this._blockNode(new w(A,L,B)),R&&this.code(R).endFunc(),this}endFunc(){return this._endBlockNode(w)}optimize(A=1){for(;A-- >0;)this._root.optimizeNodes(),this._root.optimizeNames(this._root.names,this._constants)}_leafNode(A){return this._currNode.nodes.push(A),this}_blockNode(A){this._currNode.nodes.push(A),this._nodes.push(A)}_endBlockNode(A,L){const B=this._currNode;if(B instanceof A||L&&B instanceof L)return this._nodes.pop(),this;throw new Error(`CodeGen: not in block "${L?`${A.kind}/${L.kind}`:A.kind}"`)}_elseNode(A){const L=this._currNode;if(!(L instanceof m))throw new Error('CodeGen: "else" without "if"');return this._currNode=L.else=A,this}get _root(){return this._nodes[0]}get _currNode(){const A=this._nodes;return A[A.length-1]}set _currNode(A){const L=this._nodes;L[L.length-1]=A}}e.CodeGen=$;function O(z,A){for(const L in A)z[L]=(z[L]||0)+(A[L]||0);return z}function F(z,A){return A instanceof t._CodeOrName?O(z,A.names):z}function K(z,A,L){if(z instanceof t.Name)return B(z);if(!R(z))return z;return new t._Code(z._items.reduce((I,q)=>(q instanceof t.Name&&(q=B(q)),q instanceof t._Code?I.push(...q._items):I.push(q),I),[]));function B(I){const q=L[I.str];return q===void 0||A[I.str]!==1?I:(delete A[I.str],q)}function R(I){return I instanceof t._Code&&I._items.some(q=>q instanceof t.Name&&A[q.str]===1&&L[q.str]!==void 0)}}function U(z,A){for(const L in A)z[L]=(z[L]||0)-(A[L]||0)}function ae(z){return typeof z=="boolean"||typeof z=="number"||z===null?!z:(0,t._)`!${V(z)}`}e.not=ae;const W=N(e.operators.AND);function G(...z){return z.reduce(W)}e.and=G;const re=N(e.operators.OR);function te(...z){return z.reduce(re)}e.or=te;function N(z){return(A,L)=>A===t.nil?L:L===t.nil?A:(0,t._)`${V(A)} ${z} ${V(L)}`}function V(z){return z instanceof t.Name?z:(0,t._)`(${z})`}})(Kn)),Kn}var me={},wl;function ye(){if(wl)return me;wl=1,Object.defineProperty(me,"__esModule",{value:!0}),me.checkStrictMode=me.getErrorPath=me.Type=me.useFunc=me.setEvaluated=me.evaluatedPropsToName=me.mergeEvaluated=me.eachItem=me.unescapeJsonPointer=me.escapeJsonPointer=me.escapeFragment=me.unescapeFragment=me.schemaRefOrVal=me.schemaHasRulesButRef=me.schemaHasRules=me.checkUnknownRules=me.alwaysValidSchema=me.toHash=void 0;const e=ge(),t=Yr();function s(g){const w={};for(const x of g)w[x]=!0;return w}me.toHash=s;function a(g,w){return typeof w=="boolean"?w:Object.keys(w).length===0?!0:(r(g,w),!n(w,g.self.RULES.all))}me.alwaysValidSchema=a;function r(g,w=g.schema){const{opts:x,self:T}=g;if(!x.strictSchema||typeof w=="boolean")return;const E=T.RULES.keywords;for(const C in w)E[C]||S(g,`unknown keyword: "${C}"`)}me.checkUnknownRules=r;function n(g,w){if(typeof g=="boolean")return!g;for(const x in g)if(w[x])return!0;return!1}me.schemaHasRules=n;function o(g,w){if(typeof g=="boolean")return!g;for(const x in g)if(x!=="$ref"&&w.all[x])return!0;return!1}me.schemaHasRulesButRef=o;function i({topSchemaRef:g,schemaPath:w},x,T,E){if(!E){if(typeof x=="number"||typeof x=="boolean")return x;if(typeof x=="string")return(0,e._)`${x}`}return(0,e._)`${g}${w}${(0,e.getProperty)(T)}`}me.schemaRefOrVal=i;function l(g){return u(decodeURIComponent(g))}me.unescapeFragment=l;function c(g){return encodeURIComponent(d(g))}me.escapeFragment=c;function d(g){return typeof g=="number"?`${g}`:g.replace(/~/g,"~0").replace(/\//g,"~1")}me.escapeJsonPointer=d;function u(g){return g.replace(/~1/g,"/").replace(/~0/g,"~")}me.unescapeJsonPointer=u;function p(g,w){if(Array.isArray(g))for(const x of g)w(x);else w(g)}me.eachItem=p;function f({mergeNames:g,mergeToName:w,mergeValues:x,resultToName:T}){return(E,C,$,O)=>{const F=$===void 0?C:$ instanceof e.Name?(C instanceof e.Name?g(E,C,$):w(E,C,$),$):C instanceof e.Name?(w(E,$,C),C):x(C,$);return O===e.Name&&!(F instanceof e.Name)?T(E,F):F}}me.mergeEvaluated={props:f({mergeNames:(g,w,x)=>g.if((0,e._)`${x} !== true && ${w} !== undefined`,()=>{g.if((0,e._)`${w} === true`,()=>g.assign(x,!0),()=>g.assign(x,(0,e._)`${x} || {}`).code((0,e._)`Object.assign(${x}, ${w})`))}),mergeToName:(g,w,x)=>g.if((0,e._)`${x} !== true`,()=>{w===!0?g.assign(x,!0):(g.assign(x,(0,e._)`${x} || {}`),v(g,x,w))}),mergeValues:(g,w)=>g===!0?!0:{...g,...w},resultToName:b}),items:f({mergeNames:(g,w,x)=>g.if((0,e._)`${x} !== true && ${w} !== undefined`,()=>g.assign(x,(0,e._)`${w} === true ? true : ${x} > ${w} ? ${x} : ${w}`)),mergeToName:(g,w,x)=>g.if((0,e._)`${x} !== true`,()=>g.assign(x,w===!0?!0:(0,e._)`${x} > ${w} ? ${x} : ${w}`)),mergeValues:(g,w)=>g===!0?!0:Math.max(g,w),resultToName:(g,w)=>g.var("items",w)})};function b(g,w){if(w===!0)return g.var("props",!0);const x=g.var("props",(0,e._)`{}`);return w!==void 0&&v(g,x,w),x}me.evaluatedPropsToName=b;function v(g,w,x){Object.keys(x).forEach(T=>g.assign((0,e._)`${w}${(0,e.getProperty)(T)}`,!0))}me.setEvaluated=v;const y={};function m(g,w){return g.scopeValue("func",{ref:w,code:y[w.code]||(y[w.code]=new t._Code(w.code))})}me.useFunc=m;var h;(function(g){g[g.Num=0]="Num",g[g.Str=1]="Str"})(h||(me.Type=h={}));function _(g,w,x){if(g instanceof e.Name){const T=w===h.Num;return x?T?(0,e._)`"[" + ${g} + "]"`:(0,e._)`"['" + ${g} + "']"`:T?(0,e._)`"/" + ${g}`:(0,e._)`"/" + ${g}.replace(/~/g, "~0").replace(/\\//g, "~1")`}return x?(0,e.getProperty)(g).toString():"/"+d(g)}me.getErrorPath=_;function S(g,w,x=g.opts.strictSchema){if(x){if(w=`strict mode: ${w}`,x===!0)throw new Error(w);g.self.logger.warn(w)}}return me.checkStrictMode=S,me}var ja={},xl;function _s(){if(xl)return ja;xl=1,Object.defineProperty(ja,"__esModule",{value:!0});const e=ge(),t={data:new e.Name("data"),valCxt:new e.Name("valCxt"),instancePath:new e.Name("instancePath"),parentData:new e.Name("parentData"),parentDataProperty:new e.Name("parentDataProperty"),rootData:new e.Name("rootData"),dynamicAnchors:new e.Name("dynamicAnchors"),vErrors:new e.Name("vErrors"),errors:new e.Name("errors"),this:new e.Name("this"),self:new e.Name("self"),scope:new e.Name("scope"),json:new e.Name("json"),jsonPos:new e.Name("jsonPos"),jsonLen:new e.Name("jsonLen"),jsonPart:new e.Name("jsonPart")};return ja.default=t,ja}var Tl;function fn(){return Tl||(Tl=1,(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.extendErrors=e.resetErrorsCount=e.reportExtraError=e.reportError=e.keyword$DataError=e.keywordError=void 0;const t=ge(),s=ye(),a=_s();e.keywordError={message:({keyword:y})=>(0,t.str)`must pass "${y}" keyword validation`},e.keyword$DataError={message:({keyword:y,schemaType:m})=>m?(0,t.str)`"${y}" keyword must be ${m} ($data)`:(0,t.str)`"${y}" keyword is invalid ($data)`};function r(y,m=e.keywordError,h,_){const{it:S}=y,{gen:g,compositeRule:w,allErrors:x}=S,T=u(y,m,h);_??(w||x)?l(g,T):c(S,(0,t._)`[${T}]`)}e.reportError=r;function n(y,m=e.keywordError,h){const{it:_}=y,{gen:S,compositeRule:g,allErrors:w}=_,x=u(y,m,h);l(S,x),g||w||c(_,a.default.vErrors)}e.reportExtraError=n;function o(y,m){y.assign(a.default.errors,m),y.if((0,t._)`${a.default.vErrors} !== null`,()=>y.if(m,()=>y.assign((0,t._)`${a.default.vErrors}.length`,m),()=>y.assign(a.default.vErrors,null)))}e.resetErrorsCount=o;function i({gen:y,keyword:m,schemaValue:h,data:_,errsCount:S,it:g}){if(S===void 0)throw new Error("ajv implementation error");const w=y.name("err");y.forRange("i",S,a.default.errors,x=>{y.const(w,(0,t._)`${a.default.vErrors}[${x}]`),y.if((0,t._)`${w}.instancePath === undefined`,()=>y.assign((0,t._)`${w}.instancePath`,(0,t.strConcat)(a.default.instancePath,g.errorPath))),y.assign((0,t._)`${w}.schemaPath`,(0,t.str)`${g.errSchemaPath}/${m}`),g.opts.verbose&&(y.assign((0,t._)`${w}.schema`,h),y.assign((0,t._)`${w}.data`,_))})}e.extendErrors=i;function l(y,m){const h=y.const("err",m);y.if((0,t._)`${a.default.vErrors} === null`,()=>y.assign(a.default.vErrors,(0,t._)`[${h}]`),(0,t._)`${a.default.vErrors}.push(${h})`),y.code((0,t._)`${a.default.errors}++`)}function c(y,m){const{gen:h,validateName:_,schemaEnv:S}=y;S.$async?h.throw((0,t._)`new ${y.ValidationError}(${m})`):(h.assign((0,t._)`${_}.errors`,m),h.return(!1))}const d={keyword:new t.Name("keyword"),schemaPath:new t.Name("schemaPath"),params:new t.Name("params"),propertyName:new t.Name("propertyName"),message:new t.Name("message"),schema:new t.Name("schema"),parentSchema:new t.Name("parentSchema")};function u(y,m,h){const{createErrors:_}=y.it;return _===!1?(0,t._)`{}`:p(y,m,h)}function p(y,m,h={}){const{gen:_,it:S}=y,g=[f(S,h),b(y,h)];return v(y,m,g),_.object(...g)}function f({errorPath:y},{instancePath:m}){const h=m?(0,t.str)`${y}${(0,s.getErrorPath)(m,s.Type.Str)}`:y;return[a.default.instancePath,(0,t.strConcat)(a.default.instancePath,h)]}function b({keyword:y,it:{errSchemaPath:m}},{schemaPath:h,parentSchema:_}){let S=_?m:(0,t.str)`${m}/${y}`;return h&&(S=(0,t.str)`${S}${(0,s.getErrorPath)(h,s.Type.Str)}`),[d.schemaPath,S]}function v(y,{params:m,message:h},_){const{keyword:S,data:g,schemaValue:w,it:x}=y,{opts:T,propertyName:E,topSchemaRef:C,schemaPath:$}=x;_.push([d.keyword,S],[d.params,typeof m=="function"?m(y):m||(0,t._)`{}`]),T.messages&&_.push([d.message,typeof h=="function"?h(y):h]),T.verbose&&_.push([d.schema,w],[d.parentSchema,(0,t._)`${C}${$}`],[a.default.data,g]),E&&_.push([d.propertyName,E])}})(Gn)),Gn}var Sl;function j_(){if(Sl)return Ts;Sl=1,Object.defineProperty(Ts,"__esModule",{value:!0}),Ts.boolOrEmptySchema=Ts.topBoolOrEmptySchema=void 0;const e=fn(),t=ge(),s=_s(),a={message:"boolean schema is false"};function r(i){const{gen:l,schema:c,validateName:d}=i;c===!1?o(i,!1):typeof c=="object"&&c.$async===!0?l.return(s.default.data):(l.assign((0,t._)`${d}.errors`,null),l.return(!0))}Ts.topBoolOrEmptySchema=r;function n(i,l){const{gen:c,schema:d}=i;d===!1?(c.var(l,!1),o(i)):c.var(l,!0)}Ts.boolOrEmptySchema=n;function o(i,l){const{gen:c,data:d}=i,u={gen:c,keyword:"false schema",data:d,schema:!1,schemaCode:!1,schemaValue:!1,params:{},it:i};(0,e.reportError)(u,a,void 0,l)}return Ts}var ze={},Ss={},El;function $u(){if(El)return Ss;El=1,Object.defineProperty(Ss,"__esModule",{value:!0}),Ss.getRules=Ss.isJSONType=void 0;const e=["string","number","integer","boolean","null","object","array"],t=new Set(e);function s(r){return typeof r=="string"&&t.has(r)}Ss.isJSONType=s;function a(){const r={number:{type:"number",rules:[]},string:{type:"string",rules:[]},array:{type:"array",rules:[]},object:{type:"object",rules:[]}};return{types:{...r,integer:!0,boolean:!0,null:!0},rules:[{rules:[]},r.number,r.string,r.array,r.object],post:{rules:[]},all:{},keywords:{}}}return Ss.getRules=a,Ss}var Ut={},kl;function Lu(){if(kl)return Ut;kl=1,Object.defineProperty(Ut,"__esModule",{value:!0}),Ut.shouldUseRule=Ut.shouldUseGroup=Ut.schemaHasRulesForType=void 0;function e({schema:a,self:r},n){const o=r.RULES.types[n];return o&&o!==!0&&t(a,o)}Ut.schemaHasRulesForType=e;function t(a,r){return r.rules.some(n=>s(a,n))}Ut.shouldUseGroup=t;function s(a,r){var n;return a[r.keyword]!==void 0||((n=r.definition.implements)===null||n===void 0?void 0:n.some(o=>a[o]!==void 0))}return Ut.shouldUseRule=s,Ut}var Al;function Wr(){if(Al)return ze;Al=1,Object.defineProperty(ze,"__esModule",{value:!0}),ze.reportTypeError=ze.checkDataTypes=ze.checkDataType=ze.coerceAndCheckDataType=ze.getJSONTypes=ze.getSchemaTypes=ze.DataType=void 0;const e=$u(),t=Lu(),s=fn(),a=ge(),r=ye();var n;(function(h){h[h.Correct=0]="Correct",h[h.Wrong=1]="Wrong"})(n||(ze.DataType=n={}));function o(h){const _=i(h.type);if(_.includes("null")){if(h.nullable===!1)throw new Error("type: null contradicts nullable: false")}else{if(!_.length&&h.nullable!==void 0)throw new Error('"nullable" cannot be used without "type"');h.nullable===!0&&_.push("null")}return _}ze.getSchemaTypes=o;function i(h){const _=Array.isArray(h)?h:h?[h]:[];if(_.every(e.isJSONType))return _;throw new Error("type must be JSONType or JSONType[]: "+_.join(","))}ze.getJSONTypes=i;function l(h,_){const{gen:S,data:g,opts:w}=h,x=d(_,w.coerceTypes),T=_.length>0&&!(x.length===0&&_.length===1&&(0,t.schemaHasRulesForType)(h,_[0]));if(T){const E=b(_,g,w.strictNumbers,n.Wrong);S.if(E,()=>{x.length?u(h,_,x):y(h)})}return T}ze.coerceAndCheckDataType=l;const c=new Set(["string","number","integer","boolean","null"]);function d(h,_){return _?h.filter(S=>c.has(S)||_==="array"&&S==="array"):[]}function u(h,_,S){const{gen:g,data:w,opts:x}=h,T=g.let("dataType",(0,a._)`typeof ${w}`),E=g.let("coerced",(0,a._)`undefined`);x.coerceTypes==="array"&&g.if((0,a._)`${T} == 'object' && Array.isArray(${w}) && ${w}.length == 1`,()=>g.assign(w,(0,a._)`${w}[0]`).assign(T,(0,a._)`typeof ${w}`).if(b(_,w,x.strictNumbers),()=>g.assign(E,w))),g.if((0,a._)`${E} !== undefined`);for(const $ of S)(c.has($)||$==="array"&&x.coerceTypes==="array")&&C($);g.else(),y(h),g.endIf(),g.if((0,a._)`${E} !== undefined`,()=>{g.assign(w,E),p(h,E)});function C($){switch($){case"string":g.elseIf((0,a._)`${T} == "number" || ${T} == "boolean"`).assign(E,(0,a._)`"" + ${w}`).elseIf((0,a._)`${w} === null`).assign(E,(0,a._)`""`);return;case"number":g.elseIf((0,a._)`${T} == "boolean" || ${w} === null
    ...
    `,s.forEach(n=>{const o=this.shadowRoot.querySelector(`[data-item="${n.name}"]`);o&&(o.addEventListener("click",()=>this.handleItemClick(n.name,n.topic)),o.addEventListener("keypress",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),this.handleItemClick(n.name,n.topic))}))})}}customElements.define("bma-app-foot",ny);class oy extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this._unsub=ke.subscribe(()=>this.render()),this.render()}disconnectedCallback(){this._unsub&&this._unsub()}_doLogout(){le.publish("ROUTE.HOME.USER_PROFILE.SIGNOUT",JSON.stringify({ts:Date.now()}))}render(){let t="";try{t=be().appSession?.session_app?.version||""}catch{}this.shadowRoot.innerHTML=`
            <style>
                ${De()}
                :host {
                    display: block;
        ...
        `;const s=this.shadowRoot.querySelector(".foot-logout");s&&s.addEventListener("click",()=>this._doLogout())}}customElements.define("bma-app-foot-branded",oy);const iy='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><polyline points="12 7 12 12 15 14"/></svg>',ly='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="5 12 10 17 19 7"/></svg>',cy='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><line x1="6" y1="6" x2="18" y2="18"/><line x1="18" y1="6" x2="6" y2="18"/></svg>',dy='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/></svg>';class uy extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}static get observedAttributes(){return["data-corebetslip"]}attributeChangedCallback(t,s,a){s!==a&&this.render()}get betSlipData(){const t=this.getAttribute("data-corebetslip");if(!t)return null;try{return JSON.parse(t)}catch(s){return console.error("[bma-bet-existing] Failed to parse data-corebetslip:",s),null}}render(){const t=this.betSlipData;if(!t){this.shadowRoot.innerHTML="<div>Invalid bet data</div>";return}const s=t.bet||[];if(s.length===0){this.shadowRoot.innerHTML="<div>No bet data</div>";return}const a=s[0],r=a.short_title||"Match Info N/A",o=Object.keys(a).filter(C=>C!=="short_title")[0]||"Unknown Team",i=a[o]||{},l=i.odds??"N/A",c=(i.type||"N/A").toUpperCase(),d=parseFloat(i.stake||0),u=parseFloat(i.payout||0),p=i.reconciled!==!1,f=.01;let b,v,y;p?u>d+f?(b="won",v="Won",y=ly):u<d-f?(b="lost",v="Lost",y=cy):(b="push",v="Push",y=dy):(b="pending",v="Pending",y=iy);let m=o;if(i.type==="spread"&&i.point!==void 0){const C=parseFloat(i.point),$=C>0?`+${C}`:`${C}`;m=`${o} ${$}`}else i.type==="total"&&i.point!==void 0&&(m=`${i.team==="over"?"Over":"Under"} ${i.point}`);const h=C=>`TD$ ${C.toFixed(2)}`,_=u-d;let S,g;switch(b){case"pending":S=_>0?`+${h(_)}`:h(0),g="To win";break;case"won":S=`+${h(_)}`,g="Profit";break;case"lost":S=`-${h(d)}`,g="Lost";break;case"push":S=h(d),g="Returned";break}const w=parseInt(l,10),x=Number.isFinite(w)&&w>0?`+${w}`:`${l}`,T=t.status_time?Ys.formatDateLocal(t.status_time):"",E=b==="pending"?"Placed":"Settled";this.shadowRoot.innerHTML=`
      <style>
        ${De()}
    ...
    `}}customElements.define("bma-bet-existing",uy);Aa.init();window.BrandManager=Aa;const Mc=`
