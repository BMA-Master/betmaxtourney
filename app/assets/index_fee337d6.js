...
<pre data-n55-theme="warning" style="padding: 7px 0 4px 0; height: 34px; background-color: #161616"></pre>
    ...
    `}}customElements.define("bma-match-status",fg);class os extends HTMLElement{static currentlyExpanded=null;constructor(){super(),this.attachShadow({mode:"open"}),this.expanded=!1}static get observedAttributes(){return["data-rank","data-username","data-user-guid","data-tournament-dollars","data-starting-dollars","data-total-betslips","data-total-payout","data-combined-betslips","data-user-matches","data-badge-class","data-is-current-user","data-unqualified","data-sync-theme"]}get rank(){return this.getAttribute("data-rank")||""}get username(){return this.getAttribute("data-username")||"Unknown"}get userGuid(){return this.getAttribute("data-user-guid")||""}get tournamentDollars(){return this.getAttribute("data-tournament-dollars")||"0"}get startingDollars(){return this.getAttribute("data-starting-dollars")||"0"}get totalBetslips(){return this.getAttribute("data-total-betslips")||"0"}get totalPayout(){return this.getAttribute("data-total-payout")||"0"}get combinedBetslips(){const t=this.getAttribute("data-combined-betslips");if(!t)return[];try{return JSON.parse(t)}catch(s){return console.error("[bma-leaderboard-card] Error parsing combined_betslips:",s),[]}}get userMatches(){const t=this.getAttribute("data-user-matches");if(!t)return[];try{return JSON.parse(t)}catch(s){return console.error("[bma-leaderboard-card] Error parsing user_matches:",s),[]}}get badgeClass(){return this.getAttribute("data-badge-class")||""}get isCurrentUser(){return this.getAttribute("data-is-current-user")==="true"}get unqualified(){return this.getAttribute("data-unqualified")==="true"}get theme(){return this.getAttribute("data-sync-theme")||"dark"}connectedCallback(){this._unsub=Oe.subscribe(()=>{this.render()}),this.render(),this.attachEventListeners()}disconnectedCallback(){this._unsub&&this._unsub()}attributeChangedCallback(t,s,a){s!==a&&(this.render(),this.attachEventListeners())}toggleExpanded(){os.currentlyExpanded&&os.currentlyExpanded!==this&&os.currentlyExpanded.collapse(),this.expanded=!this.expanded;const t=this.shadowRoot.querySelector(".leaderboard-card__details"),s=this.shadowRoot.querySelector(".expand-icon");this.expanded?(t.classList.add("open"),s.classList.add("expanded"),os.currentlyExpanded=this):(t.classList.remove("open"),s.classList.remove("expanded"),os.currentlyExpanded===this&&(os.currentlyExpanded=null))}collapse(){this.expanded=!1;const t=this.shadowRoot.querySelector(".leaderboard-card__details"),s=this.shadowRoot.querySelector(".expand-icon");t&&t.classList.remove("open"),s&&s.classList.remove("expanded")}attachEventListeners(){const t=this.shadowRoot.querySelector(".expand-icon");t&&t.addEventListener("click",s=>{s.stopPropagation(),this.toggleExpanded()})}getBetStats(){const t=this.combinedBetslips;let s=0,a=0,r=0,n=0,o=0;return t.forEach(i=>{const l=i.bet||[];if(l.length===0)return;const c=l[0];Object.keys(c).filter(u=>u!=="short_title").forEach(u=>{const p=c[u];!p||typeof p!="object"||(p.reconciled===!0?parseFloat(p.payout||0)>0?s++:a++:(r++,n+=parseFloat(p.stake||p.wager||0),o+=parseFloat(p.payout||0)))})}),{wins:s,losses:a,pending:r,total:s+a+r,pendingStakes:n,pendingMaxPayout:o}}renderBetsTable(){const t=this.combinedBetslips,s=this.userMatches,a=this.isCurrentUser;if(!t||t.length===0)return'<p class="no-bets">No bets available</p>';const r=t.filter(l=>{const c=l.bet||[];if(c.length===0)return!1;if(a)return!0;const d=c[0],u=Object.keys(d).filter(p=>p!=="short_title")[0];return d[u]?.reconciled===!0});if(r.length===0){if(!a){const l=t.reduce((c,d)=>{const u=(d.bet||[])[0];if(!u)return c;const p=Object.keys(u).filter(f=>f!=="short_title");return c+p.filter(f=>u[f]?.reconciled!==!0).length},0);if(l>0)return`<p class="no-bets no-bets--hidden">
            ...
            `,c.bets.forEach(f=>{const b=f.bet||[];if(b.length===0)return;const y=b[0];Object.keys(y).filter(m=>m!=="short_title").forEach(m=>{const h=y[m];if(!h||typeof h!="object")return;const _=(h.type||"").toUpperCase(),w=parseFloat(h.stake||h.wager||0).toFixed(2),g=h.odds||"-",S=g>0?`+${g}`:`${g}`,P=parseFloat(h.payout||0).toFixed(2),T=h.reconciled===!0;let x="pending",E="Pending";T&&Number(P)>0?(x="won",E="Won"):T&&Number(P)===0?(x="lost",E="Lost"):T&&(x="reconciled",E="Settled"),i+=`<div class="bet-item bet-item--${x}">
                    ...
                    </div>`})})}),!a){const l=t.reduce((c,d)=>{const u=(d.bet||[])[0];if(!u)return c;const p=Object.keys(u).filter(f=>f!=="short_title");return c+p.filter(f=>u[f]?.reconciled!==!0).length},0);l>0&&(i+=`<p class="hidden-bets-note">+ ${l} pending bet${l!==1?"s":""} hidden until settled</p>`)}return i}render(){const t=this.isCurrentUser?"leaderboard-card--current-user":"",s=this.unqualified?"leaderboard-card--unqualified":"",a=parseFloat(this.startingDollars||0),r=this.combinedBetslips;let n=0,o=0,i=0;r.forEach(y=>{const v=y.bet||[];if(v.length===0)return;const m=v[0];Object.keys(m).filter(h=>h!=="short_title").forEach(h=>{const _=m[h];if(!_||typeof _!="object")return;const w=parseFloat(_.stake||0),g=parseFloat(_.payout||0);n+=w,_.reconciled===!0?i+=g:o+=w})});const l=Math.max(0,a-n),c=a-n+o+i,d=this.badgeClass?`<div class="badge-trophy ${this.badgeClass}"></div>`:"",u=c-a,p=u>=0?"+":"",f=u>0?"profit-up":u<0?"profit-down":"profit-even",b=this.getBetStats();this.shadowRoot.innerHTML=`
            <style>
                ${Qe()}
                ${gs()}
...
`:""},this._extScope=A,this._scope=new s.Scope({parent:A}),this._nodes=[new y]}toString(){return this._root.render(this.opts)}name(A){return this._scope.name(A)}scopeName(A){return this._extScope.name(A)}scopeValue(A,R){const F=this._extScope.value(A,R);return(this._values[F.prefix]||(this._values[F.prefix]=new Set)).add(F),F}getScopeValue(A,R){return this._extScope.getValue(A,R)}scopeRefs(A){return this._extScope.scopeRefs(A,this._values)}scopeCode(){return this._extScope.scopeCode(this._values)}_def(A,R,F,L){const z=this._scope.toName(R);return F!==void 0&&L&&(this._constants[z.str]=F),this._leafNode(new o(A,z,F)),z}const(A,R,F){return this._def(s.varKinds.const,A,R,F)}let(A,R,F){return this._def(s.varKinds.let,A,R,F)}var(A,R,F){return this._def(s.varKinds.var,A,R,F)}assign(A,R,F){return this._leafNode(new i(A,R,F))}add(A,R){return this._leafNode(new l(A,e.operators.ADD,R))}code(A){return typeof A=="function"?A():A!==t.nil&&this._leafNode(new p(A)),this}object(...A){const R=["{"];for(const[F,L]of A)R.length>1&&R.push(","),R.push(F),(F!==L||this.opts.es5)&&(R.push(":"),(0,t.addCodeArg)(R,L));return R.push("}"),new t._Code(R)}if(A,R,F){if(this._blockNode(new m(A)),R&&F)this.code(R).else().code(F).endIf();else if(R)this.code(R).endIf();else if(F)throw new Error('CodeGen: "else" body without "then" body');return this}elseIf(A){return this._elseNode(new m(A))}else(){return this._elseNode(new v)}endIf(){return this._endBlockNode(m,v)}_for(A,R){return this._blockNode(A),R&&this.code(R).endFor(),this}for(A,R){return this._for(new _(A),R)}forRange(A,R,F,L,z=this.opts.es5?s.varKinds.var:s.varKinds.let){const G=this._scope.toName(A);return this._for(new w(z,G,R,F),()=>L(G))}forOf(A,R,F,L=s.varKinds.const){const z=this._scope.toName(A);if(this.opts.es5){const G=R instanceof t.Name?R:this.var("_arr",R);return this.forRange("_i",0,(0,t._)`${G}.length`,te=>{this.var(z,(0,t._)`${G}[${te}]`),F(z)})}return this._for(new g("of",L,z,R),()=>F(z))}forIn(A,R,F,L=this.opts.es5?s.varKinds.var:s.varKinds.const){if(this.opts.ownProperties)return this.forOf(A,(0,t._)`Object.keys(${R})`,F);const z=this._scope.toName(A);return this._for(new g("in",L,z,R),()=>F(z))}endFor(){return this._endBlockNode(h)}label(A){return this._leafNode(new c(A))}break(A){return this._leafNode(new d(A))}return(A){const R=new P;if(this._blockNode(R),this.code(A),R.nodes.length!==1)throw new Error('CodeGen: "return" should have one node');return this._endBlockNode(P)}try(A,R,F){if(!R&&!F)throw new Error('CodeGen: "try" without "catch" and "finally"');const L=new T;if(this._blockNode(L),this.code(A),R){const z=this.name("e");this._currNode=L.catch=new x(z),R(z)}return F&&(this._currNode=L.finally=new E,this.code(F)),this._endBlockNode(x,E)}throw(A){return this._leafNode(new u(A))}block(A,R){return this._blockStarts.push(this._nodes.length),A&&this.code(A).endBlock(R),this}endBlock(A){const R=this._blockStarts.pop();if(R===void 0)throw new Error("CodeGen: not in self-balancing block");const F=this._nodes.length-R;if(F<0||A!==void 0&&F!==A)throw new Error(`CodeGen: wrong number of nodes: ${F} vs ${A} expected`);return this._nodes.length=R,this}func(A,R=t.nil,F,L){return this._blockNode(new S(A,R,F)),L&&this.code(L).endFunc(),this}endFunc(){return this._endBlockNode(S)}optimize(A=1){for(;A-- >0;)this._root.optimizeNodes(),this._root.optimizeNames(this._root.names,this._constants)}_leafNode(A){return this._currNode.nodes.push(A),this}_blockNode(A){this._currNode.nodes.push(A),this._nodes.push(A)}_endBlockNode(A,R){const F=this._currNode;if(F instanceof A||R&&F instanceof R)return this._nodes.pop(),this;throw new Error(`CodeGen: not in block "${R?`${A.kind}/${R.kind}`:A.kind}"`)}_elseNode(A){const R=this._currNode;if(!(R instanceof m))throw new Error('CodeGen: "else" without "if"');return this._currNode=R.else=A,this}get _root(){return this._nodes[0]}get _currNode(){const A=this._nodes;return A[A.length-1]}set _currNode(A){const R=this._nodes;R[R.length-1]=A}}e.CodeGen=C;function $(B,A){for(const R in A)B[R]=(B[R]||0)+(A[R]||0);return B}function N(B,A){return A instanceof t._CodeOrName?$(B,A.names):B}function U(B,A,R){if(B instanceof t.Name)return F(B);if(!L(B))return B;return new t._Code(B._items.reduce((z,G)=>(G instanceof t.Name&&(G=F(G)),G instanceof t._Code?z.push(...G._items):z.push(G),z),[]));function F(z){const G=R[z.str];return G===void 0||A[z.str]!==1?z:(delete A[z.str],G)}function L(z){return z instanceof t._Code&&z._items.some(G=>G instanceof t.Name&&A[G.str]===1&&R[G.str]!==void 0)}}function J(B,A){for(const R in A)B[R]=(B[R]||0)-(A[R]||0)}function ae(B){return typeof B=="boolean"||typeof B=="number"||B===null?!B:(0,t._)`!${H(B)}`}e.not=ae;const Q=M(e.operators.AND);function V(...B){return B.reduce(Q)}e.and=V;const K=M(e.operators.OR);function j(...B){return B.reduce(K)}e.or=j;function M(B){return(A,R)=>A===t.nil?R:R===t.nil?A:(0,t._)`${H(A)} ${B} ${H(R)}`}function H(B){return B instanceof t.Name?B:(0,t._)`(${B})`}})(Hn)),Hn}var me={},ml;function ve(){if(ml)return me;ml=1,Object.defineProperty(me,"__esModule",{value:!0}),me.checkStrictMode=me.getErrorPath=me.Type=me.useFunc=me.setEvaluated=me.evaluatedPropsToName=me.mergeEvaluated=me.eachItem=me.unescapeJsonPointer=me.escapeJsonPointer=me.escapeFragment=me.unescapeFragment=me.schemaRefOrVal=me.schemaHasRulesButRef=me.schemaHasRules=me.checkUnknownRules=me.alwaysValidSchema=me.toHash=void 0;const e=ge(),t=jr();function s(g){const S={};for(const P of g)S[P]=!0;return S}me.toHash=s;function a(g,S){return typeof S=="boolean"?S:Object.keys(S).length===0?!0:(r(g,S),!n(S,g.self.RULES.all))}me.alwaysValidSchema=a;function r(g,S=g.schema){const{opts:P,self:T}=g;if(!P.strictSchema||typeof S=="boolean")return;const x=T.RULES.keywords;for(const E in S)x[E]||w(g,`unknown keyword: "${E}"`)}me.checkUnknownRules=r;function n(g,S){if(typeof g=="boolean")return!g;for(const P in g)if(S[P])return!0;return!1}me.schemaHasRules=n;function o(g,S){if(typeof g=="boolean")return!g;for(const P in g)if(P!=="$ref"&&S.all[P])return!0;return!1}me.schemaHasRulesButRef=o;function i({topSchemaRef:g,schemaPath:S},P,T,x){if(!x){if(typeof P=="number"||typeof P=="boolean")return P;if(typeof P=="string")return(0,e._)`${P}`}return(0,e._)`${g}${S}${(0,e.getProperty)(T)}`}me.schemaRefOrVal=i;function l(g){return u(decodeURIComponent(g))}me.unescapeFragment=l;function c(g){return encodeURIComponent(d(g))}me.escapeFragment=c;function d(g){return typeof g=="number"?`${g}`:g.replace(/~/g,"~0").replace(/\//g,"~1")}me.escapeJsonPointer=d;function u(g){return g.replace(/~1/g,"/").replace(/~0/g,"~")}me.unescapeJsonPointer=u;function p(g,S){if(Array.isArray(g))for(const P of g)S(P);else S(g)}me.eachItem=p;function f({mergeNames:g,mergeToName:S,mergeValues:P,resultToName:T}){return(x,E,C,$)=>{const N=C===void 0?E:C instanceof e.Name?(E instanceof e.Name?g(x,E,C):S(x,E,C),C):E instanceof e.Name?(S(x,C,E),E):P(E,C);return $===e.Name&&!(N instanceof e.Name)?T(x,N):N}}me.mergeEvaluated={props:f({mergeNames:(g,S,P)=>g.if((0,e._)`${P} !== true && ${S} !== undefined`,()=>{g.if((0,e._)`${S} === true`,()=>g.assign(P,!0),()=>g.assign(P,(0,e._)`${P} || {}`).code((0,e._)`Object.assign(${P}, ${S})`))}),mergeToName:(g,S,P)=>g.if((0,e._)`${P} !== true`,()=>{S===!0?g.assign(P,!0):(g.assign(P,(0,e._)`${P} || {}`),y(g,P,S))}),mergeValues:(g,S)=>g===!0?!0:{...g,...S},resultToName:b}),items:f({mergeNames:(g,S,P)=>g.if((0,e._)`${P} !== true && ${S} !== undefined`,()=>g.assign(P,(0,e._)`${S} === true ? true : ${P} > ${S} ? ${P} : ${S}`)),mergeToName:(g,S,P)=>g.if((0,e._)`${P} !== true`,()=>g.assign(P,S===!0?!0:(0,e._)`${P} > ${S} ? ${P} : ${S}`)),mergeValues:(g,S)=>g===!0?!0:Math.max(g,S),resultToName:(g,S)=>g.var("items",S)})};function b(g,S){if(S===!0)return g.var("props",!0);const P=g.var("props",(0,e._)`{}`);return S!==void 0&&y(g,P,S),P}me.evaluatedPropsToName=b;function y(g,S,P){Object.keys(P).forEach(T=>g.assign((0,e._)`${S}${(0,e.getProperty)(T)}`,!0))}me.setEvaluated=y;const v={};function m(g,S){return g.scopeValue("func",{ref:S,code:v[S.code]||(v[S.code]=new t._Code(S.code))})}me.useFunc=m;var h;(function(g){g[g.Num=0]="Num",g[g.Str=1]="Str"})(h||(me.Type=h={}));function _(g,S,P){if(g instanceof e.Name){const T=S===h.Num;return P?T?(0,e._)`"[" + ${g} + "]"`:(0,e._)`"['" + ${g} + "']"`:T?(0,e._)`"/" + ${g}`:(0,e._)`"/" + ${g}.replace(/~/g, "~0").replace(/\\//g, "~1")`}return P?(0,e.getProperty)(g).toString():"/"+d(g)}me.getErrorPath=_;function w(g,S,P=g.opts.strictSchema){if(P){if(S=`strict mode: ${S}`,P===!0)throw new Error(S);g.self.logger.warn(S)}}return me.checkStrictMode=w,me}var Da={},gl;function bs(){if(gl)return Da;gl=1,Object.defineProperty(Da,"__esModule",{value:!0});const e=ge(),t={data:new e.Name("data"),valCxt:new e.Name("valCxt"),instancePath:new e.Name("instancePath"),parentData:new e.Name("parentData"),parentDataProperty:new e.Name("parentDataProperty"),rootData:new e.Name("rootData"),dynamicAnchors:new e.Name("dynamicAnchors"),vErrors:new e.Name("vErrors"),errors:new e.Name("errors"),this:new e.Name("this"),self:new e.Name("self"),scope:new e.Name("scope"),json:new e.Name("json"),jsonPos:new e.Name("jsonPos"),jsonLen:new e.Name("jsonLen"),jsonPart:new e.Name("jsonPart")};return Da.default=t,Da}var bl;function ln(){return bl||(bl=1,(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.extendErrors=e.resetErrorsCount=e.reportExtraError=e.reportError=e.keyword$DataError=e.keywordError=void 0;const t=ge(),s=ve(),a=bs();e.keywordError={message:({keyword:v})=>(0,t.str)`must pass "${v}" keyword validation`},e.keyword$DataError={message:({keyword:v,schemaType:m})=>m?(0,t.str)`"${v}" keyword must be ${m} ($data)`:(0,t.str)`"${v}" keyword is invalid ($data)`};function r(v,m=e.keywordError,h,_){const{it:w}=v,{gen:g,compositeRule:S,allErrors:P}=w,T=u(v,m,h);_??(S||P)?l(g,T):c(w,(0,t._)`[${T}]`)}e.reportError=r;function n(v,m=e.keywordError,h){const{it:_}=v,{gen:w,compositeRule:g,allErrors:S}=_,P=u(v,m,h);l(w,P),g||S||c(_,a.default.vErrors)}e.reportExtraError=n;function o(v,m){v.assign(a.default.errors,m),v.if((0,t._)`${a.default.vErrors} !== null`,()=>v.if(m,()=>v.assign((0,t._)`${a.default.vErrors}.length`,m),()=>v.assign(a.default.vErrors,null)))}e.resetErrorsCount=o;function i({gen:v,keyword:m,schemaValue:h,data:_,errsCount:w,it:g}){if(w===void 0)throw new Error("ajv implementation error");const S=v.name("err");v.forRange("i",w,a.default.errors,P=>{v.const(S,(0,t._)`${a.default.vErrors}[${P}]`),v.if((0,t._)`${S}.instancePath === undefined`,()=>v.assign((0,t._)`${S}.instancePath`,(0,t.strConcat)(a.default.instancePath,g.errorPath))),v.assign((0,t._)`${S}.schemaPath`,(0,t.str)`${g.errSchemaPath}/${m}`),g.opts.verbose&&(v.assign((0,t._)`${S}.schema`,h),v.assign((0,t._)`${S}.data`,_))})}e.extendErrors=i;function l(v,m){const h=v.const("err",m);v.if((0,t._)`${a.default.vErrors} === null`,()=>v.assign(a.default.vErrors,(0,t._)`[${h}]`),(0,t._)`${a.default.vErrors}.push(${h})`),v.code((0,t._)`${a.default.errors}++`)}function c(v,m){const{gen:h,validateName:_,schemaEnv:w}=v;w.$async?h.throw((0,t._)`new ${v.ValidationError}(${m})`):(h.assign((0,t._)`${_}.errors`,m),h.return(!1))}const d={keyword:new t.Name("keyword"),schemaPath:new t.Name("schemaPath"),params:new t.Name("params"),propertyName:new t.Name("propertyName"),message:new t.Name("message"),schema:new t.Name("schema"),parentSchema:new t.Name("parentSchema")};function u(v,m,h){const{createErrors:_}=v.it;return _===!1?(0,t._)`{}`:p(v,m,h)}function p(v,m,h={}){const{gen:_,it:w}=v,g=[f(w,h),b(v,h)];return y(v,m,g),_.object(...g)}function f({errorPath:v},{instancePath:m}){const h=m?(0,t.str)`${v}${(0,s.getErrorPath)(m,s.Type.Str)}`:v;return[a.default.instancePath,(0,t.strConcat)(a.default.instancePath,h)]}function b({keyword:v,it:{errSchemaPath:m}},{schemaPath:h,parentSchema:_}){let w=_?m:(0,t.str)`${m}/${v}`;return h&&(w=(0,t.str)`${w}${(0,s.getErrorPath)(h,s.Type.Str)}`),[d.schemaPath,w]}function y(v,{params:m,message:h},_){const{keyword:w,data:g,schemaValue:S,it:P}=v,{opts:T,propertyName:x,topSchemaRef:E,schemaPath:C}=P;_.push([d.keyword,w],[d.params,typeof m=="function"?m(v):m||(0,t._)`{}`]),T.messages&&_.push([d.message,typeof h=="function"?h(v):h]),T.verbose&&_.push([d.schema,S],[d.parentSchema,(0,t._)`${E}${C}`],[a.default.data,g]),x&&_.push([d.propertyName,x])}})(jn)),jn}var _l;function ty(){if(_l)return Ts;_l=1,Object.defineProperty(Ts,"__esModule",{value:!0}),Ts.boolOrEmptySchema=Ts.topBoolOrEmptySchema=void 0;const e=ln(),t=ge(),s=bs(),a={message:"boolean schema is false"};function r(i){const{gen:l,schema:c,validateName:d}=i;c===!1?o(i,!1):typeof c=="object"&&c.$async===!0?l.return(s.default.data):(l.assign((0,t._)`${d}.errors`,null),l.return(!0))}Ts.topBoolOrEmptySchema=r;function n(i,l){const{gen:c,schema:d}=i;d===!1?(c.var(l,!1),o(i)):c.var(l,!0)}Ts.boolOrEmptySchema=n;function o(i,l){const{gen:c,data:d}=i,u={gen:c,keyword:"false schema",data:d,schema:!1,schemaCode:!1,schemaValue:!1,params:{},it:i};(0,e.reportError)(u,a,void 0,l)}return Ts}var Ie={},Ss={},yl;function Eu(){if(yl)return Ss;yl=1,Object.defineProperty(Ss,"__esModule",{value:!0}),Ss.getRules=Ss.isJSONType=void 0;const e=["string","number","integer","boolean","null","object","array"],t=new Set(e);function s(r){return typeof r=="string"&&t.has(r)}Ss.isJSONType=s;function a(){const r={number:{type:"number",rules:[]},string:{type:"string",rules:[]},array:{type:"array",rules:[]},object:{type:"object",rules:[]}};return{types:{...r,integer:!0,boolean:!0,null:!0},rules:[{rules:[]},r.number,r.string,r.array,r.object],post:{rules:[]},all:{},keywords:{}}}return Ss.getRules=a,Ss}var Ft={},vl;function ku(){if(vl)return Ft;vl=1,Object.defineProperty(Ft,"__esModule",{value:!0}),Ft.shouldUseRule=Ft.shouldUseGroup=Ft.schemaHasRulesForType=void 0;function e({schema:a,self:r},n){const o=r.RULES.types[n];return o&&o!==!0&&t(a,o)}Ft.schemaHasRulesForType=e;function t(a,r){return r.rules.some(n=>s(a,n))}Ft.shouldUseGroup=t;function s(a,r){var n;return a[r.keyword]!==void 0||((n=r.definition.implements)===null||n===void 0?void 0:n.some(o=>a[o]!==void 0))}return Ft.shouldUseRule=s,Ft}var wl;function Hr(){if(wl)return Ie;wl=1,Object.defineProperty(Ie,"__esModule",{value:!0}),Ie.reportTypeError=Ie.checkDataTypes=Ie.checkDataType=Ie.coerceAndCheckDataType=Ie.getJSONTypes=Ie.getSchemaTypes=Ie.DataType=void 0;const e=Eu(),t=ku(),s=ln(),a=ge(),r=ve();var n;(function(h){h[h.Correct=0]="Correct",h[h.Wrong=1]="Wrong"})(n||(Ie.DataType=n={}));function o(h){const _=i(h.type);if(_.includes("null")){if(h.nullable===!1)throw new Error("type: null contradicts nullable: false")}else{if(!_.length&&h.nullable!==void 0)throw new Error('"nullable" cannot be used without "type"');h.nullable===!0&&_.push("null")}return _}Ie.getSchemaTypes=o;function i(h){const _=Array.isArray(h)?h:h?[h]:[];if(_.every(e.isJSONType))return _;throw new Error("type must be JSONType or JSONType[]: "+_.join(","))}Ie.getJSONTypes=i;function l(h,_){const{gen:w,data:g,opts:S}=h,P=d(_,S.coerceTypes),T=_.length>0&&!(P.length===0&&_.length===1&&(0,t.schemaHasRulesForType)(h,_[0]));if(T){const x=b(_,g,S.strictNumbers,n.Wrong);w.if(x,()=>{P.length?u(h,_,P):v(h)})}return T}Ie.coerceAndCheckDataType=l;const c=new Set(["string","number","integer","boolean","null"]);function d(h,_){return _?h.filter(w=>c.has(w)||_==="array"&&w==="array"):[]}function u(h,_,w){const{gen:g,data:S,opts:P}=h,T=g.let("dataType",(0,a._)`typeof ${S}`),x=g.let("coerced",(0,a._)`undefined`);P.coerceTypes==="array"&&g.if((0,a._)`${T} == 'object' && Array.isArray(${S}) && ${S}.length == 1`,()=>g.assign(S,(0,a._)`${S}[0]`).assign(T,(0,a._)`typeof ${S}`).if(b(_,S,P.strictNumbers),()=>g.assign(x,S))),g.if((0,a._)`${x} !== undefined`);for(const C of w)(c.has(C)||C==="array"&&P.coerceTypes==="array")&&E(C);g.else(),v(h),g.endIf(),g.if((0,a._)`${x} !== undefined`,()=>{g.assign(S,x),p(h,x)});function E(C){switch(C){case"string":g.elseIf((0,a._)`${T} == "number" || ${T} == "boolean"`).assign(x,(0,a._)`"" + ${S}`).elseIf((0,a._)`${S} === null`).assign(x,(0,a._)`""`);return;case"number":g.elseIf((0,a._)`${T} == "boolean" || ${S} === null
    ...
    `,s.forEach(n=>{const o=this.shadowRoot.querySelector(`[data-item="${n.name}"]`);o&&(o.addEventListener("click",()=>this.handleItemClick(n.name,n.topic)),o.addEventListener("keypress",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),this.handleItemClick(n.name,n.topic))}))})}}customElements.define("bma-app-foot",_0);class y0 extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this._unsub=Oe.subscribe(()=>this.render()),this.render()}disconnectedCallback(){this._unsub&&this._unsub()}_doLogout(){de.publish("ROUTE.HOME.USER_PROFILE.SIGNOUT",JSON.stringify({ts:Date.now()}))}render(){let t="";try{t=we().appSession?.session_app?.version||""}catch{}this.shadowRoot.innerHTML=`
        ...
        `;const s=this.shadowRoot.querySelector(".foot-logout");s&&s.addEventListener("click",()=>this._doLogout())}}customElements.define("bma-app-foot-branded",y0);class v0 extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}static get observedAttributes(){return["data-corebetslip"]}attributeChangedCallback(t,s,a){s!==a&&this.render()}get betSlipData(){const t=this.getAttribute("data-corebetslip");if(!t)return null;try{return JSON.parse(t)}catch(s){return console.error("[bma-bet-existing] Failed to parse data-corebetslip:",s),null}}render(){const t=this.betSlipData;if(!t){this.shadowRoot.innerHTML="<div>Invalid bet data</div>";return}const s=t.bet||[];if(s.length===0){this.shadowRoot.innerHTML="<div>No bet data</div>";return}const a=s[0],r=a.short_title||"Match Info N/A",o=Object.keys(a).filter(h=>h!=="short_title")[0]||"Unknown Team",i=a[o],l=i.odds||"N/A",c=i.type||"N/A",d=parseFloat(i.stake||0).toFixed(2),u=parseFloat(i.payout||0).toFixed(2),p=i.reconciled!==!1,f=p&&parseFloat(u)>parseFloat(d),b=p&&parseFloat(u)<=parseFloat(d);let y="";p?f?y="win":b&&(y="loss"):y="unreconciled";const v=t.status_time?Sa.formatDateLocal(t.status_time):"";let m=o;if(c==="spread"&&i.point){const h=parseFloat(i.point)>0?`+${i.point}`:i.point;m=`${o} ${h}`}else c==="total"&&i.point&&(m=`${i.team==="over"?"Over":"Under"} ${i.point}`);this.shadowRoot.innerHTML=`
      <style>
        ${Qe()}
        :host {
          display: block;
