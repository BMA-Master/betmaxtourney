...
<pre data-n55-theme="warning" style="padding: 7px 0 4px 0; height: 34px; background-color: #161616"></pre>
                ...
                <div class="rows-container">
                    <div class="row row--home">
                        <div class="team team--home ${f?"team--winner":""} ${g?"team--loser":""}">
                            ...
                            ${i?`<span class="team-score ${_?"score--leading":""} ${v?"score--trailing":""}">${o}</span>`:""}
                        </div>
                        ${`
                            <div class="buttons">
    ...
    `}}customElements.define("bma-match-status",Bg);const Fg='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><polyline points="12 7 12 12 15 14"/></svg>',zg='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="5 12 10 17 19 7"/></svg>',Hg='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><line x1="6" y1="6" x2="18" y2="18"/><line x1="18" y1="6" x2="6" y2="18"/></svg>',jg='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/></svg>';class ms extends HTMLElement{static currentlyExpanded=null;constructor(){super(),this.attachShadow({mode:"open"}),this.expanded=!1}static get observedAttributes(){return["data-rank","data-username","data-user-guid","data-tournament-dollars","data-starting-dollars","data-total-betslips","data-total-payout","data-combined-betslips","data-user-matches","data-badge-class","data-is-current-user","data-unqualified","data-sync-theme"]}get rank(){return this.getAttribute("data-rank")||""}get username(){return this.getAttribute("data-username")||"Unknown"}get userGuid(){return this.getAttribute("data-user-guid")||""}get tournamentDollars(){return this.getAttribute("data-tournament-dollars")||"0"}get startingDollars(){return this.getAttribute("data-starting-dollars")||"0"}get totalBetslips(){return this.getAttribute("data-total-betslips")||"0"}get totalPayout(){return this.getAttribute("data-total-payout")||"0"}get combinedBetslips(){const t=this.getAttribute("data-combined-betslips");if(!t)return[];try{return JSON.parse(t)}catch(s){return console.error("[bma-leaderboard-card] Error parsing combined_betslips:",s),[]}}get userMatches(){const t=this.getAttribute("data-user-matches");if(!t)return[];try{return JSON.parse(t)}catch(s){return console.error("[bma-leaderboard-card] Error parsing user_matches:",s),[]}}get badgeClass(){return this.getAttribute("data-badge-class")||""}get isCurrentUser(){return this.getAttribute("data-is-current-user")==="true"}get unqualified(){return this.getAttribute("data-unqualified")==="true"}get theme(){return this.getAttribute("data-sync-theme")||"dark"}connectedCallback(){this._unsub=Me.subscribe(()=>{this.render()}),this.render(),this.attachEventListeners()}disconnectedCallback(){this._unsub&&this._unsub()}attributeChangedCallback(t,s,a){s!==a&&(this.render(),this.attachEventListeners())}toggleExpanded(){ms.currentlyExpanded&&ms.currentlyExpanded!==this&&ms.currentlyExpanded.collapse(),this.expanded=!this.expanded;const t=this.shadowRoot.querySelector(".leaderboard-card__details"),s=this.shadowRoot.querySelector(".expand-icon");this.expanded?(t.classList.add("open"),s.classList.add("expanded"),ms.currentlyExpanded=this):(t.classList.remove("open"),s.classList.remove("expanded"),ms.currentlyExpanded===this&&(ms.currentlyExpanded=null))}collapse(){this.expanded=!1;const t=this.shadowRoot.querySelector(".leaderboard-card__details"),s=this.shadowRoot.querySelector(".expand-icon");t&&t.classList.remove("open"),s&&s.classList.remove("expanded")}attachEventListeners(){const t=this.shadowRoot.querySelector(".expand-icon");t&&t.addEventListener("click",s=>{s.stopPropagation(),this.toggleExpanded()})}getBetStats(){const t=this.combinedBetslips;let s=0,a=0,n=0,r=0,o=0;return t.forEach(l=>{const i=l.bet||[];if(i.length===0)return;const c=i[0];Object.keys(c).filter(u=>u!=="short_title").forEach(u=>{const p=c[u];!p||typeof p!="object"||(p.reconciled===!0?parseFloat(p.payout||0)>0?s++:a++:(n++,r+=parseFloat(p.stake||p.wager||0),o+=parseFloat(p.payout||0)))})}),{wins:s,losses:a,pending:n,total:s+a+n,pendingStakes:r,pendingMaxPayout:o}}renderBetsTable(){const t=this.combinedBetslips,s=this.userMatches,a=this.isCurrentUser;if(!t||t.length===0)return'<p class="no-bets">No bets available</p>';const n=t.filter(i=>{const c=i.bet||[];if(c.length===0)return!1;if(a)return!0;const d=c[0],u=Object.keys(d).filter(p=>p!=="short_title")[0];return d[u]?.reconciled===!0});if(n.length===0){if(!a){const i=t.reduce((c,d)=>{const u=(d.bet||[])[0];if(!u)return c;const p=Object.keys(u).filter(f=>f!=="short_title");return c+p.filter(f=>u[f]?.reconciled!==!0).length},0);if(i>0)return`<p class="no-bets no-bets--hidden">
            ...
            `,c.bets.forEach(f=>{const g=f.bet||[];if(g.length===0)return;const _=g[0];Object.keys(_).filter(m=>m!=="short_title").forEach(m=>{const h=_[m];if(!h||typeof h!="object")return;const b=(h.type||"").toUpperCase(),w=parseFloat(h.stake||h.wager||0),y=parseFloat(h.payout||0),x=parseInt(h.odds,10),P=Number.isFinite(x)?x>0?`+${x}`:`${x}`:"—",D=h.reconciled===!0,T=y-w,k=.01;let S,O,I,q,J;D?y>w+k?(S="won",O="Won",I=zg,q=`+TD$ ${T.toFixed(2)}`,J="Profit"):y<w-k?(S="lost",O="Lost",I=Hg,q=`-TD$ ${w.toFixed(2)}`,J="Lost"):(S="push",O="Push",I=jg,q=`TD$ ${w.toFixed(2)}`,J="Returned"):(S="pending",O="Pending",I=Fg,q=T>0?`+TD$ ${T.toFixed(2)}`:"TD$ 0.00",J="To win"),l+=`<div class="bet-item ${S}">
                        <div class="bet-item__pill">
                            <span class="bet-item__pill-dot"></span>
                            <span class="bet-item__pill-icon">${I}</span>
                        ...
                        <div class="bet-item__body">
                            <div class="bet-item__middle">
                                ...
                                <div class="bet-item__meta">
                                    ...
                                    <div class="bet-item__stake">TD$ ${w.toFixed(2)} stake</div>
                                </div>
                            </div>
                            <div class="bet-item__footer">
                                <div class="bet-item__hero">${q}</div>
                                <div class="bet-item__sublabel">${J}</div>
                            </div>
                        </div>
                    </div>`})})}),!a){const i=t.reduce((c,d)=>{const u=(d.bet||[])[0];if(!u)return c;const p=Object.keys(u).filter(f=>f!=="short_title");return c+p.filter(f=>u[f]?.reconciled!==!0).length},0);i>0&&(l+=`<p class="hidden-bets-note">+ ${i} pending bet${i!==1?"s":""} hidden until settled</p>`)}return l}render(){const t=this.isCurrentUser?"leaderboard-card--current-user":"",s=this.unqualified?"leaderboard-card--unqualified":"",a=parseFloat(this.startingDollars||0),n=this.combinedBetslips;let r=0,o=0,l=0;n.forEach(h=>{const b=h.bet||[];if(b.length===0)return;const w=b[0];Object.keys(w).filter(y=>y!=="short_title").forEach(y=>{const x=w[y];if(!x||typeof x!="object")return;const P=parseFloat(x.stake||0),D=parseFloat(x.payout||0);r+=P,x.reconciled===!0?l+=D:o+=P})});const i=Math.max(0,a-r),c=h=>Math.abs(h)<.01?0:h,d=r-o,u=c(a-d+l),p=u,f=this.badgeClass?`<div class="badge-trophy ${this.badgeClass}"></div>`:"",g=c(p-a),_=g>=0?"+":"",v=g>0?"profit-up":g<0?"profit-down":"profit-even",m=this.getBetStats();this.shadowRoot.innerHTML=`
            <style>
                ${He()}
                ${Ss()}
            ...
            <div class="leaderboard-card ${t} ${s}">
                ...
                <div class="kpi-strip">
                    <div class="kpi-card">
                        ...
                        <div class="kpi-card__value ${v}">${_}TD$ ${Math.abs(g).toFixed(2)}</div>
                    </div>
                    <div class="kpi-card">
        ...
        `}}customElements.define("bma-leaderboard-card",ms);class Ru{static isPayout(t){if(!t?.Bet||!t?.Match)return console.error("[CoreBetSlip.isPayout] Invalid bet object - missing Bet or Match data"),!1;const{type:s,scope:a}=t.Bet,{home_team_id:n,home_team_score:r,away_team_id:o,away_team_score:l}=t.Match,i=s?.toUpperCase()||"",c=parseFloat(r)||0,d=parseFloat(l)||0;if(c===0&&d===0)return console.warn("[CoreBetSlip.isPayout] Invalid scores - both teams have 0 points"),!1;switch(console.log(`[CoreBetSlip.isPayout] Evaluating ${i} bet:`,{home:`${n} (${c})`,away:`${o} (${d})`,scope:a}),i){case"MONEY":return this._evaluateMoneyline(a.team_id,n,o,c,d);case"SPREAD":return this._evaluateSpread(a.team_id,a.point,n,o,c,d);case"TOTAL":return this._evaluateTotal(a.over,a.under,c,d);case"PROP":return console.warn("[CoreBetSlip.isPayout] PROP bet evaluation not implemented"),!1;case"PARLAY":return console.warn("[CoreBetSlip.isPayout] PARLAY bet evaluation not implemented"),!1;default:return console.warn("[CoreBetSlip.isPayout] Unknown bet type:",i),!1}}static _evaluateMoneyline(t,s,a,n,r){const o=t===s,l=t===a;if(!o&&!l)return console.warn("[CoreBetSlip.isPayout] Betted team does not match home or away team"),!1;const i=n>r,c=r>n;if(n===r)return console.log("[CoreBetSlip.isPayout] MONEY - PUSH (tie game)"),!1;const u=o&&i||l&&c;return console.log(`[CoreBetSlip.isPayout] MONEY - ${u?"WON":"LOST"}`),u}static _evaluateSpread(t,s,a,n,r,o){const l=t===a,i=t===n;if(!l&&!i)return console.warn("[CoreBetSlip.isPayout] Betted team does not match home or away team"),!1;const c=parseFloat(s)||0;let d=r,u=o;l?d=r+c:u=o+c;const p=d>u,f=u>d;if(d===u)return console.log("[CoreBetSlip.isPayout] SPREAD - PUSH (exact spread)"),!1;const _=l&&p||i&&f;return console.log(`[CoreBetSlip.isPayout] SPREAD (${c>0?"+":""}${c}) - ${_?"WON":"LOST"}`),_}static _evaluateTotal(t,s,a,n){const r=a+n,o=t&&t!=="";if(!o&&!(s&&s!==""))return console.warn("[CoreBetSlip.isPayout] No over/under value specified"),!1;const i=parseFloat(o?t:s);if(r===i)return console.log("[CoreBetSlip.isPayout] TOTAL - PUSH (exact line)"),!1;let c=!1;return o?(c=r>i,console.log(`[CoreBetSlip.isPayout] TOTAL OVER ${i} (actual: ${r}) - ${c?"WON":"LOST"}`)):(c=r<i,console.log(`[CoreBetSlip.isPayout] TOTAL UNDER ${i} (actual: ${r}) - ${c?"WON":"LOST"}`)),c}static calcPayout(t){if(!t?.Bet)return console.error("[CoreBetSlip] Invalid bet object - missing Bet data"),0;const{type:s,odds:a,stake:n}=t.Bet,r=s?.toUpperCase()||"",o=parseFloat(a)||0,l=parseFloat(n)||0;if(l<=0)return console.warn("[CoreBetSlip] Invalid stake amount:",l),0;if(o===0)return console.warn("[CoreBetSlip] Invalid odds value:",o),0;let i=0;switch(r){case"SPREAD":i=this.calcAmericanOddsPayout(o,l),console.log("[CoreBetSlip] SPREAD payout calculated:",{odds:o,stake:l,payout:i});break;case"MONEY":i=this.calcAmericanOddsPayout(o,l),console.log("[CoreBetSlip] MONEY payout calculated:",{odds:o,stake:l,payout:i});break;case"TOTAL":i=this.calcAmericanOddsPayout(o,l),console.log("[CoreBetSlip] TOTAL payout calculated:",{odds:o,stake:l,payout:i});break;case"PROP":i=this.calcAmericanOddsPayout(o,l),console.log("[CoreBetSlip] PROP payout calculated:",{odds:o,stake:l,payout:i});break;case"PARLAY":i=this.calcAmericanOddsPayout(o,l),console.log("[CoreBetSlip] PARLAY payout calculated (single odds):",{odds:o,stake:l,payout:i});break;default:console.warn("[CoreBetSlip] Unknown bet type:",r),i=0;break}return parseFloat(i.toFixed(2))}static calcAmericanOddsPayout(t,s){let a=0;return t>0?a=s*(t/100):t<0?a=s/(Math.abs(t)/100):a=0,s+a}static americanToDecimal(t){return t>0?t/100+1:t<0?100/Math.abs(t)+1:1}static calcImpliedProbability(t){return t>0?100/(t+100)*100:t<0?Math.abs(t)/(Math.abs(t)+100)*100:0}}function wl(e){return e!==null&&typeof e=="object"&&"constructor"in e&&e.constructor===Object}function oi(e={},t={}){const s=["__proto__","constructor","prototype"];Object.keys(t).filter(a=>s.indexOf(a)<0).forEach(a=>{typeof e[a]>"u"?e[a]=t[a]:wl(t[a])&&wl(e[a])&&Object.keys(t[a]).length>0&&oi(e[a],t[a])})}const Du={body:{},addEventListener(){},removeEventListener(){},activeElement:{blur(){},nodeName:""},querySelector(){return null},querySelectorAll(){return[]},getElementById(){return null},createEvent(){return{initEvent(){}}},createElement(){return{children:[],childNodes:[],style:{},setAttribute(){},getElementsByTagName(){return[]}}},createElementNS(){return{}},importNode(){return null},location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""}};function Ft(){const e=typeof document<"u"?document:{};return oi(e,Du),e}const Ug={document:Du,navigator:{userAgent:""},location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""},history:{replaceState(){},pushState(){},go(){},back(){}},CustomEvent:function(){return this},addEventListener(){},removeEventListener(){},getComputedStyle(){return{getPropertyValue(){return""}}},Image(){},Date(){},screen:{},setTimeout(){},clearTimeout(){},matchMedia(){return{}},requestAnimationFrame(e){return typeof setTimeout>"u"?(e(),null):setTimeout(e,0)},cancelAnimationFrame(e){typeof setTimeout>"u"||clearTimeout(e)}};function dt(){const e=typeof window<"u"?window:{};return oi(e,Ug),e}function qg(e=""){return e.trim().split(" ").filter(t=>!!t.trim())}function Vg(e){const t=e;Object.keys(t).forEach(s=>{try{t[s]=null}catch{}try{delete t[s]}catch{}})}function Nu(e,t=0){return setTimeout(e,t)}function Zn(){return Date.now()}function Gg(e){const t=dt();let s;return t.getComputedStyle&&(s=t.getComputedStyle(e,null)),!s&&e.currentStyle&&(s=e.currentStyle),s||(s=e.style),s}function Kg(e,t="x"){const s=dt();let a,n,r;const o=Gg(e);return s.WebKitCSSMatrix?(n=o.transform||o.webkitTransform,n.split(",").length>6&&(n=n.split(", ").map(l=>l.replace(",",".")).join(", ")),r=new s.WebKitCSSMatrix(n==="none"?"":n)):(r=o.MozTransform||o.OTransform||o.MsTransform||o.msTransform||o.transform||o.getPropertyValue("transform").replace("translate(","matrix(1, 0, 0, 1,"),a=r.toString().split(",")),t==="x"&&(s.WebKitCSSMatrix?n=r.m41:a.length===16?n=parseFloat(a[12]):n=parseFloat(a[4])),t==="y"&&(s.WebKitCSSMatrix?n=r.m42:a.length===16?n=parseFloat(a[13]):n=parseFloat(a[5])),n||0}function Ga(e){return typeof e=="object"&&e!==null&&e.constructor&&Object.prototype.toString.call(e).slice(8,-1)==="Object"}function Yg(e){return typeof window<"u"&&typeof window.HTMLElement<"u"?e instanceof HTMLElement:e&&(e.nodeType===1||e.nodeType===11)}function mt(...e){const t=Object(e[0]);for(let s=1;s<e.length;s+=1){const a=e[s];if(a!=null&&!Yg(a)){const n=Object.keys(Object(a)).filter(r=>r!=="__proto__"&&r!=="constructor"&&r!=="prototype");for(let r=0,o=n.length;r<o;r+=1){const l=n[r],i=Object.getOwnPropertyDescriptor(a,l);i!==void 0&&i.enumerable&&(Ga(t[l])&&Ga(a[l])?a[l].__swiper__?t[l]=a[l]:mt(t[l],a[l]):!Ga(t[l])&&Ga(a[l])?(t[l]={},a[l].__swiper__?t[l]=a[l]:mt(t[l],a[l])):t[l]=a[l])}}}return t}function Us(e,t,s){e.style.setProperty(t,s)}function Iu({swiper:e,targetPosition:t,side:s}){const a=dt(),n=-e.translate;let r=null,o;const l=e.params.speed;e.wrapperEl.style.scrollSnapType="none",a.cancelAnimationFrame(e.cssModeFrameID);const i=t>n?"next":"prev",c=(u,p)=>i==="next"&&u>=p||i==="prev"&&u<=p,d=()=>{o=new Date().getTime(),r===null&&(r=o);const u=Math.max(Math.min((o-r)/l,1),0),p=.5-Math.cos(u*Math.PI)/2;let f=n+p*(t-n);if(c(f,t)&&(f=t),e.wrapperEl.scrollTo({[s]:f}),c(f,t)){e.wrapperEl.style.overflow="hidden",e.wrapperEl.style.scrollSnapType="",setTimeout(()=>{e.wrapperEl.style.overflow="",e.wrapperEl.scrollTo({[s]:f})}),a.cancelAnimationFrame(e.cssModeFrameID);return}e.cssModeFrameID=a.requestAnimationFrame(d)};d()}function It(e,t=""){const s=dt(),a=[...e.children];return s.HTMLSlotElement&&e instanceof HTMLSlotElement&&a.push(...e.assignedElements()),t?a.filter(n=>n.matches(t)):a}function Wg(e,t){const s=[t];for(;s.length>0;){const a=s.shift();if(e===a)return!0;s.push(...a.children,...a.shadowRoot?a.shadowRoot.children:[],...a.assignedElements?a.assignedElements():[])}}function Jg(e,t){const s=dt();let a=t.contains(e);return!a&&s.HTMLSlotElement&&t instanceof HTMLSlotElement&&(a=[...t.assignedElements()].includes(e),a||(a=Wg(e,t))),a}function er(e){try{console.warn(e);return}catch{}}function tr(e,t=[]){const s=document.createElement(e);return s.classList.add(...Array.isArray(t)?t:qg(t)),s}function Xg(e,t){const s=[];for(;e.previousElementSibling;){const a=e.previousElementSibling;t?a.matches(t)&&s.push(a):s.push(a),e=a}return s}function Qg(e,t){const s=[];for(;e.nextElementSibling;){const a=e.nextElementSibling;t?a.matches(t)&&s.push(a):s.push(a),e=a}return s}function gs(e,t){return dt().getComputedStyle(e,null).getPropertyValue(t)}function sr(e){let t=e,s;if(t){for(s=0;(t=t.previousSibling)!==null;)t.nodeType===1&&(s+=1);return s}}function Bu(e,t){const s=[];let a=e.parentElement;for(;a;)t?a.matches(t)&&s.push(a):s.push(a),a=a.parentElement;return s}function Ro(e,t,s){const a=dt();return e[t==="width"?"offsetWidth":"offsetHeight"]+parseFloat(a.getComputedStyle(e,null).getPropertyValue(t==="width"?"margin-right":"margin-top"))+parseFloat(a.getComputedStyle(e,null).getPropertyValue(t==="width"?"margin-left":"margin-bottom"))}function qt(e){return(Array.isArray(e)?e:[e]).filter(t=>!!t)}function xl(e,t=""){typeof trustedTypes<"u"?e.innerHTML=trustedTypes.createPolicy("html",{createHTML:s=>s}).createHTML(t):e.innerHTML=t}let Wr;function Zg(){const e=dt(),t=Ft();return{smoothScroll:t.documentElement&&t.documentElement.style&&"scrollBehavior"in t.documentElement.style,touch:!!("ontouchstart"in e||e.DocumentTouch&&t instanceof e.DocumentTouch)}}function Fu(){return Wr||(Wr=Zg()),Wr}let Jr;function eb({userAgent:e}={}){const t=Fu(),s=dt(),a=s.navigator.platform,n=e||s.navigator.userAgent,r={ios:!1,android:!1},o=s.screen.width,l=s.screen.height,i=n.match(/(Android);?[\s\/]+([\d.]+)?/);let c=n.match(/(iPad)(?!\1).*OS\s([\d_]+)/);const d=n.match(/(iPod)(.*OS\s([\d_]+))?/),u=!c&&n.match(/(iPhone\sOS|iOS)\s([\d_]+)/),p=a==="Win32";let f=a==="MacIntel";const g=["1024x1366","1366x1024","834x1194","1194x834","834x1112","1112x834","768x1024","1024x768","820x1180","1180x820","810x1080","1080x810"];return!c&&f&&t.touch&&g.indexOf(`${o}x${l}`)>=0&&(c=n.match(/(Version)\/([\d.]+)/),c||(c=[0,1,"13_0_0"]),f=!1),i&&!p&&(r.os="android",r.android=!0),(c||u||d)&&(r.os="ios",r.ios=!0),r}function zu(e={}){return Jr||(Jr=eb(e)),Jr}let Xr;function tb(){const e=dt(),t=zu();let s=!1;function a(){const l=e.navigator.userAgent.toLowerCase();return l.indexOf("safari")>=0&&l.indexOf("chrome")<0&&l.indexOf("android")<0}if(a()){const l=String(e.navigator.userAgent);if(l.includes("Version/")){const[i,c]=l.split("Version/")[1].split(" ")[0].split(".").map(d=>Number(d));s=i<16||i===16&&c<2}}const n=/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(e.navigator.userAgent),r=a(),o=r||n&&t.ios;return{isSafari:s||r,needPerspectiveFix:s,need3dFix:o,isWebView:n}}function Hu(){return Xr||(Xr=tb()),Xr}function sb({swiper:e,on:t,emit:s}){const a=dt();let n=null,r=null;const o=()=>{!e||e.destroyed||!e.initialized||(s("beforeResize"),s("resize"))},l=()=>{!e||e.destroyed||!e.initialized||(n=new ResizeObserver(d=>{r=a.requestAnimationFrame(()=>{const{width:u,height:p}=e;let f=u,g=p;d.forEach(({contentBoxSize:_,contentRect:v,target:m})=>{m&&m!==e.el||(f=v?v.width:(_[0]||_).inlineSize,g=v?v.height:(_[0]||_).blockSize)}),(f!==u||g!==p)&&o()})}),n.observe(e.el))},i=()=>{r&&a.cancelAnimationFrame(r),n&&n.unobserve&&e.el&&(n.unobserve(e.el),n=null)},c=()=>{!e||e.destroyed||!e.initialized||s("orientationchange")};t("init",()=>{if(e.params.resizeObserver&&typeof a.ResizeObserver<"u"){l();return}a.addEventListener("resize",o),a.addEventListener("orientationchange",c)}),t("destroy",()=>{i(),a.removeEventListener("resize",o),a.removeEventListener("orientationchange",c)})}function ab({swiper:e,extendParams:t,on:s,emit:a}){const n=[],r=dt(),o=(c,d={})=>{const u=r.MutationObserver||r.WebkitMutationObserver,p=new u(f=>{if(e.__preventObserver__)return;if(f.length===1){a("observerUpdate",f[0]);return}const g=function(){a("observerUpdate",f[0])};r.requestAnimationFrame?r.requestAnimationFrame(g):r.setTimeout(g,0)});p.observe(c,{attributes:typeof d.attributes>"u"?!0:d.attributes,childList:e.isElement||(typeof d.childList>"u"?!0:d).childList,characterData:typeof d.characterData>"u"?!0:d.characterData}),n.push(p)},l=()=>{if(e.params.observer){if(e.params.observeParents){const c=Bu(e.hostEl);for(let d=0;d<c.length;d+=1)o(c[d])}o(e.hostEl,{childList:e.params.observeSlideChildren}),o(e.wrapperEl,{attributes:!1})}},i=()=>{n.forEach(c=>{c.disconnect()}),n.splice(0,n.length)};t({observer:!1,observeParents:!1,observeSlideChildren:!1}),s("init",l),s("destroy",i)}var nb={on(e,t,s){const a=this;if(!a.eventsListeners||a.destroyed||typeof t!="function")return a;const n=s?"unshift":"push";return e.split(" ").forEach(r=>{a.eventsListeners[r]||(a.eventsListeners[r]=[]),a.eventsListeners[r][n](t)}),a},once(e,t,s){const a=this;if(!a.eventsListeners||a.destroyed||typeof t!="function")return a;function n(...r){a.off(e,n),n.__emitterProxy&&delete n.__emitterProxy,t.apply(a,r)}return n.__emitterProxy=t,a.on(e,n,s)},onAny(e,t){const s=this;if(!s.eventsListeners||s.destroyed||typeof e!="function")return s;const a=t?"unshift":"push";return s.eventsAnyListeners.indexOf(e)<0&&s.eventsAnyListeners[a](e),s},offAny(e){const t=this;if(!t.eventsListeners||t.destroyed||!t.eventsAnyListeners)return t;const s=t.eventsAnyListeners.indexOf(e);return s>=0&&t.eventsAnyListeners.splice(s,1),t},off(e,t){const s=this;return!s.eventsListeners||s.destroyed||!s.eventsListeners||e.split(" ").forEach(a=>{typeof t>"u"?s.eventsListeners[a]=[]:s.eventsListeners[a]&&s.eventsListeners[a].forEach((n,r)=>{(n===t||n.__emitterProxy&&n.__emitterProxy===t)&&s.eventsListeners[a].splice(r,1)})}),s},emit(...e){const t=this;if(!t.eventsListeners||t.destroyed||!t.eventsListeners)return t;let s,a,n;return typeof e[0]=="string"||Array.isArray(e[0])?(s=e[0],a=e.slice(1,e.length),n=t):(s=e[0].events,a=e[0].data,n=e[0].context||t),a.unshift(n),(Array.isArray(s)?s:s.split(" ")).forEach(o=>{t.eventsAnyListeners&&t.eventsAnyListeners.length&&t.eventsAnyListeners.forEach(l=>{l.apply(n,[o,...a])}),t.eventsListeners&&t.eventsListeners[o]&&t.eventsListeners[o].forEach(l=>{l.apply(n,a)})}),t}};function rb(){const e=this;let t,s;const a=e.el;typeof e.params.width<"u"&&e.params.width!==null?t=e.params.width:t=a.clientWidth,typeof e.params.height<"u"&&e.params.height!==null?s=e.params.height:s=a.clientHeight,!(t===0&&e.isHorizontal()||s===0&&e.isVertical())&&(t=t-parseInt(gs(a,"padding-left")||0,10)-parseInt(gs(a,"padding-right")||0,10),s=s-parseInt(gs(a,"padding-top")||0,10)-parseInt(gs(a,"padding-bottom")||0,10),Number.isNaN(t)&&(t=0),Number.isNaN(s)&&(s=0),Object.assign(e,{width:t,height:s,size:e.isHorizontal()?t:s}))}function ob(){const e=this;function t(k,S){return parseFloat(k.getPropertyValue(e.getDirectionLabel(S))||0)}const s=e.params,{wrapperEl:a,slidesEl:n,rtlTranslate:r,wrongRTL:o}=e,l=e.virtual&&s.virtual.enabled,i=l?e.virtual.slides.length:e.slides.length,c=It(n,`.${e.params.slideClass}, swiper-slide`),d=l?e.virtual.slides.length:c.length;let u=[];const p=[],f=[];let g=s.slidesOffsetBefore;typeof g=="function"&&(g=s.slidesOffsetBefore.call(e));let _=s.slidesOffsetAfter;typeof _=="function"&&(_=s.slidesOffsetAfter.call(e));const v=e.snapGrid.length,m=e.slidesGrid.length,h=e.size-g-_;let b=s.spaceBetween,w=-g,y=0,x=0;if(typeof h>"u")return;typeof b=="string"&&b.indexOf("%")>=0?b=parseFloat(b.replace("%",""))/100*h:typeof b=="string"&&(b=parseFloat(b)),e.virtualSize=-b-g-_,c.forEach(k=>{r?k.style.marginLeft="":k.style.marginRight="",k.style.marginBottom="",k.style.marginTop=""}),s.centeredSlides&&s.cssMode&&(Us(a,"--swiper-centered-offset-before",""),Us(a,"--swiper-centered-offset-after","")),s.cssMode&&(Us(a,"--swiper-slides-offset-before",`${g}px`),Us(a,"--swiper-slides-offset-after",`${_}px`));const P=s.grid&&s.grid.rows>1&&e.grid;P?e.grid.initSlides(c):e.grid&&e.grid.unsetSlides();let D;const T=s.slidesPerView==="auto"&&s.breakpoints&&Object.keys(s.breakpoints).filter(k=>typeof s.breakpoints[k].slidesPerView<"u").length>0;for(let k=0;k<d;k+=1){D=0;const S=c[k];if(!(S&&(P&&e.grid.updateSlide(k,S,c),gs(S,"display")==="none"))){if(l&&s.slidesPerView==="auto")s.virtual.slidesPerViewAutoSlideSize&&(D=s.virtual.slidesPerViewAutoSlideSize),D&&S&&(s.roundLengths&&(D=Math.floor(D)),S.style[e.getDirectionLabel("width")]=`${D}px`);else if(s.slidesPerView==="auto"){T&&(S.style[e.getDirectionLabel("width")]="");const O=getComputedStyle(S),I=S.style.transform,q=S.style.webkitTransform;if(I&&(S.style.transform="none"),q&&(S.style.webkitTransform="none"),s.roundLengths)D=e.isHorizontal()?Ro(S,"width"):Ro(S,"height");else{const J=t(O,"width"),W=t(O,"padding-left"),Q=t(O,"padding-right"),V=t(O,"margin-left"),re=t(O,"margin-right"),Y=O.getPropertyValue("box-sizing");if(Y&&Y==="border-box")D=J+V+re;else{const{clientWidth:H,offsetWidth:X}=S;D=J+W+Q+V+re+(X-H)}}I&&(S.style.transform=I),q&&(S.style.webkitTransform=q),s.roundLengths&&(D=Math.floor(D))}else D=(h-(s.slidesPerView-1)*b)/s.slidesPerView,s.roundLengths&&(D=Math.floor(D)),S&&(S.style[e.getDirectionLabel("width")]=`${D}px`);S&&(S.swiperSlideSize=D),f.push(D),s.centeredSlides?(w=w+D/2+y/2+b,y===0&&k!==0&&(w=w-h/2-b),k===0&&(w=w-h/2-b),Math.abs(w)<1/1e3&&(w=0),s.roundLengths&&(w=Math.floor(w)),x%s.slidesPerGroup===0&&u.push(w),p.push(w)):(s.roundLengths&&(w=Math.floor(w)),(x-Math.min(e.params.slidesPerGroupSkip,x))%e.params.slidesPerGroup===0&&u.push(w),p.push(w),w=w+D+b),e.virtualSize+=D+b,y=D,x+=1}}if(e.virtualSize=Math.max(e.virtualSize,h)+_,r&&o&&(s.effect==="slide"||s.effect==="coverflow")&&(a.style.width=`${e.virtualSize+b}px`),s.setWrapperSize&&(a.style[e.getDirectionLabel("width")]=`${e.virtualSize+b}px`),P&&e.grid.updateWrapperSize(D,u),!s.centeredSlides){const k=s.slidesPerView!=="auto"&&s.slidesPerView%1!==0,S=s.snapToSlideEdge&&!s.loop&&(s.slidesPerView==="auto"||k);let O=u.length;if(S){let q;if(s.slidesPerView==="auto"){q=1;let J=0;for(let W=f.length-1;W>=0&&(J+=f[W]+(W<f.length-1?b:0),J<=h);W-=1)q=f.length-W}else q=Math.floor(s.slidesPerView);O=Math.max(d-q,0)}const I=[];for(let q=0;q<u.length;q+=1){let J=u[q];s.roundLengths&&(J=Math.floor(J)),S?q<=O&&I.push(J):u[q]<=e.virtualSize-h&&I.push(J)}u=I,Math.floor(e.virtualSize-h)-Math.floor(u[u.length-1])>1&&(S||u.push(e.virtualSize-h))}if(l&&s.loop){const k=f[0]+b;if(s.slidesPerGroup>1){const S=Math.ceil((e.virtual.slidesBefore+e.virtual.slidesAfter)/s.slidesPerGroup),O=k*s.slidesPerGroup;for(let I=0;I<S;I+=1)u.push(u[u.length-1]+O)}for(let S=0;S<e.virtual.slidesBefore+e.virtual.slidesAfter;S+=1)s.slidesPerGroup===1&&u.push(u[u.length-1]+k),p.push(p[p.length-1]+k),e.virtualSize+=k}if(u.length===0&&(u=[0]),b!==0){const k=e.isHorizontal()&&r?"marginLeft":e.getDirectionLabel("marginRight");c.filter((S,O)=>!s.cssMode||s.loop?!0:O!==c.length-1).forEach(S=>{S.style[k]=`${b}px`})}if(s.centeredSlides&&s.centeredSlidesBounds){let k=0;f.forEach(O=>{k+=O+(b||0)}),k-=b;const S=k>h?k-h:0;u=u.map(O=>O<=0?-g:O>S?S+_:O)}if(s.centerInsufficientSlides){let k=0;if(f.forEach(S=>{k+=S+(b||0)}),k-=b,k<h){const S=(h-k)/2;u.forEach((O,I)=>{u[I]=O-S}),p.forEach((O,I)=>{p[I]=O+S})}}if(Object.assign(e,{slides:c,snapGrid:u,slidesGrid:p,slidesSizesGrid:f}),s.centeredSlides&&s.cssMode&&!s.centeredSlidesBounds){Us(a,"--swiper-centered-offset-before",`${-u[0]}px`),Us(a,"--swiper-centered-offset-after",`${e.size/2-f[f.length-1]/2}px`);const k=-e.snapGrid[0],S=-e.slidesGrid[0];e.snapGrid=e.snapGrid.map(O=>O+k),e.slidesGrid=e.slidesGrid.map(O=>O+S)}if(d!==i&&e.emit("slidesLengthChange"),u.length!==v&&(e.params.watchOverflow&&e.checkOverflow(),e.emit("snapGridLengthChange")),p.length!==m&&e.emit("slidesGridLengthChange"),s.watchSlidesProgress&&e.updateSlidesOffset(),e.emit("slidesUpdated"),!l&&!s.cssMode&&(s.effect==="slide"||s.effect==="fade")){const k=`${s.containerModifierClass}backface-hidden`,S=e.el.classList.contains(k);d<=s.maxBackfaceHiddenSlides?S||e.el.classList.add(k):S&&e.el.classList.remove(k)}}function ib(e){const t=this,s=[],a=t.virtual&&t.params.virtual.enabled;let n=0,r;typeof e=="number"?t.setTransition(e):e===!0&&t.setTransition(t.params.speed);const o=l=>a?t.slides[t.getSlideIndexByData(l)]:t.slides[l];if(t.params.slidesPerView!=="auto"&&t.params.slidesPerView>1)if(t.params.centeredSlides)(t.visibleSlides||[]).forEach(l=>{s.push(l)});else for(r=0;r<Math.ceil(t.params.slidesPerView);r+=1){const l=t.activeIndex+r;if(l>t.slides.length&&!a)break;s.push(o(l))}else s.push(o(t.activeIndex));for(r=0;r<s.length;r+=1)if(typeof s[r]<"u"){const l=s[r].offsetHeight;n=l>n?l:n}(n||n===0)&&(t.wrapperEl.style.height=`${n}px`)}function lb(){const e=this,t=e.slides,s=e.isElement?e.isHorizontal()?e.wrapperEl.offsetLeft:e.wrapperEl.offsetTop:0;for(let a=0;a<t.length;a+=1)t[a].swiperSlideOffset=(e.isHorizontal()?t[a].offsetLeft:t[a].offsetTop)-s-e.cssOverflowAdjustment()}const Tl=(e,t,s)=>{t&&!e.classList.contains(s)?e.classList.add(s):!t&&e.classList.contains(s)&&e.classList.remove(s)};function cb(e=this&&this.translate||0){const t=this,s=t.params,{slides:a,rtlTranslate:n,snapGrid:r}=t;if(a.length===0)return;typeof a[0].swiperSlideOffset>"u"&&t.updateSlidesOffset();let o=-e;n&&(o=e),t.visibleSlidesIndexes=[],t.visibleSlides=[];let l=s.spaceBetween;typeof l=="string"&&l.indexOf("%")>=0?l=parseFloat(l.replace("%",""))/100*t.size:typeof l=="string"&&(l=parseFloat(l));for(let i=0;i<a.length;i+=1){const c=a[i];let d=c.swiperSlideOffset;s.cssMode&&s.centeredSlides&&(d-=a[0].swiperSlideOffset);const u=(o+(s.centeredSlides?t.minTranslate():0)-d)/(c.swiperSlideSize+l),p=(o-r[0]+(s.centeredSlides?t.minTranslate():0)-d)/(c.swiperSlideSize+l),f=-(o-d),g=f+t.slidesSizesGrid[i],_=f>=0&&f<=t.size-t.slidesSizesGrid[i],v=f>=0&&f<t.size-1||g>1&&g<=t.size||f<=0&&g>=t.size;v&&(t.visibleSlides.push(c),t.visibleSlidesIndexes.push(i)),Tl(c,v,s.slideVisibleClass),Tl(c,_,s.slideFullyVisibleClass),c.progress=n?-u:u,c.originalProgress=n?-p:p}}function db(e){const t=this;if(typeof e>"u"){const d=t.rtlTranslate?-1:1;e=t&&t.translate&&t.translate*d||0}const s=t.params,a=t.maxTranslate()-t.minTranslate();let{progress:n,isBeginning:r,isEnd:o,progressLoop:l}=t;const i=r,c=o;if(a===0)n=0,r=!0,o=!0;else{n=(e-t.minTranslate())/a;const d=Math.abs(e-t.minTranslate())<1,u=Math.abs(e-t.maxTranslate())<1;r=d||n<=0,o=u||n>=1,d&&(n=0),u&&(n=1)}if(s.loop){const d=t.getSlideIndexByData(0),u=t.getSlideIndexByData(t.slides.length-1),p=t.slidesGrid[d],f=t.slidesGrid[u],g=t.slidesGrid[t.slidesGrid.length-1],_=Math.abs(e);_>=p?l=(_-p)/g:l=(_+g-f)/g,l>1&&(l-=1)}Object.assign(t,{progress:n,progressLoop:l,isBeginning:r,isEnd:o}),(s.watchSlidesProgress||s.centeredSlides&&s.autoHeight)&&t.updateSlidesProgress(e),r&&!i&&t.emit("reachBeginning toEdge"),o&&!c&&t.emit("reachEnd toEdge"),(i&&!r||c&&!o)&&t.emit("fromEdge"),t.emit("progress",n)}const Qr=(e,t,s)=>{t&&!e.classList.contains(s)?e.classList.add(s):!t&&e.classList.contains(s)&&e.classList.remove(s)};function ub(){const e=this,{slides:t,params:s,slidesEl:a,activeIndex:n}=e,r=e.virtual&&s.virtual.enabled,o=e.grid&&s.grid&&s.grid.rows>1,l=u=>It(a,`.${s.slideClass}${u}, swiper-slide${u}`)[0];let i,c,d;if(r)if(s.loop){let u=n-e.virtual.slidesBefore;u<0&&(u=e.virtual.slides.length+u),u>=e.virtual.slides.length&&(u-=e.virtual.slides.length),i=l(`[data-swiper-slide-index="${u}"]`)}else i=l(`[data-swiper-slide-index="${n}"]`);else o?(i=t.find(u=>u.column===n),d=t.find(u=>u.column===n+1),c=t.find(u=>u.column===n-1)):i=t[n];i&&(o||(d=Qg(i,`.${s.slideClass}, swiper-slide`)[0],s.loop&&!d&&(d=t[0]),c=Xg(i,`.${s.slideClass}, swiper-slide`)[0],s.loop&&!c===0&&(c=t[t.length-1]))),t.forEach(u=>{Qr(u,u===i,s.slideActiveClass),Qr(u,u===d,s.slideNextClass),Qr(u,u===c,s.slidePrevClass)}),e.emitSlidesClasses()}const Bn=(e,t)=>{if(!e||e.destroyed||!e.params)return;const s=()=>e.isElement?"swiper-slide":`.${e.params.slideClass}`,a=t.closest(s());if(a){let n=a.querySelector(`.${e.params.lazyPreloaderClass}`);!n&&e.isElement&&(a.shadowRoot?n=a.shadowRoot.querySelector(`.${e.params.lazyPreloaderClass}`):requestAnimationFrame(()=>{a.shadowRoot&&(n=a.shadowRoot.querySelector(`.${e.params.lazyPreloaderClass}`),n&&!n.lazyPreloaderManaged&&n.remove())})),n&&!n.lazyPreloaderManaged&&n.remove()}},Zr=(e,t)=>{if(!e.slides[t])return;const s=e.slides[t].querySelector('[loading="lazy"]');s&&s.removeAttribute("loading")},Do=e=>{if(!e||e.destroyed||!e.params)return;let t=e.params.lazyPreloadPrevNext;const s=e.slides.length;if(!s||!t||t<0)return;t=Math.min(t,s);const a=e.params.slidesPerView==="auto"?e.slidesPerViewDynamic():Math.ceil(e.params.slidesPerView),n=e.activeIndex;if(e.params.grid&&e.params.grid.rows>1){const o=n,l=[o-t];l.push(...Array.from({length:t}).map((i,c)=>o+a+c)),e.slides.forEach((i,c)=>{l.includes(i.column)&&Zr(e,c)});return}const r=n+a-1;if(e.params.rewind||e.params.loop)for(let o=n-t;o<=r+t;o+=1){const l=(o%s+s)%s;(l<n||l>r)&&Zr(e,l)}else for(let o=Math.max(n-t,0);o<=Math.min(r+t,s-1);o+=1)o!==n&&(o>r||o<n)&&Zr(e,o)};function pb(e){const{slidesGrid:t,params:s}=e,a=e.rtlTranslate?e.translate:-e.translate;let n;for(let r=0;r<t.length;r+=1)typeof t[r+1]<"u"?a>=t[r]&&a<t[r+1]-(t[r+1]-t[r])/2?n=r:a>=t[r]&&a<t[r+1]&&(n=r+1):a>=t[r]&&(n=r);return s.normalizeSlideIndex&&(n<0||typeof n>"u")&&(n=0),n}function fb(e){const t=this,s=t.rtlTranslate?t.translate:-t.translate,{snapGrid:a,params:n,activeIndex:r,realIndex:o,snapIndex:l}=t;let i=e,c;const d=f=>{let g=f-t.virtual.slidesBefore;return g<0&&(g=t.virtual.slides.length+g),g>=t.virtual.slides.length&&(g-=t.virtual.slides.length),g};if(typeof i>"u"&&(i=pb(t)),a.indexOf(s)>=0)c=a.indexOf(s);else{const f=Math.min(n.slidesPerGroupSkip,i);c=f+Math.floor((i-f)/n.slidesPerGroup)}if(c>=a.length&&(c=a.length-1),i===r&&!t.params.loop){c!==l&&(t.snapIndex=c,t.emit("snapIndexChange"));return}if(i===r&&t.params.loop&&t.virtual&&t.params.virtual.enabled){t.realIndex=d(i);return}const u=t.grid&&n.grid&&n.grid.rows>1;let p;if(t.virtual&&n.virtual.enabled)n.loop?p=d(i):p=i;else if(u){const f=t.slides.find(_=>_.column===i);let g=parseInt(f.getAttribute("data-swiper-slide-index"),10);Number.isNaN(g)&&(g=Math.max(t.slides.indexOf(f),0)),p=Math.floor(g/n.grid.rows)}else if(t.slides[i]){const f=t.slides[i].getAttribute("data-swiper-slide-index");f?p=parseInt(f,10):p=i}else p=i;Object.assign(t,{previousSnapIndex:l,snapIndex:c,previousRealIndex:o,realIndex:p,previousIndex:r,activeIndex:i}),t.initialized&&Do(t),t.emit("activeIndexChange"),t.emit("snapIndexChange"),(t.initialized||t.params.runCallbacksOnInit)&&(o!==p&&t.emit("realIndexChange"),t.emit("slideChange"))}function hb(e,t){const s=this,a=s.params;let n=e.closest(`.${a.slideClass}, swiper-slide`);!n&&s.isElement&&t&&t.length>1&&t.includes(e)&&[...t.slice(t.indexOf(e)+1,t.length)].forEach(l=>{!n&&l.matches&&l.matches(`.${a.slideClass}, swiper-slide`)&&(n=l)});let r=!1,o;if(n){for(let l=0;l<s.slides.length;l+=1)if(s.slides[l]===n){r=!0,o=l;break}}if(n&&r)s.clickedSlide=n,s.virtual&&s.params.virtual.enabled?s.clickedIndex=parseInt(n.getAttribute("data-swiper-slide-index"),10):s.clickedIndex=o;else{s.clickedSlide=void 0,s.clickedIndex=void 0;return}a.slideToClickedSlide&&s.clickedIndex!==void 0&&s.clickedIndex!==s.activeIndex&&s.slideToClickedSlide()}var mb={updateSize:rb,updateSlides:ob,updateAutoHeight:ib,updateSlidesOffset:lb,updateSlidesProgress:cb,updateProgress:db,updateSlidesClasses:ub,updateActiveIndex:fb,updateClickedSlide:hb};function gb(e=this.isHorizontal()?"x":"y"){const t=this,{params:s,rtlTranslate:a,translate:n,wrapperEl:r}=t;if(s.virtualTranslate)return a?-n:n;if(s.cssMode)return n;let o=Kg(r,e);return o+=t.cssOverflowAdjustment(),a&&(o=-o),o||0}function bb(e,t){const s=this,{rtlTranslate:a,params:n,wrapperEl:r,progress:o}=s;let l=0,i=0;const c=0;s.isHorizontal()?l=a?-e:e:i=e,n.roundLengths&&(l=Math.floor(l),i=Math.floor(i)),s.previousTranslate=s.translate,s.translate=s.isHorizontal()?l:i,n.cssMode?r[s.isHorizontal()?"scrollLeft":"scrollTop"]=s.isHorizontal()?-l:-i:n.virtualTranslate||(s.isHorizontal()?l-=s.cssOverflowAdjustment():i-=s.cssOverflowAdjustment(),r.style.transform=`translate3d(${l}px, ${i}px, ${c}px)`);let d;const u=s.maxTranslate()-s.minTranslate();u===0?d=0:d=(e-s.minTranslate())/u,d!==o&&s.updateProgress(e),s.emit("setTranslate",s.translate,t)}function _b(){return-this.snapGrid[0]}function vb(){return-this.snapGrid[this.snapGrid.length-1]}function yb(e=0,t=this.params.speed,s=!0,a=!0,n){const r=this,{params:o,wrapperEl:l}=r;if(r.animating&&o.preventInteractionOnTransition)return!1;const i=r.minTranslate(),c=r.maxTranslate();let d;if(a&&e>i?d=i:a&&e<c?d=c:d=e,r.updateProgress(d),o.cssMode){const u=r.isHorizontal();if(t===0)l[u?"scrollLeft":"scrollTop"]=-d;else{if(!r.support.smoothScroll)return Iu({swiper:r,targetPosition:-d,side:u?"left":"top"}),!0;l.scrollTo({[u?"left":"top"]:-d,behavior:"smooth"})}return!0}return t===0?(r.setTransition(0),r.setTranslate(d),s&&(r.emit("beforeTransitionStart",t,n),r.emit("transitionEnd"))):(r.setTransition(t),r.setTranslate(d),s&&(r.emit("beforeTransitionStart",t,n),r.emit("transitionStart")),r.animating||(r.animating=!0,r.onTranslateToWrapperTransitionEnd||(r.onTranslateToWrapperTransitionEnd=function(p){!r||r.destroyed||p.target===this&&(r.wrapperEl.removeEventListener("transitionend",r.onTranslateToWrapperTransitionEnd),r.onTranslateToWrapperTransitionEnd=null,delete r.onTranslateToWrapperTransitionEnd,r.animating=!1,s&&r.emit("transitionEnd"))}),r.wrapperEl.addEventListener("transitionend",r.onTranslateToWrapperTransitionEnd))),!0}var wb={getTranslate:gb,setTranslate:bb,minTranslate:_b,maxTranslate:vb,translateTo:yb};function xb(e,t){const s=this;s.params.cssMode||(s.wrapperEl.style.transitionDuration=`${e}ms`,s.wrapperEl.style.transitionDelay=e===0?"0ms":""),s.emit("setTransition",e,t)}function ju({swiper:e,runCallbacks:t,direction:s,step:a}){const{activeIndex:n,previousIndex:r}=e;let o=s;o||(n>r?o="next":n<r?o="prev":o="reset"),e.emit(`transition${a}`),t&&o==="reset"?e.emit(`slideResetTransition${a}`):t&&n!==r&&(e.emit(`slideChangeTransition${a}`),o==="next"?e.emit(`slideNextTransition${a}`):e.emit(`slidePrevTransition${a}`))}function Tb(e=!0,t){const s=this,{params:a}=s;a.cssMode||(a.autoHeight&&s.updateAutoHeight(),ju({swiper:s,runCallbacks:e,direction:t,step:"Start"}))}function Sb(e=!0,t){const s=this,{params:a}=s;s.animating=!1,!a.cssMode&&(s.setTransition(0),ju({swiper:s,runCallbacks:e,direction:t,step:"End"}))}var Eb={setTransition:xb,transitionStart:Tb,transitionEnd:Sb};function kb(e=0,t,s=!0,a,n){typeof e=="string"&&(e=parseInt(e,10));const r=this;let o=e;o<0&&(o=0);const{params:l,snapGrid:i,slidesGrid:c,previousIndex:d,activeIndex:u,rtlTranslate:p,wrapperEl:f,enabled:g}=r;if(!g&&!a&&!n||r.destroyed||r.animating&&l.preventInteractionOnTransition)return!1;typeof t>"u"&&(t=r.params.speed);const _=Math.min(r.params.slidesPerGroupSkip,o);let v=_+Math.floor((o-_)/r.params.slidesPerGroup);v>=i.length&&(v=i.length-1);const m=-i[v];if(l.normalizeSlideIndex)for(let P=0;P<c.length;P+=1){const D=-Math.floor(m*100),T=Math.floor(c[P]*100),k=Math.floor(c[P+1]*100);typeof c[P+1]<"u"?D>=T&&D<k-(k-T)/2?o=P:D>=T&&D<k&&(o=P+1):D>=T&&(o=P)}if(r.initialized&&o!==u&&(!r.allowSlideNext&&(p?m>r.translate&&m>r.minTranslate():m<r.translate&&m<r.minTranslate())||!r.allowSlidePrev&&m>r.translate&&m>r.maxTranslate()&&(u||0)!==o))return!1;o!==(d||0)&&s&&r.emit("beforeSlideChangeStart"),r.updateProgress(m);let h;o>u?h="next":o<u?h="prev":h="reset";const b=r.virtual&&r.params.virtual.enabled;if(!(b&&n)&&(p&&-m===r.translate||!p&&m===r.translate))return r.updateActiveIndex(o),l.autoHeight&&r.updateAutoHeight(),r.updateSlidesClasses(),l.effect!=="slide"&&r.setTranslate(m),h!=="reset"&&(r.transitionStart(s,h),r.transitionEnd(s,h)),!1;if(l.cssMode){const P=r.isHorizontal(),D=p?m:-m;if(t===0)b&&(r.wrapperEl.style.scrollSnapType="none",r._immediateVirtual=!0),b&&!r._cssModeVirtualInitialSet&&r.params.initialSlide>0?(r._cssModeVirtualInitialSet=!0,requestAnimationFrame(()=>{f[P?"scrollLeft":"scrollTop"]=D})):f[P?"scrollLeft":"scrollTop"]=D,b&&requestAnimationFrame(()=>{r.wrapperEl.style.scrollSnapType="",r._immediateVirtual=!1});else{if(!r.support.smoothScroll)return Iu({swiper:r,targetPosition:D,side:P?"left":"top"}),!0;f.scrollTo({[P?"left":"top"]:D,behavior:"smooth"})}return!0}const x=Hu().isSafari;return b&&!n&&x&&r.isElement&&r.virtual.update(!1,!1,o),r.setTransition(t),r.setTranslate(m),r.updateActiveIndex(o),r.updateSlidesClasses(),r.emit("beforeTransitionStart",t,a),r.transitionStart(s,h),t===0?r.transitionEnd(s,h):r.animating||(r.animating=!0,r.onSlideToWrapperTransitionEnd||(r.onSlideToWrapperTransitionEnd=function(D){!r||r.destroyed||D.target===this&&(r.wrapperEl.removeEventListener("transitionend",r.onSlideToWrapperTransitionEnd),r.onSlideToWrapperTransitionEnd=null,delete r.onSlideToWrapperTransitionEnd,r.transitionEnd(s,h))}),r.wrapperEl.addEventListener("transitionend",r.onSlideToWrapperTransitionEnd)),!0}function Pb(e=0,t,s=!0,a){typeof e=="string"&&(e=parseInt(e,10));const n=this;if(n.destroyed)return;typeof t>"u"&&(t=n.params.speed);const r=n.grid&&n.params.grid&&n.params.grid.rows>1;let o=e;if(n.params.loop)if(n.virtual&&n.params.virtual.enabled)o=o+n.virtual.slidesBefore;else{let l;if(r){const _=o*n.params.grid.rows;l=n.slides.find(v=>v.getAttribute("data-swiper-slide-index")*1===_).column}else l=n.getSlideIndexByData(o);const i=r?Math.ceil(n.slides.length/n.params.grid.rows):n.slides.length,{centeredSlides:c,slidesOffsetBefore:d,slidesOffsetAfter:u}=n.params,p=c||!!d||!!u;let f=n.params.slidesPerView;f==="auto"?f=n.slidesPerViewDynamic():(f=Math.ceil(parseFloat(n.params.slidesPerView,10)),p&&f%2===0&&(f=f+1));let g=i-l<f;if(p&&(g=g||l<Math.ceil(f/2)),a&&p&&n.params.slidesPerView!=="auto"&&!r&&(g=!1),g){const _=p?l<n.activeIndex?"prev":"next":l-n.activeIndex-1<n.params.slidesPerView?"next":"prev";n.loopFix({direction:_,slideTo:!0,activeSlideIndex:_==="next"?l+1:l-i+1,slideRealIndex:_==="next"?n.realIndex:void 0})}if(r){const _=o*n.params.grid.rows;o=n.slides.find(v=>v.getAttribute("data-swiper-slide-index")*1===_).column}else o=n.getSlideIndexByData(o)}return requestAnimationFrame(()=>{n.slideTo(o,t,s,a)}),n}function Ab(e,t=!0,s){const a=this,{enabled:n,params:r,animating:o}=a;if(!n||a.destroyed)return a;typeof e>"u"&&(e=a.params.speed);let l=r.slidesPerGroup;r.slidesPerView==="auto"&&r.slidesPerGroup===1&&r.slidesPerGroupAuto&&(l=Math.max(a.slidesPerViewDynamic("current",!0),1));const i=a.activeIndex<r.slidesPerGroupSkip?1:l,c=a.virtual&&r.virtual.enabled;if(r.loop){if(o&&!c&&r.loopPreventsSliding)return!1;if(a.loopFix({direction:"next"}),a._clientLeft=a.wrapperEl.clientLeft,a.activeIndex===a.slides.length-1&&r.cssMode)return requestAnimationFrame(()=>{a.slideTo(a.activeIndex+i,e,t,s)}),!0}return r.rewind&&a.isEnd?a.slideTo(0,e,t,s):a.slideTo(a.activeIndex+i,e,t,s)}function Cb(e,t=!0,s){const a=this,{params:n,snapGrid:r,slidesGrid:o,rtlTranslate:l,enabled:i,animating:c}=a;if(!i||a.destroyed)return a;typeof e>"u"&&(e=a.params.speed);const d=a.virtual&&n.virtual.enabled;if(n.loop){if(c&&!d&&n.loopPreventsSliding)return!1;a.loopFix({direction:"prev"}),a._clientLeft=a.wrapperEl.clientLeft}const u=l?a.translate:-a.translate;function p(h){return h<0?-Math.floor(Math.abs(h)):Math.floor(h)}const f=p(u),g=r.map(h=>p(h)),_=n.freeMode&&n.freeMode.enabled;let v=r[g.indexOf(f)-1];if(typeof v>"u"&&(n.cssMode||_)){let h;r.forEach((b,w)=>{f>=b&&(h=w)}),typeof h<"u"&&(v=_?r[h]:r[h>0?h-1:h])}let m=0;if(typeof v<"u"&&(m=o.indexOf(v),m<0&&(m=a.activeIndex-1),n.slidesPerView==="auto"&&n.slidesPerGroup===1&&n.slidesPerGroupAuto&&(m=m-a.slidesPerViewDynamic("previous",!0)+1,m=Math.max(m,0))),n.rewind&&a.isBeginning){const h=a.params.virtual&&a.params.virtual.enabled&&a.virtual?a.virtual.slides.length-1:a.slides.length-1;return a.slideTo(h,e,t,s)}else if(n.loop&&a.activeIndex===0&&n.cssMode)return requestAnimationFrame(()=>{a.slideTo(m,e,t,s)}),!0;return a.slideTo(m,e,t,s)}function Ob(e,t=!0,s){const a=this;if(!a.destroyed)return typeof e>"u"&&(e=a.params.speed),a.slideTo(a.activeIndex,e,t,s)}function $b(e,t=!0,s,a=.5){const n=this;if(n.destroyed)return;typeof e>"u"&&(e=n.params.speed);let r=n.activeIndex;const o=Math.min(n.params.slidesPerGroupSkip,r),l=o+Math.floor((r-o)/n.params.slidesPerGroup),i=n.rtlTranslate?n.translate:-n.translate;if(i>=n.snapGrid[l]){const c=n.snapGrid[l],d=n.snapGrid[l+1];i-c>(d-c)*a&&(r+=n.params.slidesPerGroup)}else{const c=n.snapGrid[l-1],d=n.snapGrid[l];i-c<=(d-c)*a&&(r-=n.params.slidesPerGroup)}return r=Math.max(r,0),r=Math.min(r,n.slidesGrid.length-1),n.slideTo(r,e,t,s)}function Mb(){const e=this;if(e.destroyed)return;const{params:t,slidesEl:s}=e,a=t.slidesPerView==="auto"?e.slidesPerViewDynamic():t.slidesPerView;let n=e.getSlideIndexWhenGrid(e.clickedIndex),r;const o=e.isElement?"swiper-slide":`.${t.slideClass}`,l=e.grid&&e.params.grid&&e.params.grid.rows>1;if(t.loop){if(e.animating)return;r=parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"),10),t.centeredSlides?e.slideToLoop(r):n>(l?(e.slides.length-a)/2-(e.params.grid.rows-1):e.slides.length-a)?(e.loopFix(),n=e.getSlideIndex(It(s,`${o}[data-swiper-slide-index="${r}"]`)[0]),Nu(()=>{e.slideTo(n)})):e.slideTo(n)}else e.slideTo(n)}var Lb={slideTo:kb,slideToLoop:Pb,slideNext:Ab,slidePrev:Cb,slideReset:Ob,slideToClosest:$b,slideToClickedSlide:Mb};function Rb(e,t){const s=this,{params:a,slidesEl:n}=s;if(!a.loop||s.virtual&&s.params.virtual.enabled)return;const r=()=>{It(n,`.${a.slideClass}, swiper-slide`).forEach((g,_)=>{g.setAttribute("data-swiper-slide-index",_)})},o=()=>{const f=It(n,`.${a.slideBlankClass}`);f.forEach(g=>{g.remove()}),f.length>0&&(s.recalcSlides(),s.updateSlides())},l=s.grid&&a.grid&&a.grid.rows>1;a.loopAddBlankSlides&&(a.slidesPerGroup>1||l)&&o();const i=a.slidesPerGroup*(l?a.grid.rows:1),c=s.slides.length%i!==0,d=l&&s.slides.length%a.grid.rows!==0,u=f=>{for(let g=0;g<f;g+=1){const _=s.isElement?tr("swiper-slide",[a.slideBlankClass]):tr("div",[a.slideClass,a.slideBlankClass]);s.slidesEl.append(_)}};if(c){if(a.loopAddBlankSlides){const f=i-s.slides.length%i;u(f),s.recalcSlides(),s.updateSlides()}else er("Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)");r()}else if(d){if(a.loopAddBlankSlides){const f=a.grid.rows-s.slides.length%a.grid.rows;u(f),s.recalcSlides(),s.updateSlides()}else er("Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)");r()}else r();const p=a.centeredSlides||!!a.slidesOffsetBefore||!!a.slidesOffsetAfter;s.loopFix({slideRealIndex:e,direction:p?void 0:"next",initial:t})}function Db({slideRealIndex:e,slideTo:t=!0,direction:s,setTranslate:a,activeSlideIndex:n,initial:r,byController:o,byMousewheel:l}={}){const i=this;if(!i.params.loop)return;i.emit("beforeLoopFix");const{slides:c,allowSlidePrev:d,allowSlideNext:u,slidesEl:p,params:f}=i,{centeredSlides:g,slidesOffsetBefore:_,slidesOffsetAfter:v,initialSlide:m}=f,h=g||!!_||!!v;if(i.allowSlidePrev=!0,i.allowSlideNext=!0,i.virtual&&f.virtual.enabled){t&&(!h&&i.snapIndex===0?i.slideTo(i.virtual.slides.length,0,!1,!0):h&&i.snapIndex<f.slidesPerView?i.slideTo(i.virtual.slides.length+i.snapIndex,0,!1,!0):i.snapIndex===i.snapGrid.length-1&&i.slideTo(i.virtual.slidesBefore,0,!1,!0)),i.allowSlidePrev=d,i.allowSlideNext=u,i.emit("loopFix");return}let b=f.slidesPerView;b==="auto"?b=i.slidesPerViewDynamic():(b=Math.ceil(parseFloat(f.slidesPerView,10)),h&&b%2===0&&(b=b+1));const w=f.slidesPerGroupAuto?b:f.slidesPerGroup;let y=h?Math.max(w,Math.ceil(b/2)):w;y%w!==0&&(y+=w-y%w),y+=f.loopAdditionalSlides,i.loopedSlides=y;const x=i.grid&&f.grid&&f.grid.rows>1;c.length<b+y||i.params.effect==="cards"&&c.length<b+y*2?er("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters"):x&&f.grid.fill==="row"&&er("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");const P=[],D=[],T=x?Math.ceil(c.length/f.grid.rows):c.length,k=r&&T-m<b&&!h;let S=k?m:i.activeIndex;typeof n>"u"?n=i.getSlideIndex(c.find(V=>V.classList.contains(f.slideActiveClass))):S=n;const O=s==="next"||!s,I=s==="prev"||!s;let q=0,J=0;const Q=(x?c[n].column:n)+(h&&typeof a>"u"?-b/2+.5:0);if(Q<y){q=Math.max(y-Q,w);for(let V=0;V<y-Q;V+=1){const re=V-Math.floor(V/T)*T;if(x){const Y=T-re-1;for(let H=c.length-1;H>=0;H-=1)c[H].column===Y&&P.push(H)}else P.push(T-re-1)}}else if(Q+b>T-y){J=Math.max(Q-(T-y*2),w),k&&(J=Math.max(J,b-T+m+1));for(let V=0;V<J;V+=1){const re=V-Math.floor(V/T)*T;x?c.forEach((Y,H)=>{Y.column===re&&D.push(H)}):D.push(re)}}if(i.__preventObserver__=!0,requestAnimationFrame(()=>{i.__preventObserver__=!1}),i.params.effect==="cards"&&c.length<b+y*2&&(D.includes(n)&&D.splice(D.indexOf(n),1),P.includes(n)&&P.splice(P.indexOf(n),1)),I&&P.forEach(V=>{c[V].swiperLoopMoveDOM=!0,p.prepend(c[V]),c[V].swiperLoopMoveDOM=!1}),O&&D.forEach(V=>{c[V].swiperLoopMoveDOM=!0,p.append(c[V]),c[V].swiperLoopMoveDOM=!1}),i.recalcSlides(),f.slidesPerView==="auto"?i.updateSlides():x&&(P.length>0&&I||D.length>0&&O)&&i.slides.forEach((V,re)=>{i.grid.updateSlide(re,V,i.slides)}),f.watchSlidesProgress&&i.updateSlidesOffset(),t){if(P.length>0&&I){if(typeof e>"u"){const V=i.slidesGrid[S],Y=i.slidesGrid[S+q]-V;l?i.setTranslate(i.translate-Y):(i.slideTo(S+Math.ceil(q),0,!1,!0),a&&(i.touchEventsData.startTranslate=i.touchEventsData.startTranslate-Y,i.touchEventsData.currentTranslate=i.touchEventsData.currentTranslate-Y))}else if(a){const V=x?P.length/f.grid.rows:P.length;i.slideTo(i.activeIndex+V,0,!1,!0),i.touchEventsData.currentTranslate=i.translate}}else if(D.length>0&&O)if(typeof e>"u"){const V=i.slidesGrid[S],Y=i.slidesGrid[S-J]-V;l?i.setTranslate(i.translate-Y):(i.slideTo(S-J,0,!1,!0),a&&(i.touchEventsData.startTranslate=i.touchEventsData.startTranslate-Y,i.touchEventsData.currentTranslate=i.touchEventsData.currentTranslate-Y))}else{const V=x?D.length/f.grid.rows:D.length;i.slideTo(i.activeIndex-V,0,!1,!0)}}if(i.allowSlidePrev=d,i.allowSlideNext=u,i.controller&&i.controller.control&&!o){const V={slideRealIndex:e,direction:s,setTranslate:a,activeSlideIndex:n,byController:!0};Array.isArray(i.controller.control)?i.controller.control.forEach(re=>{!re.destroyed&&re.params.loop&&re.loopFix({...V,slideTo:re.params.slidesPerView===f.slidesPerView?t:!1})}):i.controller.control instanceof i.constructor&&i.controller.control.params.loop&&i.controller.control.loopFix({...V,slideTo:i.controller.control.params.slidesPerView===f.slidesPerView?t:!1})}i.emit("loopFix")}function Nb(){const e=this,{params:t,slidesEl:s}=e;if(!t.loop||!s||e.virtual&&e.params.virtual.enabled)return;e.recalcSlides();const a=[];e.slides.forEach(n=>{const r=typeof n.swiperSlideIndex>"u"?n.getAttribute("data-swiper-slide-index")*1:n.swiperSlideIndex;a[r]=n}),e.slides.forEach(n=>{n.removeAttribute("data-swiper-slide-index")}),a.forEach(n=>{s.append(n)}),e.recalcSlides(),e.slideTo(e.realIndex,0)}var Ib={loopCreate:Rb,loopFix:Db,loopDestroy:Nb};function Bb(e){const t=this;if(!t.params.simulateTouch||t.params.watchOverflow&&t.isLocked||t.params.cssMode)return;const s=t.params.touchEventsTarget==="container"?t.el:t.wrapperEl;t.isElement&&(t.__preventObserver__=!0),s.style.cursor="move",s.style.cursor=e?"grabbing":"grab",t.isElement&&requestAnimationFrame(()=>{t.__preventObserver__=!1})}function Fb(){const e=this;e.params.watchOverflow&&e.isLocked||e.params.cssMode||(e.isElement&&(e.__preventObserver__=!0),e[e.params.touchEventsTarget==="container"?"el":"wrapperEl"].style.cursor="",e.isElement&&requestAnimationFrame(()=>{e.__preventObserver__=!1}))}var zb={setGrabCursor:Bb,unsetGrabCursor:Fb};function Hb(e,t=this){function s(a){if(!a||a===Ft()||a===dt())return null;a.assignedSlot&&(a=a.assignedSlot);const n=a.closest(e);return!n&&!a.getRootNode?null:n||s(a.getRootNode().host)}return s(t)}function Sl(e,t,s){const a=dt(),{params:n}=e,r=n.edgeSwipeDetection,o=n.edgeSwipeThreshold;return r&&(s<=o||s>=a.innerWidth-o)?r==="prevent"?(t.preventDefault(),!0):!1:!0}function jb(e){const t=this,s=Ft();let a=e;a.originalEvent&&(a=a.originalEvent);const n=t.touchEventsData;if(a.type==="pointerdown"){if(n.pointerId!==null&&n.pointerId!==a.pointerId)return;n.pointerId=a.pointerId}else a.type==="touchstart"&&a.targetTouches.length===1&&(n.touchId=a.targetTouches[0].identifier);if(a.type==="touchstart"){Sl(t,a,a.targetTouches[0].pageX);return}const{params:r,touches:o,enabled:l}=t;if(!l||!r.simulateTouch&&a.pointerType==="mouse"||t.animating&&r.preventInteractionOnTransition)return;!t.animating&&r.cssMode&&r.loop&&t.loopFix();let i=a.target;if(r.touchEventsTarget==="wrapper"&&!Jg(i,t.wrapperEl)||"which"in a&&a.which===3||"button"in a&&a.button>0||n.isTouched&&n.isMoved)return;const c=!!r.noSwipingClass&&r.noSwipingClass!=="",d=a.composedPath?a.composedPath():a.path;c&&a.target&&a.target.shadowRoot&&d&&(i=d[0]);const u=r.noSwipingSelector?r.noSwipingSelector:`.${r.noSwipingClass}`,p=!!(a.target&&a.target.shadowRoot);if(r.noSwiping&&(p?Hb(u,i):i.closest(u))){t.allowClick=!0;return}if(r.swipeHandler&&!i.closest(r.swipeHandler))return;o.currentX=a.pageX,o.currentY=a.pageY;const f=o.currentX,g=o.currentY;if(!Sl(t,a,f))return;Object.assign(n,{isTouched:!0,isMoved:!1,allowTouchCallbacks:!0,isScrolling:void 0,startMoving:void 0}),o.startX=f,o.startY=g,n.touchStartTime=Zn(),t.allowClick=!0,t.updateSize(),t.swipeDirection=void 0,r.threshold>0&&(n.allowThresholdMove=!1);let _=!0;i.matches(n.focusableElements)&&(_=!1,i.nodeName==="SELECT"&&(n.isTouched=!1)),s.activeElement&&s.activeElement.matches(n.focusableElements)&&s.activeElement!==i&&(a.pointerType==="mouse"||a.pointerType!=="mouse"&&!i.matches(n.focusableElements))&&s.activeElement.blur();const v=_&&t.allowTouchMove&&r.touchStartPreventDefault;(r.touchStartForcePreventDefault||v)&&!i.isContentEditable&&a.preventDefault(),r.freeMode&&r.freeMode.enabled&&t.freeMode&&t.animating&&!r.cssMode&&t.freeMode.onTouchStart(),t.emit("touchStart",a)}function Ub(e){const t=Ft(),s=this,a=s.touchEventsData,{params:n,touches:r,rtlTranslate:o,enabled:l}=s;if(!l||!n.simulateTouch&&e.pointerType==="mouse")return;let i=e;if(i.originalEvent&&(i=i.originalEvent),i.type==="pointermove"&&(a.touchId!==null||i.pointerId!==a.pointerId))return;let c;if(i.type==="touchmove"){if(c=[...i.changedTouches].find(y=>y.identifier===a.touchId),!c||c.identifier!==a.touchId)return}else c=i;if(!a.isTouched){a.startMoving&&a.isScrolling&&s.emit("touchMoveOpposite",i);return}const d=c.pageX,u=c.pageY;if(i.preventedByNestedSwiper){r.startX=d,r.startY=u;return}if(!s.allowTouchMove){i.target.matches(a.focusableElements)||(s.allowClick=!1),a.isTouched&&(Object.assign(r,{startX:d,startY:u,currentX:d,currentY:u}),a.touchStartTime=Zn());return}if(n.touchReleaseOnEdges&&!n.loop)if(s.isVertical()){if(u<r.startY&&s.translate<=s.maxTranslate()||u>r.startY&&s.translate>=s.minTranslate()){a.isTouched=!1,a.isMoved=!1;return}}else{if(o&&(d>r.startX&&-s.translate<=s.maxTranslate()||d<r.startX&&-s.translate>=s.minTranslate()))return;if(!o&&(d<r.startX&&s.translate<=s.maxTranslate()||d>r.startX&&s.translate>=s.minTranslate()))return}if(t.activeElement&&t.activeElement.matches(a.focusableElements)&&t.activeElement!==i.target&&i.pointerType!=="mouse"&&t.activeElement.blur(),t.activeElement&&i.target===t.activeElement&&i.target.matches(a.focusableElements)){a.isMoved=!0,s.allowClick=!1;return}a.allowTouchCallbacks&&s.emit("touchMove",i),r.previousX=r.currentX,r.previousY=r.currentY,r.currentX=d,r.currentY=u;const p=r.currentX-r.startX,f=r.currentY-r.startY;if(s.params.threshold&&Math.sqrt(p**2+f**2)<s.params.threshold)return;if(typeof a.isScrolling>"u"){let y;s.isHorizontal()&&r.currentY===r.startY||s.isVertical()&&r.currentX===r.startX?a.isScrolling=!1:p*p+f*f>=25&&(y=Math.atan2(Math.abs(f),Math.abs(p))*180/Math.PI,a.isScrolling=s.isHorizontal()?y>n.touchAngle:90-y>n.touchAngle)}if(a.isScrolling&&s.emit("touchMoveOpposite",i),typeof a.startMoving>"u"&&(r.currentX!==r.startX||r.currentY!==r.startY)&&(a.startMoving=!0),a.isScrolling||i.type==="touchmove"&&a.preventTouchMoveFromPointerMove){a.isTouched=!1;return}if(!a.startMoving)return;s.allowClick=!1,!n.cssMode&&i.cancelable&&i.preventDefault(),n.touchMoveStopPropagation&&!n.nested&&i.stopPropagation();let g=s.isHorizontal()?p:f,_=s.isHorizontal()?r.currentX-r.previousX:r.currentY-r.previousY;n.oneWayMovement&&(g=Math.abs(g)*(o?1:-1),_=Math.abs(_)*(o?1:-1)),r.diff=g,g*=n.touchRatio,o&&(g=-g,_=-_);const v=s.touchesDirection;s.swipeDirection=g>0?"prev":"next",s.touchesDirection=_>0?"prev":"next";const m=s.params.loop&&!n.cssMode,h=s.touchesDirection==="next"&&s.allowSlideNext||s.touchesDirection==="prev"&&s.allowSlidePrev;if(!a.isMoved){if(m&&h&&s.loopFix({direction:s.swipeDirection}),a.startTranslate=s.getTranslate(),s.setTransition(0),s.animating){const y=new window.CustomEvent("transitionend",{bubbles:!0,cancelable:!0,detail:{bySwiperTouchMove:!0}});s.wrapperEl.dispatchEvent(y)}a.allowMomentumBounce=!1,n.grabCursor&&(s.allowSlideNext===!0||s.allowSlidePrev===!0)&&s.setGrabCursor(!0),s.emit("sliderFirstMove",i)}if(new Date().getTime(),n._loopSwapReset!==!1&&a.isMoved&&a.allowThresholdMove&&v!==s.touchesDirection&&m&&h&&Math.abs(g)>=1){Object.assign(r,{startX:d,startY:u,currentX:d,currentY:u,startTranslate:a.currentTranslate}),a.loopSwapReset=!0,a.startTranslate=a.currentTranslate;return}s.emit("sliderMove",i),a.isMoved=!0,a.currentTranslate=g+a.startTranslate;let b=!0,w=n.resistanceRatio;if(n.touchReleaseOnEdges&&(w=0),g>0?(m&&h&&a.allowThresholdMove&&a.currentTranslate>(n.centeredSlides?s.minTranslate()-s.slidesSizesGrid[s.activeIndex+1]-(n.slidesPerView!=="auto"&&s.slides.length-n.slidesPerView>=2?s.slidesSizesGrid[s.activeIndex+1]+s.params.spaceBetween:0)-s.params.spaceBetween:s.minTranslate())&&s.loopFix({direction:"prev",setTranslate:!0,activeSlideIndex:0}),a.currentTranslate>s.minTranslate()&&(b=!1,n.resistance&&(a.currentTranslate=s.minTranslate()-1+(-s.minTranslate()+a.startTranslate+g)**w))):g<0&&(m&&h&&a.allowThresholdMove&&a.currentTranslate<(n.centeredSlides?s.maxTranslate()+s.slidesSizesGrid[s.slidesSizesGrid.length-1]+s.params.spaceBetween+(n.slidesPerView!=="auto"&&s.slides.length-n.slidesPerView>=2?s.slidesSizesGrid[s.slidesSizesGrid.length-1]+s.params.spaceBetween:0):s.maxTranslate())&&s.loopFix({direction:"next",setTranslate:!0,activeSlideIndex:s.slides.length-(n.slidesPerView==="auto"?s.slidesPerViewDynamic():Math.ceil(parseFloat(n.slidesPerView,10)))}),a.currentTranslate<s.maxTranslate()&&(b=!1,n.resistance&&(a.currentTranslate=s.maxTranslate()+1-(s.maxTranslate()-a.startTranslate-g)**w))),b&&(i.preventedByNestedSwiper=!0),!s.allowSlideNext&&s.swipeDirection==="next"&&a.currentTranslate<a.startTranslate&&(a.currentTranslate=a.startTranslate),!s.allowSlidePrev&&s.swipeDirection==="prev"&&a.currentTranslate>a.startTranslate&&(a.currentTranslate=a.startTranslate),!s.allowSlidePrev&&!s.allowSlideNext&&(a.currentTranslate=a.startTranslate),n.threshold>0)if(Math.abs(g)>n.threshold||a.allowThresholdMove){if(!a.allowThresholdMove){a.allowThresholdMove=!0,r.startX=r.currentX,r.startY=r.currentY,a.currentTranslate=a.startTranslate,r.diff=s.isHorizontal()?r.currentX-r.startX:r.currentY-r.startY;return}}else{a.currentTranslate=a.startTranslate;return}!n.followFinger||n.cssMode||((n.freeMode&&n.freeMode.enabled&&s.freeMode||n.watchSlidesProgress)&&(s.updateActiveIndex(),s.updateSlidesClasses()),n.freeMode&&n.freeMode.enabled&&s.freeMode&&s.freeMode.onTouchMove(),s.updateProgress(a.currentTranslate),s.setTranslate(a.currentTranslate))}function qb(e){const t=this,s=t.touchEventsData;let a=e;a.originalEvent&&(a=a.originalEvent);let n;if(a.type==="touchend"||a.type==="touchcancel"){if(n=[...a.changedTouches].find(y=>y.identifier===s.touchId),!n||n.identifier!==s.touchId)return}else{if(s.touchId!==null||a.pointerId!==s.pointerId)return;n=a}if(["pointercancel","pointerout","pointerleave","contextmenu"].includes(a.type)&&!(["pointercancel","contextmenu"].includes(a.type)&&(t.browser.isSafari||t.browser.isWebView)))return;s.pointerId=null,s.touchId=null;const{params:o,touches:l,rtlTranslate:i,slidesGrid:c,enabled:d}=t;if(!d||!o.simulateTouch&&a.pointerType==="mouse")return;if(s.allowTouchCallbacks&&t.emit("touchEnd",a),s.allowTouchCallbacks=!1,!s.isTouched){s.isMoved&&o.grabCursor&&t.setGrabCursor(!1),s.isMoved=!1,s.startMoving=!1;return}o.grabCursor&&s.isMoved&&s.isTouched&&(t.allowSlideNext===!0||t.allowSlidePrev===!0)&&t.setGrabCursor(!1);const u=Zn(),p=u-s.touchStartTime;if(t.allowClick){const y=a.path||a.composedPath&&a.composedPath();t.updateClickedSlide(y&&y[0]||a.target,y),t.emit("tap click",a),p<300&&u-s.lastClickTime<300&&t.emit("doubleTap doubleClick",a)}if(s.lastClickTime=Zn(),Nu(()=>{t.destroyed||(t.allowClick=!0)}),!s.isTouched||!s.isMoved||!t.swipeDirection||l.diff===0&&!s.loopSwapReset||s.currentTranslate===s.startTranslate&&!s.loopSwapReset){s.isTouched=!1,s.isMoved=!1,s.startMoving=!1;return}s.isTouched=!1,s.isMoved=!1,s.startMoving=!1;let f;if(o.followFinger?f=i?t.translate:-t.translate:f=-s.currentTranslate,o.cssMode)return;if(o.freeMode&&o.freeMode.enabled){t.freeMode.onTouchEnd({currentPos:f});return}const g=f>=-t.maxTranslate()&&!t.params.loop;let _=0,v=t.slidesSizesGrid[0];for(let y=0;y<c.length;y+=y<o.slidesPerGroupSkip?1:o.slidesPerGroup){const x=y<o.slidesPerGroupSkip-1?1:o.slidesPerGroup;typeof c[y+x]<"u"?(g||f>=c[y]&&f<c[y+x])&&(_=y,v=c[y+x]-c[y]):(g||f>=c[y])&&(_=y,v=c[c.length-1]-c[c.length-2])}let m=null,h=null;o.rewind&&(t.isBeginning?h=o.virtual&&o.virtual.enabled&&t.virtual?t.virtual.slides.length-1:t.slides.length-1:t.isEnd&&(m=0));const b=(f-c[_])/v,w=_<o.slidesPerGroupSkip-1?1:o.slidesPerGroup;if(p>o.longSwipesMs){if(!o.longSwipes){t.slideTo(t.activeIndex);return}t.swipeDirection==="next"&&(b>=o.longSwipesRatio?t.slideTo(o.rewind&&t.isEnd?m:_+w):t.slideTo(_)),t.swipeDirection==="prev"&&(b>1-o.longSwipesRatio?t.slideTo(_+w):h!==null&&b<0&&Math.abs(b)>o.longSwipesRatio?t.slideTo(h):t.slideTo(_))}else{if(!o.shortSwipes){t.slideTo(t.activeIndex);return}t.navigation&&(a.target===t.navigation.nextEl||a.target===t.navigation.prevEl)?a.target===t.navigation.nextEl?t.slideTo(_+w):t.slideTo(_):(t.swipeDirection==="next"&&t.slideTo(m!==null?m:_+w),t.swipeDirection==="prev"&&t.slideTo(h!==null?h:_))}}function El(){const e=this,{params:t,el:s}=e;if(s&&s.offsetWidth===0)return;t.breakpoints&&e.setBreakpoint();const{allowSlideNext:a,allowSlidePrev:n,snapGrid:r}=e,o=e.virtual&&e.params.virtual.enabled;e.allowSlideNext=!0,e.allowSlidePrev=!0,e.updateSize(),e.updateSlides(),e.updateSlidesClasses();const l=o&&t.loop;(t.slidesPerView==="auto"||t.slidesPerView>1)&&e.isEnd&&!e.isBeginning&&!e.params.centeredSlides&&!l?e.slideTo(e.slides.length-1,0,!1,!0):e.params.loop&&!o?e.slideToLoop(e.realIndex,0,!1,!0):e.slideTo(e.activeIndex,0,!1,!0),e.autoplay&&e.autoplay.running&&e.autoplay.paused&&(clearTimeout(e.autoplay.resizeTimeout),e.autoplay.resizeTimeout=setTimeout(()=>{e.autoplay&&e.autoplay.running&&e.autoplay.paused&&e.autoplay.resume()},500)),e.allowSlidePrev=n,e.allowSlideNext=a,e.params.watchOverflow&&r!==e.snapGrid&&e.checkOverflow()}function Vb(e){const t=this;t.enabled&&(t.allowClick||(t.params.preventClicks&&e.preventDefault(),t.params.preventClicksPropagation&&t.animating&&(e.stopPropagation(),e.stopImmediatePropagation())))}function Gb(){const e=this,{wrapperEl:t,rtlTranslate:s,enabled:a}=e;if(!a)return;e.previousTranslate=e.translate,e.isHorizontal()?e.translate=-t.scrollLeft:e.translate=-t.scrollTop,e.translate===0&&(e.translate=0),e.updateActiveIndex(),e.updateSlidesClasses();let n;const r=e.maxTranslate()-e.minTranslate();r===0?n=0:n=(e.translate-e.minTranslate())/r,n!==e.progress&&e.updateProgress(s?-e.translate:e.translate),e.emit("setTranslate",e.translate,!1)}function Kb(e){const t=this;Bn(t,e.target),!(t.params.cssMode||t.params.slidesPerView!=="auto"&&!t.params.autoHeight)&&t.update()}function Yb(){const e=this;e.documentTouchHandlerProceeded||(e.documentTouchHandlerProceeded=!0,e.params.touchReleaseOnEdges&&(e.el.style.touchAction="auto"))}const Uu=(e,t)=>{const s=Ft(),{params:a,el:n,wrapperEl:r,device:o}=e,l=!!a.nested,i=t==="on"?"addEventListener":"removeEventListener",c=t;!n||typeof n=="string"||(s[i]("touchstart",e.onDocumentTouchStart,{passive:!1,capture:l}),n[i]("touchstart",e.onTouchStart,{passive:!1}),n[i]("pointerdown",e.onTouchStart,{passive:!1}),s[i]("touchmove",e.onTouchMove,{passive:!1,capture:l}),s[i]("pointermove",e.onTouchMove,{passive:!1,capture:l}),s[i]("touchend",e.onTouchEnd,{passive:!0}),s[i]("pointerup",e.onTouchEnd,{passive:!0}),s[i]("pointercancel",e.onTouchEnd,{passive:!0}),s[i]("touchcancel",e.onTouchEnd,{passive:!0}),s[i]("pointerout",e.onTouchEnd,{passive:!0}),s[i]("pointerleave",e.onTouchEnd,{passive:!0}),s[i]("contextmenu",e.onTouchEnd,{passive:!0}),(a.preventClicks||a.preventClicksPropagation)&&n[i]("click",e.onClick,!0),a.cssMode&&r[i]("scroll",e.onScroll),a.updateOnWindowResize?e[c](o.ios||o.android?"resize orientationchange observerUpdate":"resize observerUpdate",El,!0):e[c]("observerUpdate",El,!0),n[i]("load",e.onLoad,{capture:!0}))};function Wb(){const e=this,{params:t}=e;e.onTouchStart=jb.bind(e),e.onTouchMove=Ub.bind(e),e.onTouchEnd=qb.bind(e),e.onDocumentTouchStart=Yb.bind(e),t.cssMode&&(e.onScroll=Gb.bind(e)),e.onClick=Vb.bind(e),e.onLoad=Kb.bind(e),Uu(e,"on")}function Jb(){Uu(this,"off")}var Xb={attachEvents:Wb,detachEvents:Jb};const kl=(e,t)=>e.grid&&t.grid&&t.grid.rows>1;function Qb(){const e=this,{realIndex:t,initialized:s,params:a,el:n}=e,r=a.breakpoints;if(!r||r&&Object.keys(r).length===0)return;const o=Ft(),l=a.breakpointsBase==="window"||!a.breakpointsBase?a.breakpointsBase:"container",i=["window","container"].includes(a.breakpointsBase)||!a.breakpointsBase?e.el:o.querySelector(a.breakpointsBase),c=e.getBreakpoint(r,l,i);if(!c||e.currentBreakpoint===c)return;const u=(c in r?r[c]:void 0)||e.originalParams,p=kl(e,a),f=kl(e,u),g=e.params.grabCursor,_=u.grabCursor,v=a.enabled;p&&!f?(n.classList.remove(`${a.containerModifierClass}grid`,`${a.containerModifierClass}grid-column`),e.emitContainerClasses()):!p&&f&&(n.classList.add(`${a.containerModifierClass}grid`),(u.grid.fill&&u.grid.fill==="column"||!u.grid.fill&&a.grid.fill==="column")&&n.classList.add(`${a.containerModifierClass}grid-column`),e.emitContainerClasses()),g&&!_?e.unsetGrabCursor():!g&&_&&e.setGrabCursor(),["navigation","pagination","scrollbar"].forEach(x=>{if(typeof u[x]>"u")return;const P=a[x]&&a[x].enabled,D=u[x]&&u[x].enabled;P&&!D&&e[x].disable(),!P&&D&&e[x].enable()});const m=u.direction&&u.direction!==a.direction,h=a.loop&&(u.slidesPerView!==a.slidesPerView||m),b=a.loop;m&&s&&e.changeDirection(),mt(e.params,u);const w=e.params.enabled,y=e.params.loop;Object.assign(e,{allowTouchMove:e.params.allowTouchMove,allowSlideNext:e.params.allowSlideNext,allowSlidePrev:e.params.allowSlidePrev}),v&&!w?e.disable():!v&&w&&e.enable(),e.currentBreakpoint=c,e.emit("_beforeBreakpoint",u),s&&(h?(e.loopDestroy(),e.loopCreate(t),e.updateSlides()):!b&&y?(e.loopCreate(t),e.updateSlides()):b&&!y&&e.loopDestroy()),e.emit("breakpoint",u)}function Zb(e,t="window",s){if(!e||t==="container"&&!s)return;let a=!1;const n=dt(),r=t==="window"?n.innerHeight:s.clientHeight,o=Object.keys(e).map(l=>{if(typeof l=="string"&&l.indexOf("@")===0){const i=parseFloat(l.substr(1));return{value:r*i,point:l}}return{value:l,point:l}});o.sort((l,i)=>parseInt(l.value,10)-parseInt(i.value,10));for(let l=0;l<o.length;l+=1){const{point:i,value:c}=o[l];t==="window"?n.matchMedia(`(min-width: ${c}px)`).matches&&(a=i):c<=s.clientWidth&&(a=i)}return a||"max"}var e0={setBreakpoint:Qb,getBreakpoint:Zb};function t0(e,t){const s=[];return e.forEach(a=>{typeof a=="object"?Object.keys(a).forEach(n=>{a[n]&&s.push(t+n)}):typeof a=="string"&&s.push(t+a)}),s}function s0(){const e=this,{classNames:t,params:s,rtl:a,el:n,device:r}=e,o=t0(["initialized",s.direction,{"free-mode":e.params.freeMode&&s.freeMode.enabled},{autoheight:s.autoHeight},{rtl:a},{grid:s.grid&&s.grid.rows>1},{"grid-column":s.grid&&s.grid.rows>1&&s.grid.fill==="column"},{android:r.android},{ios:r.ios},{"css-mode":s.cssMode},{centered:s.cssMode&&s.centeredSlides},{"watch-progress":s.watchSlidesProgress}],s.containerModifierClass);t.push(...o),n.classList.add(...t),e.emitContainerClasses()}function a0(){const e=this,{el:t,classNames:s}=e;!t||typeof t=="string"||(t.classList.remove(...s),e.emitContainerClasses())}var n0={addClasses:s0,removeClasses:a0};function r0(){const e=this,{isLocked:t,params:s}=e,{slidesOffsetBefore:a}=s;if(a){const n=e.slides.length-1,r=e.slidesGrid[n]+e.slidesSizesGrid[n]+a*2;e.isLocked=e.size>r}else e.isLocked=e.snapGrid.length===1;s.allowSlideNext===!0&&(e.allowSlideNext=!e.isLocked),s.allowSlidePrev===!0&&(e.allowSlidePrev=!e.isLocked),t&&t!==e.isLocked&&(e.isEnd=!1),t!==e.isLocked&&e.emit(e.isLocked?"lock":"unlock")}var o0={checkOverflow:r0},Pl={init:!0,direction:"horizontal",oneWayMovement:!1,swiperElementNodeName:"SWIPER-CONTAINER",touchEventsTarget:"wrapper",initialSlide:0,speed:300,cssMode:!1,updateOnWindowResize:!0,resizeObserver:!0,nested:!1,createElements:!1,eventsPrefix:"swiper",enabled:!0,focusableElements:"input, select, option, textarea, button, video, label",width:null,height:null,preventInteractionOnTransition:!1,userAgent:null,url:null,edgeSwipeDetection:!1,edgeSwipeThreshold:20,autoHeight:!1,setWrapperSize:!1,virtualTranslate:!1,effect:"slide",breakpoints:void 0,breakpointsBase:"window",spaceBetween:0,slidesPerView:1,slidesPerGroup:1,slidesPerGroupSkip:0,slidesPerGroupAuto:!1,centeredSlides:!1,centeredSlidesBounds:!1,slidesOffsetBefore:0,slidesOffsetAfter:0,normalizeSlideIndex:!0,centerInsufficientSlides:!1,snapToSlideEdge:!1,watchOverflow:!0,roundLengths:!1,touchRatio:1,touchAngle:45,simulateTouch:!0,shortSwipes:!0,longSwipes:!0,longSwipesRatio:.5,longSwipesMs:300,followFinger:!0,allowTouchMove:!0,threshold:5,touchMoveStopPropagation:!1,touchStartPreventDefault:!0,touchStartForcePreventDefault:!1,touchReleaseOnEdges:!1,uniqueNavElements:!0,resistance:!0,resistanceRatio:.85,watchSlidesProgress:!1,grabCursor:!1,preventClicks:!0,preventClicksPropagation:!0,slideToClickedSlide:!1,loop:!1,loopAddBlankSlides:!0,loopAdditionalSlides:0,loopPreventsSliding:!0,rewind:!1,allowSlidePrev:!0,allowSlideNext:!0,swipeHandler:null,noSwiping:!0,noSwipingClass:"swiper-no-swiping",noSwipingSelector:null,passiveListeners:!0,maxBackfaceHiddenSlides:10,containerModifierClass:"swiper-",slideClass:"swiper-slide",slideBlankClass:"swiper-slide-blank",slideActiveClass:"swiper-slide-active",slideVisibleClass:"swiper-slide-visible",slideFullyVisibleClass:"swiper-slide-fully-visible",slideNextClass:"swiper-slide-next",slidePrevClass:"swiper-slide-prev",wrapperClass:"swiper-wrapper",lazyPreloaderClass:"swiper-lazy-preloader",lazyPreloadPrevNext:0,runCallbacksOnInit:!0,_emitClasses:!1};function i0(e,t){return function(a={}){const n=Object.keys(a)[0],r=a[n];if(typeof r!="object"||r===null){mt(t,a);return}if(e[n]===!0&&(e[n]={enabled:!0}),n==="navigation"&&e[n]&&e[n].enabled&&!e[n].prevEl&&!e[n].nextEl&&(e[n].auto=!0),["pagination","scrollbar"].indexOf(n)>=0&&e[n]&&e[n].enabled&&!e[n].el&&(e[n].auto=!0),!(n in e&&"enabled"in r)){mt(t,a);return}typeof e[n]=="object"&&!("enabled"in e[n])&&(e[n].enabled=!0),e[n]||(e[n]={enabled:!1}),mt(t,a)}}const eo={eventsEmitter:nb,update:mb,translate:wb,transition:Eb,slide:Lb,loop:Ib,grabCursor:zb,events:Xb,breakpoints:e0,checkOverflow:o0,classes:n0},to={};class xt{constructor(...t){let s,a;t.length===1&&t[0].constructor&&Object.prototype.toString.call(t[0]).slice(8,-1)==="Object"?a=t[0]:[s,a]=t,a||(a={}),a=mt({},a),s&&!a.el&&(a.el=s);const n=Ft();if(a.el&&typeof a.el=="string"&&n.querySelectorAll(a.el).length>1){const i=[];return n.querySelectorAll(a.el).forEach(c=>{const d=mt({},a,{el:c});i.push(new xt(d))}),i}const r=this;r.__swiper__=!0,r.support=Fu(),r.device=zu({userAgent:a.userAgent}),r.browser=Hu(),r.eventsListeners={},r.eventsAnyListeners=[],r.modules=[...r.__modules__],a.modules&&Array.isArray(a.modules)&&a.modules.forEach(i=>{typeof i=="function"&&r.modules.indexOf(i)<0&&r.modules.push(i)});const o={};r.modules.forEach(i=>{i({params:a,swiper:r,extendParams:i0(a,o),on:r.on.bind(r),once:r.once.bind(r),off:r.off.bind(r),emit:r.emit.bind(r)})});const l=mt({},Pl,o);return r.params=mt({},l,to,a),r.originalParams=mt({},r.params),r.passedParams=mt({},a),r.params&&r.params.on&&Object.keys(r.params.on).forEach(i=>{r.on(i,r.params.on[i])}),r.params&&r.params.onAny&&r.onAny(r.params.onAny),Object.assign(r,{enabled:r.params.enabled,el:s,classNames:[],slides:[],slidesGrid:[],snapGrid:[],slidesSizesGrid:[],isHorizontal(){return r.params.direction==="horizontal"},isVertical(){return r.params.direction==="vertical"},activeIndex:0,realIndex:0,isBeginning:!0,isEnd:!1,translate:0,previousTranslate:0,progress:0,velocity:0,animating:!1,cssOverflowAdjustment(){return Math.trunc(this.translate/2**23)*2**23},allowSlideNext:r.params.allowSlideNext,allowSlidePrev:r.params.allowSlidePrev,touchEventsData:{isTouched:void 0,isMoved:void 0,allowTouchCallbacks:void 0,touchStartTime:void 0,isScrolling:void 0,currentTranslate:void 0,startTranslate:void 0,allowThresholdMove:void 0,focusableElements:r.params.focusableElements,lastClickTime:0,clickTimeout:void 0,velocities:[],allowMomentumBounce:void 0,startMoving:void 0,pointerId:null,touchId:null},allowClick:!0,allowTouchMove:r.params.allowTouchMove,touches:{startX:0,startY:0,currentX:0,currentY:0,diff:0},imagesToLoad:[],imagesLoaded:0}),r.emit("_swiper"),r.params.init&&r.init(),r}getDirectionLabel(t){return this.isHorizontal()?t:{width:"height","margin-top":"margin-left","margin-bottom ":"margin-right","margin-left":"margin-top","margin-right":"margin-bottom","padding-left":"padding-top","padding-right":"padding-bottom",marginRight:"marginBottom"}[t]}getSlideIndex(t){const{slidesEl:s,params:a}=this,n=It(s,`.${a.slideClass}, swiper-slide`),r=sr(n[0]);return sr(t)-r}getSlideIndexByData(t){return this.getSlideIndex(this.slides.find(s=>s.getAttribute("data-swiper-slide-index")*1===t))}getSlideIndexWhenGrid(t){return this.grid&&this.params.grid&&this.params.grid.rows>1&&(this.params.grid.fill==="column"?t=Math.floor(t/this.params.grid.rows):this.params.grid.fill==="row"&&(t=t%Math.ceil(this.slides.length/this.params.grid.rows))),t}recalcSlides(){const t=this,{slidesEl:s,params:a}=t;t.slides=It(s,`.${a.slideClass}, swiper-slide`)}enable(){const t=this;t.enabled||(t.enabled=!0,t.params.grabCursor&&t.setGrabCursor(),t.emit("enable"))}disable(){const t=this;t.enabled&&(t.enabled=!1,t.params.grabCursor&&t.unsetGrabCursor(),t.emit("disable"))}setProgress(t,s){const a=this;t=Math.min(Math.max(t,0),1);const n=a.minTranslate(),o=(a.maxTranslate()-n)*t+n;a.translateTo(o,typeof s>"u"?0:s),a.updateActiveIndex(),a.updateSlidesClasses()}emitContainerClasses(){const t=this;if(!t.params._emitClasses||!t.el)return;const s=t.el.className.split(" ").filter(a=>a.indexOf("swiper")===0||a.indexOf(t.params.containerModifierClass)===0);t.emit("_containerClasses",s.join(" "))}getSlideClasses(t){const s=this;return s.destroyed?"":t.className.split(" ").filter(a=>a.indexOf("swiper-slide")===0||a.indexOf(s.params.slideClass)===0).join(" ")}emitSlidesClasses(){const t=this;if(!t.params._emitClasses||!t.el)return;const s=[];t.slides.forEach(a=>{const n=t.getSlideClasses(a);s.push({slideEl:a,classNames:n}),t.emit("_slideClass",a,n)}),t.emit("_slideClasses",s)}slidesPerViewDynamic(t="current",s=!1){const a=this,{params:n,slides:r,slidesGrid:o,slidesSizesGrid:l,size:i,activeIndex:c}=a;let d=1;if(typeof n.slidesPerView=="number")return n.slidesPerView;if(n.centeredSlides){let u=r[c]?Math.ceil(r[c].swiperSlideSize):0,p;for(let f=c+1;f<r.length;f+=1)r[f]&&!p&&(u+=Math.ceil(r[f].swiperSlideSize),d+=1,u>i&&(p=!0));for(let f=c-1;f>=0;f-=1)r[f]&&!p&&(u+=r[f].swiperSlideSize,d+=1,u>i&&(p=!0))}else if(t==="current")for(let u=c+1;u<r.length;u+=1)(s?o[u]+l[u]-o[c]<i:o[u]-o[c]<i)&&(d+=1);else for(let u=c-1;u>=0;u-=1)o[c]-o[u]<i&&(d+=1);return d}update(){const t=this;if(!t||t.destroyed)return;const{snapGrid:s,params:a}=t;a.breakpoints&&t.setBreakpoint(),[...t.el.querySelectorAll('[loading="lazy"]')].forEach(o=>{o.complete&&Bn(t,o)}),t.updateSize(),t.updateSlides(),t.updateProgress(),t.updateSlidesClasses();function n(){const o=t.rtlTranslate?t.translate*-1:t.translate,l=Math.min(Math.max(o,t.maxTranslate()),t.minTranslate());t.setTranslate(l),t.updateActiveIndex(),t.updateSlidesClasses()}let r;if(a.freeMode&&a.freeMode.enabled&&!a.cssMode)n(),a.autoHeight&&t.updateAutoHeight();else{if((a.slidesPerView==="auto"||a.slidesPerView>1)&&t.isEnd&&!a.centeredSlides){const o=t.virtual&&a.virtual.enabled?t.virtual.slides:t.slides;r=t.slideTo(o.length-1,0,!1,!0)}else r=t.slideTo(t.activeIndex,0,!1,!0);r||n()}a.watchOverflow&&s!==t.snapGrid&&t.checkOverflow(),t.emit("update")}changeDirection(t,s=!0){const a=this,n=a.params.direction;return t||(t=n==="horizontal"?"vertical":"horizontal"),t===n||t!=="horizontal"&&t!=="vertical"||(a.el.classList.remove(`${a.params.containerModifierClass}${n}`),a.el.classList.add(`${a.params.containerModifierClass}${t}`),a.emitContainerClasses(),a.params.direction=t,a.slides.forEach(r=>{t==="vertical"?r.style.width="":r.style.height=""}),a.emit("changeDirection"),s&&a.update()),a}changeLanguageDirection(t){const s=this;s.rtl&&t==="rtl"||!s.rtl&&t==="ltr"||(s.rtl=t==="rtl",s.rtlTranslate=s.params.direction==="horizontal"&&s.rtl,s.rtl?(s.el.classList.add(`${s.params.containerModifierClass}rtl`),s.el.dir="rtl"):(s.el.classList.remove(`${s.params.containerModifierClass}rtl`),s.el.dir="ltr"),s.update())}mount(t){const s=this;if(s.mounted)return!0;let a=t||s.params.el;if(typeof a=="string"&&(a=document.querySelector(a)),!a)return!1;a.swiper=s,a.parentNode&&a.parentNode.host&&a.parentNode.host.nodeName===s.params.swiperElementNodeName.toUpperCase()&&(s.isElement=!0);const n=()=>`.${(s.params.wrapperClass||"").trim().split(" ").join(".")}`;let o=a&&a.shadowRoot&&a.shadowRoot.querySelector?a.shadowRoot.querySelector(n()):It(a,n())[0];return!o&&s.params.createElements&&(o=tr("div",s.params.wrapperClass),a.append(o),It(a,`.${s.params.slideClass}`).forEach(l=>{o.append(l)})),Object.assign(s,{el:a,wrapperEl:o,slidesEl:s.isElement&&!a.parentNode.host.slideSlots?a.parentNode.host:o,hostEl:s.isElement?a.parentNode.host:a,mounted:!0,rtl:a.dir.toLowerCase()==="rtl"||gs(a,"direction")==="rtl",rtlTranslate:s.params.direction==="horizontal"&&(a.dir.toLowerCase()==="rtl"||gs(a,"direction")==="rtl"),wrongRTL:gs(o,"display")==="-webkit-box"}),!0}init(t){const s=this;if(s.initialized||s.mount(t)===!1)return s;s.emit("beforeInit"),s.params.breakpoints&&s.setBreakpoint(),s.addClasses(),s.updateSize(),s.updateSlides(),s.params.watchOverflow&&s.checkOverflow(),s.params.grabCursor&&s.enabled&&s.setGrabCursor(),s.params.loop&&s.virtual&&s.params.virtual.enabled?s.slideTo(s.params.initialSlide+s.virtual.slidesBefore,0,s.params.runCallbacksOnInit,!1,!0):s.slideTo(s.params.initialSlide,0,s.params.runCallbacksOnInit,!1,!0),s.params.loop&&s.loopCreate(void 0,!0),s.attachEvents();const n=[...s.el.querySelectorAll('[loading="lazy"]')];return s.isElement&&n.push(...s.hostEl.querySelectorAll('[loading="lazy"]')),n.forEach(r=>{r.complete?Bn(s,r):r.addEventListener("load",o=>{Bn(s,o.target)})}),Do(s),s.initialized=!0,Do(s),s.emit("init"),s.emit("afterInit"),s}destroy(t=!0,s=!0){const a=this,{params:n,el:r,wrapperEl:o,slides:l}=a;return typeof a.params>"u"||a.destroyed||(a.emit("beforeDestroy"),a.initialized=!1,a.detachEvents(),n.loop&&a.loopDestroy(),s&&(a.removeClasses(),r&&typeof r!="string"&&r.removeAttribute("style"),o&&o.removeAttribute("style"),l&&l.length&&l.forEach(i=>{i.classList.remove(n.slideVisibleClass,n.slideFullyVisibleClass,n.slideActiveClass,n.slideNextClass,n.slidePrevClass),i.removeAttribute("style"),i.removeAttribute("data-swiper-slide-index")})),a.emit("destroy"),Object.keys(a.eventsListeners).forEach(i=>{a.off(i)}),t!==!1&&(a.el&&typeof a.el!="string"&&(a.el.swiper=null),Vg(a)),a.destroyed=!0),null}static extendDefaults(t){mt(to,t)}static get extendedDefaults(){return to}static get defaults(){return Pl}static installModule(t){xt.prototype.__modules__||(xt.prototype.__modules__=[]);const s=xt.prototype.__modules__;typeof t=="function"&&s.indexOf(t)<0&&s.push(t)}static use(t){return Array.isArray(t)?(t.forEach(s=>xt.installModule(s)),xt):(xt.installModule(t),xt)}}Object.keys(eo).forEach(e=>{Object.keys(eo[e]).forEach(t=>{xt.prototype[t]=eo[e][t]})});xt.use([sb,ab]);function l0(e,t,s,a){return e.params.createElements&&Object.keys(a).forEach(n=>{if(!s[n]&&s.auto===!0){let r=It(e.el,`.${a[n]}`)[0];r||(r=tr("div",a[n]),r.className=a[n],e.el.append(r)),s[n]=r,t[n]=r}}),s}function da(e=""){return`.${e.trim().replace(/([\.:!+\/()[\]#>~*^$|=,'"@{}\\])/g,"\\$1").replace(/ /g,".")}`}function c0({swiper:e,extendParams:t,on:s,emit:a}){const n="swiper-pagination";t({pagination:{el:null,bulletElement:"span",clickable:!1,hideOnClick:!1,renderBullet:null,renderProgressbar:null,renderFraction:null,renderCustom:null,progressbarOpposite:!1,type:"bullets",dynamicBullets:!1,dynamicMainBullets:1,formatFractionCurrent:m=>m,formatFractionTotal:m=>m,bulletClass:`${n}-bullet`,bulletActiveClass:`${n}-bullet-active`,modifierClass:`${n}-`,currentClass:`${n}-current`,totalClass:`${n}-total`,hiddenClass:`${n}-hidden`,progressbarFillClass:`${n}-progressbar-fill`,progressbarOppositeClass:`${n}-progressbar-opposite`,clickableClass:`${n}-clickable`,lockClass:`${n}-lock`,horizontalClass:`${n}-horizontal`,verticalClass:`${n}-vertical`,paginationDisabledClass:`${n}-disabled`}}),e.pagination={el:null,bullets:[]};let r,o=0;function l(){return!e.params.pagination.el||!e.pagination.el||Array.isArray(e.pagination.el)&&e.pagination.el.length===0}function i(m,h){const{bulletActiveClass:b}=e.params.pagination;m&&(m=m[`${h==="prev"?"previous":"next"}ElementSibling`],m&&(m.classList.add(`${b}-${h}`),m=m[`${h==="prev"?"previous":"next"}ElementSibling`],m&&m.classList.add(`${b}-${h}-${h}`)))}function c(m,h,b){if(m=m%b,h=h%b,h===m+1)return"next";if(h===m-1)return"previous"}function d(m){const h=m.target.closest(da(e.params.pagination.bulletClass));if(!h)return;m.preventDefault();const b=sr(h)*e.params.slidesPerGroup;if(e.params.loop){if(e.realIndex===b)return;const w=c(e.realIndex,b,e.slides.length);w==="next"?e.slideNext():w==="previous"?e.slidePrev():e.slideToLoop(b)}else e.slideTo(b)}function u(){const m=e.rtl,h=e.params.pagination;if(l())return;let b=e.pagination.el;b=qt(b);let w,y;const x=e.virtual&&e.params.virtual.enabled?e.virtual.slides.length:e.slides.length,P=e.params.loop?Math.ceil(x/e.params.slidesPerGroup):e.snapGrid.length;if(e.params.loop?(y=e.previousRealIndex||0,w=e.params.slidesPerGroup>1?Math.floor(e.realIndex/e.params.slidesPerGroup):e.realIndex):typeof e.snapIndex<"u"?(w=e.snapIndex,y=e.previousSnapIndex):(y=e.previousIndex||0,w=e.activeIndex||0),h.type==="bullets"&&e.pagination.bullets&&e.pagination.bullets.length>0){const D=e.pagination.bullets;let T,k,S;if(h.dynamicBullets&&(r=Ro(D[0],e.isHorizontal()?"width":"height"),b.forEach(O=>{O.style[e.isHorizontal()?"width":"height"]=`${r*(h.dynamicMainBullets+4)}px`}),h.dynamicMainBullets>1&&y!==void 0&&(o+=w-(y||0),o>h.dynamicMainBullets-1?o=h.dynamicMainBullets-1:o<0&&(o=0)),T=Math.max(w-o,0),k=T+(Math.min(D.length,h.dynamicMainBullets)-1),S=(k+T)/2),D.forEach(O=>{const I=[...["","-next","-next-next","-prev","-prev-prev","-main"].map(q=>`${h.bulletActiveClass}${q}`)].map(q=>typeof q=="string"&&q.includes(" ")?q.split(" "):q).flat();O.classList.remove(...I)}),b.length>1)D.forEach(O=>{const I=sr(O);I===w?O.classList.add(...h.bulletActiveClass.split(" ")):e.isElement&&O.setAttribute("part","bullet"),h.dynamicBullets&&(I>=T&&I<=k&&O.classList.add(...`${h.bulletActiveClass}-main`.split(" ")),I===T&&i(O,"prev"),I===k&&i(O,"next"))});else{const O=D[w];if(O&&O.classList.add(...h.bulletActiveClass.split(" ")),e.isElement&&D.forEach((I,q)=>{I.setAttribute("part",q===w?"bullet-active":"bullet")}),h.dynamicBullets){const I=D[T],q=D[k];for(let J=T;J<=k;J+=1)D[J]&&D[J].classList.add(...`${h.bulletActiveClass}-main`.split(" "));i(I,"prev"),i(q,"next")}}if(h.dynamicBullets){const O=Math.min(D.length,h.dynamicMainBullets+4),I=(r*O-r)/2-S*r,q=m?"right":"left";D.forEach(J=>{J.style[e.isHorizontal()?q:"top"]=`${I}px`})}}b.forEach((D,T)=>{if(h.type==="fraction"&&(D.querySelectorAll(da(h.currentClass)).forEach(k=>{k.textContent=h.formatFractionCurrent(w+1)}),D.querySelectorAll(da(h.totalClass)).forEach(k=>{k.textContent=h.formatFractionTotal(P)})),h.type==="progressbar"){let k;h.progressbarOpposite?k=e.isHorizontal()?"vertical":"horizontal":k=e.isHorizontal()?"horizontal":"vertical";const S=(w+1)/P;let O=1,I=1;k==="horizontal"?O=S:I=S,D.querySelectorAll(da(h.progressbarFillClass)).forEach(q=>{q.style.transform=`translate3d(0,0,0) scaleX(${O}) scaleY(${I})`,q.style.transitionDuration=`${e.params.speed}ms`})}h.type==="custom"&&h.renderCustom?(xl(D,h.renderCustom(e,w+1,P)),T===0&&a("paginationRender",D)):(T===0&&a("paginationRender",D),a("paginationUpdate",D)),e.params.watchOverflow&&e.enabled&&D.classList[e.isLocked?"add":"remove"](h.lockClass)})}function p(){const m=e.params.pagination;if(l())return;const h=e.virtual&&e.params.virtual.enabled?e.virtual.slides.length:e.grid&&e.params.grid.rows>1?e.slides.length/Math.ceil(e.params.grid.rows):e.slides.length;let b=e.pagination.el;b=qt(b);let w="";if(m.type==="bullets"){let y=e.params.loop?Math.ceil(h/e.params.slidesPerGroup):e.snapGrid.length;e.params.freeMode&&e.params.freeMode.enabled&&y>h&&(y=h);for(let x=0;x<y;x+=1)m.renderBullet?w+=m.renderBullet.call(e,x,m.bulletClass):w+=`<${m.bulletElement} ${e.isElement?'part="bullet"':""} class="${m.bulletClass}"></${m.bulletElement}>`}m.type==="fraction"&&(m.renderFraction?w=m.renderFraction.call(e,m.currentClass,m.totalClass):w=`<span class="${m.currentClass}"></span> / <span class="${m.totalClass}"></span>`),m.type==="progressbar"&&(m.renderProgressbar?w=m.renderProgressbar.call(e,m.progressbarFillClass):w=`<span class="${m.progressbarFillClass}"></span>`),e.pagination.bullets=[],b.forEach(y=>{m.type!=="custom"&&xl(y,w||""),m.type==="bullets"&&e.pagination.bullets.push(...y.querySelectorAll(da(m.bulletClass)))}),m.type!=="custom"&&a("paginationRender",b[0])}function f(){e.params.pagination=l0(e,e.originalParams.pagination,e.params.pagination,{el:"swiper-pagination"});const m=e.params.pagination;if(!m.el)return;let h;typeof m.el=="string"&&e.isElement&&(h=e.el.querySelector(m.el)),!h&&typeof m.el=="string"&&(h=[...document.querySelectorAll(m.el)]),h||(h=m.el),!(!h||h.length===0)&&(e.params.uniqueNavElements&&typeof m.el=="string"&&Array.isArray(h)&&h.length>1&&(h=[...e.el.querySelectorAll(m.el)],h.length>1&&(h=h.find(b=>Bu(b,".swiper")[0]===e.el))),Array.isArray(h)&&h.length===1&&(h=h[0]),Object.assign(e.pagination,{el:h}),h=qt(h),h.forEach(b=>{m.type==="bullets"&&m.clickable&&b.classList.add(...(m.clickableClass||"").split(" ")),b.classList.add(m.modifierClass+m.type),b.classList.add(e.isHorizontal()?m.horizontalClass:m.verticalClass),m.type==="bullets"&&m.dynamicBullets&&(b.classList.add(`${m.modifierClass}${m.type}-dynamic`),o=0,m.dynamicMainBullets<1&&(m.dynamicMainBullets=1)),m.type==="progressbar"&&m.progressbarOpposite&&b.classList.add(m.progressbarOppositeClass),m.clickable&&b.addEventListener("click",d),e.enabled||b.classList.add(m.lockClass)}))}function g(){const m=e.params.pagination;if(l())return;let h=e.pagination.el;h&&(h=qt(h),h.forEach(b=>{b.classList.remove(m.hiddenClass),b.classList.remove(m.modifierClass+m.type),b.classList.remove(e.isHorizontal()?m.horizontalClass:m.verticalClass),m.clickable&&(b.classList.remove(...(m.clickableClass||"").split(" ")),b.removeEventListener("click",d))})),e.pagination.bullets&&e.pagination.bullets.forEach(b=>b.classList.remove(...m.bulletActiveClass.split(" ")))}s("changeDirection",()=>{if(!e.pagination||!e.pagination.el)return;const m=e.params.pagination;let{el:h}=e.pagination;h=qt(h),h.forEach(b=>{b.classList.remove(m.horizontalClass,m.verticalClass),b.classList.add(e.isHorizontal()?m.horizontalClass:m.verticalClass)})}),s("init",()=>{e.params.pagination.enabled===!1?v():(f(),p(),u())}),s("activeIndexChange",()=>{typeof e.snapIndex>"u"&&u()}),s("snapIndexChange",()=>{u()}),s("snapGridLengthChange",()=>{p(),u()}),s("destroy",()=>{g()}),s("enable disable",()=>{let{el:m}=e.pagination;m&&(m=qt(m),m.forEach(h=>h.classList[e.enabled?"remove":"add"](e.params.pagination.lockClass)))}),s("lock unlock",()=>{u()}),s("click",(m,h)=>{const b=h.target,w=qt(e.pagination.el);if(e.params.pagination.el&&e.params.pagination.hideOnClick&&w&&w.length>0&&!b.classList.contains(e.params.pagination.bulletClass)){if(e.navigation&&(e.navigation.nextEl&&b===e.navigation.nextEl||e.navigation.prevEl&&b===e.navigation.prevEl))return;const y=w[0].classList.contains(e.params.pagination.hiddenClass);a(y===!0?"paginationShow":"paginationHide"),w.forEach(x=>x.classList.toggle(e.params.pagination.hiddenClass))}});const _=()=>{e.el.classList.remove(e.params.pagination.paginationDisabledClass);let{el:m}=e.pagination;m&&(m=qt(m),m.forEach(h=>h.classList.remove(e.params.pagination.paginationDisabledClass))),f(),p(),u()},v=()=>{e.el.classList.add(e.params.pagination.paginationDisabledClass);let{el:m}=e.pagination;m&&(m=qt(m),m.forEach(h=>h.classList.add(e.params.pagination.paginationDisabledClass))),g()};Object.assign(e.pagination,{enable:_,disable:v,render:p,update:u,init:f,destroy:g})}function d0({swiper:e,extendParams:t,on:s,emit:a,params:n}){e.autoplay={running:!1,paused:!1,timeLeft:0},t({autoplay:{enabled:!1,delay:3e3,waitForTransition:!0,disableOnInteraction:!1,stopOnLastSlide:!1,reverseDirection:!1,pauseOnMouseEnter:!1}});let r,o,l=n&&n.autoplay?n.autoplay.delay:3e3,i=n&&n.autoplay?n.autoplay.delay:3e3,c,d=new Date().getTime(),u,p,f,g,_,v;function m(Q){!e||e.destroyed||!e.wrapperEl||Q.target===e.wrapperEl&&(e.wrapperEl.removeEventListener("transitionend",m),!(v||Q.detail&&Q.detail.bySwiperTouchMove)&&T())}const h=()=>{if(e.destroyed||!e.autoplay.running)return;e.autoplay.paused?u=!0:u&&(i=c,u=!1);const Q=e.autoplay.paused?c:d+i-new Date().getTime();e.autoplay.timeLeft=Q,a("autoplayTimeLeft",Q,Q/l),o=requestAnimationFrame(()=>{h()})},b=()=>{let Q;return e.virtual&&e.params.virtual.enabled?Q=e.slides.find(re=>re.classList.contains("swiper-slide-active")):Q=e.slides[e.activeIndex],Q?parseInt(Q.getAttribute("data-swiper-autoplay"),10):void 0},w=()=>{let Q=e.params.autoplay.delay;const V=b();return!Number.isNaN(V)&&V>0&&(Q=V),Q},y=Q=>{if(e.destroyed||!e.autoplay.running)return;cancelAnimationFrame(o),h();let V=Q;typeof V>"u"&&(V=w(),l=V,i=V),c=V;const re=e.params.speed,Y=()=>{!e||e.destroyed||(e.params.autoplay.reverseDirection?!e.isBeginning||e.params.loop||e.params.rewind?(e.slidePrev(re,!0,!0),a("autoplay")):e.params.autoplay.stopOnLastSlide||(e.slideTo(e.slides.length-1,re,!0,!0),a("autoplay")):!e.isEnd||e.params.loop||e.params.rewind?(e.slideNext(re,!0,!0),a("autoplay")):e.params.autoplay.stopOnLastSlide||(e.slideTo(0,re,!0,!0),a("autoplay")),e.params.cssMode&&(d=new Date().getTime(),requestAnimationFrame(()=>{y()})))};return V>0?(clearTimeout(r),r=setTimeout(()=>{Y()},V)):requestAnimationFrame(()=>{Y()}),V},x=()=>{d=new Date().getTime(),e.autoplay.running=!0,y(),a("autoplayStart")},P=()=>{e.autoplay.running=!1,clearTimeout(r),cancelAnimationFrame(o),a("autoplayStop")},D=(Q,V)=>{if(e.destroyed||!e.autoplay.running)return;clearTimeout(r),Q||(_=!0);const re=()=>{a("autoplayPause"),e.params.autoplay.waitForTransition?e.wrapperEl.addEventListener("transitionend",m):T()};if(e.autoplay.paused=!0,V){re();return}c=(c||e.params.autoplay.delay)-(new Date().getTime()-d),!(e.isEnd&&c<0&&!e.params.loop)&&(c<0&&(c=0),re())},T=()=>{e.isEnd&&c<0&&!e.params.loop||e.destroyed||!e.autoplay.running||(d=new Date().getTime(),_?(_=!1,y(c)):y(),e.autoplay.paused=!1,a("autoplayResume"))},k=()=>{if(e.destroyed||!e.autoplay.running)return;const Q=Ft();Q.visibilityState==="hidden"&&(_=!0,D(!0)),Q.visibilityState==="visible"&&T()},S=Q=>{Q.pointerType==="mouse"&&(_=!0,v=!0,!(e.animating||e.autoplay.paused)&&D(!0))},O=Q=>{Q.pointerType==="mouse"&&(v=!1,e.autoplay.paused&&T())},I=()=>{e.params.autoplay.pauseOnMouseEnter&&(e.el.addEventListener("pointerenter",S),e.el.addEventListener("pointerleave",O))},q=()=>{e.el&&typeof e.el!="string"&&(e.el.removeEventListener("pointerenter",S),e.el.removeEventListener("pointerleave",O))},J=()=>{Ft().addEventListener("visibilitychange",k)},W=()=>{Ft().removeEventListener("visibilitychange",k)};s("init",()=>{e.params.autoplay.enabled&&(I(),J(),x())}),s("destroy",()=>{q(),W(),e.autoplay.running&&P()}),s("_freeModeStaticRelease",()=>{(f||_)&&T()}),s("_freeModeNoMomentumRelease",()=>{e.params.autoplay.disableOnInteraction?P():D(!0,!0)}),s("beforeTransitionStart",(Q,V,re)=>{e.destroyed||!e.autoplay.running||(re||!e.params.autoplay.disableOnInteraction?D(!0,!0):P())}),s("sliderFirstMove",()=>{if(!(e.destroyed||!e.autoplay.running)){if(e.params.autoplay.disableOnInteraction){P();return}p=!0,f=!1,_=!1,g=setTimeout(()=>{_=!0,f=!0,D(!0)},200)}}),s("touchEnd",()=>{if(!(e.destroyed||!e.autoplay.running||!p)){if(clearTimeout(g),clearTimeout(r),e.params.autoplay.disableOnInteraction){f=!1,p=!1;return}f&&e.params.cssMode&&T(),f=!1,p=!1}}),s("slideChange",()=>{e.destroyed||!e.autoplay.running||e.autoplay.paused&&(c=w(),l=w())}),Object.assign(e.autoplay,{start:x,stop:P,pause:D,resume:T})}const u0={class:"home-layout"},p0={class:"sticky-header-group"},f0=["data-user-name"],h0={class:"home-tabs",id:"home-tabs--id"},m0={class:"home-tab home-tab--lobby home-tab--active","data-home-tab":"lobby-active"},g0={width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",style:{"vertical-align":"-3px","margin-right":"4px"}},b0={class:"home-tab home-tab--lobby","data-home-tab":"lobby-completed"},_0={width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",style:{"vertical-align":"-3px","margin-right":"4px"}},v0={class:"home-tab home-tab--my home-tab--active","data-home-tab":"my-active"},y0={width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",style:{"vertical-align":"-3px","margin-right":"4px"}},w0={class:"home-tab home-tab--my","data-home-tab":"my-completed"},x0={width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",style:{"vertical-align":"-3px","margin-right":"4px"}},T0={class:"home-tab home-tab--private home-tab--active","data-home-tab":"private-all"},S0={width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",style:{"vertical-align":"-3px","margin-right":"4px"}},E0={class:"home-tab home-tab--private","data-home-tab":"private-invites"},k0={width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",style:{"vertical-align":"-3px","margin-right":"4px"}},P0={class:"create-cta-banner__content"},A0={__name:"home_route",setup(e){const t=ct(),s=xe();window.CoreBetSlip=Ru;const a=()=>{t.push({name:"create_tournament_route"})};document.addEventListener("click",d=>{const u=d.target;if(u&&u.dataset?.promotionTopic){const p={timestamp:Date.now(),heroImg:u.dataset.promotionHeroImg||"",caption:u.dataset.promotionCaption||"",tagline:u.dataset.promotionTagline||"",toast:u.dataset.promotionToast||"",topic:u.dataset.promotionTopic||"",topicToken:u.dataset.promotionTopicToken||"",marquee:u.dataset.promotionMarquee||""};console.log("[home_route] Publishing PROMOTION__CLICK:",p),de.publish(s.hierTopics.PROMOTION__CLICK,JSON.stringify(p))}u&&u.dataset?.publishRouteHome&&(u.dataset.publishRouteHome.startsWith("ROUTE.HOME.SODAPOP_PLAY.")&&document.querySelectorAll(".play-cntr .dash-nav__btn").forEach(f=>{f.classList.toggle("dash-nav__btn--active",f===u)}),de.publish(u.dataset.publishRouteHome,`{"ts": ${Date.now()} }`)),u&&u.dataset?.sodapopClose&&neodigmSodaPop&&neodigmSodaPop.close()});const n=(d,u=!1,p="cards",f={})=>{const g=document.querySelector(".tournaments-grid");if(!g)return;g.innerHTML="",g.style.animation="none",g.offsetHeight,g.style.animation="panel-enter 0.3s ease-out both",g.classList.toggle("tournaments-grid--list",p==="list");const _=document.getElementById("app"),v=_?.getAttribute("data-sync-theme")||"dark",m=_?.getAttribute("data-sync-lang")||"en",h=_?.getAttribute("data-sync-motif")||"brand",b=(x="")=>String(x).replace(/\S+/g,P=>/[A-Z]/.test(P)&&P===P.toUpperCase()?P:P.charAt(0).toUpperCase()+P.slice(1).toLowerCase()),w=x=>{const P=document.createElement("bma-tournament-list-card");P.setAttribute("data-bma-tourn-guid",x.guid||""),P.setAttribute("data-bma-tourn-caption",x.caption||""),P.setAttribute("data-bma-tourn-tagline",x.tagline||""),P.setAttribute("data-bma-tourn-status",x.status||""),P.setAttribute("data-bma-tourn-class",x.status||""),P.setAttribute("data-bma-tourn-game-type",x.class||"DEFAULT"),P.setAttribute("data-bma-tourn-sports_allowed",Array.isArray(x.sports_allowed)?JSON.stringify(x.sports_allowed):""),P.setAttribute("data-bma-tourn-entities",x.entities?JSON.stringify(x.entities):""),P.setAttribute("data-bma-tourn-entry_fee",x.entry_fee||"0"),P.setAttribute("data-bma-tourn-tournament_dollars",x.tournament_dollars||"0"),P.setAttribute("data-bma-tourn-matches",x.matches_expanded?.length||"0"),P.setAttribute("data-bma-tourn-tags",Array.isArray(x.tags)?JSON.stringify(x.tags):"[]"),P.setAttribute("data-bma-tourn-window_start_time",x.window_start_time||""),P.setAttribute("data-bma-tourn-window_end_time",x.window_end_time||""),P.setAttribute("data-sync-theme",v);try{const D=s.appSession?.session_user?.guid,T=(x.status||x.class)==="COMPLETED",k=x.entities?.guids||[],S=D&&k.includes(D);if(T&&S&&typeof window.GameMode?.get=="function"){const O=window.GameMode.get(x.class||"DEFAULT_FORMAT");if(O&&typeof O.rankLeaderboard=="function"){const I=k.map(W=>{const Q=Array.isArray(x.combined_betslips)?x.combined_betslips.filter(V=>V.entity_guid===W||V.user_guid===W||V.guid===W):[];return{guid:W,bets:Q,tournament_dollars:x.tournament_dollars,timestamp:x.status_time}}),q=O.rankLeaderboard(I,x),J=q.findIndex(W=>W.guid===D);J>=0&&(P.setAttribute("data-user-rank",String(J+1)),P.setAttribute("data-user-total",String(q.length)))}}}catch{}return P},y=x=>{const P=document.createElement("article"),D=x.status||"DRAFT";P.className=`tournament-item tournament-status-${D.toLowerCase()}`;const T=document.createElement("bma-tournament-card");return T.setAttribute("data-bma-tourn-id",x.id||""),T.setAttribute("data-bma-tourn-guid",x.guid||""),T.setAttribute("data-bma-tourn-caption",x.caption||""),T.setAttribute("data-bma-tourn-tagline",x.tagline||""),T.setAttribute("data-bma-tourn-window_start_time",x.window_start_time||""),T.setAttribute("data-bma-tourn-window_end_time",x.window_end_time||""),T.setAttribute("data-bma-tourn-sports_allowed",Array.isArray(x.sports_allowed)?JSON.stringify(x.sports_allowed):x.sports_allowed||""),T.setAttribute("data-bma-tourn-entities",x.entities?JSON.stringify(x.entities):""),T.setAttribute("data-bma-tourn-tournament_dollars",x.tournament_dollars||""),T.setAttribute("data-bma-tourn-prize_distro",Array.isArray(x.prize_distro)?JSON.stringify(x.prize_distro):x.prize_distro||""),T.setAttribute("data-bma-tourn-matches",Array.isArray(x.matches_guids)?JSON.stringify(x.matches_guids):x.matches_guids||""),T.setAttribute("data-bma-tourn-matches_expanded",Array.isArray(x.matches_expanded)?JSON.stringify(x.matches_expanded):x.matches_expanded||""),T.setAttribute("data-bma-tourn-entry_fee",x.entry_fee||""),T.setAttribute("data-bma-tourn-rake",x.rake||""),T.setAttribute("data-bma-tourn-tags",Array.isArray(x.tags)?JSON.stringify(x.tags):x.tags||""),T.setAttribute("data-bma-tourn-comments",x.comments||""),T.setAttribute("data-bma-tourn-class",x.status||""),T.setAttribute("data-bma-tourn-game-type",x.class||"DEFAULT"),T.setAttribute("data-bma-tourn-status",x.status||""),T.setAttribute("data-sync-theme",v),T.setAttribute("data-sync-lang",m),T.setAttribute("data-sync-motif",h),T.setAttribute("data-n55-size","medium"),T.setAttribute("data-n55-enchanted-cta-ambient","none"),T.setAttribute("data-tourn-custom-css",""),T.setAttribute("data-tourn-trophy","0"),T.setAttribute("data-bma-tourn-focus",""),T.setAttribute("data-bma-tourn-wait","false"),P.appendChild(T),P};if(u){d.forEach(P=>{if(P.type==="stats"){const $=document.createElement("div");$.className="tournament-category tournament-category--stats",$.innerHTML=P.html||"",g.appendChild($);return}const D=document.createElement("div");D.className="tournament-category";const T=document.createElement("header");T.className="tournament-category-header";const k=document.createElement("div");if(k.className="category-title-line",P.tournaments){const $=document.createElement("span");$.className="category-count-pill";const U=(()=>{const B=P.sportKey;if(!B||B==="all")return'<span class="category-count-pill__icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="#fff"><path d="M19 5h-2V3H7v2H5c-1.1 0-2 .9-2 2v1c0 2.55 1.92 4.63 4.39 4.94.63 1.5 1.98 2.63 3.61 2.96V19H7v2h10v-2h-4v-3.1c1.63-.33 2.98-1.46 3.61-2.96C19.08 12.63 21 10.55 21 8V7c0-1.1-.9-2-2-2zM5 8V7h2v3.82C5.84 10.4 5 9.3 5 8zm14 0c0 1.3-.84 2.4-2 2.82V7h2v1z"/></svg></span>';if(B==="multi")return'<span class="category-count-pill__icon"><bma-sport-icon sport="multi" data-sport-group="Multi"></bma-sport-icon></span>';const j=Ge.find(Z=>Z.key===B)?.group||"default";return`<span class="category-count-pill__icon"><bma-sport-icon sport="${B}" data-sport-group="${j}"></bma-sport-icon></span>`})();$.classList.add("category-count-pill--with-icon"),$.innerHTML=`${U}<span class="category-count-pill__num">${P.tournaments.length}</span>`,k.appendChild($)}const S=document.createElement("h2");S.className="category-title",S.textContent=b(P.title),k.appendChild(S);const{tab:O="lobby",subStatus:I="all",sort:q="default",result:J="all",odds:W="all"}=f,V=P.title.toLowerCase().includes("completed"),re=!V&&O==="my",Y=($,U,B)=>`<option value="${$}"${B?" selected":""}>${U}</option>`;let H="";O==="lobby"?H=`
            ...
            <select class="category-dropdown" data-filter-type="sort">
              ${Y("default","Starting TD$: Default",q==="default")}
              ${Y("td_high","Starting TD$: High to Low",q==="td_high")}
              ${Y("td_low","Starting TD$: Low to High",q==="td_low")}
            </select>
          `:O==="my"&&re?H=`
            <select class="category-dropdown" data-filter-type="gameMode" disabled>
              ${Y("default","Game Mode: Default",!0)}
            ...
            <select class="category-dropdown" data-filter-type="subStatus">
              ${Y("all","Status: All",I==="all")}
              ${Y("active","Status: Active",I==="active")}
              ${Y("upcoming","Status: Upcoming",I==="upcoming")}
            </select>
            <select class="category-dropdown" data-filter-type="odds">
              ${Y("all","Odds: All",W==="all")}
              ${Y("available","Odds: Available",W==="available")}
              ${Y("none","Odds: Not Available",W==="none")}
            </select>
          `:(O==="my"&&V||O==="completed")&&(H=`
            <select class="category-dropdown" data-filter-type="result">
              ${Y("all","Result: All",J==="all")}
              ${Y("trophy","Result: Won Trophy",J==="trophy")}
              ${Y("no_trophy","Result: No Trophy",J==="no_trophy")}
            </select>
          `),T.appendChild(k);const X=localStorage.getItem("bma_view_mode")||"cards",K=document.createElement("div");if(K.className="category-controls",H){const $=document.createElement("button");$.className="category-filter-toggle",$.setAttribute("aria-label","Toggle filters"),$.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M10 18h4v-2h-4v2zM3 6v2h18V6H3zm3 7h12v-2H6v2z"/></svg> Filters <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" class="filter-chevron"><path d="M7 10l5 5 5-5z"/></svg>',K.appendChild($)}const A=document.createElement("span");if(A.className="category-view-btns",A.innerHTML=`
          <button class="category-view-btn${X==="cards"?" category-view-btn--active":""}" data-view-mode="cards" aria-label="Card view">
          ...
          <button class="category-view-btn${X==="list"?" category-view-btn--active":""}" data-view-mode="list" aria-label="List view">
        ...
        `,K.appendChild(A),T.appendChild(K),H){const $=document.createElement("div");if($.className="category-filter-row",$.style.display=window._bmaFilterRowOpen?"":"none",$.innerHTML=H,T.appendChild($),window._bmaFilterRowOpen){const U=T.querySelector(".category-filter-toggle");U&&U.classList.add("category-filter-toggle--open")}}if(D.appendChild(T),g.appendChild(D),P.tournaments.length===0){const $=P.emptyMessage||"No tournaments available",B=Object.prototype.hasOwnProperty.call(P,"emptySubtext")?P.emptySubtext||"":"Check back later for new tournaments",G=P.emptyMessage?'<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="rgba(255,255,255,0.15)" style="margin-bottom: 16px;"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>':'<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="rgba(255,255,255,0.12)" style="margin-bottom: 12px;"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>',j=document.createElement("div");j.className="tournaments-empty",j.style.cssText="grid-column: 1 / -1; text-align: center; padding: 48px 24px; animation: motion-fade-through-enter 210ms cubic-bezier(0.4, 0, 0.2, 1) both;",j.innerHTML=`
            ${G}
            <p style="font-size: 1rem; font-weight: 700; color: rgba(255,255,255,0.55); margin: 0 0 8px;">${$}</p>
            ${B?`<p style="font-size: 0.82rem; color: rgba(255,255,255,0.4); margin: 0; max-width: 320px; margin-left: auto; margin-right: auto;">${B}</p>`:""}
          `,D.appendChild(j)}else{const $=document.createElement("div");if($.className="card-rail",P.tournaments.forEach((U,B)=>{const G=p==="list"?w(U):y(U);G.style.animation="motion-slide-up-enter 300ms cubic-bezier(0.4, 0, 0.2, 1) both",G.style.animationDelay=`${Math.min(B*50,300)}ms`,$.appendChild(G)}),D.appendChild($),P.tournaments.length>1){const U=document.createElement("div");U.className="card-rail__dots";for(let B=0;B<P.tournaments.length;B++){const G=document.createElement("span");G.className=`card-rail__dot${B===0?" card-rail__dot--active":""}`,U.appendChild(G)}D.appendChild(U)}if(P.tournaments.length>1){const U=document.createElement("button");U.className="card-rail__arrow card-rail__arrow--prev",U.setAttribute("aria-label","Previous card"),U.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/></svg>',U.style.opacity="0";const B=document.createElement("button");B.className="card-rail__arrow card-rail__arrow--next",B.setAttribute("aria-label","Next card"),B.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>',D.appendChild(U),D.appendChild(B);const G=D.querySelector(".card-rail__dots");$.addEventListener("scroll",()=>{const j=$.scrollLeft,Z=$.firstElementChild?.offsetWidth||1,E=Math.round(j/(Z+12));G&&G.querySelectorAll(".card-rail__dot").forEach((N,R)=>{N.classList.toggle("card-rail__dot--active",R===E)}),U.style.opacity=j<=10?"0":"";const M=$.scrollWidth-$.clientWidth;B.style.opacity=j>=M-10?"0":""},{passive:!0}),U.addEventListener("click",()=>{const j=$.firstElementChild?.offsetWidth||300;$.scrollBy({left:-(j+12),behavior:"smooth"})}),B.addEventListener("click",()=>{const j=$.firstElementChild?.offsetWidth||300;$.scrollBy({left:j+12,behavior:"smooth"})})}}});const x=g.dataset.filterContext;if(x!=="lobby"&&x!=="private"&&g.querySelectorAll("bma-tournament-card, bma-tournament-list-card").length===0){let P="No tournaments available",D="Check back later for new tournaments";x==="my"?(P="You haven't joined any tournaments yet",D="Head to the lobby to find tournaments"):x==="completed"&&(P="No completed tournaments yet",D="Tournaments will appear here once they finish");const T=document.createElement("div");T.className="tournaments-empty",T.style.cssText="grid-column: 1 / -1; text-align: center; padding: 48px 24px; animation: motion-fade-through-enter 210ms cubic-bezier(0.4, 0, 0.2, 1) both;",T.innerHTML=`
        ...
        `;const t=this.shadowRoot.getElementById("guide-modes-rail"),s=this.shadowRoot.querySelectorAll("#guide-modes-dots .modes-dot"),a=this.shadowRoot.getElementById("guide-modes-prev"),n=this.shadowRoot.getElementById("guide-modes-next");if(t&&s.length){const r=()=>(t.firstElementChild?.offsetWidth||300)+12;t.addEventListener("scroll",()=>{const o=Math.round(t.scrollLeft/r());s.forEach((l,i)=>l.classList.toggle("modes-dot--active",i===o))},{passive:!0}),s.forEach((o,l)=>{o.addEventListener("click",()=>{t.scrollTo({left:l*r(),behavior:"smooth"})})}),a&&a.addEventListener("click",()=>{t.scrollBy({left:-r(),behavior:"smooth"})}),n&&n.addEventListener("click",()=>{t.scrollBy({left:r(),behavior:"smooth"})})}}}customElements.define("bma-profile-guide",H_);const j_={class:"profile-layout"},U_={class:"profile-shell"},q_={class:"profile-sidebar"},V_=["data-active-section"],G_={class:"profile-content"},K_={class:"profile-panel"},Y_={class:"profile-panel"},W_={class:"profile-panel"},J_={class:"profile-panel profile-panel--account-desktop"},X_={class:"account-panel"},Q_={class:"mobile-account-bar"},Z_={__name:"profile_route",setup(e){const t=ct(),s=xe(),a=Ne("overview"),n=Ne(!1),r=()=>{t.push({name:"home_route"})},o=u=>{a.value=u.detail?.section||"overview"},l=u=>{const p=u.detail?.contestGuid;p&&(window._pendingTournGuid=p,t.push({name:"home_route"}))},i=()=>{const u=s.appSession?.session_user||{},p=u.guid,f=s.coreTourn.length>0?s.coreTourn[s.coreTourn.length-1].data:[],g=f.filter(W=>(W.entities?.guids||[]).includes(p)),_=g.filter(W=>["LOCKED","UPCOMING"].includes(W.status||W.class)),v=g.filter(W=>(W.status||W.class)==="COMPLETED");let m=0,h=0,b=0;g.forEach(W=>{(Array.isArray(W.tags)?W.tags:[]).forEach(V=>{if(!V||typeof V!="object")return;const re=(V.entity_guid===p?V.badge:null)||(typeof V[p]=="string"?V[p]:null);typeof re=="string"&&re.startsWith("--badge__ribbon--")&&(re==="--badge__ribbon--gold"?m++:re==="--badge__ribbon--silver"?h++:re==="--badge__ribbon--bronze"&&b++)})});const w={};g.forEach(W=>{(W.sports_allowed||[]).forEach(Q=>{const re=Ge.find(Y=>Y.key===Q.key)?.group||"Other";w[re]=(w[re]||0)+1})});let y="",x="",P=0;Object.entries(w).forEach(([W,Q])=>{Q>P&&(P=Q,y=W,x=W)});const D=ke._betStatsCache?.stats||null;let T="—",k="";if(D){const W=D.wins+D.losses;W>0&&(T=Math.round(D.wins/W*100)+"%",k=`${D.wins}-${D.losses}`)}const S=W=>{let Q=null;(Array.isArray(W.tags)?W.tags:[]).forEach(X=>{if(!X||typeof X!="object")return;const K=(X.entity_guid===p?X.badge:null)||(typeof X[p]=="string"?X[p]:null);K==="--badge__ribbon--gold"?Q=1:K==="--badge__ribbon--silver"?Q=2:K==="--badge__ribbon--bronze"&&(Q=3)});const re=W.sports_allowed?.[0]?.key||"",Y=Ge.find(X=>X.key===re),H=!!(W.creator_guid&&W.creator_guid===p);return{id:W.guid,name:W.caption||"Tournament",sport:Y?.title||"",sports:[re],status:W.status||W.class||"",placement:Q,startTime:W.window_start_time,isPrivate:W.is_private===!0,isHosting:H}},O=(W,Q)=>new Date(Q.status_time||0)-new Date(W.status_time||0),I=[...g].filter(W=>W.is_private!==!0).sort(O).slice(0,20).map(S),J=f.filter(W=>W.is_private===!0).filter(W=>{const Q=W.creator_guid&&W.creator_guid===p,V=(W.entities?.guids||[]).includes(p);return Q||V}).sort(O).slice(0,20).map(S);return{username:u.userName||u.name||"Player",email:u.email||"",activeCount:_.length,playedCount:v.length,trophyCount:m+h+b,gold:m,silver:h,bronze:b,firstPlace:m,favSport:y,favGroup:x,winRate:T,record:k,recentContests:I,privateContests:J}},c=()=>{const u=i(),p=document.querySelector("bma-profile-hero");p&&(p.setAttribute("data-username",u.username),p.setAttribute("data-email",u.email),p.setAttribute("data-active-count",String(u.activeCount)),p.setAttribute("data-played-count",String(u.playedCount)),p.setAttribute("data-trophy-count",String(u.trophyCount)));const f=document.querySelector("bma-profile-stats");f&&(f.setAttribute("data-played",String(u.playedCount)),f.setAttribute("data-first-place",String(u.firstPlace)),f.setAttribute("data-trophies",String(u.trophyCount)),f.setAttribute("data-favorite-sport",u.favSport),f.setAttribute("data-favorite-sport-group",u.favGroup),f.setAttribute("data-win-rate",u.winRate),f.setAttribute("data-win-loss-record",u.record));const g=document.querySelector("bma-profile-history");g&&(g.setAttribute("data-contests",JSON.stringify(u.recentContests)),g.setAttribute("data-private-contests",JSON.stringify(u.privateContests)));const _=document.getElementById("profile-trophy-pack");_&&(_.innerHTML=`
      ...
      `)};let d=null;return lt(async()=>{if(!s.appSession.session_user.authenticated){t.push({name:"signin_route"});return}window.scrollTo(0,0),document.documentElement&&(document.documentElement.scrollTop=0),document.body&&(document.body.scrollTop=0),c();const u=s.appSession?.session_user?.guid;u&&ke._ensureBetStatsCache(u).then(p=>{p&&c()}),d=de.subscribe(s.hierTopics.ROUTE__HOME_HYDRATE,()=>{c()})}),os(()=>{d&&de.unsubscribe(d)}),(u,p)=>(ue(),pe("main",j_,[C("div",{class:"profile-header"},[C("button",{class:"profile-header__back",onClick:r,"aria-label":"Back"},[...p[7]||(p[7]=[C("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.5","stroke-linecap":"round","stroke-linejoin":"round"},[C("polyline",{points:"15 18 9 12 15 6"})],-1)])]),p[8]||(p[8]=C("h1",{class:"profile-header__title"},"My Profile",-1))]),p[18]||(p[18]=C("bma-profile-hero",null,null,-1)),C("div",U_,[C("aside",q_,[C("bma-profile-nav",{"data-active-section":a.value,onSectionChange:o},null,40,V_)]),C("div",G_,[ts(C("section",K_,[...p[9]||(p[9]=[C("div",{id:"profile-trophy-pack",class:"trophy-pack"},null,-1),C("bma-profile-stats",null,null,-1)])],512),[[qa,a.value==="overview"]]),ts(C("section",Y_,[C("bma-profile-history",{onContestClick:l},null,32)],512),[[qa,a.value==="contests"]]),ts(C("section",W_,[...p[10]||(p[10]=[C("bma-profile-guide",null,null,-1)])],512),[[qa,a.value==="guide"]]),ts(C("section",J_,[C("div",X_,[C("button",{class:"account-btn",onClick:p[0]||(p[0]=f=>ut(de).publish("ROUTE.HOME.USER_PROFILE.RESET_PASSWORD",JSON.stringify({ts:Date.now()})))},[...p[11]||(p[11]=[C("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor"},[C("path",{d:"M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"})],-1),ot(" Change Password ",-1)])]),C("button",{class:"account-btn account-btn--signout",onClick:p[1]||(p[1]=f=>ut(de).publish("ROUTE.HOME.USER_PROFILE.SIGNOUT",JSON.stringify({ts:Date.now()})))},[...p[12]||(p[12]=[C("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor"},[C("path",{d:"M17 7l-1.41 1.41L18.17 11H8v2h10.17l-2.58 2.58L17 17l5-5zM4 5h8V3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8v-2H4V5z"})],-1),ot(" Sign Out ",-1)])])])],512),[[qa,a.value==="account"]])])]),C("div",Q_,[n.value?(ue(),pe("div",{key:0,class:"mobile-account-scrim",onClick:p[2]||(p[2]=f=>n.value=!1)})):$e("",!0),n.value?(ue(),pe("div",{key:1,class:"mobile-account-bar__panel",onClick:p[5]||(p[5]=na(()=>{},["stop"]))},[C("button",{class:"account-btn",onClick:p[3]||(p[3]=f=>ut(de).publish("ROUTE.HOME.USER_PROFILE.RESET_PASSWORD",JSON.stringify({ts:Date.now()})))},[...p[13]||(p[13]=[C("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor"},[C("path",{d:"M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"})],-1),ot(" Change Password ",-1)])]),C("button",{class:"account-btn account-btn--signout",onClick:p[4]||(p[4]=f=>ut(de).publish("ROUTE.HOME.USER_PROFILE.SIGNOUT",JSON.stringify({ts:Date.now()})))},[...p[14]||(p[14]=[C("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor"},[C("path",{d:"M17 7l-1.41 1.41L18.17 11H8v2h10.17l-2.58 2.58L17 17l5-5zM4 5h8V3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8v-2H4V5z"})],-1),ot(" Sign Out ",-1)])])])):$e("",!0),C("div",{class:"mobile-account-bar__trigger",onClick:p[6]||(p[6]=f=>n.value=!n.value)},[p[16]||(p[16]=C("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"currentColor"},[C("path",{d:"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"})],-1)),p[17]||(p[17]=C("span",null,"Account",-1)),(ue(),pe("svg",{class:Ue(["mobile-account-bar__chevron",n.value?"mobile-account-bar__chevron--open":""]),viewBox:"0 0 24 24",fill:"currentColor"},[...p[15]||(p[15]=[C("path",{d:"M7 10l5 5 5-5z"},null,-1)])],2))])])]))}};class ev extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}static get observedAttributes(){return["data-username","data-rank","data-trophies","data-td-dollars"]}connectedCallback(){this._unsub=Me.subscribe(()=>this.render()),this.render()}disconnectedCallback(){this._unsub&&this._unsub()}attributeChangedCallback(t,s,a){this.shadowRoot&&s!==a&&this.render()}render(){const t=this.getAttribute("data-username")||"Player",s=this.getAttribute("data-rank")||"—",a=this.getAttribute("data-trophies")||"0",n=parseFloat(this.getAttribute("data-td-dollars")||"0"),r=n>=1e3?`${Math.round(n/100)/10}K`:Math.round(n).toLocaleString(),o=t.charAt(0).toUpperCase();this.shadowRoot.innerHTML=`
        ...
        `}}customElements.define("bma-top-players-hero",ev);const tv={class:"top-players-layout"},sv={class:"top-players-shell"},av={class:"top-players-sidebar"},nv=["data-active-section"],rv={__name:"top_players_route",setup(e){const t=ct(),s=xe(),a=Ne("overall"),n=()=>{t.push({name:"home_route"})},r=i=>{const c=i.detail?.section||"overall";a.value=c;const d=document.querySelector(`#global-leaderboard-container .glb__tab[data-tab="${c}"]`);d&&d.click()},o=i=>{const c=s.appSession?.session_user?.guid,d=s.appSession?.session_user?.userName||s.appSession?.session_user?.name||"Player",u=i.find(f=>f.user_guid===c),p=document.querySelector("bma-top-players-hero");if(p)if(u){const f=i.indexOf(u)+1;p.setAttribute("data-username",u.username||d),p.setAttribute("data-rank",String(f)),p.setAttribute("data-trophies",String(u.tournaments_won||0)),p.setAttribute("data-td-dollars",String(u.total_payout||0))}else p.setAttribute("data-username",d),p.setAttribute("data-rank","—"),p.setAttribute("data-trophies","0"),p.setAttribute("data-td-dollars","0")},l=async()=>{try{const i=ke._globalLBCache?.ALL;let c;i?.data&&Date.now()-i.ts<300*1e3?c=i.data:(c=await Oe.fetchAllTimeLeaderboard("ALL",100,"td"),ke._globalLBCache&&(ke._globalLBCache.ALL={data:c,ts:Date.now(),inflight:!1})),o(c?.data||[]),typeof window._renderTopPlayers=="function"&&await window._renderTopPlayers("ALL")}catch(i){console.warn("[top_players_route] load failed",i)}};return lt(()=>{if(!s.appSession.session_user.authenticated){t.push({name:"signin_route"});return}window.scrollTo(0,0),document.documentElement&&(document.documentElement.scrollTop=0),document.body&&(document.body.scrollTop=0),requestAnimationFrame(()=>{l()})}),(i,c)=>(ue(),pe("main",tv,[C("div",{class:"top-players-header"},[C("button",{class:"top-players-header__back",onClick:n,"aria-label":"Back"},[...c[0]||(c[0]=[C("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.5","stroke-linecap":"round","stroke-linejoin":"round"},[C("polyline",{points:"15 18 9 12 15 6"})],-1)])]),c[1]||(c[1]=C("h1",{class:"top-players-header__title"},"Top Players",-1))]),c[3]||(c[3]=C("bma-top-players-hero",null,null,-1)),C("div",sv,[C("aside",av,[C("bma-profile-nav",{"data-active-section":a.value,onSectionChange:r,"data-sections":"top-players"},null,40,nv)]),c[2]||(c[2]=C("div",{class:"top-players-content"},[C("div",{id:"global-leaderboard-container"},[C("div",{class:"leaderboard-empty"},[C("p",null,"Loading leaderboard...")])])],-1))])]))}},ov={class:"play-cntr","data-current-tourn-guid":"","data-current-tourn-action":""},iv={id:"play-section-PLAY",class:"play-section",style:{display:"none","padding-top":"8px"}},lv={class:"bet-grid"},cv={class:"bet-grid__slip","data-active-bet-tab":"MYBETS"},dv={class:"bet-grid__slip-BETSLIP",style:{display:"none"},"data-bets-valid":"false"},uv=["innerHTML"],pv={__name:"play_route",setup(e){const t=ct(),s=Ba(),a=xe(),n=window.EMPTY_BETSLIP_HTML||"",r=()=>{t.push({name:"home_route"})},o=()=>{const i=document.querySelector(".bet-grid__toggle"),c=document.querySelector(".bet-grid__toggle-text"),d=document.querySelector(".bet-grid__toggle-container"),u=document.querySelector(".bet-grid__select"),p=document.querySelector(".bet-grid__slip");if(!i||!c||!d||!u||!p){console.warn("[play_route] initBetGridToggle: missing elements");return}const f=window.matchMedia("(orientation: portrait)").matches,g=window.matchMedia("(max-width: 768px)").matches,_=m=>{u.classList.toggle("collapsed",m),p.classList.toggle("collapsed",!m),c.textContent=m?"Close Bet Slip":"Open Bet Slip",d.classList.toggle("bet-grid__toggle-container--open",m)};(f||g)&&_(!1);let v=null;i.addEventListener("pointerdown",m=>{v=m.pointerId}),i.addEventListener("pointerup",m=>{if(m.pointerId!==v)return;v=null;const h=!p.classList.contains("collapsed");_(!h)}),i.addEventListener("pointercancel",()=>{v=null}),i.addEventListener("click",m=>{m.preventDefault(),m.stopPropagation()})},l=i=>{const c=i.target.closest("[data-publish-route-home], [data-sodapop-close]");c&&c.dataset?.publishRouteHome?.startsWith("ROUTE.HOME.SODAPOP_PLAY.")&&(document.querySelectorAll(".play-cntr .dash-nav__btn").forEach(u=>{u.classList.toggle("dash-nav__btn--active",u===c)}),de.publish(c.dataset.publishRouteHome,`{"ts": ${Date.now()} }`))};return lt(async()=>{if(!a.appSession.session_user.authenticated){t.push({name:"signin_route"});return}const i=s.query.guid||"",c=s.query.action||"INFO";if(!i){console.warn("[play_route] No tournament guid provided"),t.push({name:"home_route"});return}const d=a.appSession?.session_user?.guid;if(d)try{const u=await Oe.fetchBetSlips(d,i);u?.rows&&(a.pushcoreBetSlip({timestamp:Date.now(),source:"API",data:u.rows}),setTimeout(()=>{de.publish(a.hierTopics.SODAPOP__HYDRATE__COREBETSLIP,JSON.stringify(u))},300))}catch(u){console.warn("[play_route] fetchBetSlips failed:",u)}document.body.classList.add("route-locked"),document.addEventListener("click",l),window.initBetGridToggle=o,requestAnimationFrame(()=>{typeof ke.initPlayScreen=="function"&&ke.initPlayScreen(i,c)})}),os(()=>{document.body.classList.remove("route-locked"),document.removeEventListener("click",l),delete window.initBetGridToggle;const i=document.querySelector(".play-cntr");i&&(i.dataset.currentTournGuid="",i.dataset.currentTournAction="")}),(i,c)=>(ue(),pe("article",ov,[C("div",{class:"head-caption tourn-dashboard"},[C("div",{class:"head-caption__back",onClick:r,role:"button",tabindex:"0","aria-label":"Back"},[...c[0]||(c[0]=[C("svg",{xmlns:"http://www.w3.org/2000/svg",width:"28",height:"28",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.5","stroke-linecap":"round","stroke-linejoin":"round"},[C("polyline",{points:"15 18 9 12 15 6"})],-1)])]),c[1]||(c[1]=C("section",{class:"head-caption__content"},[C("h3",{id:"pop-play__tourn-caption--id",class:"pop-play__tourn-caption"},"Tournament"),C("p",{id:"pop-play__tourn-tagline--id",class:"pop-play__tourn-tagline"},"Loading...")],-1))]),c[6]||(c[6]=_t('<div class="dash-stats"><div class="dash-stat"><span class="dash-stat__label">TD$ Balance</span><span class="dash-stat__value" id="dashboard-td-balance">TD$ 0<span style="display:block;font-size:0.6em;margin-top:2px;visibility:hidden;">(0)</span></span><div class="dash-stat__gauge"><div class="dash-stat__gauge-fill dash-stat__gauge-fill--balance" style="width:100%;"></div></div></div><div class="dash-stat"><span class="dash-stat__label">At Risk</span><span class="dash-stat__value dash-stat__value--pending" id="dashboard-td-pending">TD$ 0<span style="display:block;font-size:0.6em;margin-top:2px;visibility:hidden;">(0)</span></span><div class="dash-stat__gauge"><div class="dash-stat__gauge-fill dash-stat__gauge-fill--pending" style="width:0%;"></div></div></div><div class="dash-stat"><span class="dash-stat__label">Rank</span><span class="dash-stat__value" id="dashboard-rank"><span class="tourn-dashboard__rank-text">-/-</span><span style="display:block;font-size:0.6em;margin-top:2px;visibility:hidden;">(0)</span></span><div class="dash-stat__gauge"><div class="dash-stat__gauge-fill dash-stat__gauge-fill--participants" style="width:0%;"></div></div></div></div><nav class="dash-nav"><button class="dash-nav__btn" data-publish-route-home="ROUTE.HOME.SODAPOP_PLAY.INFO"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"></path></svg><span>Info</span></button><button id="btn-join__play--id" class="dash-nav__btn" data-publish-route-home="ROUTE.HOME.SODAPOP_PLAY.PLAY" style="visibility:hidden;"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"></path></svg><span>Play</span></button><button class="dash-nav__btn" data-publish-route-home="ROUTE.HOME.SODAPOP_PLAY.LEADERBOARD"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 21H2V9h5.5v12zm7.25-18h-5.5v18h5.5V3zM22 11h-5.5v10H22V11z"></path></svg><span>Leaderboard</span></button></nav><div id="play-section-INFO" class="play-section play-section--active"><div id="pop-play__caro-info-summary2--id"></div><div id="pop-play__caro-info-summary1--id"></div><div id="pop-play__caro-info-list--id"></div></div>',3)),C("div",iv,[C("article",lv,[c[5]||(c[5]=_t('<section class="bet-grid__select"><div id="game-mode-progress" style="display:none;"></div><article class="select-grid"></article></section><div class="bet-grid__toggle-container"><button id="bet-grid-toggle" class="bet-grid__toggle" aria-label="Toggle bet slip"><span class="bet-grid__toggle-summary"><span class="bet-grid__toggle-badge" id="bet-grid-toggle-count">0</span><span class="bet-grid__toggle-label">Bets</span></span><span class="bet-grid__toggle-action"><span class="bet-grid__toggle-text">Open Bet Slip</span><svg class="bet-grid__toggle-chevron" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M7 14l5-5 5 5z"></path></svg></span></button></div>',2)),C("aside",cv,[c[3]||(c[3]=_t('<nav class="bet-slip__tabs"><button class="bet-slip-tab" data-bet-tab="BETSLIP">Bet Slip<span class="bet-slip-tab__badge bet-slip-tab__badge--slip" id="bet-slip-tab-slip-badge" style="visibility:hidden;">0</span></button><button class="bet-slip-tab" data-bet-tab="MYBETS">My Bets<span class="bet-slip-tab__badge bet-slip-tab__badge--mybets" id="bet-slip-tab-mybets-badge" style="visibility:hidden;">0</span></button></nav>',1)),C("section",dv,[C("div",{class:"bet-grid__slip-BETSLIP-content",innerHTML:ut(n)},null,8,uv),c[2]||(c[2]=_t('<output class="bet-grid__slip-BETSLIP-summary"><div class="summary-row summary-row--labels"><div class="summary-cell">TD$</div><div class="summary-cell">Stake</div><div class="summary-cell">Payout</div></div><div class="summary-row summary-row--values"><div id="summary-balance" class="summary-cell">0.00</div><div id="summary-stake" class="summary-cell">0.00</div><div id="summary-payout" class="summary-cell">0.00</div></div></output><button class="bet-grid__slip-BETSLIP-cta" data-publish-betslip="COREBETSLIP.BET">BET!</button>',2))]),c[4]||(c[4]=C("div",{class:"bet-grid__slip-MYBETS"},null,-1))])])]),c[7]||(c[7]=C("div",{id:"play-section-LEADERBOARD",class:"play-section",style:{display:"none"}},[C("div",{id:"pop-play__caro-leaderboard--id"})],-1)),c[8]||(c[8]=C("br",null,null,-1))]))}},fv={class:"preview-cntr"},hv={class:"head-caption tourn-dashboard"},mv={class:"head-caption__content"},gv={class:"pop-play__tourn-caption"},bv={class:"pop-play__tourn-tagline"},_v={key:0,class:"preview-wrap"},vv={key:0,class:"preview-invite-band"},yv={class:"info-summary-pack"},wv={class:"info-summary-pack__stat"},xv={class:"info-summary-pack__stat-value",style:{color:"var(--status-upcoming-text, #00E676)"}},Tv={class:"info-summary-pack__stat"},Sv={class:"info-summary-pack__stat-value"},Ev={class:"info-summary-pack__stat"},kv={class:"info-summary-pack__stat-value"},Pv={class:"info-pack info-pack--padded"},Av={class:"info-progress-status"},Cv={class:"info-progress-status__row"},Ov={key:0,class:"preview-countdown"},$v={class:"preview-schedule-row"},Mv={class:"preview-schedule-value"},Lv={class:"preview-schedule-value"},Rv={key:1,class:"info-pack info-pack--padded preview-joined"},Dv={class:"preview-section-row"},Nv={class:"preview-section-meta"},Iv={class:"preview-players-row"},Bv={class:"preview-player-avatar"},Fv={class:"preview-player-name"},zv={key:0,class:"preview-player-more"},Hv={key:2,class:"info-pack info-pack--padded preview-trophies"},jv={class:"preview-trophy-podium"},Uv={key:0,class:"preview-trophy preview-trophy--silver"},qv={class:"preview-trophy-count"},Vv={key:1,class:"preview-trophy preview-trophy--gold"},Gv={class:"preview-trophy-count"},Kv={key:2,class:"preview-trophy preview-trophy--bronze"},Yv={class:"preview-trophy-count"},Wv={class:"info-pack preview-legend"},Jv={class:"preview-legend-item"},Xv={class:"preview-legend-value"},Qv={class:"preview-legend-item"},Zv={class:"preview-legend-value"},ey={class:"preview-legend-item"},ty={class:"preview-legend-value",style:{color:"var(--status-locked-text, #F7C60D)"}},sy={class:"preview-cta-bar"},ay={key:1,class:"preview-cta-hint"},ny={key:2,class:"preview-cta-hint"},ry={key:1,class:"preview-empty"},oy={__name:"preview_route",setup(e){const t=ct(),s=Ba(),a=xe(),n=ge(()=>s.params.guid||""),r=ge(()=>s.query.s||null),o=Ne(null),l=Ne("idle"),i=ge(()=>{if(a.coreTourn.length){const $=a.coreTourn[a.coreTourn.length-1].data.find(U=>U.guid===n.value);if($)return $}return o.value}),c=ge(()=>a.appSession?.session_user?.authenticated===!0),d=ge(()=>!c.value),u=ge(()=>a.appSession?.session_user?.guid||""),p=ge(()=>!c.value||!i.value?!1:(i.value.entities?.guids||[]).includes(u.value)),f=ge(()=>{if(!c.value||!i.value)return!1;const A=i.value.creator_guid;return!!A&&A===u.value}),g=ge(()=>{const A=i.value;if(!A)return"";if(A.share_url)return A.share_url;const U=`${window.location.origin+window.location.pathname}#/preview/${A.guid||n.value}`;return A.join_slug?`${U}?s=${encodeURIComponent(A.join_slug)}`:U}),_=ge(()=>Number(i.value?.tournament_dollars||0)),v=ge(()=>{const A=i.value;return A?typeof A.entities?.count=="number"?A.entities.count:A.entities?.guids?.length||0:0}),m=ge(()=>i.value?.entities?.max||0),h=ge(()=>i.value?.matches_expanded?.length||0),b=ge(()=>{const A=i.value;return A?A.format?.on_going!==void 0?A.format.on_going:(A.tags||[]).some($=>$.override_last_match_close===!0):!1}),w=ge(()=>{const A=i.value;return A?A.format?.odds_locked_at_start!==void 0?A.format.odds_locked_at_start:(A.tags||[]).some($=>$.match_inprogress_lock===!0):!1}),y=ge(()=>{const A=i.value;if(!A)return null;if(A.trophies){const j=A.trophies.gold||0,Z=A.trophies.silver||0,F=A.trophies.bronze||0;return j+Z+F===0?null:{gold:j,silver:Z,bronze:F}}const $=(A.tags||[]).find(j=>j.badge_gold!==void 0||j.badge_silver!==void 0||j.badge_bronze!==void 0);if(!$)return null;const U=$.badge_gold||0,B=$.badge_silver||0,G=$.badge_bronze||0;return U+B+G===0?null:{gold:U,silver:B,bronze:G}}),x=ge(()=>{const A=o.value?.joined_players||i.value?.joined_players;return Array.isArray(A)?A:[]}),P=ge(()=>Math.max(0,v.value-x.value.length)),D=ge(()=>w.value?"Locked Odds":"Live Odds"),T=ge(()=>b.value?"On-going":"Fixed Slate"),k=ge(()=>{const A=i.value;if(!A)return"Bet Max Tourney";const $=A.game_mode?.class||A.class||"DEFAULT_FORMAT";return $==="DEFAULT_FORMAT"?"Bet Max Tourney":A.game_mode?.label||$}),S=ge(()=>{if(I.value!=="UPCOMING")return"";const A=i.value;if(!A?.window_start_time)return"";let $=A.window_start_time;!$.includes("Z")&&!$.match(/[+-]\d{2}:\d{2}$/)&&($+="Z");const U=new Date($).getTime()-Date.now();if(U<=0)return"Starting now";const B=Math.floor(U/36e5),G=Math.floor(U%36e5/6e4);return B>=24?`Starts in ${Math.floor(B/24)}d ${B%24}h`:B>0?`Starts in ${B}h ${G}m`:G>5?`Starts in ${G}m`:"Starting soon"}),O=ge(()=>h.value===0?"TBD":`${h.value}${b.value?"+":""}`),I=ge(()=>i.value?.status||""),q=ge(()=>I.value==="LOCKED"?"In Progress":I.value==="UPCOMING"?"Open for Entry":I.value==="COMPLETED"?"Completed":I.value),J=ge(()=>I.value==="LOCKED"?"var(--status-locked-text, #F7C60D)":I.value==="UPCOMING"?"var(--status-upcoming-text, #00E676)":I.value==="COMPLETED"?"var(--status-completed-text, #CD5659)":"#fff"),W=ge(()=>c.value?p.value?"View Tournament":I.value==="COMPLETED"?"View Results":I.value==="LOCKED"?"View Tournament":i.value?.is_private===!0?"Join Bet Max Pool":"Join Tournament":"Sign Up to Join"),Q=()=>{c.value?t.push({name:"home_route"}):t.push({name:"signin_route"})},V=()=>{if(i.value){if(!c.value){kg(n.value,r.value),t.push({name:"signup_route"});return}if(p.value||I.value!=="UPCOMING"){t.push({name:"play_route",query:{guid:n.value,action:"INFO"}});return}de.publish(a.hierTopics.WC__TOURN_ACTION,JSON.stringify({action:"JOIN",tournamentGuid:n.value,ts:Date.now()}))}},re=async()=>{const A=g.value;if(!A)return;const $=i.value?.caption||"Join my tournament",U=`You're invited to join ${$} on Bet Max Tourney.`;if(typeof navigator<"u"&&typeof navigator.share=="function")try{await navigator.share({title:$,text:U,url:A});return}catch(B){if(B?.name==="AbortError")return}try{await navigator.clipboard.writeText(A),typeof neodigmToast<"u"&&neodigmToast.q("Invite link copied","success")}catch(B){console.warn("[preview_route] clipboard write failed:",B),typeof neodigmToast<"u"&&neodigmToast.q("Copy failed. Long-press to copy: "+A,"danger")}},Y=ge(()=>{const A=i.value;return A?(A.game_mode?.class||A.game_mode_class||"DEFAULT_FORMAT")==="DEFAULT_FORMAT":!0}),H=A=>{if(!A)return"TBD";let $=new Date(A);if(!A.includes("Z")&&!A.match(/[+-]\d{2}:\d{2}$/)&&($=new Date(A+"Z")),isNaN($.getTime()))return"TBD";const U=Y.value?{weekday:"short",month:"short",day:"numeric"}:{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"};return $.toLocaleString(void 0,U)},X=async()=>{if(n.value){l.value="loading";try{const{data:A,status:$,ok:U}=await Oe.fetchTournamentPreview(n.value,r.value);U&&A?(o.value=A,l.value="ok"):$===404?l.value="not_found":$===410?l.value="archived":l.value="error"}catch(A){console.warn("[preview_route] fetchTournamentPreview failed:",A),l.value="error"}}},K=ge(()=>{switch(l.value){case"loading":return"Loading tournament…";case"not_found":return"This tournament doesn't exist or the link is wrong.";case"archived":return"This tournament has ended and been archived.";case"error":return"Couldn't load this tournament. Please try again.";default:return"Tournament details aren't available yet."}});return lt(()=>{document.body.classList.add("route-tournament-preview"),X()}),os(()=>{document.body.classList.remove("route-tournament-preview")}),(A,$)=>(ue(),pe("main",fv,[C("div",hv,[C("div",{class:"head-caption__back",onClick:Q,role:"button",tabindex:"0","aria-label":"Back"},[...$[0]||($[0]=[C("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.5","stroke-linecap":"round","stroke-linejoin":"round"},[C("polyline",{points:"15 18 9 12 15 6"})],-1)])]),C("section",mv,[C("h3",gv,me(i.value?.caption||"Tournament"),1),C("p",bv,me(i.value?.tagline||(d.value?"You're invited to a tournament":"")),1)])]),i.value?(ue(),pe("div",_v,[d.value?(ue(),pe("div",vv,[...$[1]||($[1]=[C("img",{class:"preview-invite-band__logo",src:"https://machfive-bmacdev-rest.onrender.com/m5t/v5/coreAssets/image?token=bmt_white_primary_logo&format=png",alt:"Bet Max Tourney"},null,-1),C("div",{class:"preview-invite-band__text"},[C("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":"true"},[C("path",{d:"M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"})]),C("span",null,"You're invited to join this tournament")],-1)])])):$e("",!0),C("div",yv,[C("div",wv,[$[2]||($[2]=C("span",{class:"info-summary-pack__stat-label"},"Starting TD$",-1)),C("span",xv,"TD$ "+me(_.value.toLocaleString()),1)]),C("div",Tv,[$[3]||($[3]=C("span",{class:"info-summary-pack__stat-label"},"Players",-1)),C("span",Sv,me(v.value)+" / "+me(m.value),1)]),C("div",Ev,[$[4]||($[4]=C("span",{class:"info-summary-pack__stat-label"},"Games",-1)),C("span",kv,me(O.value),1)])]),C("div",Pv,[C("div",Av,[C("div",Cv,[$[5]||($[5]=C("span",{class:"info-progress-status__label"},"Status",-1)),C("span",{class:"info-progress-status__value",style:pr({color:J.value})},me(q.value),5)]),S.value?(ue(),pe("div",Ov,me(S.value),1)):$e("",!0)]),$[8]||($[8]=C("div",{class:"info-progress-divider"},null,-1)),C("div",$v,[C("div",null,[$[6]||($[6]=C("span",{class:"info-progress-status__label"},"Starts",-1)),C("span",Mv,me(H(i.value.window_start_time)),1)]),C("div",null,[$[7]||($[7]=C("span",{class:"info-progress-status__label"},"Ends (est.)",-1)),C("span",Lv,me(H(i.value.window_end_time)),1)])])]),x.value.length>0?(ue(),pe("div",Rv,[C("div",Dv,[$[9]||($[9]=C("span",{class:"preview-section-label"},"Who's In",-1)),C("span",Nv,me(v.value)+" joined",1)]),C("div",Iv,[(ue(!0),pe(qe,null,ds(x.value,U=>(ue(),pe("div",{class:"preview-player-chip",key:U.username},[C("div",Bv,me((U.username||"?").charAt(0).toUpperCase()),1),C("span",Fv,me(U.username),1)]))),128)),P.value>0?(ue(),pe("div",zv," +"+me(P.value)+" more ",1)):$e("",!0)])])):$e("",!0),y.value?(ue(),pe("div",Hv,[$[16]||($[16]=C("span",{class:"preview-section-label"},"Trophies",-1)),C("div",jv,[y.value.silver>0?(ue(),pe("div",Uv,[$[10]||($[10]=C("div",{class:"preview-trophy-img"},null,-1)),C("span",qv,"×"+me(y.value.silver),1),$[11]||($[11]=C("span",{class:"preview-trophy-place"},"2nd",-1))])):$e("",!0),y.value.gold>0?(ue(),pe("div",Vv,[$[12]||($[12]=C("div",{class:"preview-trophy-img preview-trophy-img--lg"},null,-1)),C("span",Gv,"×"+me(y.value.gold),1),$[13]||($[13]=C("span",{class:"preview-trophy-place"},"1st",-1))])):$e("",!0),y.value.bronze>0?(ue(),pe("div",Kv,[$[14]||($[14]=C("div",{class:"preview-trophy-img"},null,-1)),C("span",Yv,"×"+me(y.value.bronze),1),$[15]||($[15]=C("span",{class:"preview-trophy-place"},"3rd",-1))])):$e("",!0)])])):$e("",!0),C("div",Wv,[C("div",Jv,[$[17]||($[17]=C("span",{class:"preview-legend-label"},"Odds Format",-1)),C("span",Xv,me(D.value),1)]),C("div",Qv,[$[18]||($[18]=C("span",{class:"preview-legend-label"},"Format",-1)),C("span",Zv,me(T.value),1)]),C("div",ey,[$[19]||($[19]=C("span",{class:"preview-legend-label"},"Game Mode",-1)),C("span",ty,me(k.value),1)]),$[20]||($[20]=C("div",{class:"preview-legend-item"},[C("span",{class:"preview-legend-label"},"Entry"),C("span",{class:"preview-legend-value",style:{color:"var(--status-upcoming-text, #00E676)"}},"Free")],-1))]),C("div",sy,[f.value?(ue(),pe("button",{key:0,class:"preview-share-btn",onClick:re,"aria-label":"Share invite link"},[...$[21]||($[21]=[C("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":"true"},[C("path",{d:"M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92s2.92-1.31 2.92-2.92-1.31-2.92-2.92-2.92z"})],-1),C("span",null,"Share Invite Link",-1)])])):$e("",!0),C("button",{class:"preview-cta-btn",onClick:V},me(W.value),1),d.value?(ue(),pe("p",ay," Sign up is quick. You'll come right back to join. ")):f.value?(ue(),pe("p",ny," You're the host. Share the link to fill your lobby. ")):$e("",!0)])])):(ue(),pe("div",ry,[C("p",null,me(K.value),1),l.value!=="loading"?(ue(),pe("button",{key:0,class:"preview-empty-btn",onClick:Q},"Back")):$e("",!0)]))]))}},iy={class:"create-cntr"},ly={class:"create-steps"},cy=["onClick"],dy={class:"create-steps__num"},uy={class:"create-steps__label"},py={class:"create-wrap"},fy={key:0,class:"create-banner create-banner--error"},hy={key:1,class:"create-step"},my={class:"create-field"},gy={key:0,class:"create-field__hint"},by={key:1,class:"create-field__hint create-field__hint--muted"},_y={class:"create-field"},vy={key:0,class:"create-field__hint"},yy={key:1,class:"create-field__hint create-field__hint--muted"},wy={class:"create-field"},xy=["data-offset","onClick"],Ty={class:"create-day-chip__dow"},Sy={class:"create-day-chip__date"},Ey={key:0,class:"create-day-chip__tag"},ky={class:"create-field"},Py={class:"create-chip-row"},Ay=["onClick"],Cy={key:0,class:"create-field__hint"},Oy={key:1,class:"create-field__hint create-field__hint--muted"},$y={key:0,class:"create-duration"},My={class:"create-duration__range"},Ly={class:"create-duration__day"},Ry={class:"create-duration__day"},Dy={class:"create-duration__num-row"},Ny={class:"create-duration__num"},Iy={class:"create-duration__label"},By={key:2,class:"create-step"},Fy={class:"create-mode-list"},zy=["disabled","onClick"],Hy={class:"create-mode__head"},jy={class:"create-mode__title"},Uy={class:"create-mode__desc"},qy={key:0,class:"create-mode__check","aria-hidden":"true"},Vy={key:0,class:"create-field__hint",style:{display:"block","margin-top":"8px"}},Gy={key:3,class:"create-step"},Ky={class:"create-sports-header"},Yy={class:"create-sports-counter__num"},Wy={class:"create-sport-picker"},Jy=["disabled","onClick"],Xy={class:"create-sport-pick__icon"},Qy=["sport","data-sport-group"],Zy={class:"create-sport-pick__title"},e1={key:0,class:"create-sport-pick__check","aria-hidden":"true"},t1={key:0,class:"create-field__hint",style:{display:"block","margin-top":"8px"}},s1={key:1,class:"create-slate"},a1={class:"create-slate__rows"},n1={class:"create-slate-row__icon"},r1=["sport","data-sport-group"],o1={class:"create-slate-row__main"},i1={class:"create-slate-row__title"},l1={key:0,class:"create-slate-row__status"},c1={key:1,class:"create-slate-row__status create-slate-row__status--muted"},d1=["aria-label","onClick"],u1={key:0,class:"create-slate__footnote"},p1={key:1,class:"create-slate__footnote create-slate__footnote--muted"},f1={key:4,class:"create-step"},h1={class:"create-field"},m1={key:0,class:"create-field__hint"},g1={key:1,class:"create-field__hint create-field__hint--muted"},b1={class:"create-toggle"},_1={key:5,class:"create-step"},v1={class:"create-review-card"},y1={class:"create-review-row"},w1={class:"create-review-value"},x1={key:0,class:"create-review-row"},T1={class:"create-review-value"},S1={class:"create-review-row"},E1={class:"create-review-value"},k1={class:"create-review-row"},P1={class:"create-review-value"},A1={class:"create-review-row"},C1={class:"create-review-value"},O1={class:"create-review-row"},$1={class:"create-review-value"},M1={class:"create-nav"},L1=["disabled"],R1=["disabled"],D1=["disabled"],so=7,N1=28,Al=2,I1={__name:"create_tournament_route",setup(e){const t=ct(),s=xe(),a=[{id:1,label:"Basics"},{id:2,label:"Game Mode"},{id:3,label:"Sports"},{id:4,label:"Players"},{id:5,label:"Review"}],n=Ne(1),r=[{key:"DEFAULT_FORMAT",title:"Bet Max Tourney",tagline:"The classic",description:"Place bets across every game on your slate. Mix spreads, moneylines, and totals to build your edge and chase the biggest win in the pool.",available:!0},{key:"SET_AND_FORGET",title:"Set It and Forget It",tagline:"Coming soon",description:"Lock in all your picks before the window opens. No in-window edits, the slate plays itself out while you watch.",available:!1},{key:"LONGSHOT_MAYHEM",title:"Longshot Mayhem",tagline:"Coming soon",description:"Boosted payouts on underdogs and plus-money plays. Chalk barely moves the needle, upsets blow the pool wide open.",available:!1},{key:"BRACKET_MODE",title:"Bracket Mode",tagline:"Coming soon",description:"Classic head-to-head bracket. Pick winners round by round and survive all the way to the final matchup.",available:!1},{key:"SURVIVOR",title:"Survivor",tagline:"Coming soon",description:"One pick a day, and your pick has to hit. Miss once and you're out. Last entrant standing takes the pool.",available:!1},{key:"SQUADS",title:"Squads",tagline:"Coming soon",description:"Team up with friends and bet together. Squad scores stack across the roster, compete as a crew for the top of the board.",available:!1}],o=ge(()=>{const R=s.appSession?.session_user||{};return R.first||R.username||"My"}),l=ge(()=>{const R=new Date().toLocaleString(void 0,{month:"long"});return`${o.value}'s ${R} Pool`}),i=R=>{const L=z=>String(z).padStart(2,"0");return`${R.getFullYear()}-${L(R.getMonth()+1)}-${L(R.getDate())}`},c=(()=>{const R=new Date;return R.setHours(0,0,0,0),R})(),d=(R,L)=>{const z=new Date(R.getTime());return z.setDate(z.getDate()+L),z},u=Array.from({length:N1},(R,L)=>L),p=R=>d(c,R),f=R=>R.toLocaleDateString(void 0,{weekday:"short"}),g=R=>R.toLocaleDateString(void 0,{month:"short",day:"numeric"}),_=R=>R===0?"Today":R===1?"Tomorrow":"",v=[{key:1,label:"1 day"},{key:2,label:"2 days"},{key:3,label:"3 days"},{key:5,label:"5 days"},{key:7,label:"7 days"}],m=(()=>{const R=(6-c.getDay()+7)%7;return R===0?0:R})(),h=Ne({caption:l.value,tagline:"",sportKeys:[],gameMode:"DEFAULT_FORMAT",startOffset:m,lengthDays:3,maxEntrants:10,creatorParticipating:!0}),b=R=>{const L=r.find(z=>z.key===R);!L||!L.available||(h.value.gameMode=R)},w=ge(()=>i(d(c,h.value.startOffset))),y=ge(()=>{const R=h.value.startOffset+Math.max(1,h.value.lengthDays)-1;return i(d(c,R))}),x=Ne(typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`draft_${crypto.randomUUID()}`:`draft_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`),P=Ne(!1),D=Ne(""),T=Ne({}),k=Ne(null),S=(R,L=!1)=>{if(!R)return"";const[z,se,oe]=R.split("-").map(Number);return new Date(z,(se||1)-1,oe||1,L?23:0,L?59:0,0,0).toISOString()},O=ge(()=>S(w.value,!1)),I=ge(()=>S(y.value,!0)),q=R=>{if(!R)return"";const[L,z,se]=R.split("-").map(Number);return new Date(L,(z||1)-1,se||1).toLocaleDateString(void 0,{weekday:"short",month:"short",day:"numeric"})},J=R=>{if(!R)return NaN;const[L,z,se]=R.split("-").map(Number);return new Date(L,(z||1)-1,se||1,0,0,0,0).getTime()},W=ge(()=>{if(!w.value||!y.value)return 0;const R=J(w.value),L=J(y.value);return isNaN(R)||isNaN(L)?0:Math.max(1,Math.round((L-R)/(24*3600*1e3))+1)}),Q=ge(()=>{const R=new Set,L=[],z=s.coreTourn?.length?s.coreTourn[s.coreTourn.length-1]:null;if(!z)return L;for(const se of z.data||[]){const oe=Array.isArray(se.matches_expanded)?se.matches_expanded:[];for(const ie of oe){const ae=ie.guid||ie.odds_id||ie.id;!ae||R.has(ae)||(R.add(ae),L.push(ie))}}return L}),V=R=>{if(!R||!O.value||!I.value)return 0;const L=new Date(O.value).getTime(),z=new Date(I.value).getTime();return Q.value.reduce((se,oe)=>{if(oe.sport_id!==R)return se;const ie=oe.scheduled_at||"";let ae=new Date(ie);!ie.includes("Z")&&!ie.match(/[+-]\d{2}:\d{2}$/)&&(ae=new Date(ie+"Z"));const ne=ae.getTime();return isNaN(ne)?se:ne>=L&&ne<=z?se+1:se},0)},re=ge(()=>(s.appMeta?.sports||[]).filter(L=>L.active===!0&&!L.has_outrights).map(L=>({key:L.key,title:L.title||L.description||L.key,group:L.group||"default"})).sort((L,z)=>L.title.localeCompare(z.title))),Y=R=>re.value.find(L=>L.key===R)||{key:R,title:R,group:"default"},H=ge(()=>h.value.sportKeys.length>=Al),X=R=>{const L=h.value.sportKeys.indexOf(R);if(L>=0){h.value.sportKeys.splice(L,1);return}if(h.value.sportKeys.length>=2){D.value="Free tier is limited to 2 sports. Deselect one first.";return}h.value.sportKeys.push(R)},K=R=>h.value.sportKeys.includes(R),A=ge(()=>h.value.sportKeys.reduce((R,L)=>R+V(L),0)),$=ge(()=>{const R={},L=J(w.value),z=J(y.value),se=c.getTime();isNaN(L)?R.window="Pick a start day.":L<se&&(R.window="Start day can't be in the past."),isNaN(z)?R.window=R.window||"Pick a length.":L&&z<L&&(R.window="End day must be on or after the start day."),h.value.lengthDays>so&&(R.window=`Free tier contests max out at ${so} days.`);const oe=(h.value.caption||"").trim();(oe.length<3||oe.length>60)&&(R.caption="Name must be 3 to 60 characters."),(h.value.tagline||"").trim().length>120&&(R.tagline="Tagline max is 120 characters.");const ae=r.find(ee=>ee.key===h.value.gameMode);(!ae||!ae.available)&&(R.mode="Pick a game mode."),h.value.sportKeys.length<1&&(R.sports="Pick at least one sport."),h.value.sportKeys.length>2&&(R.sports="Free tier is limited to 2 sports.");const ne=Number(h.value.maxEntrants);return ne>=2&&ne<=10||(R.max="Max entrants must be between 2 and 10."),R}),U=R=>{const L=$.value;return R===1?!L.window&&!L.caption&&!L.tagline:R===2?!L.mode:R===3?!L.sports:R===4?!L.max:R===5?!L.window&&!L.caption&&!L.tagline&&!L.mode&&!L.sports&&!L.max:!0},B=ge(()=>U(n.value)),G=()=>{if(D.value="",!B.value){D.value="Please complete this step before moving on.",T.value=$.value;return}T.value={},n.value<a.length&&n.value++},j=()=>{D.value="",T.value={},n.value>1&&n.value--},Z=R=>{R<n.value&&(n.value=R,D.value="",T.value={})},F=()=>({caption:h.value.caption.trim(),tagline:h.value.tagline.trim()||void 0,sports_allowed:h.value.sportKeys.map(R=>({key:R})),window_start_time:O.value,window_end_time:I.value,entities:{max:Number(h.value.maxEntrants)},creator_participating:h.value.creatorParticipating,game_mode_class:h.value.gameMode,client_draft_id:x.value}),E=R=>{console.warn("[create_tournament_route] server rejected create:",{httpStatus:R?.status,ok:R?.ok,data:R?.data});const L=R?.data?.error||`http_${R?.status||"unknown"}`,z=R?.data?.reason?` (${R.data.reason})`:"",se=R?.data?.message||R?.data?.detail||"";switch(L){case"invalid_caption":return T.value.caption=`Name rejected${z}.`,n.value=1,"Please fix the tournament name.";case"invalid_tagline":return T.value.tagline=`Tagline rejected${z}.`,n.value=1,"Please fix the tagline.";case"invalid_sports":return T.value.sports=`Sports rejected${z}.`,n.value=3,"Please review your sport selection.";case"invalid_window":return T.value.window=`Window rejected${z}.`,n.value=1,"Please review the tournament window.";case"invalid_max_entrants":return T.value.max="Max entrants rejected.",n.value=4,"Max entrants must be between 2 and 10.";case"invalid_request_shape":return`Request rejected as malformed${se?": "+se:""}.`;case"active_limit_reached":return"You already have an active contest. Cancel or finish it first.";case"tier_gate_violation":return`That option isn't available on the free tier yet${R?.data?.field?` (${R.data.field})`:""}.`;case"rate_limited":return"Too many create attempts. Try again in a bit.";case"unauthenticated":return"Your session expired. Please sign in again.";case"internal":return"Server error. Please try again in a moment.";default:return`Server said: ${L}${se?" · "+se:""}`}},M=async()=>{if(D.value="",T.value={},!U(5)){D.value="Please check all steps before publishing.",T.value=$.value;return}P.value=!0;try{const R=F();console.log("[create_tournament_route] POST /m5t/v5/tournament payload:",R);const L=await Oe.createTournament(R);if(console.log("[create_tournament_route] response:",L),L.ok&&L.data?.tournament){const z=L.data.tournament;s.pushCoreTourn({timestamp:Date.now(),source:"API",data:[z]}),typeof neodigmToast<"u"&&neodigmToast.q("Tournament created. Share the link to invite friends.","success"),t.push({name:"preview_route",params:{guid:z.guid},query:z.join_slug?{s:z.join_slug}:void 0});return}D.value=E(L)}catch(R){console.warn("[create_tournament_route] createTournament failed:",R),D.value="Network error. Please try again."}finally{P.value=!1}},N=()=>t.push({name:"home_route"});return lt(()=>{document.body.classList.add("route-create-tournament"),window.scrollTo(0,0),document.documentElement&&(document.documentElement.scrollTop=0),document.body&&(document.body.scrollTop=0),requestAnimationFrame(()=>{const R=k.value;if(!R)return;const L=R.querySelector(`[data-offset="${h.value.startOffset}"]`);if(L){const z=L.offsetLeft-R.clientWidth/2+L.offsetWidth/2;R.scrollLeft=Math.max(0,z)}})}),os(()=>{document.body.classList.remove("route-create-tournament")}),(()=>{const R=new Date;return R.setHours(0,0,0,0),i(R)})(),(R,L)=>(ue(),pe("main",iy,[C("div",{class:"create-header"},[C("button",{class:"create-header__back",onClick:N,"aria-label":"Back to home"},[...L[4]||(L[4]=[C("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.5","stroke-linecap":"round","stroke-linejoin":"round"},[C("polyline",{points:"15 18 9 12 15 6"})],-1)])]),L[5]||(L[5]=C("h1",{class:"create-header__title"},"Create a Tournament",-1))]),C("div",ly,[(ue(),pe(qe,null,ds(a,z=>C("div",{key:z.id,class:Ue(["create-steps__dot",{"create-steps__dot--active":z.id===n.value,"create-steps__dot--complete":z.id<n.value}]),onClick:se=>Z(z.id)},[C("span",dy,me(z.id),1),C("span",uy,me(z.label),1)],10,cy)),64))]),C("div",py,[D.value?(ue(),pe("div",fy,me(D.value),1)):$e("",!0),n.value===1?(ue(),pe("section",hy,[L[11]||(L[11]=C("div",{class:"create-banner create-banner--dev",role:"status"},[C("span",{class:"create-banner__tag"},"BETA"),C("span",{class:"create-banner__msg"},"Feature in active development.")],-1)),L[12]||(L[12]=C("h4",{class:"create-step__heading"},"Name it and set the window",-1)),L[13]||(L[13]=C("p",{class:"create-step__hint"},"Quick setup: a name for the invite, a start day, and how long it runs.",-1)),C("label",my,[L[6]||(L[6]=C("span",{class:"create-field__label"},"Name",-1)),ts(C("input",{type:"text","onUpdate:modelValue":L[0]||(L[0]=z=>h.value.caption=z),maxlength:"60",placeholder:"Name your tournament",autocapitalize:"words",autocomplete:"off",enterkeyhint:"next",class:Ue(["create-field__input",{"create-field__input--error":T.value.caption}])},null,2),[[zr,h.value.caption]]),T.value.caption?(ue(),pe("span",gy,me(T.value.caption),1)):(ue(),pe("span",by,me((h.value.caption||"").length)+" / 60",1))]),C("label",_y,[L[7]||(L[7]=C("span",{class:"create-field__label"},[ot("Tagline "),C("span",{class:"create-field__optional"},"(optional)")],-1)),ts(C("input",{type:"text","onUpdate:modelValue":L[1]||(L[1]=z=>h.value.tagline=z),maxlength:"120",placeholder:"One line about your contest",autocapitalize:"sentences",autocomplete:"off",enterkeyhint:"next",class:Ue(["create-field__input",{"create-field__input--error":T.value.tagline}])},null,2),[[zr,h.value.tagline]]),T.value.tagline?(ue(),pe("span",vy,me(T.value.tagline),1)):(ue(),pe("span",yy,me((h.value.tagline||"").length)+" / 120",1))]),C("div",wy,[L[8]||(L[8]=C("span",{class:"create-field__label"},"Starts",-1)),C("div",{class:"create-day-scroller",ref_key:"dayScrollerEl",ref:k},[(ue(!0),pe(qe,null,ds(ut(u),z=>(ue(),pe("button",{key:z,type:"button",class:Ue(["create-day-chip",{"create-day-chip--on":h.value.startOffset===z}]),"data-offset":z,onClick:se=>h.value.startOffset=z},[C("span",Ty,me(f(p(z))),1),C("span",Sy,me(g(p(z))),1),_(z)?(ue(),pe("span",Ey,me(_(z)),1)):$e("",!0)],10,xy))),128))],512)]),C("div",ky,[L[9]||(L[9]=C("span",{class:"create-field__label"},"Length",-1)),C("div",Py,[(ue(),pe(qe,null,ds(v,z=>C("button",{key:z.key,type:"button",class:Ue(["create-chip",{"create-chip--on":h.value.lengthDays===z.key}]),onClick:se=>h.value.lengthDays=z.key},me(z.label),11,Ay)),64))]),T.value.window?(ue(),pe("span",Cy,me(T.value.window),1)):(ue(),pe("span",Oy,"Free tier runs up to "+me(so)+" days."))]),W.value>0?(ue(),pe("div",$y,[C("div",My,[C("span",Ly,me(q(w.value)),1),L[10]||(L[10]=C("span",{class:"create-duration__arrow"},"→",-1)),C("span",Ry,me(q(y.value)),1)]),C("div",Dy,[C("span",Ny,me(W.value),1),C("span",Iy,me(W.value===1?"day":"days")+" of play",1)])])):$e("",!0)])):$e("",!0),n.value===2?(ue(),pe("section",By,[L[15]||(L[15]=C("h4",{class:"create-step__heading"},"Choose a game mode",-1)),L[16]||(L[16]=C("p",{class:"create-step__hint"},"Only Bet Max Tourney is live right now. More modes are in development.",-1)),C("div",Fy,[(ue(),pe(qe,null,ds(r,z=>C("button",{key:z.key,type:"button",class:Ue(["create-mode",{"create-mode--on":h.value.gameMode===z.key&&z.available,"create-mode--disabled":!z.available}]),disabled:!z.available,onClick:se=>b(z.key)},[C("div",Hy,[C("span",jy,me(z.title),1),C("span",{class:Ue(["create-mode__tagline",{"create-mode__tagline--soon":!z.available}])},me(z.tagline),3)]),C("p",Uy,me(z.description),1),h.value.gameMode===z.key&&z.available?(ue(),pe("span",qy,[...L[14]||(L[14]=[C("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"3","stroke-linecap":"round","stroke-linejoin":"round"},[C("polyline",{points:"20 6 9 17 4 12"})],-1)])])):$e("",!0)],10,zy)),64))]),T.value.mode?(ue(),pe("span",Vy,me(T.value.mode),1)):$e("",!0)])):$e("",!0),n.value===3?(ue(),pe("section",Gy,[C("div",Ky,[L[18]||(L[18]=C("div",null,[C("h4",{class:"create-step__heading",style:{"margin-bottom":"4px"}},"Pick your sports"),C("p",{class:"create-step__hint",style:{margin:"0"}},"Tap a chip to add it. Games scheduled during your window will be added automatically as odds post.")],-1)),C("div",{class:Ue(["create-sports-counter",{"create-sports-counter--max":H.value}])},[C("span",Yy,me(h.value.sportKeys.length),1),L[17]||(L[17]=C("span",{class:"create-sports-counter__divider"},"/",-1)),C("span",{class:"create-sports-counter__max"},me(Al))],2)]),C("div",Wy,[(ue(!0),pe(qe,null,ds(re.value,z=>(ue(),pe("button",{key:z.key,type:"button",class:Ue(["create-sport-pick",{"create-sport-pick--on":K(z.key),"create-sport-pick--disabled":H.value&&!K(z.key)}]),disabled:H.value&&!K(z.key),onClick:se=>X(z.key)},[C("span",Xy,[C("bma-sport-icon",{sport:z.key,"data-sport-group":z.group},null,8,Qy)]),C("span",Zy,me(z.title),1),K(z.key)?(ue(),pe("span",e1,[...L[19]||(L[19]=[C("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"3","stroke-linecap":"round","stroke-linejoin":"round"},[C("polyline",{points:"20 6 9 17 4 12"})],-1)])])):$e("",!0)],10,Jy))),128))]),T.value.sports?(ue(),pe("span",t1,me(T.value.sports),1)):$e("",!0),h.value.sportKeys.length>0?(ue(),pe("div",s1,[L[21]||(L[21]=C("div",{class:"create-slate__label"},"Your slate",-1)),C("div",a1,[(ue(!0),pe(qe,null,ds(h.value.sportKeys,z=>(ue(),pe("div",{key:z,class:"create-slate-row"},[C("span",n1,[C("bma-sport-icon",{sport:z,"data-sport-group":Y(z).group},null,8,r1)]),C("div",o1,[C("span",i1,me(Y(z).title),1),V(z)>0?(ue(),pe("span",l1,me(V(z))+" game"+me(V(z)===1?"":"s")+" available this window",1)):(ue(),pe("span",c1," Games will be added when odds post "))]),C("button",{class:"create-slate-row__remove",type:"button","aria-label":"Remove "+Y(z).title,onClick:se=>X(z)},[...L[20]||(L[20]=[C("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.5","stroke-linecap":"round","stroke-linejoin":"round"},[C("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),C("line",{x1:"6",y1:"6",x2:"18",y2:"18"})],-1)])],8,d1)]))),128))]),A.value>0?(ue(),pe("div",u1,me(A.value)+" game"+me(A.value===1?"":"s")+" already on the slate · more added during the tournament. ",1)):(ue(),pe("div",p1," No games are on the slate yet. They'll populate as odds post. "))])):$e("",!0)])):$e("",!0),n.value===4?(ue(),pe("section",f1,[L[24]||(L[24]=C("h4",{class:"create-step__heading"},"How many players?",-1)),L[25]||(L[25]=C("p",{class:"create-step__hint"},"Up to 10 on the free tier. You're in by default — toggle off if you're just hosting.",-1)),C("label",h1,[L[22]||(L[22]=C("span",{class:"create-field__label"},"Max Entrants",-1)),ts(C("input",{type:"number",min:"2",max:"10",inputmode:"numeric",pattern:"[0-9]*","onUpdate:modelValue":L[2]||(L[2]=z=>h.value.maxEntrants=z),class:Ue(["create-field__input create-field__input--num",{"create-field__input--error":T.value.max}])},null,2),[[zr,h.value.maxEntrants,void 0,{number:!0}]]),T.value.max?(ue(),pe("span",m1,me(T.value.max),1)):(ue(),pe("span",g1,"Free tier max is 10."))]),C("label",b1,[ts(C("input",{type:"checkbox","onUpdate:modelValue":L[3]||(L[3]=z=>h.value.creatorParticipating=z)},null,512),[[cu,h.value.creatorParticipating]]),L[23]||(L[23]=C("span",null,"I'm playing in this tournament",-1))])])):$e("",!0),n.value===5?(ue(),pe("section",_1,[L[33]||(L[33]=C("h4",{class:"create-step__heading"},"Ready to publish?",-1)),L[34]||(L[34]=C("p",{class:"create-step__hint"},"Here's what your invitees will see. Tap any step number above to edit.",-1)),C("div",v1,[C("div",y1,[L[26]||(L[26]=C("span",{class:"create-review-label"},"Name",-1)),C("span",w1,me(h.value.caption),1)]),h.value.tagline?(ue(),pe("div",x1,[L[27]||(L[27]=C("span",{class:"create-review-label"},"Tagline",-1)),C("span",T1,me(h.value.tagline),1)])):$e("",!0),C("div",S1,[L[28]||(L[28]=C("span",{class:"create-review-label"},"Dates",-1)),C("span",E1,me(q(w.value))+" → "+me(q(y.value)),1)]),C("div",k1,[L[29]||(L[29]=C("span",{class:"create-review-label"},"Sports",-1)),C("span",P1,[(ue(!0),pe(qe,null,ds(h.value.sportKeys,z=>(ue(),pe("span",{key:z,class:"create-review-pill"},me((re.value.find(se=>se.key===z)||{}).title||z)+" · "+me(V(z)),1))),128))])]),C("div",A1,[L[30]||(L[30]=C("span",{class:"create-review-label"},"Players",-1)),C("span",C1,"Up to "+me(h.value.maxEntrants)+" · "+me(h.value.creatorParticipating?"you're in":"hosting only"),1)]),C("div",O1,[L[31]||(L[31]=C("span",{class:"create-review-label"},"Format",-1)),C("span",$1,me((r.find(z=>z.key===h.value.gameMode)||{}).title||"Bet Max Tourney")+" · Fixed Slate · TD$ 500",1)]),L[32]||(L[32]=C("div",{class:"create-review-row"},[C("span",{class:"create-review-label"},"Trophies"),C("span",{class:"create-review-value"},"1 Gold · 1 Silver · 1 Bronze")],-1))])])):$e("",!0),C("div",M1,[C("button",{class:"create-nav__btn create-nav__btn--ghost",onClick:j,disabled:n.value===1||P.value},"Back",8,L1),n.value<a.length?(ue(),pe("button",{key:0,class:"create-nav__btn create-nav__btn--primary",onClick:G,disabled:!B.value},"Next",8,R1)):(ue(),pe("button",{key:1,class:"create-nav__btn create-nav__btn--primary",onClick:M,disabled:P.value},me(P.value?"Publishing…":"Publish Tournament"),9,D1))])])]))}},ka=qm({history:Tm(),routes:[{path:"/",name:"splash_route",component:yl},{path:"/splash_route",name:"splash_route",component:yl},{path:"/error_route",name:"error_route",component:Ka},{path:"/forgot_route",name:"forgot_route",component:__},{path:"/resetforgot_route",name:"resetforgot_route",component:Ka},{path:"/resethash_route",name:"resethash_route",component:C_},{path:"/signin_route",name:"signin_route",component:q0},{path:"/signout_route",name:"signout_route",component:K0},{path:"/signup_route",name:"signup_route",component:p_},{path:"/verf_link_route",name:"verf_link_route",component:N_},{path:"/offline_route",name:"offline_route",component:Ka},{path:"/home_route",name:"home_route",component:A0},{path:"/profile_route",name:"profile_route",component:Z_},{path:"/top_players_route",name:"top_players_route",component:rv},{path:"/play_route",name:"play_route",component:pv},{path:"/create_tournament_route",name:"create_tournament_route",component:I1},{path:"/preview/:guid",name:"preview_route",component:oy,meta:{previewAllowed:!0}},{path:"/appFAQ",name:"appFAQ",component:Ka},{path:"/appHelp",name:"appHelp",component:L0}]});ka.beforeEach((e,t,s)=>{if(e.query.brand!==void 0){const a=e.query.brand;a==="null"||a===""?sa.clearBrand():sa.setBrand(a);const n={...e.query};delete n.brand,s({...e,query:n,replace:!0})}else s()});class B1 extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._countdownInterval=null}static get observedAttributes(){return["data-bma-tourn-guid","data-bma-tourn-caption","data-bma-tourn-tagline","data-bma-tourn-status","data-bma-tourn-class","data-bma-tourn-sports_allowed","data-bma-tourn-entities","data-bma-tourn-entry_fee","data-bma-tourn-tournament_dollars","data-bma-tourn-matches","data-bma-tourn-tags","data-bma-tourn-window_start_time","data-bma-tourn-window_end_time","data-user-rank","data-user-total","data-user-td-balance","data-user-bets","data-user-payout","data-sync-theme"]}connectedCallback(){this.render(),this.attachEventListeners(),this._startCountdown(),this._unsub=Me.subscribe(()=>{this.render(),this.attachEventListeners()})}disconnectedCallback(){this._unsub&&this._unsub(),this._clearCountdown()}attributeChangedCallback(t,s,a){s!==a&&this.shadowRoot&&(this.render(),this.attachEventListeners())}get guid(){return this.getAttribute("data-bma-tourn-guid")||""}get caption(){return this.getAttribute("data-bma-tourn-caption")||"Tournament"}get tagline(){return this.getAttribute("data-bma-tourn-tagline")||""}get status(){return(this.getAttribute("data-bma-tourn-status")||"UPCOMING").toUpperCase()}get tournClass(){return(this.getAttribute("data-bma-tourn-class")||this.status).toUpperCase()}get gameType(){return this.getAttribute("data-bma-tourn-game-type")||"DEFAULT"}get gameModeBadge(){if(typeof window.GameMode>"u")return null;const t=window.GameMode.get(this.gameType);return t?t.getBadge():null}get sportsAllowed(){try{const t=this.getAttribute("data-bma-tourn-sports_allowed");return t?JSON.parse(t):[]}catch{return[]}}get entities(){try{const t=this.getAttribute("data-bma-tourn-entities"),s=t?JSON.parse(t):{guids:[],max:0};return{current:Array.isArray(s)?s[1]?.length||0:s.guids?.length||0,max:Array.isArray(s)?parseInt(s[0]?.max||0):s.max||0}}catch{return{current:0,max:0}}}get entryFee(){const t=this.getAttribute("data-bma-tourn-entry_fee");return!t||t==="0"||t==="0.00"?"Free":`$${t}`}get tournamentDollars(){return this.getAttribute("data-bma-tourn-tournament_dollars")||"0"}get matches(){return this.getAttribute("data-bma-tourn-matches")||"0"}get userRank(){return this.getAttribute("data-user-rank")||"-"}get userTotal(){return this.getAttribute("data-user-total")||"-"}get userTDBalance(){return this.getAttribute("data-user-td-balance")||"0"}get userBets(){return this.getAttribute("data-user-bets")||"0"}get userPayout(){return this.getAttribute("data-user-payout")||"0"}get windowStartTime(){return this.getAttribute("data-bma-tourn-window_start_time")||""}get windowEndTime(){return this.getAttribute("data-bma-tourn-window_end_time")||""}get theme(){return Me.theme}isUserParticipating(){const s=document.getElementById("app")?.dataset?.userGuid;if(!s)return!1;try{const a=this.getAttribute("data-bma-tourn-entities"),n=a?JSON.parse(a):{guids:[]};return(Array.isArray(n)?n[1]||[]:n.guids||[]).includes(s)}catch{return!1}}getUserTrophy(){const s=document.getElementById("app")?.dataset?.userGuid;if(!s)return null;try{const a=JSON.parse(this.getAttribute("data-bma-tourn-tags")||"[]");for(const n of a){if(typeof n!="object"||!n)continue;let r=null;if(n.entity_guid===s&&n.badge?r=n.badge:n[s]&&(r=n[s]),r?.includes("gold"))return"gold";if(r?.includes("silver"))return"silver";if(r?.includes("bronze"))return"bronze"}}catch{}return null}getCountdown(){const t=this.status==="UPCOMING"?this.windowStartTime:this.status==="LOCKED"?this.windowEndTime:null;if(!t)return null;let s=new Date(t);!t.includes("Z")&&!t.match(/[+-]\d{2}:\d{2}$/)&&(s=new Date(t+"Z"));const a=Date.now(),n=s.getTime()-a;if(n<=0)return null;const r=Math.floor(n/864e5),o=Math.floor(n%864e5/36e5),l=Math.floor(n%36e5/6e4);return r>0?`${r}d ${o}h`:o>0?`${o}h ${l}m`:`${l}m`}_startCountdown(){this._clearCountdown(),(this.status==="UPCOMING"||this.status==="LOCKED")&&(this._countdownInterval=setInterval(()=>{const t=this.shadowRoot?.querySelector(".ring__countdown");if(t){const s=this.getCountdown();t.textContent=s||"",s||(t.style.display="none")}},6e4))}_clearCountdown(){this._countdownInterval&&(clearInterval(this._countdownInterval),this._countdownInterval=null)}getSportsDisplay(){const t={basketball_nba:"NBA",basketball_ncaab:"NCAAB",football_nfl:"NFL",football_ncaaf:"NCAAF",icehockey_nhl:"NHL",hockey_nhl:"NHL",baseball_mlb:"MLB",soccer_mls:"MLS",soccer_epl:"EPL",soccer_uefa:"UEFA",mma_ufc:"UFC",boxing:"BOXING"},s=this.sportsAllowed;if(!Array.isArray(s)||s.length===0)return'<bma-sport-icon sport="default" data-sport-group="default" style="width:20px;height:20px;"></bma-sport-icon>';const a=Math.min(s.length,3);let n="";for(let r=0;r<a;r++){const o=s[r].key||s[r],l=Ge.find(d=>d.key===o),i=l?l.group:"default",c=t[o]||o.replace(/^[a-z]+_/,"").toUpperCase();n+=`<span class="lc__sport-item"><bma-sport-icon sport="${o}" data-sport-group="${i}" style="width:20px;height:20px;"></bma-sport-icon><span class="lc__sport-label">${c}</span></span>`}return s.length>3&&(n+=`<span class="lc__sport-count" data-sport-overflow="true">+${s.length-3}</span>`),n}getSportsFullList(){const t={basketball_nba:"NBA",basketball_ncaab:"NCAAB",football_nfl:"NFL",football_ncaaf:"NCAAF",icehockey_nhl:"NHL",hockey_nhl:"NHL",baseball_mlb:"MLB",soccer_mls:"MLS",soccer_epl:"EPL",soccer_uefa:"UEFA",mma_ufc:"UFC",boxing:"BOXING"};return this.sportsAllowed.map(s=>{const a=s.key||s;return t[a]||a.replace(/^[a-z]+_/,"").toUpperCase()}).join(", ")}buildRing(t,s,a,n){const r=(t-s)/2,o=2*Math.PI*r,l=o-a/100*o,i=t/2;return`<svg class="ring__svg" width="${t}" height="${t}" viewBox="0 0 ${t} ${t}">
            ...
            `);const v=this.gameModeBadge?.label||(this.gameType==="DEFAULT_FORMAT"?"Bet Max Tourney":""),m=v?`<span class="lcs__pill lcs__pill--neutral">${v}</span>`:"",h=`<span class="lcs__pill lcs__pill--${t}">${o}</span>`,b=(()=>{const w=`<button class="lcs__btn lcs__btn--info" data-action="INFO" aria-label="Info">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>
                <span>Info</span>
            </button>`;let y="";return s?y='<button class="lcs__btn lcs__btn--play" data-action="PLAY" aria-label="Play"><span>Play</span></button>':a?y='<button class="lcs__btn lcs__btn--join" data-action="JOIN" aria-label="Join"><span>Join</span></button>':y='<button class="lcs__btn lcs__btn--view" data-action="INFO" aria-label="View"><span>View</span></button>',`${w}${y}`})();this.shadowRoot.innerHTML=`
            <style>
                ${He()}
                ${Ss()}
        ...
        `}}customElements.define("bma-tournament-list-card",B1);const Fn=`
...
`.trim();typeof window<"u"&&(window.EMPTY_BETSLIP_HTML=Fn);const ke={updateTDBalance(e,t){const s=document.querySelector(e);if(!s)return;t%1!==0?s.textContent=t.toFixed(2):neodigmUtils.countTo(e,t)},updateSummaryAndDashboard(e,t,s,a=null,n=0){const r=document.querySelector("#summary-balance"),o=document.querySelector("#summary-stake"),l=document.querySelector("#summary-payout");r&&(this.updateTDBalance("#summary-balance",e),e<0?r.classList.add("summary-cell__red"):r.classList.remove("summary-cell__red")),o&&(o.textContent=t.toFixed(2)),l&&(l.textContent=s.toFixed(2),s<0?l.classList.add("summary-cell__red"):l.classList.remove("summary-cell__red"));const i=document.getElementById("dashboard-td-balance"),c=document.getElementById("dashboard-td-pending");if(i){let d="";if(a){const p=a.tournament_dollars||0,f=e-p;f>0?d=`<span style="display: block; color: var(--status-upcoming-text, #00E676); font-size: 0.6em; margin-top: 2px;">(+${f.toLocaleString()})</span>`:f<0&&(d=`<span style="display: block; color: var(--status-locked-text, #F7C60D); font-size: 0.6em; margin-top: 2px;">(${f.toLocaleString()})</span>`)}const u=e<0?"#FF5252":"#00E676";i.innerHTML=`<span style="color: ${u};">TD$ ${e.toLocaleString()}</span>${d}`}if(c){const d=n||s||0;let u="";d>0&&(u=`<span style="display: block; color: var(--status-upcoming-text, #00E676); font-size: 0.6em; margin-top: 2px;">(→${d.toLocaleString()})</span>`),c.innerHTML=`TD$ ${t.toLocaleString()}${u}`}if(a&&a.tournament_dollars){const d=a.tournament_dollars,u=document.querySelector(".dash-stat__gauge-fill--balance");if(u){const f=Math.max(e/d*100,0);u.style.width=`${f}%`}const p=document.querySelector(".dash-stat__gauge-fill--pending");if(p){const f=Math.min(t/d*100,100);p.style.width=`${f}%`}}this.updateBetSlipToggleSummary()},updateBetSlipToggleSummary(){const e=document.getElementById("bet-grid-toggle-count"),t=document.querySelector(".bet-grid__toggle-container");if(!e||!t)return;const s=document.querySelectorAll(".bet-grid__slip-BETSLIP-content bma-bet-entry").length;e.textContent=s,t.classList.toggle("bet-grid__toggle-container--has-bets",s>0);const a=document.getElementById("bet-slip-tab-slip-badge");a&&(a.textContent=s,a.style.visibility=s>0?"visible":"hidden");const n=document.getElementById("bet-slip-tab-mybets-badge");if(n){const r=document.querySelectorAll(".bet-grid__slip-MYBETS bma-bet-existing").length;n.textContent=r,n.style.visibility=r>0?"visible":"hidden"}},_globalLBCache:{},async prefetchGlobalLeaderboard(e="ALL"){const s=this._globalLBCache[e];if(s?.data&&Date.now()-s.ts<3e5)return s.data;if(s?.inflight)return null;this._globalLBCache[e]={data:s?.data||null,ts:s?.ts||0,inflight:!0};try{const a=await Oe.fetchAllTimeLeaderboard(e,100,"td");return this._globalLBCache[e]={data:a,ts:Date.now(),inflight:!1},console.log(`[appEvents] All-time leaderboard prefetched [${e}]:`,a?.count||0,"rows, last_updated:",a?.last_updated),a}catch(a){return console.warn(`[appEvents] All-time leaderboard prefetch failed [${e}]:`,a),this._globalLBCache[e]&&(this._globalLBCache[e].inflight=!1),null}},_betStatsCache:{stats:null,ts:0,inflight:!1},async _ensureBetStatsCache(e){const s=Date.now();if(this._betStatsCache.stats&&s-this._betStatsCache.ts<3e5)return this._betStatsCache.stats;if(this._betStatsCache.inflight)return null;this._betStatsCache.inflight=!0;try{const n=(await Oe.fetchBetSlips(e))?.rows||[];let r=0,o=0,l=0;return n.forEach(i=>{(i.bet||[]).forEach(d=>{Object.keys(d).forEach(u=>{if(u==="short_title")return;const p=d[u];!p||typeof p!="object"||(p.reconciled===!0?parseFloat(p.payout||0)>0?r++:o++:l++)})})}),this._betStatsCache={stats:{wins:r,losses:o,pending:l},ts:s,inflight:!1},this._betStatsCache.stats}catch(a){return console.warn("[app_events] fetchBetSlips failed for stats panel",a),this._betStatsCache.inflight=!1,null}},buildStatsPanel(e,t,s=null){if(!t||!e||e.length===0)return"";const a=e.filter(g=>(g.entities?.guids||[]).includes(t)),n=a.filter(g=>(g.status||g.class)==="COMPLETED").length;let r=0,o=0;a.forEach(g=>{(Array.isArray(g.tags)?g.tags:[]).forEach(v=>{if(!v||typeof v!="object")return;const m=(v.entity_guid===t?v.badge:null)||(typeof v[t]=="string"?v[t]:null);typeof m=="string"&&m.startsWith("--badge__ribbon--")&&(o++,m==="--badge__ribbon--gold"&&r++)})});const l={};a.forEach(g=>{(Array.isArray(g.sports_allowed)?g.sports_allowed:[]).forEach(v=>{const h=Ge.find(b=>b.key===v.key)?.group||"Other";l[h]=(l[h]||0)+1})});let i="—",c="",d=0;Object.entries(l).forEach(([g,_])=>{_>d&&(d=_,i=g,c=g)});let u="—",p="Pending";if(s){const g=s.wins+s.losses;g>0?(u=`${Math.round(s.wins/g*100)}%`,p=`${s.wins}-${s.losses}`):(u="—",p="No settled bets")}const f=c?`<bma-sport-icon data-sport-group="${c.toLowerCase()}"></bma-sport-icon>`:"";return`
        ...
        `},categorizeTournaments(e,t,s,a,n={}){const r=[],{subStatus:o="all",sort:l="default",result:i="all",odds:c="all"}=n,d=T=>(T.entities?.guids||[]).includes(a),u=T=>T.status==="UPCOMING"||T.class==="UPCOMING",p=T=>T.status==="LOCKED"||T.class==="LOCKED",f=T=>u(T)||p(T),g=T=>T.status==="COMPLETED"||T.class==="COMPLETED",_=T=>Array.isArray(T.matches_expanded)&&T.matches_expanded.length>0,v=(T,k)=>(T.sports_allowed||[]).some(S=>S.key===k),m=T=>{if(!T)return"";const k=String(T),S=k.toLowerCase(),O=Ge.find(I=>I.key===k||String(I.key).toLowerCase()===S||String(I.title||"").toLowerCase()===S);return O?.title?O.title:/^[a-zA-Z]{2,5}$/.test(k)?k.toUpperCase():k},h=T=>{const k=T.tags||[];for(const S of k)if(!(typeof S!="object"||!S)&&(S.entity_guid===a&&S.badge||S[a]))return!0;return!1},b=T=>{if(l==="default")return T;const k=[...T];switch(l){case"starting_soon":k.sort((S,O)=>new Date(S.window_start_time||0)-new Date(O.window_start_time||0));break;case"most_entrants":k.sort((S,O)=>(O.entities?.guids?.length||0)-(S.entities?.guids?.length||0));break;case"fewest_spots":k.sort((S,O)=>{const I=(S.entities?.max||0)-(S.entities?.guids?.length||0),q=(O.entities?.max||0)-(O.entities?.guids?.length||0);return I-q});break;case"recently_active":k.sort((S,O)=>new Date(O.status_time||0)-new Date(S.status_time||0));break;case"newest":k.sort((S,O)=>new Date(O.status_time||0)-new Date(S.status_time||0));break;case"td_high":k.sort((S,O)=>parseFloat(O.tournament_dollars||0)-parseFloat(S.tournament_dollars||0));break;case"td_low":k.sort((S,O)=>parseFloat(S.tournament_dollars||0)-parseFloat(O.tournament_dollars||0));break}return k},w=T=>i==="all"?T:i==="trophy"?T.filter(k=>h(k)):i==="no_trophy"?T.filter(k=>!h(k)):T;let y=e,x="",P=s||"all";if(s==="multi"?(y=e.filter(T=>(T.sports_allowed?.length||0)>1),x="Multi-Sport "):s!=="all"&&(y=e.filter(T=>v(T,s)),x=m(s)+" "),t==="lobby"){const T=n.lobbySubTab||"active";let k=y.filter(S=>S.is_private!==!0);if(T==="completed"){const S=b(k.filter(O=>g(O))).slice(0,20);S.length>0?r.push({title:`Recently Completed ${x}Tournaments`,tournaments:S}):r.push({title:`Recently Completed ${x}Tournaments`,tournaments:[],emptyMessage:"No recently completed tournaments",emptySubtext:"Finished public tournaments will show up here."})}else{let S=k.filter(q=>f(q));o==="open"?S=S.filter(q=>u(q)):o==="locked"&&(S=S.filter(q=>p(q)));const O=b(S.filter(q=>u(q)&&!d(q)));r.push({title:`Open Entry ${x}Tournaments`,tournaments:O});const I=b(S.filter(q=>p(q)&&!d(q)));I.length>0&&r.push({title:`In Progress - Entry Closed ${x}Tournaments`,tournaments:I})}}else if(t==="my"){const T=n.mySubTab||"active",k=y.filter(S=>d(S));if(T==="completed"){const S=w(k.filter(I=>g(I))),O=b(S);O.length>0?r.push({title:`Your Completed ${x}Tournaments`,tournaments:O}):r.push({title:`Completed ${x}Tournaments`,tournaments:[],emptyMessage:"No completed contests yet",emptySubtext:"Finished tournaments you joined will show here."})}else{let S=k.filter(I=>f(I));o==="active"?S=S.filter(I=>p(I)):o==="upcoming"&&(S=S.filter(I=>u(I))),c==="available"?S=S.filter(I=>_(I)):c==="none"&&(S=S.filter(I=>!_(I)));const O=b(S);O.length>0?r.push({title:`Your Active ${x}Tournaments`,tournaments:O}):r.push({title:`Active ${x}Tournaments`,tournaments:[],emptyMessage:"No active contests",emptySubtext:"Join a tournament from the Lobby and it'll show up here."})}}else if(t==="private")if((n.privateSubTab||"all")==="invites")r.push({title:"Invites",tournaments:[],emptyMessage:"No pending invites",emptySubtext:null});else{const k=y.filter(I=>I.is_private===!0),S=b(k.filter(I=>I.creator_guid&&I.creator_guid===a)),O=b(k.filter(I=>(!I.creator_guid||I.creator_guid!==a)&&d(I)));S.length>0&&r.push({title:"Running",tournaments:S}),O.length>0&&r.push({title:"Playing In",tournaments:O}),S.length===0&&O.length===0&&r.push({title:"Bet Max Pools",tournaments:[],emptyMessage:"No pools yet",emptySubtext:"Start your own Bet Max Pool. Your contest, your rules."})}else r.push({title:"Tournaments",tournaments:e});const D=P==="all"||P==="multi"?"":m(P);return r.forEach(T=>{T.sportKey=P,T.sportLabel=D}),r},updateTournamentDashboard(e){if(!e)return;console.log("[Dashboard Update] Starting dashboard update for:",e.caption);const t=xe();t.appSession?.session_user?.guid;const s=e.tournament_dollars||1e4;let a=0,n=0,r=0;if(t.coreBetSlip&&t.coreBetSlip.length>0){const v=t.coreBetSlip[t.coreBetSlip.length-1].data.filter(m=>m.tournament_guid===e.guid);console.log("[Dashboard Update] Found",v.length,"existing bets for this tournament"),v.forEach(m=>{(m.bet||[]).forEach(b=>{Object.keys(b).filter(y=>y!=="short_title").forEach(y=>{const x=b[y];x&&(x.stake&&(a+=parseFloat(x.stake)),x.reconciled===!0&&x.payout>0&&(n+=parseFloat(x.payout)))})})})}const o=document.querySelector("#summary-stake");if(o){const _=parseFloat(o.textContent)||0;r=Math.max(0,_-a),console.log("[Dashboard Update] Summary total stakes:",_,"Pending:",r)}const l=a+r,i=s-a-r+n;console.log("[Dashboard Update] TD$:",s,"Committed:",a,"Pending:",r,"Payouts:",n,"=> Balance:",i);const c=document.getElementById("dashboard-td-balance");if(c){const _=i-s;let v="";_>0?v=`<span style="display: block; color: var(--status-upcoming-text, #00E676); font-size: 0.6em; margin-top: 2px;">(+${_.toLocaleString()})</span>`:_<0&&(v=`<span style="display: block; color: var(--status-locked-text, #F7C60D); font-size: 0.6em; margin-top: 2px;">(${_.toLocaleString()})</span>`);const m=i<0?"#FF5252":"#00E676";c.innerHTML=`<span style="color: ${m};">TD$ ${i.toLocaleString()}</span>${v}`}const d=document.getElementById("dashboard-td-pending"),u=document.querySelector(".dash-stat__gauge-fill--pending");if(d){const _=r>0?r:l,v=n||0;let m="";if(v>0&&(m=` <span style="color: var(--status-upcoming-text, #00E676); font-size: 0.7em;">(→${v.toLocaleString()})</span>`),d.innerHTML=`TD$ ${_.toLocaleString()}${m}`,u){const h=Math.min(_/s*100,100);u.style.width=`${h}%`}}const p=document.querySelector(".dash-stat__gauge-fill--balance");if(p){const _=Math.max(i/s*100,0);p.style.width=`${_}%`}const f=document.querySelector(".dash-stat__gauge-fill--participants");if(f&&e){const _=e.entities?.guids?.length||0,v=e.entities?.max||100,m=_/v*100;f.style.width=`${m}%`}const g=document.getElementById("game-mode-progress");if(g&&typeof window.GameMode<"u"){const _=e.class||"DEFAULT",v=window.GameMode.get(_),m=t.coreBetSlip.length>0?t.coreBetSlip[t.coreBetSlip.length-1].data.filter(b=>b.coreTournaments__guid===e.guid||b.tournament_guid===e.guid):[],h=v.getProgressUI(m,e);if(h.type!=="NONE"){const b=h.typesStatus?h.typesStatus.map(y=>y.placed?`<span style="display: inline-flex; align-items: center; gap: 5px; padding: 4px 12px; border-radius: 9999px; background: rgba(0, 230, 118, 0.12); box-shadow: inset 0 0 0 1px rgba(0, 230, 118, 0.35); color: #00E676; font-size: 0.72rem; font-weight: 700; letter-spacing: 0.3px;">
        ...
        `:`<div class="info-empty-state">
            ...
            <p>No trophies configured for this tournament</p>
        </div>`,q=(()=>{if(!n.matches_expanded||!Array.isArray(n.matches_expanded)||n.matches_expanded.length===0)return`<div class="info-empty-state" style="animation: motion-fade-through-enter 210ms cubic-bezier(0.4, 0, 0.2, 1) both;">
                ...
                </div>`;let N=0,R=0,L=0;const z=new Date;n.matches_expanded.forEach(ee=>{let ce=null;try{ce=typeof ee.scoreboard_data=="string"?JSON.parse(ee.scoreboard_data):ee.scoreboard_data}catch{}ce?.time_remaining?ce.time_remaining.toLowerCase()==="final"?N++:R++:new Date(ee.scheduled_at)<z?N++:L++});const se=R>0?"live":"upcoming",oe=[];N>0&&oe.push(`<span class="match-filter-btn${se==="final"?" match-filter--active":""}" data-filter="final">${N} Final</span>`),R>0&&oe.push(`<span class="match-filter-btn match-filter-btn--live${se==="live"?" match-filter--active":""}" data-filter="live">${R} Live</span>`),L>0&&oe.push(`<span class="match-filter-btn match-filter-btn--upcoming${se==="upcoming"?" match-filter--active":""}" data-filter="upcoming">${L} Upcoming</span>`);const ie=oe.length>0?`<div class="match-filter-bar">${oe.join("")}</div>`:"",ae=new Date,ne=n.matches_expanded.map(ee=>{const ce=ee.scoreboard_data?typeof ee.scoreboard_data=="string"?ee.scoreboard_data:JSON.stringify(ee.scoreboard_data):"";let fe="upcoming",he=null;try{he=typeof ee.scoreboard_data=="string"?JSON.parse(ee.scoreboard_data):ee.scoreboard_data}catch{}he?.time_remaining?fe=he.time_remaining.toLowerCase()==="final"?"final":"live":fe=new Date(ee.scheduled_at)<ae?"final":"upcoming";const ve=fe!==se;return`<bma-match-status
                    ...
                    data-match-scoreboard="${ce.replace(/"/g,"&quot;")}"
            ...
            `})(),J=n.status==="UPCOMING"?"Accepting new players. Place bets before each match starts.":n.status==="LOCKED"?"No new entrants. Joined players can still bet on matches that haven't started yet.":n.status==="COMPLETED"?"All matches settled. Final standings locked in.":"",W=`
            <div class="info-summary-pack">
                ...
                <div class="info-summary-pack__stat">
                    ...
                    <span class="info-summary-pack__stat-value">${D}</span>
                </div>
            </div>
        `,X=`
            ...
            <div class="info-pack info-pack--padded">
                <div class="info-progress-status">
                    <div class="info-progress-status__row">
                        ...
                        <span class="info-progress-status__value" style="color: ${k};">${T}</span>
                    </div>
                    ${J?`<div class="info-progress-status__hint">${J}</div>`:""}
                </div>
        ...
        `;r.innerHTML=`
            <div class="info-wrap">
                ...
                <div class="info-pack">
                    ...
                    <div class="info-tab-panel" data-info-panel="summary">${O}${S}</div>
        ...
        `;const j=r.querySelector("[data-info-legend-toggle]");j&&j.addEventListener("click",()=>{const R=j.closest(".info-legend").classList.toggle("info-legend--open");j.setAttribute("aria-expanded",String(R))});const Z=r.querySelector("[data-info-share-btn]");Z&&Z.addEventListener("click",async()=>{const N=Z.dataset.shareUrl,R=Z.dataset.shareCaption||"tournament";if(!N)return;const L=`Join ${R}`,z=`You're invited to join ${R} on Bet Max Tourney.`;if(typeof navigator<"u"&&typeof navigator.share=="function")try{await navigator.share({title:L,text:z,url:N});return}catch(se){if(se?.name==="AbortError")return}try{await navigator.clipboard.writeText(N),typeof neodigmToast<"u"&&neodigmToast.q("Invite link copied","success")}catch(se){console.warn("[info share] clipboard write failed:",se),typeof neodigmToast<"u"&&neodigmToast.q("Copy failed. Link: "+N,"danger")}}),r.querySelectorAll(".info-tab").forEach(N=>{N.addEventListener("click",()=>{r.querySelectorAll(".info-tab").forEach(L=>L.classList.remove("info-tab--active")),N.classList.add("info-tab--active");const R=N.dataset.infoTab;r.querySelectorAll(".info-tab-panel").forEach(L=>{L.style.display=L.dataset.infoPanel===R?"":"none"})})});const F=r.querySelector('[data-info-panel="matches"]');F&&F.addEventListener("click",N=>{const R=N.target.closest(".match-filter-btn");R&&(F.querySelectorAll(".match-filter-btn").forEach(L=>L.classList.remove("match-filter--active")),R.classList.add("match-filter--active"),F.querySelectorAll("bma-match-status").forEach(L=>{L.style.display=L.dataset.matchStatus===R.dataset.filter?"":"none"}))});const E=document.getElementById("pop-play__caro-info-summary2--id");E&&(E.innerHTML="");const M=document.getElementById("pop-play__caro-info-list--id");M&&(M.innerHTML="")},async populateLeaderboard(){const e=xe(),s=document.querySelector(".play-cntr")?.dataset?.currentTournGuid,a=e.appSession?.session_user?.guid;if(!s){console.warn("[appEvents] Cannot populate leaderboard: no tournament GUID");return}const n=document.getElementById("pop-play__caro-leaderboard--id");if(!n)return;let r=document.getElementById("leaderboard-loading-banner");r||(r=document.createElement("neodigm-juicebar"),r.id="leaderboard-loading-banner",r.setAttribute("role","progressbar"),r.setAttribute("data-n55-theme","warning"),r.setAttribute("data-n55-size","small"),r.innerHTML="<div></div>",r.style.cssText=`
                width: 100%;
                margin: 6px;
            `,n.parentNode.insertBefore(r,n)),r.style.visibility="visible";try{const o=await Oe.fetchLeaderboard(s),l=o?.data||o?.rows;if(l&&l.length>0){const c=e.coreTourn[e.coreTourn.length-1]?.data.find(J=>J.guid===s),d=c?.class||"DEFAULT_FORMAT",u=window.GameMode?.get?.(d),p=u?.rankLeaderboard?u.rankLeaderboard(l.map(J=>{const W=typeof J.combined_betslips=="string"?(()=>{try{return JSON.parse(J.combined_betslips)}catch{return[]}})():J.combined_betslips||[];return{...J,bets:W,timestamp:J.created_at||J.updated_at||0}}),c):l,f=parseFloat(c?.tournament_dollars||0),g=J=>{if(d!=="DEFAULT_FORMAT"||f<=0)return!0;let W=0;return(J.bets||[]).forEach(Q=>{(Q.bet||[]).forEach(V=>{Object.keys(V).forEach(re=>{re!=="short_title"&&(W+=parseFloat(V[re]?.stake||0))})})}),W>=f-.01},v=(()=>{if(d!=="DEFAULT_FORMAT")return"";const W=(c?.tags||[]).find(B=>B.badge_gold!==void 0||B.badge_silver!==void 0||B.badge_bronze!==void 0);if(!W)return"";const Q=W.badge_gold||0,V=W.badge_silver||0,re=W.badge_bronze||0;if(Q===0&&V===0&&re===0)return"";const H=p.some(B=>(B.bets||[]).some(G=>(G.bet||[]).some(j=>Object.keys(j).some(Z=>Z!=="short_title"&&j[Z]?.reconciled===!0))))?p.filter(g):[],X=B=>{if(!B)return'<span class="podium-slot__empty">Open</span>';const G=B.user_guid===a;return`<span class="podium-slot__name${G?" podium-slot__name--you":""}">${B.username||"Unknown"}${G?' <span class="podium-slot__you">YOU</span>':""}</span>`},K=Array.from({length:Q},(B,G)=>X(H[G])).join(""),A=Array.from({length:V},(B,G)=>X(H[Q+G])).join(""),$=Array.from({length:re},(B,G)=>X(H[Q+V+G])).join(""),U=c?.status==="COMPLETED"?"":"Waiting for bets to settle";return`
                        <div class="leaderboard-podium">
                            <div class="leaderboard-podium__title">Trophy Preview</div>
                            <div class="leaderboard-podium__pack">
                                ${V>0?`<div class="podium-slot podium-slot--silver">
                                    <div class="podium-slot__trophy podium-slot__trophy--silver"></div>
                                    <span class="podium-slot__count">&times;${V}</span>
                                ...
                                ${Q>0?`<div class="podium-slot podium-slot--gold">
                                    ...
                                    <div class="podium-slot__pedestal podium-slot__pedestal--gold">
                                        <div class="podium-slot__names">${K}</div>
                                    </div>
                                </div>`:'<div class="podium-slot podium-slot--spacer"></div>'}
                                ${re>0?`<div class="podium-slot podium-slot--bronze">
                ...
                `,y=(J,W,Q=!1)=>{let V="";if(c?.tags&&Array.isArray(c.tags)){const A=c.tags.find($=>!!(typeof $=="object"&&$!==null&&($.entity_guid===J.user_guid&&$.badge&&$.badge.startsWith("--badge__ribbon--")||$[J.user_guid]&&$[J.user_guid].startsWith("--badge__ribbon--"))));if(A){const $=A.badge||A[J.user_guid];$==="--badge__ribbon--gold"?V="badge-trophy--gold":$==="--badge__ribbon--silver"?V="badge-trophy--silver":$==="--badge__ribbon--bronze"&&(V="badge-trophy--bronze")}}const re=J.combined_betslips?typeof J.combined_betslips=="string"?J.combined_betslips:JSON.stringify(J.combined_betslips):"[]";let Y="[]";if(J.combined_betslips&&c?.matches_expanded){const A=typeof J.combined_betslips=="string"?JSON.parse(J.combined_betslips):J.combined_betslips,$=[...new Set(A.map(B=>B.coreMatches__guid||B.match_guid||B.odds_id).filter(Boolean))],U=c.matches_expanded.filter(B=>{const G=B.guid||B.id||B.odds_id;return $.includes(G)});Y=JSON.stringify(U)}const H=parseFloat(J.calculated_tournament_dollars||0),X=parseInt(J.total_betslips||0),K=H===0&&X===0?c?.tournament_dollars||0:J.calculated_tournament_dollars||0;return`
                        <bma-leaderboard-card
                            data-rank="${W}"
                            data-username="${J.username||"Unknown"}"
                            data-user-guid="${J.user_guid||""}"
                            data-tournament-dollars="${K}"
                            data-starting-dollars="${c?.tournament_dollars||0}"
                            data-total-betslips="${J.total_betslips||0}"
                            data-total-payout="${J.total_payout||0}"
                            data-combined-betslips="${re.replace(/"/g,"&quot;")}"
                            data-user-matches="${Y.replace(/"/g,"&quot;")}"
                            data-badge-class="${V}"
                            data-is-current-user="${J.user_guid===a}"
                            data-unqualified="${Q}"
                            data-sync-theme="dark"
                        ></bma-leaderboard-card>
                    `},x=p.filter(g),P=p.filter(J=>!g(J)),T=(d==="DEFAULT_FORMAT"&&x.length>0?`
                ...
                `:"")+x.map((J,W)=>y(J,W+1,!1)).join(""),k=P.length>0?`
                    ...
                    ${P.map(J=>y(J,"—",!0)).join("")}
                `:"";n.innerHTML=v+w+T+k,requestAnimationFrame(()=>{n.querySelectorAll("bma-leaderboard-card").forEach((J,W)=>{J.style.animation="motion-slide-up-enter 300ms cubic-bezier(0.4, 0, 0.2, 1) both",J.style.animationDelay=`${Math.min(W*60,400)}ms`})}),n.querySelectorAll(".leaderboard-tab").forEach(J=>{J.addEventListener("click",()=>{const W=J.dataset.lbTab;n.querySelectorAll(".leaderboard-tab").forEach(Q=>Q.classList.remove("leaderboard-tab--active")),J.classList.add("leaderboard-tab--active"),n.querySelectorAll("[data-lb-panel]").forEach(Q=>{Q.style.display=Q.dataset.lbPanel===W?"":"none"})})});const S=x.findIndex(J=>J.user_guid===a),O=c?.entities?.guids?.length||p.length,I=S>=0?S+1:"—",q=document.getElementById("dashboard-rank");if(q){const J=I==="—"?"—":`${I}/${O}`;q.innerHTML=`<span class="tourn-dashboard__rank-text">${J}</span><span style="display: block; font-size: 0.6em; margin-top: 2px; visibility: hidden;">(0)</span>`}}else n.innerHTML=`
            ...
            `;let d={subStatus:a,sort:n,result:r};c.addEventListener("click",u=>{const p=u.target.closest(".filter-chip");if(!p||p.classList.contains("filter-chip--disabled"))return;const f=p.dataset.filterType,g=p.dataset.filterVal;d[f]=g,c.querySelectorAll(`[data-filter-type="${f}"]`).forEach(_=>_.classList.remove("filter-chip--active")),p.classList.add("filter-chip--active")}),document.getElementById("filter-reset-btn")?.addEventListener("click",()=>{const u=i[s]||i.lobby;d={...u},Object.keys(u).forEach(p=>{c.querySelectorAll(`[data-filter-type="${p}"]`).forEach(f=>f.classList.remove("filter-chip--active")),c.querySelector(`[data-filter-type="${p}"][data-filter-val="${u[p]}"]`)?.classList.add("filter-chip--active")})}),document.getElementById("filter-apply-btn")?.addEventListener("click",()=>{neodigmSodaPop.close(),t&&t(d)})}),neodigmSodaPop.autoOpen("sodapop_filters")},bindAppListeners(e){de.subscribe("APP",(T,k)=>{console.warn("~~ sub all APP | "+T+"|"+k)}),de.subscribe("WC",(T,k)=>{console.warn("~~ sub all WC  | "+T+"|"+k)}),de.subscribe("ROUTE",(T,k)=>{console.warn("~~ sub all ROUTE  | "+T+"|"+k)});let t="lobby",s="all",a="all",n="all",r="active",o="active",l="default",i="all",c="all",d=localStorage.getItem("bma_view_mode")||"cards";const u=()=>{s="all";const T=document.querySelector("bma-app-head-sports");T&&T.setAttribute("data-selected-chip","all")},p=()=>{const T=document.getElementById("filter-bar__count--id");if(!T)return;let k=0;a!=="all"&&k++,l!=="default"&&k++,i!=="all"&&k++,T.textContent=k,T.style.display=k>0?"":"none"},f=()=>{document.querySelectorAll(".home-tab").forEach(O=>O.classList.remove("home-tab--active"));let k=null;if(t==="lobby"?k=o==="completed"?'[data-home-tab="lobby-completed"]':'[data-home-tab="lobby-active"]':t==="private"?k=n==="invites"?'[data-home-tab="private-invites"]':'[data-home-tab="private-all"]':t==="my"&&(k=r==="completed"?'[data-home-tab="my-completed"]':'[data-home-tab="my-active"]'),!k)return;const S=document.querySelector(k);S&&S.classList.add("home-tab--active")},g=()=>{a="all",l="default",i="all",c="all"};document.addEventListener("click",T=>{const k=T.target.closest(".category-filter-toggle");if(k){const I=k.closest(".tournament-category-header")?.querySelector(".category-filter-row");if(I){const q=I.style.display!=="none";I.style.display=q?"none":"",k.classList.toggle("category-filter-toggle--open",!q),window._bmaFilterRowOpen=!q}return}const S=T.target.closest("[data-view-mode]");if(S){const O=S.dataset.viewMode;if(O===d)return;d=O,localStorage.setItem("bma_view_mode",O),document.querySelectorAll("[data-view-mode]").forEach(I=>I.classList.remove("view-toggle__btn--active")),document.querySelectorAll(`[data-view-mode="${O}"]`).forEach(I=>I.classList.add("view-toggle__btn--active")),de.publish(e.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"VIEW_MODE_CHANGE"}))}}),document.addEventListener("click",T=>{const k=T.target.closest("[data-home-tab]");if(!k)return;const S=k.dataset.homeTab;let O=!1;if(S==="lobby-active"||S==="lobby-completed"){const I=S==="lobby-completed"?"completed":"active";if(t==="lobby"&&I===o)return;t="lobby",o=I,O=!0}else if(S==="my-active"||S==="my-completed"){const I=S==="my-completed"?"completed":"active";if(t==="my"&&I===r)return;t="my",r=I,O=!0}else if(S==="private-all"||S==="private-invites"){const I=S==="private-invites"?"invites":"all";if(t==="private"&&I===n)return;t="private",n=I,O=!0}O&&(u(),g(),p(),document.querySelectorAll(".home-tab").forEach(I=>I.classList.remove("home-tab--active")),k.classList.add("home-tab--active"),de.publish(e.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"HOME_TAB_CHANGE"})))}),document.addEventListener("change",T=>{const k=T.target.closest(".category-dropdown");if(!k)return;const S=k.dataset.filterType,O=k.value;S==="subStatus"?a=O:S==="sort"?l=O:S==="result"?i=O:S==="odds"&&(c=O),p(),de.publish(e.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"DROPDOWN_FILTER_CHANGE"}))}),de.subscribe(e.hierTopics.COREBETSLIP,(T,k)=>{JSON.parse(k);let S=16;switch(T){case e.hierTopics.COREBETSLIP__BET:S=5,aa.shootConfetti(),console.log("~~~  |  "+T+" | ",k);const O=document.querySelector("[data-bets-valid]");O&&(O.dataset.betsValid="false");const I=document.querySelector("neodigm-sodapop");I&&I.setAttribute("data-wait","true");const q=document.querySelectorAll(".bet-grid__slip-BETSLIP-content bma-bet-entry");if(q.length===0){console.warn("[app_events] No bets to submit"),I&&I.setAttribute("data-wait","false"),typeof neodigmToast<"u"&&neodigmToast.q("No bets to submit","warning");break}const J=document.querySelector(".play-cntr"),W=J?.dataset?.currentTournGuid,Q=e.appSession?.session_user?.guid;if(!W||!Q){console.error("[app_events] Missing tournament or user GUID"),I&&I.setAttribute("data-wait","false"),typeof neodigmToast<"u"&&neodigmToast.q("Missing tournament or user data","danger");break}const V=Array.from(q).map(B=>{const G=B.getAttribute("data-content-team-points"),j=B.getAttribute("data-content-odds"),Z=B.getAttribute("data-stake")||"0",F=B.getAttribute("data-content-type"),E=B.getAttribute("data-payout")||"0",M=B.getAttribute("data-match-guid")||"",N={};return N[G]={type:F,stake:parseFloat(Z),odds:parseFloat(j),payout:parseFloat(E),reconciled:!1},{acctEntity__guid:Q,coreTournaments__guid:W,coreMatches__guid:M,bet:[N],status:"PENDING"}});console.log("[app_events] Submitting bet slips:",V);const re=J?.dataset?.gameType||"DEFAULT";if(typeof window.GameMode<"u"){const B=window.GameMode.get(re),j=[...e.coreBetSlip.length>0?e.coreBetSlip[e.coreBetSlip.length-1].data.filter(M=>M.coreTournaments__guid===W):[],...V],F=(e.coreTourn.length>0?e.coreTourn[e.coreTourn.length-1]:null)?.data.find(M=>M.guid===W),E=B.validateBetSlip(j,F,0);if(!E.valid){console.log("[app_events] Game mode validation failed:",E.errors),typeof neodigmToast<"u"&&E.errors.forEach(N=>neodigmToast.q(N,"warning",4e3)),I&&I.setAttribute("data-wait","false");const M=document.querySelector("[data-publish-betslip]");M&&delete M.dataset.processing;break}}Oe.postBetSlips(V).then(B=>{console.log("[app_events] Bet slips posted successfully:",B);const G=V.reduce((j,Z)=>{const F=Z.bet[0],E=Object.keys(F)[0];return j+(F[E]?.stake||0)},0);typeof neodigmToast<"u"&&neodigmToast.q(`Bets placed successfully!|Total Stake: TD$ ${G.toFixed(2)}`,"success"),Oe.fetchBetSlips(Q,W).then(j=>{if(j?.rows){const Z={timestamp:Date.now(),source:"API",data:j.rows};e.pushcoreBetSlip(Z),console.log("[app_events] Refreshed bet slips in store:",j.rows.length,"items")}ke.refreshPlayPopupUI(W,j),I&&I.setAttribute("data-wait","false")}).catch(j=>{console.error("[app_events] Error fetching fresh bet slips:",j);const Z=document.querySelector("[data-publish-betslip]");Z&&delete Z.dataset.processing,O&&(O.dataset.betsValid="true"),I&&I.setAttribute("data-wait","false"),typeof neodigmToast<"u"&&neodigmToast.q("Bets placed but failed to refresh|Please close and reopen","warning")})}).catch(B=>{console.error("[app_events] Error posting bet slips:",B);const G=document.querySelector("[data-publish-betslip]");G&&delete G.dataset.processing,O&&(O.dataset.betsValid="true"),typeof neodigmToast<"u"&&neodigmToast.q("Failed to place bets|Please try again","danger"),I&&I.setAttribute("data-wait","false")});break;case e.hierTopics.COREBETSLIP__SPREAD:break;case e.hierTopics.COREBETSLIP__MONEY:break;case e.hierTopics.COREBETSLIP__TOTAL:break;case e.hierTopics.COREBETSLIP__CLOSE:S=24;break;case e.hierTopics.COREBETSLIP__TDSYNC:if(document.querySelector("#summary-balance")&&k){k=JSON.parse(k);const G=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;if(e.coreBetSlip[0]?.data&&G){const j=e.coreBetSlip[0].data.filter(se=>se.coreTournaments__guid===G),Z=[],F=[],E=[];j.forEach(se=>{const oe=se.bet||[];if(oe.length===0)return;const ie=oe[0];Object.keys(ie).filter(ne=>ne!=="short_title").forEach(ne=>{const ee=ie[ne],ce=ee?.reconciled!==!1,fe=parseFloat(ee?.payout||0);ce?fe===0?F.push(se):E.push(se):Z.push(se)})});const M=wt.search(Z,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0,N=wt.search(F,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0,R=M+N,L=wt.search(E,"sum([].bet[].* | [].payout | map(&to_number(@), @)) || `0`")||0,z=k.tournament_dollars-R+L;ke.updateTDBalance("#summary-balance",z)}else ke.updateTDBalance("#summary-balance",k.tournament_dollars)}break;case e.hierTopics.COREBETSLIP__INTERSYNC:let H=0,X=0,K=0;if(e.coreBetSlip.length>0){const G=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;if(G){const Z=e.coreBetSlip[e.coreBetSlip.length-1].data.filter(L=>L.coreTournaments__guid===G),F=[],E=[],M=[];Z.forEach(L=>{const z=L.bet||[];if(z.length===0)return;const se=z[0];Object.keys(se).filter(ie=>ie!=="short_title").forEach(ie=>{const ae=se[ie],ne=ae?.reconciled!==!1,ee=parseFloat(ae?.payout||0);ne?ee===0?E.push(L):M.push(L):F.push(L)})}),H=wt.search(F,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0,X=wt.search(M,"sum([].bet[].* | [].payout | map(&to_number(@), @)) || `0`")||0;const N=wt.search(E,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0,R=wt.search(M,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0;K=N+R}}let A=!0,$=0;const U=document.querySelector("[data-bets-valid]");if(U&&k){k=JSON.parse(k),k.pending_stake_sum=0,k.pending_payout_sum=0,k.bets.length||(A=!1),k.bets.forEach(M=>{M.stake=Number(M.stake),M.stake>0?k.pending_stake_sum+=M.stake:A=!1}),document.querySelectorAll(".bet-grid__slip-BETSLIP-content bma-bet-entry").forEach(M=>{const N=parseFloat(M.getAttribute("data-payout")||"0");k.pending_payout_sum+=N});const G=H+k.pending_stake_sum,j=X+k.pending_payout_sum;$=parseFloat((k.tournament_dollars-G-K+X).toFixed(2));const F=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;let E=null;F&&e.coreTourn.length>0&&(E=e.coreTourn[e.coreTourn.length-1]?.data?.find(N=>N.guid===F)),ke.updateSummaryAndDashboard($,G,j,E,k.pending_payout_sum||0),(k.tournament_dollars<0||$<0)&&(A=!1),U.dataset.betsValid=A}break}S&&neodigmWired4Sound&&neodigmWired4Sound.sound(S,"QUITE").vibrate()});const _=()=>{const k=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;let S=0;k&&e.coreTourn.length>0&&(S=e.coreTourn[e.coreTourn.length-1].data.find(q=>q.guid===k)?.tournament_dollars||0),de.publish(e.hierTopics.COREBETSLIP__TDSYNC,JSON.stringify({tournament_dollars:S,timestamp:Date.now()}))},v=()=>{const k=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;let S=0;k&&e.coreTourn.length>0&&(S=e.coreTourn[e.coreTourn.length-1].data.find(Y=>Y.guid===k)?.tournament_dollars||0);let O=0,I=0,q=0,J=0;if(e.coreBetSlip.length>0&&k){const re=e.coreBetSlip[e.coreBetSlip.length-1].data.filter(U=>U.coreTournaments__guid===k);console.log("[app_events] Filtered bets for tournament:",k,"found:",re.length),console.log("[app_events] Using latest bet slip data index:",e.coreBetSlip.length-1),console.log("[app_events] First bet sample:",re[0]);const Y=[],H=[],X=[];re.forEach(U=>{const B=U.bet||[];if(B.length===0)return;const G=B[0];Object.keys(G).filter(Z=>Z!=="short_title").forEach(Z=>{const F=G[Z],E=F?.reconciled!==!1,M=parseFloat(F?.payout||0);E?M===0?H.push(U):X.push(U):Y.push(U)})}),console.log("[app_events] Bet categories:",{unreconciled:Y.length,reconciledZero:H.length,reconciledNonZero:X.length});const K=wt.search(Y,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0,A=wt.search(H,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0,$=wt.search(X,"sum([].bet[].* | [].stake | map(&to_number(@), @)) || `0`")||0;q=A+$,I=wt.search(X,"sum([].bet[].* | [].payout | map(&to_number(@), @)) || `0`")||0,J=wt.search(Y,"sum([].bet[].* | [].payout | map(&to_number(@), @)) || `0`")||0,O=K,console.log("[app_events] Balance calculation:",{unreconciledStakes:K,lostBetStakes:A,wonBetStakes:$,allReconciledStakes:q,displayedStake:O,reconciledPayouts:I,tournamentDollars:S,calculatedBalance:S-O-q+I})}else console.warn("[app_events] No bet data found in Pinia store or missing tournamentGuid");const W=S-O-q+I;let Q=null;k&&e.coreTourn.length>0&&(Q=e.coreTourn[e.coreTourn.length-1].data.find(re=>re.guid===k)),ke.updateSummaryAndDashboard(W,O,I,Q,J)};de.subscribe(e.hierTopics.SODAPOP__HYDRATE__COREBETSLIP,(T,k)=>{const O=JSON.parse(k)?.rows||[],I=document.querySelector(".bet-grid__slip-MYBETS");if(!I)return;if(I.innerHTML="",O.length===0){I.innerHTML='<p style="color: var(--app-core-color--gray-6__dark--brand, #969696); text-align: center; padding: 20px;">No active bets</p>';const Q=document.querySelector(".bet-grid__slip");Q&&Q.setAttribute("data-active-bet-tab","BETSLIP"),_();return}O.forEach(Q=>{if((Q.bet||[]).length===0)return;const re=document.createElement("bma-bet-existing");re.setAttribute("data-corebetslip",JSON.stringify(Q)),I.appendChild(re)});const q=document.querySelector(".bet-grid__slip");q&&q.setAttribute("data-active-bet-tab","MYBETS"),xe().appCLIFeatures?.features?.disable_existing_bet_btn?.state===!0&&ke.disableExistingBetButtons(),setTimeout(()=>{console.log("[app_events] Calling updateSummaryFromExistingBets after HYDRATE, bet count:",O.length),console.log("[app_events] Pinia store bet count:",e.coreBetSlip[0]?.data?.length||0),v()},200)}),document.addEventListener("click",T=>{const k=T.target;if(k&&k.classList.contains("bet-slip-tab")){const S=k.dataset.betTab,O=document.querySelector(".bet-grid__slip");S&&O&&(O.setAttribute("data-active-bet-tab",S),neodigmWired4Sound&&neodigmWired4Sound.sound(3),console.log("[app_events] Switched to bet tab:",S))}if(k&&k.dataset.publishBetslip){if(document.querySelector("[data-bets-valid]")?.dataset?.betsValid!=="true"){console.warn("[app_events] Cannot submit - bets invalid or button disabled");return}if(k.dataset.processing==="true"){console.warn("[app_events] Bet submission already in progress");return}k.dataset.processing="true";const O=k.dataset.publishBetslip;de.publish(O,JSON.stringify({timestamp:Date.now()}))}});const m=()=>{const k=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;let S=0;k&&e.coreTourn.length>0&&(S=e.coreTourn[e.coreTourn.length-1].data.find(W=>W.guid===k)?.tournament_dollars||0);const O=document.querySelectorAll(".bet-grid__slip-BETSLIP-content bma-bet-entry"),I=Array.from(O).map(q=>({teamPoints:q.getAttribute("data-content-team-points"),odds:q.getAttribute("data-content-odds"),stake:q.getAttribute("data-stake")||"0",type:q.getAttribute("data-content-type"),abbreviatedTitle:q.getAttribute("data-abbreviated-title"),scheduledAt:q.getAttribute("data-scheduled-at")}));de.publish(e.hierTopics.COREBETSLIP__INTERSYNC,JSON.stringify({tournament_dollars:S,bets:I,timestamp:Date.now()}))},h=(T,k)=>{const S=JSON.parse(k),O=document.querySelector(".bet-grid__slip-BETSLIP-content");if(!O){console.error("[app_events] Bet slip container not found");return}const I=O.querySelector(".bet-slip__empty");I&&I.remove();let q="";S.type==="total"?q=S.team==="over"?"Over":"Under":S.team==="home"?q=S.homeTeam:S.team==="away"&&(q=S.awayTeam);let J=q;if(S.point)if(S.type==="spread"){const H=parseFloat(S.point)>0?`+${S.point}`:S.point;J=`${q} ${H}`}else S.type==="total"&&(J=`${q} ${S.point}`);const W=document.createElement("bma-bet-entry");W.setAttribute("data-content-team-points",J),W.setAttribute("data-content-odds",S.price||"0"),W.setAttribute("data-content-stake-text","0"),W.setAttribute("data-content-type",S.type||""),W.setAttribute("data-abbreviated-title",S.abbreviatedTitle||`${S.homeTeam} vs ${S.awayTeam}`),W.setAttribute("data-scheduled-at",S.scheduledAt||""),W.setAttribute("data-match-guid",S.matchGuid||""),W.setAttribute("data-home-team",S.homeTeam||""),W.setAttribute("data-away-team",S.awayTeam||""),W.setAttribute("data-bet-team",q||"");const V=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;if(V&&e.coreTourn.length>0){const X=e.coreTourn[e.coreTourn.length-1].data.find(K=>K.guid===V);if(X?.sports_allowed&&X.sports_allowed.length>0){const K=X.sports_allowed[0];W.setAttribute("data-sport-key",K.key||"");const A=Ge.find($=>$.key===K.key);W.setAttribute("data-sport-group",A?.group||"")}}O.appendChild(W),console.log("[app_events] Bet entry appended to container:",W,"Container children:",O.children.length),setTimeout(()=>{w(W)},0);const re=document.querySelector(".bet-grid__slip");re&&(re.setAttribute("data-active-bet-tab","BETSLIP"),console.log("[app_events] Switched to BETSLIP tab"));const Y=O.querySelectorAll("bma-bet-entry").length;Y>=3?requestAnimationFrame(()=>{setTimeout(()=>{const H=document.querySelector(".bet-grid__slip");H&&(console.log("[app_events] Scrolling parent to bottom - bet count:",Y,"scrollHeight:",H.scrollHeight,"current scrollTop:",H.scrollTop),H.scrollTo({top:H.scrollHeight,behavior:"smooth"}),setTimeout(()=>{console.log("[app_events] After scroll - scrollTop:",H.scrollTop)},500))},150)}):console.log("[app_events] Skipping scroll - only",Y,"bet cards (need 3+)"),setTimeout(()=>{m()},200),console.log("[app_events] Created bet entry:",{teamPoints:J,odds:S.price,type:S.type})};de.subscribe(e.hierTopics.COREBETSLIP__SPREAD,(T,k)=>{h(T,k),b()}),de.subscribe(e.hierTopics.COREBETSLIP__MONEY,(T,k)=>{h(T,k),b()}),de.subscribe(e.hierTopics.COREBETSLIP__TOTAL,(T,k)=>{h(T,k),b()});function b(){const T=window.matchMedia("(orientation: portrait)").matches,k=window.matchMedia("(max-width: 768px)").matches;if(T||k){const S=document.querySelector(".bet-grid__select"),O=document.querySelector(".bet-grid__slip"),I=document.querySelector(".bet-grid__toggle-text");S&&O&&I&&(S.classList.add("collapsed"),O.classList.remove("collapsed"),I.textContent="Close Bet Slip",console.log("[app_events] Bet slip expanded on portrait mode"))}}const w=T=>{const k={sport:{key:T.getAttribute("data-sport-key")||"",group:T.getAttribute("data-sport-group")||""},Match:{scheduled_at:T.getAttribute("data-scheduled-at")||"",home_team_id:T.getAttribute("data-home-team")||"",home_team_score:"",away_team_id:T.getAttribute("data-away-team")||"",away_team_score:""},Bet:{scope:{team_id:T.getAttribute("data-bet-team")||"",over:"",under:""},type:T.getAttribute("data-content-type")||"",odds:T.getAttribute("data-content-odds")||"0",stake:T.getAttribute("data-stake")||"0"}},S=Ru.calcPayout(k);T.setAttribute("data-payout",S.toString()),console.log("[app_events] Payout calculated:",{stake:k.Bet.stake,odds:k.Bet.odds,payout:S})};new MutationObserver(T=>{T.forEach(k=>{k.type==="attributes"&&k.attributeName==="data-stake"&&k.target.tagName==="BMA-BET-ENTRY"&&(console.log("[app_events] Stake changed:",k.target.getAttribute("data-stake")),w(k.target),clearTimeout(window.betSlipStakeTimeout),window.betSlipStakeTimeout=setTimeout(()=>{m()},300))})}).observe(document.body,{attributes:!0,attributeFilter:["data-stake"],subtree:!0}),console.log("[app_events] MutationObserver for stake changes initialized"),document.addEventListener("bma-bet-entry-remove",T=>{console.log("[app_events] Removing bet entry:",T.detail);const k=T.target,S=T.detail;k.remove(),setTimeout(()=>{const J=document.querySelector(".play-cntr")?.dataset?.currentTournGuid;if(J){const W=xe(),Q=W.coreTourn[W.coreTourn.length-1];if(Q&&Q.data){const V=Q.data.find(re=>re.guid===J);V&&ke.updateTournamentDashboard(V)}}},100),document.querySelectorAll("bma-bet-match-card").forEach(q=>{(q.shadowRoot?.querySelectorAll(".btn")||[]).forEach(W=>{const Q=W.dataset.betType,V=W.dataset.price,re=Q===S.type,Y=V===S.odds;re&&Y&&W.classList.contains("btn--active")&&(W.classList.remove("btn--active"),console.log("[app_events] Deactivated button via X removal:",{btnType:Q,btnPrice:V}))})});const I=document.querySelector(".bet-grid__slip-BETSLIP-content");I&&I.children.length===0&&(I.innerHTML=Fn),setTimeout(()=>{m()},100)}),de.subscribe(e.hierTopics.CANVAS__HYDRATE__STATUS,(T,k)=>{const S=JSON.parse(k);S&&S.guid&&neodigmUtils&&neodigmUtils.shake(`[data-bma-tourn-guid="${S.guid}"]`)}),de.subscribe(e.hierTopics.WC__APP__FOOT,(T,k)=>{switch(JSON.parse(k),T){case"WC.APP.FOOT.LOBBY":case"WC.APP.FOOT.ALL_SPORTS":de.publish(e.hierTopics.WC__APP__HEAD_MID__HEAD_MID_LOBBY,JSON.stringify({tab:"LOBBY",timestamp:Date.now()}));break;case"WC.APP.FOOT.TOURNEYS":de.publish(e.hierTopics.WC__APP__HEAD_MID__HEAD_MID_TOURNEYS,JSON.stringify({tab:"TOURNEYS",timestamp:Date.now()}));break;case"WC.APP.FOOT.PRIVATE":case"WC.APP.FOOT.MY_TOURNEYS":de.publish(e.hierTopics.WC__APP__HEAD_MID__HEAD_MID_PRIVATE,JSON.stringify({tab:"PRIVATE",timestamp:Date.now()}));break;case"WC.APP.FOOT.LEADERBOARD":de.publish(e.hierTopics.WC__APP__HEAD_MID__HEAD_MID_LEADERBOARD,JSON.stringify({tab:"LEADERBOARD",timestamp:Date.now()}));break;case"WC.APP.FOOT.MY_PROFILE":neodigmSodaPop&&neodigmSodaPop.close(),window.location.hash="#/profile_route";break}}),de.subscribe(e.hierTopics.WC__APP__HEAD_SPORTS,(T,k)=>{const S=JSON.parse(k);let O=16;T=="WC.APP.HEAD_SPORTS.PREV"||T=="WC.APP.HEAD_SPORTS.NEXT"||T=="WC.APP.HEAD_SPORTS.HEAD_SPORTS_DRAG_START"?O=3:(s=S.key||"all",console.log(`[app_events] Sports filter changed to: ${s} (${S.group})`),p(),de.publish(e.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"SPORT_FILTER_CHANGE"}))),O&&neodigmWired4Sound&&neodigmWired4Sound.sound(O).vibrate()}),de.subscribe(e.hierTopics.WC__APP__HEAD_MID,(T,k)=>{JSON.parse(k);let S=16;const O=(I,q="active")=>{t=I,n="all",r=q,o="active",document.body.dataset.tournFilter=I,u(),g(),p(),f(),(window.location.hash||"").startsWith("#/home_route")||(window.location.hash||"")==="#/"||!window.location.hash||(typeof neodigmSodaPop<"u"&&neodigmSodaPop&&neodigmSodaPop.close(),window.location.hash="#/home_route"),de.publish(e.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"FILTER_CHANGE"}))};switch(T){case"WC.APP.HEAD_MID.HEAD_MID_LOBBY":O("lobby");break;case"WC.APP.HEAD_MID.HEAD_MID_TOURNEYS":O("my","active");break;case"WC.APP.HEAD_MID.HEAD_MID_PRIVATE":case"WC.APP.HEAD_MID.HEAD_MID_MY":O("private");break;case"WC.APP.HEAD_MID.HEAD_MID_COMPLETED":O("my","completed");break;case"WC.APP.HEAD_MID.HEAD_MID_LEADERBOARD":S=16,neodigmSodaPop&&neodigmSodaPop.close(),window.location.hash="#/top_players_route";break;case"WC.APP.HEAD_MID.HEAD_MID_SQUAD":de.publish(e.hierTopics.WC__APP__HEAD_TOP__USER_PROFILE,JSON.stringify({tab:"USER_PROFILE",timestamp:Date.now()}));break}S&&neodigmWired4Sound&&neodigmWired4Sound.sound(S).vibrate()}),de.subscribe(e.hierTopics.ROUTE__HOME__USER_PROFILE,async(T,k)=>{JSON.parse(k);let S=16;switch(T){case"ROUTE.HOME.USER_PROFILE.INSTALL_PWA":const O=window.deferredPWAPrompt;if(!O){console.log("No install prompt available"),typeof neodigmToast<"u"&&neodigmToast.q("PWA install not available","warning");return}try{O.prompt();const{outcome:q}=await O.userChoice;q==="accepted"?(console.log("PWA installed successfully"),window.deferredPWAPrompt=null,typeof neodigmToast<"u"&&neodigmToast.q("App installed successfully!","success"),S=8,neodigmSodaPop&&neodigmSodaPop.close()):(console.log("PWA install declined"),typeof neodigmToast<"u"&&neodigmToast.q("Install cancelled","night"))}catch(q){console.error("PWA install error:",q),typeof neodigmToast<"u"&&neodigmToast.q("Install failed","danger")}break;case"ROUTE.HOME.USER_PROFILE.TOGGLE_THEME":(()=>{const J=e.appCLIFeatures.features.theme.state==="dark"?"light":"dark";e.setFeaturePersistPub("theme",{state:J});const W=document.getElementById("app");W&&W.setAttribute("data-sync-theme",J),document.body.setAttribute("data-sync-theme",J)})(),neodigmSodaPop&&neodigmSodaPop.close();break;case"ROUTE.HOME.USER_PROFILE.RESET_PASSWORD":ka.push({name:"resethash_route"}),neodigmSodaPop&&neodigmSodaPop.close();break;case"ROUTE.HOME.USER_PROFILE.SIGNOUT":ka.push({name:"signout_route"}),neodigmSodaPop&&neodigmSodaPop.close();break}S&&neodigmWired4Sound&&neodigmWired4Sound.sound(S).vibrate()});const x=T=>{document.querySelectorAll(".play-section").forEach(S=>{S.style.display="none",S.classList.remove("play-section--active")});const k=document.getElementById(`play-section-${T}`);k&&(k.style.display="",k.classList.add("play-section--active"))},P=(T,k)=>{const S=T.split(".").pop(),O=document.querySelectorAll(".play-cntr .dash-nav__btn"),q=document.querySelector(".play-cntr")?.closest("neodigm-sodapop");x(S),O.forEach(J=>{const W=J.dataset.publishRouteHome?.split(".").pop()||"";J.classList.toggle("dash-nav__btn--active",W===S)}),typeof neodigmWired4Sound<"u"&&neodigmWired4Sound.sound(3),q&&(q.style.overflow=S==="PLAY"?"hidden":"auto")};de.subscribe("ROUTE.HOME.SODAPOP_PLAY.INFO",P);let D=null;de.subscribe("ROUTE.HOME.SODAPOP_PLAY.LEADERBOARD",(T,k)=>{if(P(T),D){console.log("[appEvents] Leaderboard refresh debounced (cooling down)");return}D=setTimeout(()=>{D=null},2e3),console.log("[appEvents] Refreshing leaderboard data"),ke.populateLeaderboard()}),de.subscribe("ROUTE.HOME.SODAPOP_PLAY.PLAY",(T,k)=>{JSON.parse(k);const S=document.getElementById("btn-join__play--id");if(!S){console.warn("[app_events] PLAY button not found");return}const O=S.dataset.requiresJoin==="true",I=S.textContent.trim().toLowerCase();if(console.log("[app_events] PLAY button clicked - text:",I,"requiresJoin:",O),O&&I==="join"){const J=document.querySelector(".play-cntr")?.dataset?.currentTournGuid,W=xe();if(!J){console.error("[app_events] No tournament GUID found");return}console.log("[app_events] Executing JOIN for tournament:",J),de.publish(W.hierTopics.WC__TOURN_ACTION,JSON.stringify({action:"JOIN",tournamentGuid:J,timestamp:Date.now()})),S.textContent="Play",S.dataset.requiresJoin="false",setTimeout(()=>{P(T),console.log("[app_events] JOIN triggered, advancing carousel to PLAY page")},500)}else P(T),console.log("[app_events] Advancing carousel to PLAY page")}),de.subscribe(e.hierTopics.WC__APP__HEAD_TOP,(T,k)=>{JSON.parse(k);let S=10;switch(T){case"WC.APP.HEAD_TOP.USER_PROFILE":S=0,neodigmSodaPop&&neodigmSodaPop.close(),window.location.hash="#/profile_route";break;case"WC.APP.HEAD_TOP.LOGO":const O=e.appSession.session_app.version,I=new Date().getFullYear();O&&neodigmToast&&neodigmToast.q(`${O} 4/22/2026, 10:05:14 AM|© ${I} Bet Max Action`,"night");break;case"WC.APP.HEAD_TOP.CREATE_CONTEST":de.publish(e.hierTopics.WC__APP__FOOT__MY_TOURNEYS,JSON.stringify({tab:"MY_TOURNEYS",timestamp:Date.now()}));break}S&&neodigmWired4Sound&&neodigmWired4Sound.sound(S).vibrate()}),de.subscribe(e.hierTopics.WC__TOURN_ACTION,(T,k)=>{const S=JSON.parse(k);let O=0;switch(S?.action){case"JOIN":O=512;break;case"PLAY":O=8;break;case"INFO":O=8;break}if(O){const I=S?.tournamentGuid,q=S?.action;console.log("[app_events] Navigating to play_route:",I,q),setTimeout(()=>{ka.push({name:"play_route",query:{guid:I,action:q}})},O)}}),de.subscribe(e.hierTopics.WC__TOURN_ACTION,(T,k)=>{const S=JSON.parse(k);let O=16;switch(S?.action){case"FOCUS":O=3;break;case"SPORT_ICON":O=10;break;case"JOIN":O=5;break;case"PLAY":O=16;break}O&&neodigmWired4Sound&&neodigmWired4Sound.sound(O).vibrate()}),de.subscribe(e.hierTopics.WC__TOURN_ACTION,(T,k)=>{const S=JSON.parse(k);let O=0,I="night";switch(neodigmOpt&&neodigmOpt.EVENT_SOUNDS&&(neodigmOpt.EVENT_SOUNDS=!1),S?.tournamentStatus){case"UPCOMING":I="success";break;case"LOCKED":I="warning";break;case"COMPLETED":I="danger";break}switch(S?.action){case"SPORT_ICON":S?.sportTitle==S?.sportDescription?O=S?.sportTitle:O=S?.sportTitle+"|"+S?.sportDescription;break}O&&neodigmToast&&neodigmToast.q(O,I)}),de.subscribe(e.hierTopics.WC__TOURN_ACTION,async(T,k)=>{const S=JSON.parse(k);if(S?.action==="JOIN"){const I=xe().appSession?.session_user?.guid;if(!I){console.error("No entity guid found in session"),typeof neodigmToast<"u"&&neodigmToast.q("Please sign in to join tournaments","warning");return}const q=document.querySelector(`bma-tournament-card[data-bma-tourn-guid="${S.tournamentGuid}"]`);q&&(q.setAttribute("data-bma-tourn-wait","true"),aa.shootConfetti());const J={acctEntityGuid:I,tournamentGuid:S.tournamentGuid};try{const W={method:"POST",body:JSON.stringify(J),headers:Oe.genHeaders()};console.log("Posting to:",Oe.API_baseURI+"/m5t/"+Oe.API_ver+"/coreTournaments/join",J);const V=await(await fetch(Oe.API_baseURI+"/m5t/"+Oe.API_ver+"/coreTournaments/join",W)).json();if(console.log("Join response:",V),V.ok)typeof neodigmToast<"u"&&neodigmToast.q("Successfully joined tournament!","success"),setTimeout(()=>{const re=document.querySelector(`bma-tournament-card[data-bma-tourn-guid="${S.tournamentGuid}"]`);if(re){re.setAttribute("data-bma-tourn-wait","false");const Y=re.getAttribute("data-bma-tourn-entities");if(Y)try{const H=JSON.parse(Y);H.guids.includes(I)||(H.guids.push(I),re.setAttribute("data-bma-tourn-entities",JSON.stringify(H)))}catch(H){console.error("Failed to parse entities:",H)}}},3e3);else{const re=V?.message||"Failed to join tournament";typeof neodigmToast<"u"&&neodigmToast.q(re,"danger");const Y=document.querySelector(`bma-tournament-card[data-bma-tourn-guid="${S.tournamentGuid}"]`);Y&&Y.setAttribute("data-bma-tourn-wait","false")}}catch(W){console.error("Join tournament error:",W),typeof neodigmToast<"u"&&neodigmToast.q("Network error joining tournament","danger"),typeof neodigmUtils<"u"&&neodigmUtils.hardReload()}}}),de.subscribe(e.hierTopics.ROUTE__HOME_ONMOUNT,async(T,k)=>{console.log("[app_events] ROUTE__HOME_ONMOUNT event received");const S=xe();if(t="lobby",s="all",a="all",l="default",i="all",c="all",S.coreTourn.length>0){console.log("[app_events] coreTourn already populated, hydrating from existing data"),de.publish(S.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"REMOUNT"}));return}try{const O=await Oe.fetchTournaments();console.log("[app_events] Tournaments fetched:",O),O?.rows&&Array.isArray(O.rows)?(S.pushCoreTourn({timestamp:Date.now(),source:"API",data:O.rows}),console.log("[app_events] Pushed to coreTourn, length:",S.coreTourn.length),de.publish(S.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now()}))):console.warn("[app_events] Invalid API response format:",O)}catch(O){console.error("[app_events] Error fetching tournaments:",O),typeof neodigmToast<"u"&&neodigmToast.q("Please Sign In","success")}}),de.subscribe(e.hierTopics.PROMOTION__LOAD,async(T,k)=>{console.log("[app_events] PROMOTION__LOAD event received");try{const S=await Oe.fetchPromotions();if(console.log("[app_events] Promotions fetched:",S),S?.ok&&S?.data&&Array.isArray(S.data)){const O=S.data.filter(q=>q.class==="banner"&&q.status==="LIVE");console.log("[app_events] Banner promotions:",O);const I=document.querySelector(".featured-swiper .swiper-wrapper");if(!I){console.warn("[app_events] Swiper wrapper not found");return}if(I.innerHTML="",O.forEach((q,J)=>{const W=document.createElement("div");W.className="swiper-slide";const Q=document.createElement("div");Q.className=`featured-card featured-card--${J+1}`;const V=q.hero_img?encodeURI(q.hero_img):"";Q.style.backgroundImage=`url("${V}")`,Q.setAttribute("data-promotion-hero-img",q.hero_img||""),Q.setAttribute("data-promotion-caption",q.caption||""),Q.setAttribute("data-promotion-tagline",q.tagline||""),Q.setAttribute("data-promotion-toast",q.toast||""),Q.setAttribute("data-promotion-topic",q.topic?.topic||""),Q.setAttribute("data-promotion-topic-token",q.topic?.token||""),Q.setAttribute("data-promotion-marquee",q.maquee||""),W.appendChild(Q),I.appendChild(W)}),console.log("[app_events] Created",O.length,"promotion slides"),window.featuredSwiper&&window.featuredSwiper.update(),O.length===1){const q=document.querySelector(".featured-swiper .swiper-wrapper");q&&(q.style.justifyContent="center")}}}catch(S){console.error("[app_events] Error fetching promotions:",S)}}),de.subscribe(e.hierTopics.PROMOTION__CLICK,(T,k)=>{console.log("[app_events] PROMOTION__CLICK event received");try{const S=JSON.parse(k);console.log("[app_events] Promotion clicked:",S),S.toast&&typeof neodigmToast<"u"&&neodigmToast.q(S.toast,"success"),typeof neodigmSodaPop<"u"&&(neodigmSodaPop.setOnAfterOpen(()=>{const O=document.querySelector(".l-promotion #promoHero");O&&S.heroImg&&(O.src=S.heroImg);const I=document.querySelector(".l-promotion #promCaption");I&&S.caption&&(I.textContent=S.caption);const q=document.querySelector(".l-promotion #promoTagline");return q&&S.tagline&&(/<[^>]+>/.test(S.tagline)?q.innerHTML=S.tagline:q.textContent=S.tagline),!0},"sodapop_promotion"),neodigmSodaPop.autoOpen("sodapop_promotion"))}catch(S){console.error("[app_events] Error handling promotion click:",S)}}),de.subscribe(e.hierTopics.ROUTE__HOME_HYDRATE,(T,k)=>{console.log("[app_events] ROUTE__HOME_HYDRATE event received");const S=xe();if(S.coreTourn.length===0){console.warn("[app_events] No tournament data in coreTourn array");return}const O=S.coreTourn[S.coreTourn.length-1],I=S.coreTourn.length>1?S.coreTourn[S.coreTourn.length-2]:null;console.log("[app_events] Hydrating with latest data:",O);const q=[];if(I){const re=O.data,Y=I.data;re.forEach(H=>{const X=Y.find(K=>K.guid===H.guid);X&&X.status!==H.status&&(console.log(`[app_events] Status changed for tournament ${H.guid}: ${X.status} -> ${H.status}`),q.push(H.guid))})}const J=S.appSession?.session_user?.guid,W=[...O.data].sort((re,Y)=>{const H=re.status||re.class,X=Y.status||Y.class,K=re.entities?.guids||[],A=Y.entities?.guids||[],$=K.includes(J),U=A.includes(J),B=(L,z)=>{const se=new Date(L.status_time||0).getTime();return new Date(z.status_time||0).getTime()-se},G=H==="LOCKED"&&$,j=X==="LOCKED"&&U;if(G&&!j)return-1;if(!G&&j)return 1;if(G&&j)return B(re,Y);const Z=H==="UPCOMING",F=X==="UPCOMING";if(Z&&!F)return-1;if(!Z&&F)return 1;if(Z&&F)return B(re,Y);const E=H==="COMPLETED"&&$,M=X==="COMPLETED"&&U;if(E&&!M)return-1;if(!E&&M)return 1;if(E&&M)return B(re,Y);const N=H==="COMPLETED"&&!$,R=X==="COMPLETED"&&!U;return N&&!R?1:!N&&R?-1:B(re,Y)}),Q=ke.categorizeTournaments(W,t,s,J,{subStatus:a,sort:l,result:i,privateSubTab:n,mySubTab:r,lobbySubTab:o});if(console.log(`[app_events] Categorized into ${Q.length} categories for filter: ${t}/${s} sub:${a} sort:${l} result:${i}`),document.body.dataset.tournFilter=t,window._homeRouteRenderCards&&typeof window._homeRouteRenderCards=="function"){const re=document.querySelector(".tournaments-grid");re&&(re.dataset.filterContext=t),window._homeRouteRenderCards(Q,!0,d,{tab:t,subStatus:a,sort:l,result:i,odds:c});const Y=W.filter(G=>{const j=G.status||G.class,Z=G.entities?.guids||[];return(j==="LOCKED"||j==="UPCOMING")&&Z.includes(J)}).length,H=W.reduce((G,j)=>{const Z=j.status||j.class,F=j.entities?.guids||[];return(Z==="LOCKED"||Z==="UPCOMING")&&F.includes(J)?G+parseFloat(j.tournament_dollars||0):G},0),X=document.querySelector("bma-app-foot");X&&X.setAttribute("data-active-count",String(Y));const K=document.querySelector("bma-app-head-mid");K&&K.setAttribute("data-active-count",String(Y));const A=document.querySelector("bma-app-head-top");A&&(A.setAttribute("data-active-count",String(Y)),A.setAttribute("data-td-dollars",String(H)));const $=document.getElementById("home-tab-active-badge");$&&($.textContent=Y,$.style.visibility=Y>0?"visible":"hidden");const U=W.filter(G=>{if(G.is_private!==!0)return!1;const j=G.entities?.guids||[];return G.creator_guid===J||j.includes(J)}).length,B=document.getElementById("home-tab-private-badge");if(B&&(B.textContent=U),K&&K.setAttribute("data-private-count",String(U)),X&&X.setAttribute("data-private-count",String(U)),q.length>0){const G=O.data;q.forEach(j=>{const Z=G.find(F=>F.guid===j);if(Z){const F=Math.floor(Math.random()*2e3)+1e3;setTimeout(()=>{de.publish(S.hierTopics.CANVAS__HYDRATE__STATUS,JSON.stringify({guid:j,status:Z.status,timestamp:Date.now()}))},F)}})}}else console.warn("[app_events] window._homeRouteRenderCards not available");const V=document.getElementById("bma-scores-banner--id");if(V){const re=new Set,Y=[];for(const H of O.data){const X=Array.isArray(H.matches_expanded)?H.matches_expanded:[];for(const K of X){const A=K.guid||K.id||K.odds_id;!A||re.has(A)||(re.add(A),Y.push(K))}}V.setAttribute("data-matches",JSON.stringify(Y))}ke.prefetchGlobalLeaderboard()}),de.subscribe(e.hierTopics.SSE__CORE__TOURN_SYNC,(T,k)=>{console.log("[app_events] SSE__CORE__TOURN_SYNC event received:",k);const S=xe();try{const O=JSON.parse(k);console.log("[app_events] SSE tournament sync data:",O);const I=JSON.parse(O.msg);if(console.log("[app_events] Parsed tournaments array:",I),!Array.isArray(I)){console.warn("[app_events] SSE msg is not an array:",I);return}S.pushCoreTourn({timestamp:Date.now(),source:"SSE",data:I}),console.log("[app_events] Pushed SSE data to coreTourn, length:",S.coreTourn.length),de.publish(S.hierTopics.ROUTE__HOME_HYDRATE,JSON.stringify({timestamp:Date.now(),source:"SSE"})),document.querySelector(".play-cntr")&&(console.log("[SSE] Play route is active, triggering real-time update"),ke.hydratePlayPopup())}catch(O){console.error("[app_events] Error processing SSE tournament sync:",O)}}),setTimeout(function(){neodigmSodaPop&&neodigmMarquee&&neodigmEnchantedCTA&&(neodigmSodaPop.setOnAfterOpen(function(){setTimeout(()=>{},1e3),neodigmMetronome.init().pause(800),neodigmEnchantedCTA.init(),neodigmCarousel.init()}),neodigmSodaPop.setOnAfterOpen(function(){setTimeout(()=>{NeodigmClaire.showCanv("neodigm-sodapop",.5).setTheme(["warning","success"]).initCanvOn("neodigm-sodapop").waxOn("neodigm-sodapop");const T=document.querySelector("#caption__my-profile");T&&(T.textContent="My Profile");const k=document.getElementById("profile-trophy-username");k&&(k.textContent=e.appSession?.session_user?.userName||e.appSession?.session_user?.name||"");const S=e.appSession?.session_user?.guid;if(console.log("[app_events] User GUID:",S),console.log("[app_events] coreTourn length:",e.coreTourn.length),!S||e.coreTourn.length===0){console.warn("[app_events] Missing user GUID or tournament data");return}const I=e.coreTourn[e.coreTourn.length-1].data;console.log("[app_events] Processing tournaments:",I.length);const q=V=>{const re=document.getElementById("profile-stats-panel");re&&(re.innerHTML=ke.buildStatsPanel(I,S,V))};q(ke._betStatsCache?.stats||null),ke._ensureBetStatsCache(S).then(V=>{V&&q(V)});let J=0,W=0,Q=0;I.forEach((V,re)=>{if(!V.tags||!Array.isArray(V.tags)){console.log(`[app_events] Tournament ${re} has no tags or tags not an array`);return}V.tags.forEach((Y,H)=>{if(typeof Y=="object"&&Y!==null){let X=null;Y.entity_guid===S&&Y.badge?X=Y.badge:Y[S]&&(X=Y[S]),X==="--badge__ribbon--gold"?J++:X==="--badge__ribbon--silver"?W++:X==="--badge__ribbon--bronze"&&Q++}})}),setTimeout(()=>{let V=document.querySelectorAll(".badge-counter");if(V.length===0){const re=document.querySelector("neodigm-sodapop");re&&(V=re.querySelectorAll(".badge-counter"))}V.length>=3?(V[0].textContent=W,V[1].textContent=J,V[2].textContent=Q,console.log("[app_events] Updated UI counters successfully")):console.warn("[app_events] Not enough counter elements found")},500),setTimeout(()=>{const V=document.querySelector("#profile-tournaments-list");if(!V||!S||e.coreTourn.length===0)return;const H=e.coreTourn[e.coreTourn.length-1].data.filter($=>{try{return(typeof $.entities=="string"?JSON.parse($.entities):$.entities)?.guids?.includes(S)}catch{return!1}}),X={LOCKED:0,UPCOMING:1,COMPLETED:2};H.sort(($,U)=>{const B=X[$.status]??3,G=X[U.status]??3;return B!==G?B-G:new Date(U.status_time||0)-new Date($.status_time||0)});const K=$=>{let U=H;if($==="active"?U=H.filter(B=>B.status==="LOCKED"||B.status==="UPCOMING"):$==="completed"&&(U=H.filter(B=>B.status==="COMPLETED")),U.length===0){V.innerHTML='<div class="profile-tournaments__empty">No tournaments found</div>';return}V.innerHTML=U.map(B=>{const G=B.entities?JSON.stringify(B.entities).replace(/"/g,"&quot;"):"",j=B.tags?JSON.stringify(B.tags).replace(/"/g,"&quot;"):"[]",Z=B.sports_allowed?JSON.stringify(B.sports_allowed).replace(/"/g,"&quot;"):"[]";return`<bma-tournament-list-card
                                        data-bma-tourn-guid="${B.guid||""}"
                                        data-bma-tourn-caption="${B.caption||""}"
                                        data-bma-tourn-tagline="${B.tagline||""}"
                                        data-bma-tourn-status="${B.status||""}"
                                        data-bma-tourn-class="${B.status||""}"
                                        data-bma-tourn-sports_allowed="${Z}"
                                        data-bma-tourn-entities="${G}"
                                        data-bma-tourn-entry_fee="${B.entry_fee||0}"
                                        data-bma-tourn-tournament_dollars="${B.tournament_dollars||0}"
                                        data-bma-tourn-matches="${B.matches_expanded?.length||0}"
                                        data-bma-tourn-tags="${j}"
                                        data-bma-tourn-window_start_time="${B.window_start_time||""}"
                                        data-bma-tourn-window_end_time="${B.window_end_time||""}"
                                        data-sync-theme="dark"
                                    ></bma-tournament-list-card>`}).join(""),requestAnimationFrame(()=>{V.querySelectorAll("bma-tournament-list-card").forEach((B,G)=>{B.style.animation="motion-slide-up-enter 300ms cubic-bezier(0.4, 0, 0.2, 1) both",B.style.animationDelay=`${Math.min(G*60,400)}ms`})})};K("all");const A=document.querySelector(".profile-tournaments__filters");A&&A.addEventListener("click",$=>{const U=$.target.closest(".profile-tourn-filter");U&&(A.querySelectorAll(".profile-tourn-filter").forEach(B=>B.classList.remove("profile-tourn-filter--active")),U.classList.add("profile-tourn-filter--active"),K(U.dataset.filter))})},600)},1e3)},"sodapop_my_profile"))},3e3),window._renderTopPlayers=async function(T="ALL"){const k=xe(),S=document.getElementById("global-leaderboard-container");if(S){S.innerHTML=`<div style="display: flex; flex-direction: column; align-items: center; gap: 24px; padding: 60px 24px;">
                        ...
                        <div style="display: block; height: 8px; width: 80%; max-width: 400px; background-color: #242424; overflow: hidden; border-radius: 4px;">
                            <div style="height: 100%; background-color: var(--neodigm-theme-brand-alt, #F7C60D); animation: juicebar_linear 1s infinite ease-in-out; transform-origin: 0% 50%;"></div>
                    ...
                    </div>`;try{let O;const I=ke._globalLBCache[T];I?.data&&Date.now()-I.ts<300*1e3?(console.log(`[Global Leaderboard] Using prefetched cache [${T}]`),O=I.data):(console.log(`[Global Leaderboard] Cache miss [${T}], fetching fresh`),O=await Oe.fetchAllTimeLeaderboard(T,100,"td"),ke._globalLBCache[T]={data:O,ts:Date.now(),inflight:!1});const q=O?.data||[],J=O?.last_updated||null,W=k.coreTourn.length>0?k.coreTourn[k.coreTourn.length-1].data:[];if(!q.length){S.innerHTML='<div class="leaderboard-empty"><p>No leaderboard data yet.</p></div>',myContainer&&(myContainer.innerHTML='<div class="leaderboard-empty"><p>No tournament data yet.</p></div>');return}const Q=S,V=k.appSession?.session_user?.guid,re={};q.forEach(j=>{const Z=j.user_guid;re[Z]={username:j.username||"Unknown",user_guid:Z,totalTDWon:parseFloat(j.total_payout||0),totalPayout:parseFloat(j.total_payout||0),totalBets:parseInt(j.total_betslips||0),tournamentsPlayed:parseInt(j.tournaments_joined||0),tournamentsWon:parseInt(j.tournaments_won||0),totalTD:parseFloat(j.total_td_dollars||0),gold:0,silver:0,bronze:0,sports:new Set}}),W.forEach(j=>{!j.tags||!Array.isArray(j.tags)||j.tags.forEach(Z=>{if(typeof Z!="object"||!Z)return;let F=null,E=null;if(Z.entity_guid&&Z.badge){if(Z.entity_guid==="SYSTEM")return;F=Z.entity_guid,E=Z.badge}else{const N=Object.keys(Z);for(const R of N){const L=Z[R];if(typeof L=="string"&&L.startsWith("--badge__ribbon--")){F=R,E=L;break}}}if(!F||!E)return;re[F]||(re[F]={username:F.substring(0,8),user_guid:F,totalTDWon:0,totalPayout:0,totalBets:0,tournamentsPlayed:0,tournamentsWon:0,totalTD:0,gold:0,silver:0,bronze:0,sports:new Set});const M=re[F];E==="--badge__ribbon--gold"?M.gold++:E==="--badge__ribbon--silver"?M.silver++:E==="--badge__ribbon--bronze"&&M.bronze++})});const Y=Object.values(re).filter(j=>j.username!=="Unknown");if(J){const j=Math.round((Date.now()-new Date(J).getTime())/6e4),Z=j<1?"just now":j===1?"1 minute ago":`${j} minutes ago`;console.log(`[Global Leaderboard] Server last updated ${Z}`)}const H=Y.filter(j=>j.gold+j.silver+j.bronze>0),X=new Set;Y.forEach(j=>j.sports.forEach(Z=>X.add(Z)));const K={basketball_nba:"NBA",basketball_ncaab:"NCAAB",football_nfl:"NFL",football_ncaaf:"NCAAF",icehockey_nhl:"NHL",hockey_nhl:"NHL",baseball_mlb:"MLB",soccer_mls:"MLS",soccer_epl:"EPL",soccer_uefa:"UEFA",mma_ufc:"UFC",boxing:"BOXING"},A=[{id:"overall",label:"Overall"},{id:"earnings",label:"TD$ Won"}];let $="all";const U=(j,Z)=>{let F=[...Y],E;j==="overall"&&(F=F.filter(ne=>ne.gold+ne.silver+ne.bronze>0)),j==="bysport"&&Z&&Z!=="all"&&(F=F.filter(ne=>ne.sports.has(Z)));const M=Q.querySelector(".glb__note");switch(M&&M.remove(),j){case"overall":F.sort((ne,ee)=>ee.gold*100+ee.silver*10+ee.bronze-(ne.gold*100+ne.silver*10+ne.bronze)||ee.totalPayout-ne.totalPayout||ee.totalBets-ne.totalBets),E=(ne,ee,ce,fe,he)=>`
                                        <div class="glb__row">
                                            <span class="glb__row-left">
                                                <span class="glb__rank ${ee<3?"glb__rank--top3":""}">#${ee+1}</span>
                                                <span class="glb__avatar" style="background: ${fe};">${ce}</span>
                                                <span class="glb__name">${ne.username}</span>
                                                ${he?'<span class="glb__you-badge">YOU</span>':""}
                                            </span>
                                            <span class="glb__row-right">
                                                ${ne.gold?`<div class="glb__badge"><div class="glb__badge-icon" style="background-image: var(--trophy-gold-tall);"></div><span style="color: var(--status-locked-text, #FFD700);">${ne.gold}</span></div>`:""}
                                                ${ne.silver?`<div class="glb__badge"><div class="glb__badge-icon" style="background-image: var(--trophy-silver-tall);"></div><span style="color: #C0C0C0;">${ne.silver}</span></div>`:""}
                                                ${ne.bronze?`<div class="glb__badge"><div class="glb__badge-icon" style="background-image: var(--trophy-bronze-tall);"></div><span style="color: #DA954B;">${ne.bronze}</span></div>`:""}
                                            </span>
                                        </div>`;break;case"earnings":F=F.filter(ne=>ne.totalTDWon>0),F.sort((ne,ee)=>ee.totalTDWon-ne.totalTDWon),E=(ne,ee,ce,fe,he)=>`
                                        <div class="glb__row">
                                            <span class="glb__row-left">
                                                <span class="glb__rank ${ee<3?"glb__rank--top3":""}">#${ee+1}</span>
                                                <span class="glb__avatar" style="background: ${fe};">${ce}</span>
                                            ...
                                            <span class="glb__earnings">TD$ ${Math.round(ne.totalTDWon).toLocaleString()}</span>
                                        </div>`;break;case"bysport":F.sort((ne,ee)=>ee.totalPayout-ne.totalPayout||ee.totalBets-ne.totalBets),E=(ne,ee,ce,fe,he)=>`
                                        <div class="glb__row">
                                            <span class="glb__row-left">
                                                <span class="glb__rank ${ee<3?"glb__rank--top3":""}">#${ee+1}</span>
                                                <span class="glb__avatar" style="background: ${fe};">${ce}</span>
                                            ...
                                            <span class="glb__row-right" style="gap: 10px;">
                                                <span style="font-size: 0.75rem; color: rgba(255,255,255,0.4);">${ne.totalBets} bets</span>
                                                <span class="glb__earnings">TD$ ${ne.totalPayout.toFixed(0)}</span>
                                            </span>
                                        </div>`;break}const N=Q.querySelector(".glb__list");if(!N)return;if(F.length===0){const ne=j==="earnings"?"No TD$ won from reconciled bets yet":j==="bysport"?"No players found for this sport":"No leaderboard data available";N.innerHTML=`<div class="leaderboard-empty"><p>${ne}</p></div>`;return}const R=["#2a3a2e","#3a3528","#3a2a2a","#2a303a","#332a3a","#2a3836","#3a2e28","#2e3234"],L=ne=>R[ne.charCodeAt(0)%R.length];let z="";if(j==="overall"&&F.length>=3){const ne=(ee,ce,fe,he,ve)=>{const _e=F[ee],Ie=_e.user_guid===V;return`<div style="display: flex; flex-direction: column; align-items: center; flex: 1; max-width: 140px;">
                                        <div style="width: ${ce===1?80:ce===2?64:56}px; height: ${ce===1?80:ce===2?64:56}px; background-image: var(${he}); background-size: contain; background-repeat: no-repeat; background-position: center; margin-bottom: 6px;"></div>
                                        ...
                                        <div style="width: 100%; height: ${fe}px; background: linear-gradient(180deg, ${ve}33 0%, ${ve}0D 100%); border-top: 3px solid ${ve}80; border-radius: 4px 4px 0 0; display: flex; align-items: center; justify-content: center;">
                                            <span style="font-size: 1.2rem; font-weight: 800; color: ${ve};">${ce===1?"1st":ce===2?"2nd":"3rd"}</span>
                                        </div>
                                    </div>`};z=`
                                    <div style="display: flex; align-items: flex-end; justify-content: center; gap: 8px; padding: 20px 12px 0;">
                                        ${ne(1,2,70,"--badge__silver","#C0C0C0")}
                                        ${ne(0,1,90,"--badge__gold","#FFD700")}
                                        ${ne(2,3,50,"--badge__bronze","#DA954B")}
                                    </div>
                                ...
                                `}const se='<div class="info-section__title">Rankings</div>',oe='<div style="text-align: center; padding: 10px 16px; margin: 8px 16px; font-size: 0.78rem; color: var(--status-locked-text, #F7C60D); font-weight: 600; background: rgba(247, 198, 13, 0.08); border-radius: 8px; box-shadow: inset 0 0 0 1px rgba(247, 198, 13, 0.2);"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" style="vertical-align: -2px; margin-right: 6px;"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>Ranked by trophies — Gold weighted highest, then Silver, then Bronze</div>',ie='<div style="text-align: center; padding: 10px 16px; margin: 8px 16px; font-size: 0.78rem; color: var(--status-upcoming-text, #00E676); font-weight: 600; background: rgba(0, 230, 118, 0.08); border-radius: 8px; box-shadow: inset 0 0 0 1px rgba(0, 230, 118, 0.2);"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" style="vertical-align: -2px; margin-right: 6px;"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>Ranked by total TD$ payouts from completed bets — does not include pending bets</div>';if(j==="bysport"&&!Q.querySelector(".glb__note")){const ee=document.createElement("div");ee.className="glb__note",ee.style.cssText="text-align: center; padding: 10px 16px; margin: 8px 16px; font-size: 0.78rem; color: var(--status-locked-text, #F7C60D); font-weight: 600; background: rgba(247, 198, 13, 0.08); border-radius: 8px; box-shadow: inset 0 0 0 1px rgba(247, 198, 13, 0.2);",ee.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" style="vertical-align: -2px; margin-right: 6px;"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>Ranked by TD$ won in tournaments featuring this sport';const ce=Q.querySelector(".glb__sport-filters");ce&&ce.parentNode.insertBefore(ee,ce)}let ae="";if(j==="earnings"&&F.length>=3){const ne=(ee,ce,fe,he)=>{const ve=F[ee],_e=ve.user_guid===V;return`<div style="display: flex; flex-direction: column; align-items: center; flex: 1; max-width: 140px;">
                                        <div style="width: ${ce===1?80:ce===2?64:56}px; height: ${ce===1?80:ce===2?64:56}px; margin-bottom: 6px;">
                                        ...
                                        <div style="width: 100%; height: ${fe}px; background: linear-gradient(180deg, rgba(0, 230, 118, 0.15) 0%, rgba(0, 230, 118, 0.03) 100%); border-top: 3px solid rgba(0, 230, 118, 0.4); border-radius: 4px 4px 0 0; display: flex; align-items: center; justify-content: center;">
                                            <span style="font-size: 1.2rem; font-weight: 800; color: var(--status-upcoming-text, #00E676);">${ce===1?"1st":ce===2?"2nd":"3rd"}</span>
                                        </div>
                                    </div>`};ae=`
                                    <div style="display: flex; align-items: flex-end; justify-content: center; gap: 8px; padding: 20px 12px 0;">
                                        ${ne(1,2,70,"#00E676")}
                                ...
                                `}if(j==="overall")N.innerHTML=z+oe+se+F.map((ne,ee)=>{const ce=(ne.username||"?")[0].toUpperCase(),fe=L(ne.username),he=ne.user_guid===V;return E(ne,ee,ce,fe,he)}).join("");else if(j==="earnings"){const ne='<div class="info-section__title">TD$ Won</div>';N.innerHTML=ae+ie+ne+F.map((ee,ce)=>{const fe=(ee.username||"?")[0].toUpperCase(),he=L(ee.username),ve=ee.user_guid===V;return E(ee,ce,fe,he,ve)}).join("")}else if(j==="bysport"){let ne="";if(F.length>=3){const ce=(fe,he,ve)=>{const _e=F[fe],Ie=_e.user_guid===V,Ve=L(_e.username),vt=(_e.username||"?")[0].toUpperCase();return`<div style="display: flex; flex-direction: column; align-items: center; flex: 1; max-width: 140px;">
                                            <span class="glb__avatar" style="background: ${Ve}; width: ${he===1?48:38}px; height: ${he===1?48:38}px; font-size: ${he===1?"1rem":"0.8rem"};">${vt}</span>
                                            ...
                                            <div style="width: 100%; height: ${ve}px; background: linear-gradient(180deg, rgba(247, 198, 13, 0.15) 0%, rgba(247, 198, 13, 0.03) 100%); border-top: 3px solid rgba(247, 198, 13, 0.4); border-radius: 4px 4px 0 0; display: flex; align-items: center; justify-content: center;">
                                                <span style="font-size: 1.2rem; font-weight: 800; color: var(--status-locked-text, #F7C60D);">${he===1?"1st":he===2?"2nd":"3rd"}</span>
                                            </div>
                                        </div>`};ne=`
                                        <div style="display: flex; align-items: flex-end; justify-content: center; gap: 8px; padding: 20px 12px 0;">
                                            ${ce(1,2,70)}
                                    ...
                                    `}const ee='<div class="info-section__title">Rankings</div>';N.innerHTML=ne+ee+F.map((ce,fe)=>{const he=(ce.username||"?")[0].toUpperCase(),ve=L(ce.username),_e=ce.user_guid===V;return E(ce,fe,he,ve,_e)}).join("")}requestAnimationFrame(()=>{N.querySelectorAll(".glb__card, .info-row").forEach((ne,ee)=>{ne.style.animation="motion-slide-up-enter 300ms cubic-bezier(0.4, 0, 0.2, 1) both",ne.style.animationDelay=`${Math.min(ee*50,400)}ms`})})},B=[...X].map(j=>{const Z=K[j]||j.replace(/^[a-z]+_/,"").toUpperCase(),F=Ge.find(M=>M.key===j),E=F?F.group:"default";return`<button class="glb__sport-chip" data-sport="${j}">
                            ...
                            <div class="glb__tabs" style="animation: motion-fade-enter 150ms cubic-bezier(0.4,0,0.2,1) both;">
                                ${A.map((j,Z)=>`
                                    <button class="glb__tab ${Z===0?"glb__tab--active":""}" data-tab="${j.id}">${j.label}</button>
                                `).join("")}
                            </div>
    ...
    `,s.forEach(o=>{const l=this.shadowRoot.querySelector(`[data-item="${o.name}"]`);l&&(l.addEventListener("click",()=>this.handleItemClick(o.name,o.topic)),l.addEventListener("keypress",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),this.handleItemClick(o.name,o.topic))}))})}}customElements.define("bma-app-foot",F1);const z1=["data-selected-item"],H1={__name:"App",setup(e){const t=ct(),s=Ba(),a=xe(),n=ge(()=>{const c=s.name;return c==="home_route"||c==="top_players_route"}),r=Ne("foot_lobby"),o=c=>c==="my"?"foot_tourneys":c==="private"?"foot_private":"foot_lobby",l=()=>{const c=window.location.hash||"";if(c.startsWith("#/top_players_route"))r.value="foot_leaderboard";else if(c.startsWith("#/home_route")||c==="#/"||!c){const d=document.body.dataset.tournFilter||"lobby";r.value=o(d)}};Xs(()=>s.name,()=>l(),{immediate:!0});let i=null;return lt(()=>{i=de.subscribe("ROUTE.HOME_HYDRATE",()=>l())}),os(()=>{i&&de.unsubscribe(i)}),lt(()=>{setTimeout(()=>{const c=a.appSession?.session_user?.guid,d=a.appSession?.session_user?.authenticated;c&&d&&a.appCLIFeatures.features.sse.state&&(console.log("[App] Reconnecting SSE for existing session, GUID:",c),ar.establishSSE("https://machfive-bmacdev-rest.onrender.com/v5/sse?appid=BMACORE&sseid=##SSEID##&lastkey=##LASTKEY##",c,a,!0))},2e3)}),setTimeout(function(){neodigmOpt.mvvLegit&&mvvLegit.setNavConroller((c=null)=>{t.currentRoute.value?.meta?.previewAllowed||(neodigmOpt.N55_DEBUG_lOG&&neodigmToast.q(`Legit route: ${c}`,"primary"),t.push({name:c}))}).setOnState((c=null)=>{c&&neodigmOpt.ROOT&&(neodigmOpt.ROOT.dataset.mvvLegit=c)}).init({BASE:Oe.API_baseURI})},2e3),setTimeout(()=>{ke.bindAppListeners(a)},3e3),t.beforeEach((c,d,u)=>{if(c.name==="splash_route")return vl(Ea.AUTHED),u();if(!c.name)return u(!1);const p=Sg(c.name,c.meta);if(vl(p),p===Ea.DENIED)return u(!1);u()}),(c,d)=>(ue(),pe(qe,null,[tt(ut(Pu),null,{default:_o(({Component:u})=>[tt(ah,{name:"slide-left"},{default:_o(()=>[(ue(),su(rf(u)))]),_:2},1024)]),_:1}),n.value?(ue(),pe("bma-app-foot",{key:0,"data-selected-item":r.value},null,8,z1)):$e("",!0)],64))}};class qu{constructor(){this.id="DEFAULT",this.label="Bet Max Tourney",this.description="Place any bets you want across the tournament slate."}get rules(){return{betTypes:["SPREAD","MONEY","TOTAL"],requiredBetTypes:[],maxBetsPerType:-1,maxBetsTotal:-1,minBetsTotal:0,stakeRule:"FREE",stakeMin:1,stakeMax:null,allowPartialSubmit:!0,allowBetModification:!0,lockOnFirstBet:!1,oneBetPerMatchPerType:!1}}getEffectiveRules(t){const s=this.rules;if(!t?.tags||!Array.isArray(t.tags))return s;const a=t.tags.find(n=>typeof n=="object"&&n!==null&&n.game_rules);return a?.game_rules?{...s,...a.game_rules}:s}get scoring(){return{method:"PAYOUT_SUM",rankBy:["totalPayout","totalBets"],bonuses:[],penalizeMissing:!1}}_parseBets(t){const s=[];return t.forEach(a=>{const n=a.coreMatches__guid||a.match_guid||"";(a.bet||[]).forEach(o=>{Object.keys(o).forEach(l=>{if(l==="short_title")return;const i=o[l];i&&s.push({matchGuid:n,type:(i.type||"").toUpperCase(),team:l,stake:parseFloat(i.stake||0),payout:parseFloat(i.payout||0),odds:parseFloat(i.odds||0),reconciled:i.reconciled||!1})})})}),s}_getTypeCounts(t){const s={};return t.forEach(a=>{s[a.type]=(s[a.type]||0)+1}),s}_getTotalStakes(t){return parseFloat(t.reduce((s,a)=>s+a.stake,0).toFixed(2))}_typeLabel(t){switch(t){case"SPREAD":return"Spread";case"MONEY":return"Money Line";case"TOTAL":return"Over/Under";default:return t}}_typeShortLabel(t){switch(t){case"SPREAD":return"Spread";case"MONEY":return"Money";case"TOTAL":return"Total";default:return t}}canPlaceBet(t,s,a){const n=this.getEffectiveRules(a),r=this._parseBets(s),o=(t.type||"").toUpperCase();return n.oneBetPerMatchPerType&&r.find(i=>i.matchGuid===t.matchGuid&&i.type===o)?{allowed:!1,reason:`You already have a ${this._typeLabel(o)} bet on this match`}:n.maxBetsPerType>0&&r.filter(i=>i.type===o).length>=n.maxBetsPerType?{allowed:!1,reason:`Maximum ${n.maxBetsPerType} ${this._typeLabel(o)} bets reached`}:n.maxBetsTotal>0&&r.length>=n.maxBetsTotal?{allowed:!1,reason:`Maximum ${n.maxBetsTotal} total bets reached`}:{allowed:!0,reason:null}}validateBetSlip(t,s,a){const n=this.getEffectiveRules(s),r=[],o=[],l=this._parseBets(t),i=this._getTypeCounts(l),c=this._getTotalStakes(l),d=parseFloat(s?.tournament_dollars||0);if(n.requiredBetTypes.forEach(u=>{i[u]||r.push(`You need at least one ${this._typeLabel(u)} bet`)}),n.minBetsTotal>0&&l.length<n.minBetsTotal&&r.push(`Place at least ${n.minBetsTotal} bets`),n.stakeRule==="SPEND_ALL"&&d>0){if(c<d){const u=parseFloat((d-c).toFixed(2));r.push(`You have TD$ ${u.toLocaleString()} left to spend — use your entire balance`)}else if(c>d+.01){const u=parseFloat((c-d).toFixed(2));r.push(`You've exceeded your TD$ balance by ${u.toLocaleString()}`)}}return!n.allowPartialSubmit&&r.length>0,{valid:r.length===0,errors:r,warnings:o}}scoreEntry(t,s){const a=parseFloat(t.total_payout||0);return{score:a,breakdown:{payout:a}}}rankLeaderboard(t,s){return[...t].sort((a,n)=>{const r=this.scoreEntry(a,s).score;return this.scoreEntry(n,s).score-r})}getProgressUI(t,s){const a=this.getEffectiveRules(s),n=a.requiredBetTypes.length>0,r=a.stakeRule==="SPEND_ALL";if(!n&&!r)return{type:"NONE",percent:0,label:"",hints:[],typesStatus:[],complete:!0};const o=this._parseBets(t),l=this._getTypeCounts(o),i=this._getTotalStakes(o),c=parseFloat(s?.tournament_dollars||0),d=c>0?Math.min(100,Math.round(i/c*100)):0,u=a.requiredBetTypes.every(m=>l[m]),p=!r||Math.abs(i-c)<.01,f=a.requiredBetTypes.map(m=>({type:m,label:this._typeShortLabel(m),placed:!!l[m],count:l[m]||0})),g=[],v=a.requiredBetTypes.filter(m=>!l[m]).map(m=>this._typeLabel(m));return v.length>0&&!p?g.push(`Need a ${v.join(", ")} bet · Spend all TD$ ${Math.round(c).toLocaleString()}`):v.length>0?g.push(`Need a ${v.join(", ")} bet`):!p&&i<c&&g.push(`TD$ ${Math.round(c-i).toLocaleString()} left to allocate`),{type:n?"BET_TYPES":"STAKE_PROGRESS",percent:d,label:r?`TD$ ${Math.round(i).toLocaleString()} / ${Math.round(c).toLocaleString()} spent`:`${o.length} bets placed`,typesStatus:f,hints:g,complete:u&&p}}getValidationMessages(t,s,a){return this.getProgressUI(t,s).hints}getBadge(){return null}getRulesHTML(t){return"<p>Place bets on any matches in the tournament. The player with the highest total payout wins.</p>"}getEmptyStateText(){return"Select a match to start betting"}}class Cl extends qu{constructor(){super(),this.id="DEFAULT_FORMAT",this.label="Bet Max Tourney",this.description="Place any bets you want across the tournament slate."}get scoring(){return{method:"SETTLED_PNL",rankBy:["score","pendingPayout","firstBetTime"],bonuses:[],penalizeMissing:!1}}_firstBetTime(t){const s=t?.bets||[];let a=1/0;for(const n of s){const r=n?.status_time||n?.create_time||n?.timestamp;if(!r)continue;const o=new Date(r).getTime();!isNaN(o)&&o<a&&(a=o)}return a}scoreEntry(t,s){const a=parseFloat(t.tournament_dollars??s?.tournament_dollars??0),n=this._parseBets(t.bets||[]);let r=0,o=0,l=0,i=0,c=0;n.forEach(f=>{r+=f.stake,f.reconciled?(o+=f.stake,c+=f.payout):(l+=f.stake,i+=f.payout)});const d=a-r,u=parseFloat((a-o+c).toFixed(2)),p=u;return{score:u,breakdown:{startingTD:parseFloat(a.toFixed(2)),remainingTD:parseFloat(d.toFixed(2)),totalStakes:parseFloat(r.toFixed(2)),committedStakes:parseFloat(o.toFixed(2)),pendingStakes:parseFloat(l.toFixed(2)),balance:parseFloat(p.toFixed(2)),pendingPayout:parseFloat(i.toFixed(2)),settledPayout:parseFloat(c.toFixed(2)),firstBetTime:this._firstBetTime(t)}}}rankLeaderboard(t,s){return[...t].map(a=>({entry:a,...this.scoreEntry(a,s)})).sort((a,n)=>n.score!==a.score?n.score-a.score:n.breakdown.pendingPayout!==a.breakdown.pendingPayout?n.breakdown.pendingPayout-a.breakdown.pendingPayout:a.breakdown.firstBetTime-n.breakdown.firstBetTime).map(a=>a.entry)}}class j1 extends qu{constructor(){super(),this.id="SET_IT_AND_FORGET_IT",this.label="Set It and Forget It",this.description="Build your lineup with one of each bet type across the slate. Spend all your TD$."}get rules(){return{betTypes:["SPREAD","MONEY","TOTAL"],requiredBetTypes:["SPREAD","MONEY","TOTAL"],maxBetsPerType:-1,maxBetsTotal:-1,minBetsTotal:3,stakeRule:"SPEND_ALL",stakeMin:1,stakeMax:null,allowPartialSubmit:!1,allowBetModification:!0,lockOnFirstBet:!1,oneBetPerMatchPerType:!0}}get scoring(){return{method:"PAYOUT_SUM",rankBy:["totalPayout","betCount","timestamp"],bonuses:[],penalizeMissing:!0}}getBadge(){return{label:"Set & Forget",color:"ghost"}}getEmptyStateText(){return"Build your lineup — place one of each bet type and spend all your TD$"}getRulesHTML(t){const s=t?.tournament_dollars||0;return`
            ...
            </div>`}}var Ya={exports:{}},ao={},Vt={},Os={},no={},ro={},oo={},Ol;function nr(){return Ol||(Ol=1,(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.regexpCode=e.getEsmExportName=e.getProperty=e.safeStringify=e.stringify=e.strConcat=e.addCodeArg=e.str=e._=e.nil=e._Code=e.Name=e.IDENTIFIER=e._CodeOrName=void 0;class t{}e._CodeOrName=t,e.IDENTIFIER=/^[a-z$_][a-z$_0-9]*$/i;class s extends t{constructor(h){if(super(),!e.IDENTIFIER.test(h))throw new Error("CodeGen: name must be a valid identifier");this.str=h}toString(){return this.str}emptyStr(){return!1}get names(){return{[this.str]:1}}}e.Name=s;class a extends t{constructor(h){super(),this._items=typeof h=="string"?[h]:h}toString(){return this.str}emptyStr(){if(this._items.length>1)return!1;const h=this._items[0];return h===""||h==='""'}get str(){var h;return(h=this._str)!==null&&h!==void 0?h:this._str=this._items.reduce((b,w)=>`${b}${w}`,"")}get names(){var h;return(h=this._names)!==null&&h!==void 0?h:this._names=this._items.reduce((b,w)=>(w instanceof s&&(b[w.str]=(b[w.str]||0)+1),b),{})}}e._Code=a,e.nil=new a("");function n(m,...h){const b=[m[0]];let w=0;for(;w<h.length;)l(b,h[w]),b.push(m[++w]);return new a(b)}e._=n;const r=new a("+");function o(m,...h){const b=[f(m[0])];let w=0;for(;w<h.length;)b.push(r),l(b,h[w]),b.push(r,f(m[++w]));return i(b),new a(b)}e.str=o;function l(m,h){h instanceof a?m.push(...h._items):h instanceof s?m.push(h):m.push(u(h))}e.addCodeArg=l;function i(m){let h=1;for(;h<m.length-1;){if(m[h]===r){const b=c(m[h-1],m[h+1]);if(b!==void 0){m.splice(h-1,3,b);continue}m[h++]="+"}h++}}function c(m,h){if(h==='""')return m;if(m==='""')return h;if(typeof m=="string")return h instanceof s||m[m.length-1]!=='"'?void 0:typeof h!="string"?`${m.slice(0,-1)}${h}"`:h[0]==='"'?m.slice(0,-1)+h.slice(1):void 0;if(typeof h=="string"&&h[0]==='"'&&!(m instanceof s))return`"${m}${h.slice(1)}`}function d(m,h){return h.emptyStr()?m:m.emptyStr()?h:o`${m}${h}`}e.strConcat=d;function u(m){return typeof m=="number"||typeof m=="boolean"||m===null?m:f(Array.isArray(m)?m.join(","):m)}function p(m){return new a(f(m))}e.stringify=p;function f(m){return JSON.stringify(m).replace(/\u2028/g,"\\u2028").replace(/\u2029/g,"\\u2029")}e.safeStringify=f;function g(m){return typeof m=="string"&&e.IDENTIFIER.test(m)?new a(`.${m}`):n`[${m}]`}e.getProperty=g;function _(m){if(typeof m=="string"&&e.IDENTIFIER.test(m))return new a(`${m}`);throw new Error(`CodeGen: invalid export name: ${m}, use explicit $id name mapping`)}e.getEsmExportName=_;function v(m){return new a(m.toString())}e.regexpCode=v})(oo)),oo}var io={},$l;function Ml(){return $l||($l=1,(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.ValueScope=e.ValueScopeName=e.Scope=e.varKinds=e.UsedValueState=void 0;const t=nr();class s extends Error{constructor(c){super(`CodeGen: "code" for ${c} not defined`),this.value=c.value}}var a;(function(i){i[i.Started=0]="Started",i[i.Completed=1]="Completed"})(a||(e.UsedValueState=a={})),e.varKinds={const:new t.Name("const"),let:new t.Name("let"),var:new t.Name("var")};class n{constructor({prefixes:c,parent:d}={}){this._names={},this._prefixes=c,this._parent=d}toName(c){return c instanceof t.Name?c:this.name(c)}name(c){return new t.Name(this._newName(c))}_newName(c){const d=this._names[c]||this._nameGroup(c);return`${c}${d.index++}`}_nameGroup(c){var d,u;if(!((u=(d=this._parent)===null||d===void 0?void 0:d._prefixes)===null||u===void 0)&&u.has(c)||this._prefixes&&!this._prefixes.has(c))throw new Error(`CodeGen: prefix "${c}" is not allowed in this scope`);return this._names[c]={prefix:c,index:0}}}e.Scope=n;class r extends t.Name{constructor(c,d){super(d),this.prefix=c}setValue(c,{property:d,itemIndex:u}){this.value=c,this.scopePath=(0,t._)`.${new t.Name(d)}[${u}]`}}e.ValueScopeName=r;const o=(0,t._)`\n`;class l extends n{constructor(c){super(c),this._values={},this._scope=c.scope,this.opts={...c,_n:c.lines?o:t.nil}}get(){return this._scope}name(c){return new r(c,this._newName(c))}value(c,d){var u;if(d.ref===void 0)throw new Error("CodeGen: ref must be passed in value");const p=this.toName(c),{prefix:f}=p,g=(u=d.key)!==null&&u!==void 0?u:d.ref;let _=this._values[f];if(_){const h=_.get(g);if(h)return h}else _=this._values[f]=new Map;_.set(g,p);const v=this._scope[f]||(this._scope[f]=[]),m=v.length;return v[m]=d.ref,p.setValue(d,{property:f,itemIndex:m}),p}getValue(c,d){const u=this._values[c];if(u)return u.get(d)}scopeRefs(c,d=this._values){return this._reduceValues(d,u=>{if(u.scopePath===void 0)throw new Error(`CodeGen: name "${u}" has no value`);return(0,t._)`${c}${u.scopePath}`})}scopeCode(c=this._values,d,u){return this._reduceValues(c,p=>{if(p.value===void 0)throw new Error(`CodeGen: name "${p}" has no value`);return p.value.code},d,u)}_reduceValues(c,d,u={},p){let f=t.nil;for(const g in c){const _=c[g];if(!_)continue;const v=u[g]=u[g]||new Map;_.forEach(m=>{if(v.has(m))return;v.set(m,a.Started);let h=d(m);if(h){const b=this.opts.es5?e.varKinds.var:e.varKinds.const;f=(0,t._)`${f}${b} ${m} = ${h};${this.opts._n}`}else if(h=p?.(m))f=(0,t._)`${f}${h}${this.opts._n}`;else throw new s(m);v.set(m,a.Completed)})}return f}}e.ValueScope=l})(io)),io}var Ll;function Te(){return Ll||(Ll=1,(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.or=e.and=e.not=e.CodeGen=e.operators=e.varKinds=e.ValueScopeName=e.ValueScope=e.Scope=e.Name=e.regexpCode=e.stringify=e.getProperty=e.nil=e.strConcat=e.str=e._=void 0;const t=nr(),s=Ml();var a=nr();Object.defineProperty(e,"_",{enumerable:!0,get:function(){return a._}}),Object.defineProperty(e,"str",{enumerable:!0,get:function(){return a.str}}),Object.defineProperty(e,"strConcat",{enumerable:!0,get:function(){return a.strConcat}}),Object.defineProperty(e,"nil",{enumerable:!0,get:function(){return a.nil}}),Object.defineProperty(e,"getProperty",{enumerable:!0,get:function(){return a.getProperty}}),Object.defineProperty(e,"stringify",{enumerable:!0,get:function(){return a.stringify}}),Object.defineProperty(e,"regexpCode",{enumerable:!0,get:function(){return a.regexpCode}}),Object.defineProperty(e,"Name",{enumerable:!0,get:function(){return a.Name}});var n=Ml();Object.defineProperty(e,"Scope",{enumerable:!0,get:function(){return n.Scope}}),Object.defineProperty(e,"ValueScope",{enumerable:!0,get:function(){return n.ValueScope}}),Object.defineProperty(e,"ValueScopeName",{enumerable:!0,get:function(){return n.ValueScopeName}}),Object.defineProperty(e,"varKinds",{enumerable:!0,get:function(){return n.varKinds}}),e.operators={GT:new t._Code(">"),GTE:new t._Code(">="),LT:new t._Code("<"),LTE:new t._Code("<="),EQ:new t._Code("==="),NEQ:new t._Code("!=="),NOT:new t._Code("!"),OR:new t._Code("||"),AND:new t._Code("&&"),ADD:new t._Code("+")};class r{optimizeNodes(){return this}optimizeNames(A,$){return this}}class o extends r{constructor(A,$,U){super(),this.varKind=A,this.name=$,this.rhs=U}render({es5:A,_n:$}){const U=A?s.varKinds.var:this.varKind,B=this.rhs===void 0?"":` = ${this.rhs}`;return`${U} ${this.name}${B};`+$}optimizeNames(A,$){if(A[this.name.str])return this.rhs&&(this.rhs=q(this.rhs,A,$)),this}get names(){return this.rhs instanceof t._CodeOrName?this.rhs.names:{}}}class l extends r{constructor(A,$,U){super(),this.lhs=A,this.rhs=$,this.sideEffects=U}render({_n:A}){return`${this.lhs} = ${this.rhs};`+A}optimizeNames(A,$){if(!(this.lhs instanceof t.Name&&!A[this.lhs.str]&&!this.sideEffects))return this.rhs=q(this.rhs,A,$),this}get names(){const A=this.lhs instanceof t.Name?{}:{...this.lhs.names};return I(A,this.rhs)}}class i extends l{constructor(A,$,U,B){super(A,U,B),this.op=$}render({_n:A}){return`${this.lhs} ${this.op}= ${this.rhs};`+A}}class c extends r{constructor(A){super(),this.label=A,this.names={}}render({_n:A}){return`${this.label}:`+A}}class d extends r{constructor(A){super(),this.label=A,this.names={}}render({_n:A}){return`break${this.label?` ${this.label}`:""};`+A}}class u extends r{constructor(A){super(),this.error=A}render({_n:A}){return`throw ${this.error};`+A}get names(){return this.error.names}}class p extends r{constructor(A){super(),this.code=A}render({_n:A}){return`${this.code};`+A}optimizeNodes(){return`${this.code}`?this:void 0}optimizeNames(A,$){return this.code=q(this.code,A,$),this}get names(){return this.code instanceof t._CodeOrName?this.code.names:{}}}class f extends r{constructor(A=[]){super(),this.nodes=A}render(A){return this.nodes.reduce(($,U)=>$+U.render(A),"")}optimizeNodes(){const{nodes:A}=this;let $=A.length;for(;$--;){const U=A[$].optimizeNodes();Array.isArray(U)?A.splice($,1,...U):U?A[$]=U:A.splice($,1)}return A.length>0?this:void 0}optimizeNames(A,$){const{nodes:U}=this;let B=U.length;for(;B--;){const G=U[B];G.optimizeNames(A,$)||(J(A,G.names),U.splice(B,1))}return U.length>0?this:void 0}get names(){return this.nodes.reduce((A,$)=>O(A,$.names),{})}}class g extends f{render(A){return"{"+A._n+super.render(A)+"}"+A._n}}class _ extends f{}class v extends g{}v.kind="else";class m extends g{constructor(A,$){super($),this.condition=A}render(A){let $=`if(${this.condition})`+super.render(A);return this.else&&($+="else "+this.else.render(A)),$}optimizeNodes(){super.optimizeNodes();const A=this.condition;if(A===!0)return this.nodes;let $=this.else;if($){const U=$.optimizeNodes();$=this.else=Array.isArray(U)?new v(U):U}if($)return A===!1?$ instanceof m?$:$.nodes:this.nodes.length?this:new m(W(A),$ instanceof m?[$]:$.nodes);if(!(A===!1||!this.nodes.length))return this}optimizeNames(A,$){var U;if(this.else=(U=this.else)===null||U===void 0?void 0:U.optimizeNames(A,$),!!(super.optimizeNames(A,$)||this.else))return this.condition=q(this.condition,A,$),this}get names(){const A=super.names;return I(A,this.condition),this.else&&O(A,this.else.names),A}}m.kind="if";class h extends g{}h.kind="for";class b extends h{constructor(A){super(),this.iteration=A}render(A){return`for(${this.iteration})`+super.render(A)}optimizeNames(A,$){if(super.optimizeNames(A,$))return this.iteration=q(this.iteration,A,$),this}get names(){return O(super.names,this.iteration.names)}}class w extends h{constructor(A,$,U,B){super(),this.varKind=A,this.name=$,this.from=U,this.to=B}render(A){const $=A.es5?s.varKinds.var:this.varKind,{name:U,from:B,to:G}=this;return`for(${$} ${U}=${B}; ${U}<${G}; ${U}++)`+super.render(A)}get names(){const A=I(super.names,this.from);return I(A,this.to)}}class y extends h{constructor(A,$,U,B){super(),this.loop=A,this.varKind=$,this.name=U,this.iterable=B}render(A){return`for(${this.varKind} ${this.name} ${this.loop} ${this.iterable})`+super.render(A)}optimizeNames(A,$){if(super.optimizeNames(A,$))return this.iterable=q(this.iterable,A,$),this}get names(){return O(super.names,this.iterable.names)}}class x extends g{constructor(A,$,U){super(),this.name=A,this.args=$,this.async=U}render(A){return`${this.async?"async ":""}function ${this.name}(${this.args})`+super.render(A)}}x.kind="func";class P extends f{render(A){return"return "+super.render(A)}}P.kind="return";class D extends g{render(A){let $="try"+super.render(A);return this.catch&&($+=this.catch.render(A)),this.finally&&($+=this.finally.render(A)),$}optimizeNodes(){var A,$;return super.optimizeNodes(),(A=this.catch)===null||A===void 0||A.optimizeNodes(),($=this.finally)===null||$===void 0||$.optimizeNodes(),this}optimizeNames(A,$){var U,B;return super.optimizeNames(A,$),(U=this.catch)===null||U===void 0||U.optimizeNames(A,$),(B=this.finally)===null||B===void 0||B.optimizeNames(A,$),this}get names(){const A=super.names;return this.catch&&O(A,this.catch.names),this.finally&&O(A,this.finally.names),A}}class T extends g{constructor(A){super(),this.error=A}render(A){return`catch(${this.error})`+super.render(A)}}T.kind="catch";class k extends g{render(A){return"finally"+super.render(A)}}k.kind="finally";class S{constructor(A,$={}){this._values={},this._blockStarts=[],this._constants={},this.opts={...$,_n:$.lines?`
`:""},this._extScope=A,this._scope=new s.Scope({parent:A}),this._nodes=[new _]}toString(){return this._root.render(this.opts)}name(A){return this._scope.name(A)}scopeName(A){return this._extScope.name(A)}scopeValue(A,$){const U=this._extScope.value(A,$);return(this._values[U.prefix]||(this._values[U.prefix]=new Set)).add(U),U}getScopeValue(A,$){return this._extScope.getValue(A,$)}scopeRefs(A){return this._extScope.scopeRefs(A,this._values)}scopeCode(){return this._extScope.scopeCode(this._values)}_def(A,$,U,B){const G=this._scope.toName($);return U!==void 0&&B&&(this._constants[G.str]=U),this._leafNode(new o(A,G,U)),G}const(A,$,U){return this._def(s.varKinds.const,A,$,U)}let(A,$,U){return this._def(s.varKinds.let,A,$,U)}var(A,$,U){return this._def(s.varKinds.var,A,$,U)}assign(A,$,U){return this._leafNode(new l(A,$,U))}add(A,$){return this._leafNode(new i(A,e.operators.ADD,$))}code(A){return typeof A=="function"?A():A!==t.nil&&this._leafNode(new p(A)),this}object(...A){const $=["{"];for(const[U,B]of A)$.length>1&&$.push(","),$.push(U),(U!==B||this.opts.es5)&&($.push(":"),(0,t.addCodeArg)($,B));return $.push("}"),new t._Code($)}if(A,$,U){if(this._blockNode(new m(A)),$&&U)this.code($).else().code(U).endIf();else if($)this.code($).endIf();else if(U)throw new Error('CodeGen: "else" body without "then" body');return this}elseIf(A){return this._elseNode(new m(A))}else(){return this._elseNode(new v)}endIf(){return this._endBlockNode(m,v)}_for(A,$){return this._blockNode(A),$&&this.code($).endFor(),this}for(A,$){return this._for(new b(A),$)}forRange(A,$,U,B,G=this.opts.es5?s.varKinds.var:s.varKinds.let){const j=this._scope.toName(A);return this._for(new w(G,j,$,U),()=>B(j))}forOf(A,$,U,B=s.varKinds.const){const G=this._scope.toName(A);if(this.opts.es5){const j=$ instanceof t.Name?$:this.var("_arr",$);return this.forRange("_i",0,(0,t._)`${j}.length`,Z=>{this.var(G,(0,t._)`${j}[${Z}]`),U(G)})}return this._for(new y("of",B,G,$),()=>U(G))}forIn(A,$,U,B=this.opts.es5?s.varKinds.var:s.varKinds.const){if(this.opts.ownProperties)return this.forOf(A,(0,t._)`Object.keys(${$})`,U);const G=this._scope.toName(A);return this._for(new y("in",B,G,$),()=>U(G))}endFor(){return this._endBlockNode(h)}label(A){return this._leafNode(new c(A))}break(A){return this._leafNode(new d(A))}return(A){const $=new P;if(this._blockNode($),this.code(A),$.nodes.length!==1)throw new Error('CodeGen: "return" should have one node');return this._endBlockNode(P)}try(A,$,U){if(!$&&!U)throw new Error('CodeGen: "try" without "catch" and "finally"');const B=new D;if(this._blockNode(B),this.code(A),$){const G=this.name("e");this._currNode=B.catch=new T(G),$(G)}return U&&(this._currNode=B.finally=new k,this.code(U)),this._endBlockNode(T,k)}throw(A){return this._leafNode(new u(A))}block(A,$){return this._blockStarts.push(this._nodes.length),A&&this.code(A).endBlock($),this}endBlock(A){const $=this._blockStarts.pop();if($===void 0)throw new Error("CodeGen: not in self-balancing block");const U=this._nodes.length-$;if(U<0||A!==void 0&&U!==A)throw new Error(`CodeGen: wrong number of nodes: ${U} vs ${A} expected`);return this._nodes.length=$,this}func(A,$=t.nil,U,B){return this._blockNode(new x(A,$,U)),B&&this.code(B).endFunc(),this}endFunc(){return this._endBlockNode(x)}optimize(A=1){for(;A-- >0;)this._root.optimizeNodes(),this._root.optimizeNames(this._root.names,this._constants)}_leafNode(A){return this._currNode.nodes.push(A),this}_blockNode(A){this._currNode.nodes.push(A),this._nodes.push(A)}_endBlockNode(A,$){const U=this._currNode;if(U instanceof A||$&&U instanceof $)return this._nodes.pop(),this;throw new Error(`CodeGen: not in block "${$?`${A.kind}/${$.kind}`:A.kind}"`)}_elseNode(A){const $=this._currNode;if(!($ instanceof m))throw new Error('CodeGen: "else" without "if"');return this._currNode=$.else=A,this}get _root(){return this._nodes[0]}get _currNode(){const A=this._nodes;return A[A.length-1]}set _currNode(A){const $=this._nodes;$[$.length-1]=A}}e.CodeGen=S;function O(K,A){for(const $ in A)K[$]=(K[$]||0)+(A[$]||0);return K}function I(K,A){return A instanceof t._CodeOrName?O(K,A.names):K}function q(K,A,$){if(K instanceof t.Name)return U(K);if(!B(K))return K;return new t._Code(K._items.reduce((G,j)=>(j instanceof t.Name&&(j=U(j)),j instanceof t._Code?G.push(...j._items):G.push(j),G),[]));function U(G){const j=$[G.str];return j===void 0||A[G.str]!==1?G:(delete A[G.str],j)}function B(G){return G instanceof t._Code&&G._items.some(j=>j instanceof t.Name&&A[j.str]===1&&$[j.str]!==void 0)}}function J(K,A){for(const $ in A)K[$]=(K[$]||0)-(A[$]||0)}function W(K){return typeof K=="boolean"||typeof K=="number"||K===null?!K:(0,t._)`!${X(K)}`}e.not=W;const Q=H(e.operators.AND);function V(...K){return K.reduce(Q)}e.and=V;const re=H(e.operators.OR);function Y(...K){return K.reduce(re)}e.or=Y;function H(K){return(A,$)=>A===t.nil?$:$===t.nil?A:(0,t._)`${X(A)} ${K} ${X($)}`}function X(K){return K instanceof t.Name?K:(0,t._)`(${K})`}})(ro)),ro}var we={},Rl;function Ee(){if(Rl)return we;Rl=1,Object.defineProperty(we,"__esModule",{value:!0}),we.checkStrictMode=we.getErrorPath=we.Type=we.useFunc=we.setEvaluated=we.evaluatedPropsToName=we.mergeEvaluated=we.eachItem=we.unescapeJsonPointer=we.escapeJsonPointer=we.escapeFragment=we.unescapeFragment=we.schemaRefOrVal=we.schemaHasRulesButRef=we.schemaHasRules=we.checkUnknownRules=we.alwaysValidSchema=we.toHash=void 0;const e=Te(),t=nr();function s(y){const x={};for(const P of y)x[P]=!0;return x}we.toHash=s;function a(y,x){return typeof x=="boolean"?x:Object.keys(x).length===0?!0:(n(y,x),!r(x,y.self.RULES.all))}we.alwaysValidSchema=a;function n(y,x=y.schema){const{opts:P,self:D}=y;if(!P.strictSchema||typeof x=="boolean")return;const T=D.RULES.keywords;for(const k in x)T[k]||w(y,`unknown keyword: "${k}"`)}we.checkUnknownRules=n;function r(y,x){if(typeof y=="boolean")return!y;for(const P in y)if(x[P])return!0;return!1}we.schemaHasRules=r;function o(y,x){if(typeof y=="boolean")return!y;for(const P in y)if(P!=="$ref"&&x.all[P])return!0;return!1}we.schemaHasRulesButRef=o;function l({topSchemaRef:y,schemaPath:x},P,D,T){if(!T){if(typeof P=="number"||typeof P=="boolean")return P;if(typeof P=="string")return(0,e._)`${P}`}return(0,e._)`${y}${x}${(0,e.getProperty)(D)}`}we.schemaRefOrVal=l;function i(y){return u(decodeURIComponent(y))}we.unescapeFragment=i;function c(y){return encodeURIComponent(d(y))}we.escapeFragment=c;function d(y){return typeof y=="number"?`${y}`:y.replace(/~/g,"~0").replace(/\//g,"~1")}we.escapeJsonPointer=d;function u(y){return y.replace(/~1/g,"/").replace(/~0/g,"~")}we.unescapeJsonPointer=u;function p(y,x){if(Array.isArray(y))for(const P of y)x(P);else x(y)}we.eachItem=p;function f({mergeNames:y,mergeToName:x,mergeValues:P,resultToName:D}){return(T,k,S,O)=>{const I=S===void 0?k:S instanceof e.Name?(k instanceof e.Name?y(T,k,S):x(T,k,S),S):k instanceof e.Name?(x(T,S,k),k):P(k,S);return O===e.Name&&!(I instanceof e.Name)?D(T,I):I}}we.mergeEvaluated={props:f({mergeNames:(y,x,P)=>y.if((0,e._)`${P} !== true && ${x} !== undefined`,()=>{y.if((0,e._)`${x} === true`,()=>y.assign(P,!0),()=>y.assign(P,(0,e._)`${P} || {}`).code((0,e._)`Object.assign(${P}, ${x})`))}),mergeToName:(y,x,P)=>y.if((0,e._)`${P} !== true`,()=>{x===!0?y.assign(P,!0):(y.assign(P,(0,e._)`${P} || {}`),_(y,P,x))}),mergeValues:(y,x)=>y===!0?!0:{...y,...x},resultToName:g}),items:f({mergeNames:(y,x,P)=>y.if((0,e._)`${P} !== true && ${x} !== undefined`,()=>y.assign(P,(0,e._)`${x} === true ? true : ${P} > ${x} ? ${P} : ${x}`)),mergeToName:(y,x,P)=>y.if((0,e._)`${P} !== true`,()=>y.assign(P,x===!0?!0:(0,e._)`${P} > ${x} ? ${P} : ${x}`)),mergeValues:(y,x)=>y===!0?!0:Math.max(y,x),resultToName:(y,x)=>y.var("items",x)})};function g(y,x){if(x===!0)return y.var("props",!0);const P=y.var("props",(0,e._)`{}`);return x!==void 0&&_(y,P,x),P}we.evaluatedPropsToName=g;function _(y,x,P){Object.keys(P).forEach(D=>y.assign((0,e._)`${x}${(0,e.getProperty)(D)}`,!0))}we.setEvaluated=_;const v={};function m(y,x){return y.scopeValue("func",{ref:x,code:v[x.code]||(v[x.code]=new t._Code(x.code))})}we.useFunc=m;var h;(function(y){y[y.Num=0]="Num",y[y.Str=1]="Str"})(h||(we.Type=h={}));function b(y,x,P){if(y instanceof e.Name){const D=x===h.Num;return P?D?(0,e._)`"[" + ${y} + "]"`:(0,e._)`"['" + ${y} + "']"`:D?(0,e._)`"/" + ${y}`:(0,e._)`"/" + ${y}.replace(/~/g, "~0").replace(/\\//g, "~1")`}return P?(0,e.getProperty)(y).toString():"/"+d(y)}we.getErrorPath=b;function w(y,x,P=y.opts.strictSchema){if(P){if(x=`strict mode: ${x}`,P===!0)throw new Error(x);y.self.logger.warn(x)}}return we.checkStrictMode=w,we}var Wa={},Dl;function Es(){if(Dl)return Wa;Dl=1,Object.defineProperty(Wa,"__esModule",{value:!0});const e=Te(),t={data:new e.Name("data"),valCxt:new e.Name("valCxt"),instancePath:new e.Name("instancePath"),parentData:new e.Name("parentData"),parentDataProperty:new e.Name("parentDataProperty"),rootData:new e.Name("rootData"),dynamicAnchors:new e.Name("dynamicAnchors"),vErrors:new e.Name("vErrors"),errors:new e.Name("errors"),this:new e.Name("this"),self:new e.Name("self"),scope:new e.Name("scope"),json:new e.Name("json"),jsonPos:new e.Name("jsonPos"),jsonLen:new e.Name("jsonLen"),jsonPart:new e.Name("jsonPart")};return Wa.default=t,Wa}var Nl;function Sr(){return Nl||(Nl=1,(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.extendErrors=e.resetErrorsCount=e.reportExtraError=e.reportError=e.keyword$DataError=e.keywordError=void 0;const t=Te(),s=Ee(),a=Es();e.keywordError={message:({keyword:v})=>(0,t.str)`must pass "${v}" keyword validation`},e.keyword$DataError={message:({keyword:v,schemaType:m})=>m?(0,t.str)`"${v}" keyword must be ${m} ($data)`:(0,t.str)`"${v}" keyword is invalid ($data)`};function n(v,m=e.keywordError,h,b){const{it:w}=v,{gen:y,compositeRule:x,allErrors:P}=w,D=u(v,m,h);b??(x||P)?i(y,D):c(w,(0,t._)`[${D}]`)}e.reportError=n;function r(v,m=e.keywordError,h){const{it:b}=v,{gen:w,compositeRule:y,allErrors:x}=b,P=u(v,m,h);i(w,P),y||x||c(b,a.default.vErrors)}e.reportExtraError=r;function o(v,m){v.assign(a.default.errors,m),v.if((0,t._)`${a.default.vErrors} !== null`,()=>v.if(m,()=>v.assign((0,t._)`${a.default.vErrors}.length`,m),()=>v.assign(a.default.vErrors,null)))}e.resetErrorsCount=o;function l({gen:v,keyword:m,schemaValue:h,data:b,errsCount:w,it:y}){if(w===void 0)throw new Error("ajv implementation error");const x=v.name("err");v.forRange("i",w,a.default.errors,P=>{v.const(x,(0,t._)`${a.default.vErrors}[${P}]`),v.if((0,t._)`${x}.instancePath === undefined`,()=>v.assign((0,t._)`${x}.instancePath`,(0,t.strConcat)(a.default.instancePath,y.errorPath))),v.assign((0,t._)`${x}.schemaPath`,(0,t.str)`${y.errSchemaPath}/${m}`),y.opts.verbose&&(v.assign((0,t._)`${x}.schema`,h),v.assign((0,t._)`${x}.data`,b))})}e.extendErrors=l;function i(v,m){const h=v.const("err",m);v.if((0,t._)`${a.default.vErrors} === null`,()=>v.assign(a.default.vErrors,(0,t._)`[${h}]`),(0,t._)`${a.default.vErrors}.push(${h})`),v.code((0,t._)`${a.default.errors}++`)}function c(v,m){const{gen:h,validateName:b,schemaEnv:w}=v;w.$async?h.throw((0,t._)`new ${v.ValidationError}(${m})`):(h.assign((0,t._)`${b}.errors`,m),h.return(!1))}const d={keyword:new t.Name("keyword"),schemaPath:new t.Name("schemaPath"),params:new t.Name("params"),propertyName:new t.Name("propertyName"),message:new t.Name("message"),schema:new t.Name("schema"),parentSchema:new t.Name("parentSchema")};function u(v,m,h){const{createErrors:b}=v.it;return b===!1?(0,t._)`{}`:p(v,m,h)}function p(v,m,h={}){const{gen:b,it:w}=v,y=[f(w,h),g(v,h)];return _(v,m,y),b.object(...y)}function f({errorPath:v},{instancePath:m}){const h=m?(0,t.str)`${v}${(0,s.getErrorPath)(m,s.Type.Str)}`:v;return[a.default.instancePath,(0,t.strConcat)(a.default.instancePath,h)]}function g({keyword:v,it:{errSchemaPath:m}},{schemaPath:h,parentSchema:b}){let w=b?m:(0,t.str)`${m}/${v}`;return h&&(w=(0,t.str)`${w}${(0,s.getErrorPath)(h,s.Type.Str)}`),[d.schemaPath,w]}function _(v,{params:m,message:h},b){const{keyword:w,data:y,schemaValue:x,it:P}=v,{opts:D,propertyName:T,topSchemaRef:k,schemaPath:S}=P;b.push([d.keyword,w],[d.params,typeof m=="function"?m(v):m||(0,t._)`{}`]),D.messages&&b.push([d.message,typeof h=="function"?h(v):h]),D.verbose&&b.push([d.schema,x],[d.parentSchema,(0,t._)`${k}${S}`],[a.default.data,y]),T&&b.push([d.propertyName,T])}})(no)),no}var Il;function U1(){if(Il)return Os;Il=1,Object.defineProperty(Os,"__esModule",{value:!0}),Os.boolOrEmptySchema=Os.topBoolOrEmptySchema=void 0;const e=Sr(),t=Te(),s=Es(),a={message:"boolean schema is false"};function n(l){const{gen:i,schema:c,validateName:d}=l;c===!1?o(l,!1):typeof c=="object"&&c.$async===!0?i.return(s.default.data):(i.assign((0,t._)`${d}.errors`,null),i.return(!0))}Os.topBoolOrEmptySchema=n;function r(l,i){const{gen:c,schema:d}=l;d===!1?(c.var(i,!1),o(l)):c.var(i,!0)}Os.boolOrEmptySchema=r;function o(l,i){const{gen:c,data:d}=l,u={gen:c,keyword:"false schema",data:d,schema:!1,schemaCode:!1,schemaValue:!1,params:{},it:l};(0,e.reportError)(u,a,void 0,i)}return Os}var Ye={},$s={},Bl;function Vu(){if(Bl)return $s;Bl=1,Object.defineProperty($s,"__esModule",{value:!0}),$s.getRules=$s.isJSONType=void 0;const e=["string","number","integer","boolean","null","object","array"],t=new Set(e);function s(n){return typeof n=="string"&&t.has(n)}$s.isJSONType=s;function a(){const n={number:{type:"number",rules:[]},string:{type:"string",rules:[]},array:{type:"array",rules:[]},object:{type:"object",rules:[]}};return{types:{...n,integer:!0,boolean:!0,null:!0},rules:[{rules:[]},n.number,n.string,n.array,n.object],post:{rules:[]},all:{},keywords:{}}}return $s.getRules=a,$s}var Gt={},Fl;function Gu(){if(Fl)return Gt;Fl=1,Object.defineProperty(Gt,"__esModule",{value:!0}),Gt.shouldUseRule=Gt.shouldUseGroup=Gt.schemaHasRulesForType=void 0;function e({schema:a,self:n},r){const o=n.RULES.types[r];return o&&o!==!0&&t(a,o)}Gt.schemaHasRulesForType=e;function t(a,n){return n.rules.some(r=>s(a,r))}Gt.shouldUseGroup=t;function s(a,n){var r;return a[n.keyword]!==void 0||((r=n.definition.implements)===null||r===void 0?void 0:r.some(o=>a[o]!==void 0))}return Gt.shouldUseRule=s,Gt}var zl;function rr(){if(zl)return Ye;zl=1,Object.defineProperty(Ye,"__esModule",{value:!0}),Ye.reportTypeError=Ye.checkDataTypes=Ye.checkDataType=Ye.coerceAndCheckDataType=Ye.getJSONTypes=Ye.getSchemaTypes=Ye.DataType=void 0;const e=Vu(),t=Gu(),s=Sr(),a=Te(),n=Ee();var r;(function(h){h[h.Correct=0]="Correct",h[h.Wrong=1]="Wrong"})(r||(Ye.DataType=r={}));function o(h){const b=l(h.type);if(b.includes("null")){if(h.nullable===!1)throw new Error("type: null contradicts nullable: false")}else{if(!b.length&&h.nullable!==void 0)throw new Error('"nullable" cannot be used without "type"');h.nullable===!0&&b.push("null")}return b}Ye.getSchemaTypes=o;function l(h){const b=Array.isArray(h)?h:h?[h]:[];if(b.every(e.isJSONType))return b;throw new Error("type must be JSONType or JSONType[]: "+b.join(","))}Ye.getJSONTypes=l;function i(h,b){const{gen:w,data:y,opts:x}=h,P=d(b,x.coerceTypes),D=b.length>0&&!(P.length===0&&b.length===1&&(0,t.schemaHasRulesForType)(h,b[0]));if(D){const T=g(b,y,x.strictNumbers,r.Wrong);w.if(T,()=>{P.length?u(h,b,P):v(h)})}return D}Ye.coerceAndCheckDataType=i;const c=new Set(["string","number","integer","boolean","null"]);function d(h,b){return b?h.filter(w=>c.has(w)||b==="array"&&w==="array"):[]}function u(h,b,w){const{gen:y,data:x,opts:P}=h,D=y.let("dataType",(0,a._)`typeof ${x}`),T=y.let("coerced",(0,a._)`undefined`);P.coerceTypes==="array"&&y.if((0,a._)`${D} == 'object' && Array.isArray(${x}) && ${x}.length == 1`,()=>y.assign(x,(0,a._)`${x}[0]`).assign(D,(0,a._)`typeof ${x}`).if(g(b,x,P.strictNumbers),()=>y.assign(T,x))),y.if((0,a._)`${T} !== undefined`);for(const S of w)(c.has(S)||S==="array"&&P.coerceTypes==="array")&&k(S);y.else(),v(h),y.endIf(),y.if((0,a._)`${T} !== undefined`,()=>{y.assign(x,T),p(h,T)});function k(S){switch(S){case"string":y.elseIf((0,a._)`${D} == "number" || ${D} == "boolean"`).assign(T,(0,a._)`"" + ${x}`).elseIf((0,a._)`${x} === null`).assign(T,(0,a._)`""`);return;case"number":y.elseIf((0,a._)`${D} == "boolean" || ${x} === null
              || (${D} == "string" && ${x} && ${x} == +${x})`).assign(T,(0,a._)`+${x}`);return;case"integer":y.elseIf((0,a._)`${D} === "boolean" || ${x} === null
              || (${D} === "string" && ${x} && ${x} == +${x} && !(${x} % 1))`).assign(T,(0,a._)`+${x}`);return;case"boolean":y.elseIf((0,a._)`${x} === "false" || ${x} === 0 || ${x} === null`).assign(T,!1).elseIf((0,a._)`${x} === "true" || ${x} === 1`).assign(T,!0);return;case"null":y.elseIf((0,a._)`${x} === "" || ${x} === 0 || ${x} === false`),y.assign(T,null);return;case"array":y.elseIf((0,a._)`${D} === "string" || ${D} === "number"
              || ${D} === "boolean" || ${x} === null`).assign(T,(0,a._)`[${x}]`)}}}function p({gen:h,parentData:b,parentDataProperty:w},y){h.if((0,a._)`${b} !== undefined`,()=>h.assign((0,a._)`${b}[${w}]`,y))}function f(h,b,w,y=r.Correct){const x=y===r.Correct?a.operators.EQ:a.operators.NEQ;let P;switch(h){case"null":return(0,a._)`${b} ${x} null`;case"array":P=(0,a._)`Array.isArray(${b})`;break;case"object":P=(0,a._)`${b} && typeof ${b} == "object" && !Array.isArray(${b})`;break;case"integer":P=D((0,a._)`!(${b} % 1) && !isNaN(${b})`);break;case"number":P=D();break;default:return(0,a._)`typeof ${b} ${x} ${h}`}return y===r.Correct?P:(0,a.not)(P);function D(T=a.nil){return(0,a.and)((0,a._)`typeof ${b} == "number"`,T,w?(0,a._)`isFinite(${b})`:a.nil)}}Ye.checkDataType=f;function g(h,b,w,y){if(h.length===1)return f(h[0],b,w,y);let x;const P=(0,n.toHash)(h);if(P.array&&P.object){const D=(0,a._)`typeof ${b} != "object"`;x=P.null?D:(0,a._)`!${b} || ${D}`,delete P.null,delete P.array,delete P.object}else x=a.nil;P.number&&delete P.integer;for(const D in P)x=(0,a.and)(x,f(D,b,w,y));return x}Ye.checkDataTypes=g;const _={message:({schema:h})=>`must be ${h}`,params:({schema:h,schemaValue:b})=>typeof h=="string"?(0,a._)`{type: ${h}}`:(0,a._)`{type: ${b}}`};function v(h){const b=m(h);(0,s.reportError)(b,_)}Ye.reportTypeError=v;function m(h){const{gen:b,data:w,schema:y}=h,x=(0,n.schemaRefOrVal)(h,y,"type");return{gen:b,keyword:"type",data:w,schema:y.type,schemaCode:x,schemaValue:x,parentSchema:y,params:{},it:h}}return Ye}var ua={},Hl;function q1(){if(Hl)return ua;Hl=1,Object.defineProperty(ua,"__esModule",{value:!0}),ua.assignDefaults=void 0;const e=Te(),t=Ee();function s(n,r){const{properties:o,items:l}=n.schema;if(r==="object"&&o)for(const i in o)a(n,i,o[i].default);else r==="array"&&Array.isArray(l)&&l.forEach((i,c)=>a(n,c,i.default))}ua.assignDefaults=s;function a(n,r,o){const{gen:l,compositeRule:i,data:c,opts:d}=n;if(o===void 0)return;const u=(0,e._)`${c}${(0,e.getProperty)(r)}`;if(i){(0,t.checkStrictMode)(n,`default is ignored for: ${u}`);return}let p=(0,e._)`${u} === undefined`;d.useDefaults==="empty"&&(p=(0,e._)`${p} || ${u} === null || ${u} === ""`),l.if(p,(0,e._)`${u} = ${(0,e.stringify)(o)}`)}return ua}var kt={},Ce={},jl;function Ot(){if(jl)return Ce;jl=1,Object.defineProperty(Ce,"__esModule",{value:!0}),Ce.validateUnion=Ce.validateArray=Ce.usePattern=Ce.callValidateCode=Ce.schemaProperties=Ce.allSchemaProperties=Ce.noPropertyInData=Ce.propertyInData=Ce.isOwnProperty=Ce.hasPropFunc=Ce.reportMissingProp=Ce.checkMissingProp=Ce.checkReportMissingProp=void 0;const e=Te(),t=Ee(),s=Es(),a=Ee();function n(h,b){const{gen:w,data:y,it:x}=h;w.if(d(w,y,b,x.opts.ownProperties),()=>{h.setParams({missingProperty:(0,e._)`${b}`},!0),h.error()})}Ce.checkReportMissingProp=n;function r({gen:h,data:b,it:{opts:w}},y,x){return(0,e.or)(...y.map(P=>(0,e.and)(d(h,b,P,w.ownProperties),(0,e._)`${x} = ${P}`)))}Ce.checkMissingProp=r;function o(h,b){h.setParams({missingProperty:b},!0),h.error()}Ce.reportMissingProp=o;function l(h){return h.scopeValue("func",{ref:Object.prototype.hasOwnProperty,code:(0,e._)`Object.prototype.hasOwnProperty`})}Ce.hasPropFunc=l;function i(h,b,w){return(0,e._)`${l(h)}.call(${b}, ${w})`}Ce.isOwnProperty=i;function c(h,b,w,y){const x=(0,e._)`${b}${(0,e.getProperty)(w)} !== undefined`;return y?(0,e._)`${x} && ${i(h,b,w)}`:x}Ce.propertyInData=c;function d(h,b,w,y){const x=(0,e._)`${b}${(0,e.getProperty)(w)} === undefined`;return y?(0,e.or)(x,(0,e.not)(i(h,b,w))):x}Ce.noPropertyInData=d;function u(h){return h?Object.keys(h).filter(b=>b!=="__proto__"):[]}Ce.allSchemaProperties=u;function p(h,b){return u(b).filter(w=>!(0,t.alwaysValidSchema)(h,b[w]))}Ce.schemaProperties=p;function f({schemaCode:h,data:b,it:{gen:w,topSchemaRef:y,schemaPath:x,errorPath:P},it:D},T,k,S){const O=S?(0,e._)`${h}, ${b}, ${y}${x}`:b,I=[[s.default.instancePath,(0,e.strConcat)(s.default.instancePath,P)],[s.default.parentData,D.parentData],[s.default.parentDataProperty,D.parentDataProperty],[s.default.rootData,s.default.rootData]];D.opts.dynamicRef&&I.push([s.default.dynamicAnchors,s.default.dynamicAnchors]);const q=(0,e._)`${O}, ${w.object(...I)}`;return k!==e.nil?(0,e._)`${T}.call(${k}, ${q})`:(0,e._)`${T}(${q})`}Ce.callValidateCode=f;const g=(0,e._)`new RegExp`;function _({gen:h,it:{opts:b}},w){const y=b.unicodeRegExp?"u":"",{regExp:x}=b.code,P=x(w,y);return h.scopeValue("pattern",{key:P.toString(),ref:P,code:(0,e._)`${x.code==="new RegExp"?g:(0,a.useFunc)(h,x)}(${w}, ${y})`})}Ce.usePattern=_;function v(h){const{gen:b,data:w,keyword:y,it:x}=h,P=b.name("valid");if(x.allErrors){const T=b.let("valid",!0);return D(()=>b.assign(T,!1)),T}return b.var(P,!0),D(()=>b.break()),P;function D(T){const k=b.const("len",(0,e._)`${w}.length`);b.forRange("i",0,k,S=>{h.subschema({keyword:y,dataProp:S,dataPropType:t.Type.Num},P),b.if((0,e.not)(P),T)})}}Ce.validateArray=v;function m(h){const{gen:b,schema:w,keyword:y,it:x}=h;if(!Array.isArray(w))throw new Error("ajv implementation error");if(w.some(k=>(0,t.alwaysValidSchema)(x,k))&&!x.opts.unevaluated)return;const D=b.let("valid",!1),T=b.name("_valid");b.block(()=>w.forEach((k,S)=>{const O=h.subschema({keyword:y,schemaProp:S,compositeRule:!0},T);b.assign(D,(0,e._)`${D} || ${T}`),h.mergeValidEvaluated(O,T)||b.if((0,e.not)(D))})),h.result(D,()=>h.reset(),()=>h.error(!0))}return Ce.validateUnion=m,Ce}var Ul;function V1(){if(Ul)return kt;Ul=1,Object.defineProperty(kt,"__esModule",{value:!0}),kt.validateKeywordUsage=kt.validSchemaType=kt.funcKeywordCode=kt.macroKeywordCode=void 0;const e=Te(),t=Es(),s=Ot(),a=Sr();function n(p,f){const{gen:g,keyword:_,schema:v,parentSchema:m,it:h}=p,b=f.macro.call(h.self,v,m,h),w=c(g,_,b);h.opts.validateSchema!==!1&&h.self.validateSchema(b,!0);const y=g.name("valid");p.subschema({schema:b,schemaPath:e.nil,errSchemaPath:`${h.errSchemaPath}/${_}`,topSchemaRef:w,compositeRule:!0},y),p.pass(y,()=>p.error(!0))}kt.macroKeywordCode=n;function r(p,f){var g;const{gen:_,keyword:v,schema:m,parentSchema:h,$data:b,it:w}=p;i(w,f);const y=!b&&f.compile?f.compile.call(w.self,m,h,w):f.validate,x=c(_,v,y),P=_.let("valid");p.block$data(P,D),p.ok((g=f.valid)!==null&&g!==void 0?g:P);function D(){if(f.errors===!1)S(),f.modifying&&o(p),O(()=>p.error());else{const I=f.async?T():k();f.modifying&&o(p),O(()=>l(p,I))}}function T(){const I=_.let("ruleErrs",null);return _.try(()=>S((0,e._)`await `),q=>_.assign(P,!1).if((0,e._)`${q} instanceof ${w.ValidationError}`,()=>_.assign(I,(0,e._)`${q}.errors`),()=>_.throw(q))),I}function k(){const I=(0,e._)`${x}.errors`;return _.assign(I,null),S(e.nil),I}function S(I=f.async?(0,e._)`await `:e.nil){const q=w.opts.passContext?t.default.this:t.default.self,J=!("compile"in f&&!b||f.schema===!1);_.assign(P,(0,e._)`${I}${(0,s.callValidateCode)(p,x,q,J)}`,f.modifying)}function O(I){var q;_.if((0,e.not)((q=f.valid)!==null&&q!==void 0?q:P),I)}}kt.funcKeywordCode=r;function o(p){const{gen:f,data:g,it:_}=p;f.if(_.parentData,()=>f.assign(g,(0,e._)`${_.parentData}[${_.parentDataProperty}]`))}function l(p,f){const{gen:g}=p;g.if((0,e._)`Array.isArray(${f})`,()=>{g.assign(t.default.vErrors,(0,e._)`${t.default.vErrors} === null ? ${f} : ${t.default.vErrors}.concat(${f})`).assign(t.default.errors,(0,e._)`${t.default.vErrors}.length`),(0,a.extendErrors)(p)},()=>p.error())}function i({schemaEnv:p},f){if(f.async&&!p.$async)throw new Error("async keyword in sync schema")}function c(p,f,g){if(g===void 0)throw new Error(`keyword "${f}" failed to compile`);return p.scopeValue("keyword",typeof g=="function"?{ref:g}:{ref:g,code:(0,e.stringify)(g)})}function d(p,f,g=!1){return!f.length||f.some(_=>_==="array"?Array.isArray(p):_==="object"?p&&typeof p=="object"&&!Array.isArray(p):typeof p==_||g&&typeof p>"u")}kt.validSchemaType=d;function u({schema:p,opts:f,self:g,errSchemaPath:_},v,m){if(Array.isArray(v.keyword)?!v.keyword.includes(m):v.keyword!==m)throw new Error("ajv implementation error");const h=v.dependencies;if(h?.some(b=>!Object.prototype.hasOwnProperty.call(p,b)))throw new Error(`parent schema must have dependencies of ${m}: ${h.join(",")}`);if(v.validateSchema&&!v.validateSchema(p[m])){const w=`keyword "${m}" value is invalid at path "${_}": `+g.errorsText(v.validateSchema.errors);if(f.validateSchema==="log")g.logger.error(w);else throw new Error(w)}}return kt.validateKeywordUsage=u,kt}var Kt={},ql;function G1(){if(ql)return Kt;ql=1,Object.defineProperty(Kt,"__esModule",{value:!0}),Kt.extendSubschemaMode=Kt.extendSubschemaData=Kt.getSubschema=void 0;const e=Te(),t=Ee();function s(r,{keyword:o,schemaProp:l,schema:i,schemaPath:c,errSchemaPath:d,topSchemaRef:u}){if(o!==void 0&&i!==void 0)throw new Error('both "keyword" and "schema" passed, only one allowed');if(o!==void 0){const p=r.schema[o];return l===void 0?{schema:p,schemaPath:(0,e._)`${r.schemaPath}${(0,e.getProperty)(o)}`,errSchemaPath:`${r.errSchemaPath}/${o}`}:{schema:p[l],schemaPath:(0,e._)`${r.schemaPath}${(0,e.getProperty)(o)}${(0,e.getProperty)(l)}`,errSchemaPath:`${r.errSchemaPath}/${o}/${(0,t.escapeFragment)(l)}`}}if(i!==void 0){if(c===void 0||d===void 0||u===void 0)throw new Error('"schemaPath", "errSchemaPath" and "topSchemaRef" are required with "schema"');return{schema:i,schemaPath:c,topSchemaRef:u,errSchemaPath:d}}throw new Error('either "keyword" or "schema" must be passed')}Kt.getSubschema=s;function a(r,o,{dataProp:l,dataPropType:i,data:c,dataTypes:d,propertyName:u}){if(c!==void 0&&l!==void 0)throw new Error('both "data" and "dataProp" passed, only one allowed');const{gen:p}=o;if(l!==void 0){const{errorPath:g,dataPathArr:_,opts:v}=o,m=p.let("data",(0,e._)`${o.data}${(0,e.getProperty)(l)}`,!0);f(m),r.errorPath=(0,e.str)`${g}${(0,t.getErrorPath)(l,i,v.jsPropertySyntax)}`,r.parentDataProperty=(0,e._)`${l}`,r.dataPathArr=[..._,r.parentDataProperty]}if(c!==void 0){const g=c instanceof e.Name?c:p.let("data",c,!0);f(g),u!==void 0&&(r.propertyName=u)}d&&(r.dataTypes=d);function f(g){r.data=g,r.dataLevel=o.dataLevel+1,r.dataTypes=[],o.definedProperties=new Set,r.parentData=o.data,r.dataNames=[...o.dataNames,g]}}Kt.extendSubschemaData=a;function n(r,{jtdDiscriminator:o,jtdMetadata:l,compositeRule:i,createErrors:c,allErrors:d}){i!==void 0&&(r.compositeRule=i),c!==void 0&&(r.createErrors=c),d!==void 0&&(r.allErrors=d),r.jtdDiscriminator=o,r.jtdMetadata=l}return Kt.extendSubschemaMode=n,Kt}var st={},lo,Vl;function Ku(){return Vl||(Vl=1,lo=function e(t,s){if(t===s)return!0;if(t&&s&&typeof t=="object"&&typeof s=="object"){if(t.constructor!==s.constructor)return!1;var a,n,r;if(Array.isArray(t)){if(a=t.length,a!=s.length)return!1;for(n=a;n--!==0;)if(!e(t[n],s[n]))return!1;return!0}if(t.constructor===RegExp)return t.source===s.source&&t.flags===s.flags;if(t.valueOf!==Object.prototype.valueOf)return t.valueOf()===s.valueOf();if(t.toString!==Object.prototype.toString)return t.toString()===s.toString();if(r=Object.keys(t),a=r.length,a!==Object.keys(s).length)return!1;for(n=a;n--!==0;)if(!Object.prototype.hasOwnProperty.call(s,r[n]))return!1;for(n=a;n--!==0;){var o=r[n];if(!e(t[o],s[o]))return!1}return!0}return t!==t&&s!==s}),lo}var co={exports:{}},Gl;function K1(){if(Gl)return co.exports;Gl=1;var e=co.exports=function(a,n,r){typeof n=="function"&&(r=n,n={}),r=n.cb||r;var o=typeof r=="function"?r:r.pre||function(){},l=r.post||function(){};t(n,o,l,a,"",a)};e.keywords={additionalItems:!0,items:!0,contains:!0,additionalProperties:!0,propertyNames:!0,not:!0,if:!0,then:!0,else:!0},e.arrayKeywords={items:!0,allOf:!0,anyOf:!0,oneOf:!0},e.propsKeywords={$defs:!0,definitions:!0,properties:!0,patternProperties:!0,dependencies:!0},e.skipKeywords={default:!0,enum:!0,const:!0,required:!0,maximum:!0,minimum:!0,exclusiveMaximum:!0,exclusiveMinimum:!0,multipleOf:!0,maxLength:!0,minLength:!0,pattern:!0,format:!0,maxItems:!0,minItems:!0,uniqueItems:!0,maxProperties:!0,minProperties:!0};function t(a,n,r,o,l,i,c,d,u,p){if(o&&typeof o=="object"&&!Array.isArray(o)){n(o,l,i,c,d,u,p);for(var f in o){var g=o[f];if(Array.isArray(g)){if(f in e.arrayKeywords)for(var _=0;_<g.length;_++)t(a,n,r,g[_],l+"/"+f+"/"+_,i,l,f,o,_)}else if(f in e.propsKeywords){if(g&&typeof g=="object")for(var v in g)t(a,n,r,g[v],l+"/"+f+"/"+s(v),i,l,f,o,v)}else(f in e.keywords||a.allKeys&&!(f in e.skipKeywords))&&t(a,n,r,g,l+"/"+f,i,l,f,o)}r(o,l,i,c,d,u,p)}}function s(a){return a.replace(/~/g,"~0").replace(/\//g,"~1")}return co.exports}var Kl;function Er(){if(Kl)return st;Kl=1,Object.defineProperty(st,"__esModule",{value:!0}),st.getSchemaRefs=st.resolveUrl=st.normalizeId=st._getFullPath=st.getFullPath=st.inlineRef=void 0;const e=Ee(),t=Ku(),s=K1(),a=new Set(["type","format","pattern","maxLength","minLength","maxProperties","minProperties","maxItems","minItems","maximum","minimum","uniqueItems","multipleOf","required","enum","const"]);function n(_,v=!0){return typeof _=="boolean"?!0:v===!0?!o(_):v?l(_)<=v:!1}st.inlineRef=n;const r=new Set(["$ref","$recursiveRef","$recursiveAnchor","$dynamicRef","$dynamicAnchor"]);function o(_){for(const v in _){if(r.has(v))return!0;const m=_[v];if(Array.isArray(m)&&m.some(o)||typeof m=="object"&&o(m))return!0}return!1}function l(_){let v=0;for(const m in _){if(m==="$ref")return 1/0;if(v++,!a.has(m)&&(typeof _[m]=="object"&&(0,e.eachItem)(_[m],h=>v+=l(h)),v===1/0))return 1/0}return v}function i(_,v="",m){m!==!1&&(v=u(v));const h=_.parse(v);return c(_,h)}st.getFullPath=i;function c(_,v){return _.serialize(v).split("#")[0]+"#"}st._getFullPath=c;const d=/#\/?$/;function u(_){return _?_.replace(d,""):""}st.normalizeId=u;function p(_,v,m){return m=u(m),_.resolve(v,m)}st.resolveUrl=p;const f=/^[a-z_][-a-z0-9._]*$/i;function g(_,v){if(typeof _=="boolean")return{};const{schemaId:m,uriResolver:h}=this.opts,b=u(_[m]||v),w={"":b},y=i(h,b,!1),x={},P=new Set;return s(_,{allKeys:!0},(k,S,O,I)=>{if(I===void 0)return;const q=y+S;let J=w[I];typeof k[m]=="string"&&(J=W.call(this,k[m])),Q.call(this,k.$anchor),Q.call(this,k.$dynamicAnchor),w[S]=J;function W(V){const re=this.opts.uriResolver.resolve;if(V=u(J?re(J,V):V),P.has(V))throw T(V);P.add(V);let Y=this.refs[V];return typeof Y=="string"&&(Y=this.refs[Y]),typeof Y=="object"?D(k,Y.schema,V):V!==u(q)&&(V[0]==="#"?(D(k,x[V],V),x[V]=k):this.refs[V]=q),V}function Q(V){if(typeof V=="string"){if(!f.test(V))throw new Error(`invalid anchor "${V}"`);W.call(this,`#${V}`)}}}),x;function D(k,S,O){if(S!==void 0&&!t(k,S))throw T(O)}function T(k){return new Error(`reference "${k}" resolves to more than one schema`)}}return st.getSchemaRefs=g,st}var Yl;function kr(){if(Yl)return Vt;Yl=1,Object.defineProperty(Vt,"__esModule",{value:!0}),Vt.getData=Vt.KeywordCxt=Vt.validateFunctionCode=void 0;const e=U1(),t=rr(),s=Gu(),a=rr(),n=q1(),r=V1(),o=G1(),l=Te(),i=Es(),c=Er(),d=Ee(),u=Sr();function p(F){if(y(F)&&(P(F),w(F))){v(F);return}f(F,()=>(0,e.topBoolOrEmptySchema)(F))}Vt.validateFunctionCode=p;function f({gen:F,validateName:E,schema:M,schemaEnv:N,opts:R},L){R.code.es5?F.func(E,(0,l._)`${i.default.data}, ${i.default.valCxt}`,N.$async,()=>{F.code((0,l._)`"use strict"; ${h(M,R)}`),_(F,R),F.code(L)}):F.func(E,(0,l._)`${i.default.data}, ${g(R)}`,N.$async,()=>F.code(h(M,R)).code(L))}function g(F){return(0,l._)`{${i.default.instancePath}="", ${i.default.parentData}, ${i.default.parentDataProperty}, ${i.default.rootData}=${i.default.data}${F.dynamicRef?(0,l._)`, ${i.default.dynamicAnchors}={}`:l.nil}}={}`}function _(F,E){F.if(i.default.valCxt,()=>{F.var(i.default.instancePath,(0,l._)`${i.default.valCxt}.${i.default.instancePath}`),F.var(i.default.parentData,(0,l._)`${i.default.valCxt}.${i.default.parentData}`),F.var(i.default.parentDataProperty,(0,l._)`${i.default.valCxt}.${i.default.parentDataProperty}`),F.var(i.default.rootData,(0,l._)`${i.default.valCxt}.${i.default.rootData}`),E.dynamicRef&&F.var(i.default.dynamicAnchors,(0,l._)`${i.default.valCxt}.${i.default.dynamicAnchors}`)},()=>{F.var(i.default.instancePath,(0,l._)`""`),F.var(i.default.parentData,(0,l._)`undefined`),F.var(i.default.parentDataProperty,(0,l._)`undefined`),F.var(i.default.rootData,i.default.data),E.dynamicRef&&F.var(i.default.dynamicAnchors,(0,l._)`{}`)})}function v(F){const{schema:E,opts:M,gen:N}=F;f(F,()=>{M.$comment&&E.$comment&&I(F),k(F),N.let(i.default.vErrors,null),N.let(i.default.errors,0),M.unevaluated&&m(F),D(F),q(F)})}function m(F){const{gen:E,validateName:M}=F;F.evaluated=E.const("evaluated",(0,l._)`${M}.evaluated`),E.if((0,l._)`${F.evaluated}.dynamicProps`,()=>E.assign((0,l._)`${F.evaluated}.props`,(0,l._)`undefined`)),E.if((0,l._)`${F.evaluated}.dynamicItems`,()=>E.assign((0,l._)`${F.evaluated}.items`,(0,l._)`undefined`))}function h(F,E){const M=typeof F=="object"&&F[E.schemaId];return M&&(E.code.source||E.code.process)?(0,l._)`/*# sourceURL=${M} */`:l.nil}function b(F,E){if(y(F)&&(P(F),w(F))){x(F,E);return}(0,e.boolOrEmptySchema)(F,E)}function w({schema:F,self:E}){if(typeof F=="boolean")return!F;for(const M in F)if(E.RULES.all[M])return!0;return!1}function y(F){return typeof F.schema!="boolean"}function x(F,E){const{schema:M,gen:N,opts:R}=F;R.$comment&&M.$comment&&I(F),S(F),O(F);const L=N.const("_errs",i.default.errors);D(F,L),N.var(E,(0,l._)`${L} === ${i.default.errors}`)}function P(F){(0,d.checkUnknownRules)(F),T(F)}function D(F,E){if(F.opts.jtd)return W(F,[],!1,E);const M=(0,t.getSchemaTypes)(F.schema),N=(0,t.coerceAndCheckDataType)(F,M);W(F,M,!N,E)}function T(F){const{schema:E,errSchemaPath:M,opts:N,self:R}=F;E.$ref&&N.ignoreKeywordsWithRef&&(0,d.schemaHasRulesButRef)(E,R.RULES)&&R.logger.warn(`$ref: keywords ignored in schema at path "${M}"`)}function k(F){const{schema:E,opts:M}=F;E.default!==void 0&&M.useDefaults&&M.strictSchema&&(0,d.checkStrictMode)(F,"default is ignored in the schema root")}function S(F){const E=F.schema[F.opts.schemaId];E&&(F.baseId=(0,c.resolveUrl)(F.opts.uriResolver,F.baseId,E))}function O(F){if(F.schema.$async&&!F.schemaEnv.$async)throw new Error("async schema in sync schema")}function I({gen:F,schemaEnv:E,schema:M,errSchemaPath:N,opts:R}){const L=M.$comment;if(R.$comment===!0)F.code((0,l._)`${i.default.self}.logger.log(${L})`);else if(typeof R.$comment=="function"){const z=(0,l.str)`${N}/$comment`,se=F.scopeValue("root",{ref:E.root});F.code((0,l._)`${i.default.self}.opts.$comment(${L}, ${z}, ${se}.schema)`)}}function q(F){const{gen:E,schemaEnv:M,validateName:N,ValidationError:R,opts:L}=F;M.$async?E.if((0,l._)`${i.default.errors} === 0`,()=>E.return(i.default.data),()=>E.throw((0,l._)`new ${R}(${i.default.vErrors})`)):(E.assign((0,l._)`${N}.errors`,i.default.vErrors),L.unevaluated&&J(F),E.return((0,l._)`${i.default.errors} === 0`))}function J({gen:F,evaluated:E,props:M,items:N}){M instanceof l.Name&&F.assign((0,l._)`${E}.props`,M),N instanceof l.Name&&F.assign((0,l._)`${E}.items`,N)}function W(F,E,M,N){const{gen:R,schema:L,data:z,allErrors:se,opts:oe,self:ie}=F,{RULES:ae}=ie;if(L.$ref&&(oe.ignoreKeywordsWithRef||!(0,d.schemaHasRulesButRef)(L,ae))){R.block(()=>B(F,"$ref",ae.all.$ref.definition));return}oe.jtd||V(F,E),R.block(()=>{for(const ee of ae.rules)ne(ee);ne(ae.post)});function ne(ee){(0,s.shouldUseGroup)(L,ee)&&(ee.type?(R.if((0,a.checkDataType)(ee.type,z,oe.strictNumbers)),Q(F,ee),E.length===1&&E[0]===ee.type&&M&&(R.else(),(0,a.reportTypeError)(F)),R.endIf()):Q(F,ee),se||R.if((0,l._)`${i.default.errors} === ${N||0}`))}}function Q(F,E){const{gen:M,schema:N,opts:{useDefaults:R}}=F;R&&(0,n.assignDefaults)(F,E.type),M.block(()=>{for(const L of E.rules)(0,s.shouldUseRule)(N,L)&&B(F,L.keyword,L.definition,E.type)})}function V(F,E){F.schemaEnv.meta||!F.opts.strictTypes||(re(F,E),F.opts.allowUnionTypes||Y(F,E),H(F,F.dataTypes))}function re(F,E){if(E.length){if(!F.dataTypes.length){F.dataTypes=E;return}E.forEach(M=>{K(F.dataTypes,M)||$(F,`type "${M}" not allowed by context "${F.dataTypes.join(",")}"`)}),A(F,E)}}function Y(F,E){E.length>1&&!(E.length===2&&E.includes("null"))&&$(F,"use allowUnionTypes to allow union type keyword")}function H(F,E){const M=F.self.RULES.all;for(const N in M){const R=M[N];if(typeof R=="object"&&(0,s.shouldUseRule)(F.schema,R)){const{type:L}=R.definition;L.length&&!L.some(z=>X(E,z))&&$(F,`missing type "${L.join(",")}" for keyword "${N}"`)}}}function X(F,E){return F.includes(E)||E==="number"&&F.includes("integer")}function K(F,E){return F.includes(E)||E==="integer"&&F.includes("number")}function A(F,E){const M=[];for(const N of F.dataTypes)K(E,N)?M.push(N):E.includes("integer")&&N==="number"&&M.push("integer");F.dataTypes=M}function $(F,E){const M=F.schemaEnv.baseId+F.errSchemaPath;E+=` at "${M}" (strictTypes)`,(0,d.checkStrictMode)(F,E,F.opts.strictTypes)}class U{constructor(E,M,N){if((0,r.validateKeywordUsage)(E,M,N),this.gen=E.gen,this.allErrors=E.allErrors,this.keyword=N,this.data=E.data,this.schema=E.schema[N],this.$data=M.$data&&E.opts.$data&&this.schema&&this.schema.$data,this.schemaValue=(0,d.schemaRefOrVal)(E,this.schema,N,this.$data),this.schemaType=M.schemaType,this.parentSchema=E.schema,this.params={},this.it=E,this.def=M,this.$data)this.schemaCode=E.gen.const("vSchema",Z(this.$data,E));else if(this.schemaCode=this.schemaValue,!(0,r.validSchemaType)(this.schema,M.schemaType,M.allowUndefined))throw new Error(`${N} value must be ${JSON.stringify(M.schemaType)}`);("code"in M?M.trackErrors:M.errors!==!1)&&(this.errsCount=E.gen.const("_errs",i.default.errors))}result(E,M,N){this.failResult((0,l.not)(E),M,N)}failResult(E,M,N){this.gen.if(E),N?N():this.error(),M?(this.gen.else(),M(),this.allErrors&&this.gen.endIf()):this.allErrors?this.gen.endIf():this.gen.else()}pass(E,M){this.failResult((0,l.not)(E),void 0,M)}fail(E){if(E===void 0){this.error(),this.allErrors||this.gen.if(!1);return}this.gen.if(E),this.error(),this.allErrors?this.gen.endIf():this.gen.else()}fail$data(E){if(!this.$data)return this.fail(E);const{schemaCode:M}=this;this.fail((0,l._)`${M} !== undefined && (${(0,l.or)(this.invalid$data(),E)})`)}error(E,M,N){if(M){this.setParams(M),this._error(E,N),this.setParams({});return}this._error(E,N)}_error(E,M){(E?u.reportExtraError:u.reportError)(this,this.def.error,M)}$dataError(){(0,u.reportError)(this,this.def.$dataError||u.keyword$DataError)}reset(){if(this.errsCount===void 0)throw new Error('add "trackErrors" to keyword definition');(0,u.resetErrorsCount)(this.gen,this.errsCount)}ok(E){this.allErrors||this.gen.if(E)}setParams(E,M){M?Object.assign(this.params,E):this.params=E}block$data(E,M,N=l.nil){this.gen.block(()=>{this.check$data(E,N),M()})}check$data(E=l.nil,M=l.nil){if(!this.$data)return;const{gen:N,schemaCode:R,schemaType:L,def:z}=this;N.if((0,l.or)((0,l._)`${R} === undefined`,M)),E!==l.nil&&N.assign(E,!0),(L.length||z.validateSchema)&&(N.elseIf(this.invalid$data()),this.$dataError(),E!==l.nil&&N.assign(E,!1)),N.else()}invalid$data(){const{gen:E,schemaCode:M,schemaType:N,def:R,it:L}=this;return(0,l.or)(z(),se());function z(){if(N.length){if(!(M instanceof l.Name))throw new Error("ajv implementation error");const oe=Array.isArray(N)?N:[N];return(0,l._)`${(0,a.checkDataTypes)(oe,M,L.opts.strictNumbers,a.DataType.Wrong)}`}return l.nil}function se(){if(R.validateSchema){const oe=E.scopeValue("validate$data",{ref:R.validateSchema});return(0,l._)`!${oe}(${M})`}return l.nil}}subschema(E,M){const N=(0,o.getSubschema)(this.it,E);(0,o.extendSubschemaData)(N,this.it,E),(0,o.extendSubschemaMode)(N,E);const R={...this.it,...N,items:void 0,props:void 0};return b(R,M),R}mergeEvaluated(E,M){const{it:N,gen:R}=this;N.opts.unevaluated&&(N.props!==!0&&E.props!==void 0&&(N.props=d.mergeEvaluated.props(R,E.props,N.props,M)),N.items!==!0&&E.items!==void 0&&(N.items=d.mergeEvaluated.items(R,E.items,N.items,M)))}mergeValidEvaluated(E,M){const{it:N,gen:R}=this;if(N.opts.unevaluated&&(N.props!==!0||N.items!==!0))return R.if(M,()=>this.mergeEvaluated(E,l.Name)),!0}}Vt.KeywordCxt=U;function B(F,E,M,N){const R=new U(F,M,E);"code"in M?M.code(R,N):R.$data&&M.validate?(0,r.funcKeywordCode)(R,M):"macro"in M?(0,r.macroKeywordCode)(R,M):(M.compile||M.validate)&&(0,r.funcKeywordCode)(R,M)}const G=/^\/(?:[^~]|~0|~1)*$/,j=/^([0-9]+)(#|\/(?:[^~]|~0|~1)*)?$/;function Z(F,{dataLevel:E,dataNames:M,dataPathArr:N}){let R,L;if(F==="")return i.default.rootData;if(F[0]==="/"){if(!G.test(F))throw new Error(`Invalid JSON-pointer: ${F}`);R=F,L=i.default.rootData}else{const ie=j.exec(F);if(!ie)throw new Error(`Invalid JSON-pointer: ${F}`);const ae=+ie[1];if(R=ie[2],R==="#"){if(ae>=E)throw new Error(oe("property/index",ae));return N[E-ae]}if(ae>E)throw new Error(oe("data",ae));if(L=M[E-ae],!R)return L}let z=L;const se=R.split("/");for(const ie of se)ie&&(L=(0,l._)`${L}${(0,l.getProperty)((0,d.unescapeJsonPointer)(ie))}`,z=(0,l._)`${z} && ${L}`);return z;function oe(ie,ae){return`Cannot access ${ie} ${ae} levels up, current level is ${E}`}}return Vt.getData=Z,Vt}var Ja={},Wl;function ii(){if(Wl)return Ja;Wl=1,Object.defineProperty(Ja,"__esModule",{value:!0});class e extends Error{constructor(s){super("validation failed"),this.errors=s,this.ajv=this.validation=!0}}return Ja.default=e,Ja}var Xa={},Jl;function Pr(){if(Jl)return Xa;Jl=1,Object.defineProperty(Xa,"__esModule",{value:!0});const e=Er();class t extends Error{constructor(a,n,r,o){super(o||`can't resolve reference ${r} from id ${n}`),this.missingRef=(0,e.resolveUrl)(a,n,r),this.missingSchema=(0,e.normalizeId)((0,e.getFullPath)(a,this.missingRef))}}return Xa.default=t,Xa}var ft={},Xl;function li(){if(Xl)return ft;Xl=1,Object.defineProperty(ft,"__esModule",{value:!0}),ft.resolveSchema=ft.getCompilingSchema=ft.resolveRef=ft.compileSchema=ft.SchemaEnv=void 0;const e=Te(),t=ii(),s=Es(),a=Er(),n=Ee(),r=kr();class o{constructor(m){var h;this.refs={},this.dynamicAnchors={};let b;typeof m.schema=="object"&&(b=m.schema),this.schema=m.schema,this.schemaId=m.schemaId,this.root=m.root||this,this.baseId=(h=m.baseId)!==null&&h!==void 0?h:(0,a.normalizeId)(b?.[m.schemaId||"$id"]),this.schemaPath=m.schemaPath,this.localRefs=m.localRefs,this.meta=m.meta,this.$async=b?.$async,this.refs={}}}ft.SchemaEnv=o;function l(v){const m=d.call(this,v);if(m)return m;const h=(0,a.getFullPath)(this.opts.uriResolver,v.root.baseId),{es5:b,lines:w}=this.opts.code,{ownProperties:y}=this.opts,x=new e.CodeGen(this.scope,{es5:b,lines:w,ownProperties:y});let P;v.$async&&(P=x.scopeValue("Error",{ref:t.default,code:(0,e._)`require("ajv/dist/runtime/validation_error").default`}));const D=x.scopeName("validate");v.validateName=D;const T={gen:x,allErrors:this.opts.allErrors,data:s.default.data,parentData:s.default.parentData,parentDataProperty:s.default.parentDataProperty,dataNames:[s.default.data],dataPathArr:[e.nil],dataLevel:0,dataTypes:[],definedProperties:new Set,topSchemaRef:x.scopeValue("schema",this.opts.code.source===!0?{ref:v.schema,code:(0,e.stringify)(v.schema)}:{ref:v.schema}),validateName:D,ValidationError:P,schema:v.schema,schemaEnv:v,rootId:h,baseId:v.baseId||h,schemaPath:e.nil,errSchemaPath:v.schemaPath||(this.opts.jtd?"":"#"),errorPath:(0,e._)`""`,opts:this.opts,self:this};let k;try{this._compilations.add(v),(0,r.validateFunctionCode)(T),x.optimize(this.opts.code.optimize);const S=x.toString();k=`${x.scopeRefs(s.default.scope)}return ${S}`,this.opts.code.process&&(k=this.opts.code.process(k,v));const I=new Function(`${s.default.self}`,`${s.default.scope}`,k)(this,this.scope.get());if(this.scope.value(D,{ref:I}),I.errors=null,I.schema=v.schema,I.schemaEnv=v,v.$async&&(I.$async=!0),this.opts.code.source===!0&&(I.source={validateName:D,validateCode:S,scopeValues:x._values}),this.opts.unevaluated){const{props:q,items:J}=T;I.evaluated={props:q instanceof e.Name?void 0:q,items:J instanceof e.Name?void 0:J,dynamicProps:q instanceof e.Name,dynamicItems:J instanceof e.Name},I.source&&(I.source.evaluated=(0,e.stringify)(I.evaluated))}return v.validate=I,v}catch(S){throw delete v.validate,delete v.validateName,k&&this.logger.error("Error compiling schema, function code:",k),S}finally{this._compilations.delete(v)}}ft.compileSchema=l;function i(v,m,h){var b;h=(0,a.resolveUrl)(this.opts.uriResolver,m,h);const w=v.refs[h];if(w)return w;let y=p.call(this,v,h);if(y===void 0){const x=(b=v.localRefs)===null||b===void 0?void 0:b[h],{schemaId:P}=this.opts;x&&(y=new o({schema:x,schemaId:P,root:v,baseId:m}))}if(y!==void 0)return v.refs[h]=c.call(this,y)}ft.resolveRef=i;function c(v){return(0,a.inlineRef)(v.schema,this.opts.inlineRefs)?v.schema:v.validate?v:l.call(this,v)}function d(v){for(const m of this._compilations)if(u(m,v))return m}ft.getCompilingSchema=d;function u(v,m){return v.schema===m.schema&&v.root===m.root&&v.baseId===m.baseId}function p(v,m){let h;for(;typeof(h=this.refs[m])=="string";)m=h;return h||this.schemas[m]||f.call(this,v,m)}function f(v,m){const h=this.opts.uriResolver.parse(m),b=(0,a._getFullPath)(this.opts.uriResolver,h);let w=(0,a.getFullPath)(this.opts.uriResolver,v.baseId,void 0);if(Object.keys(v.schema).length>0&&b===w)return _.call(this,h,v);const y=(0,a.normalizeId)(b),x=this.refs[y]||this.schemas[y];if(typeof x=="string"){const P=f.call(this,v,x);return typeof P?.schema!="object"?void 0:_.call(this,h,P)}if(typeof x?.schema=="object"){if(x.validate||l.call(this,x),y===(0,a.normalizeId)(m)){const{schema:P}=x,{schemaId:D}=this.opts,T=P[D];return T&&(w=(0,a.resolveUrl)(this.opts.uriResolver,w,T)),new o({schema:P,schemaId:D,root:v,baseId:w})}return _.call(this,h,x)}}ft.resolveSchema=f;const g=new Set(["properties","patternProperties","enum","dependencies","definitions"]);function _(v,{baseId:m,schema:h,root:b}){var w;if(((w=v.fragment)===null||w===void 0?void 0:w[0])!=="/")return;for(const P of v.fragment.slice(1).split("/")){if(typeof h=="boolean")return;const D=h[(0,n.unescapeFragment)(P)];if(D===void 0)return;h=D;const T=typeof h=="object"&&h[this.opts.schemaId];!g.has(P)&&T&&(m=(0,a.resolveUrl)(this.opts.uriResolver,m,T))}let y;if(typeof h!="boolean"&&h.$ref&&!(0,n.schemaHasRulesButRef)(h,this.RULES)){const P=(0,a.resolveUrl)(this.opts.uriResolver,m,h.$ref);y=f.call(this,b,P)}const{schemaId:x}=this.opts;if(y=y||new o({schema:h,schemaId:x,root:b,baseId:m}),y.schema!==y.root.schema)return y}return ft}const Y1="https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#",W1="Meta-schema for $data reference (JSON AnySchema extension proposal)",J1="object",X1=["$data"],Q1={$data:{type:"string",anyOf:[{format:"relative-json-pointer"},{format:"json-pointer"}]}},Z1=!1,ew={$id:Y1,description:W1,type:J1,required:X1,properties:Q1,additionalProperties:Z1};var Qa={},pa={exports:{}},uo,Ql;function Yu(){if(Ql)return uo;Ql=1;const e=RegExp.prototype.test.bind(/^[\da-f]{8}-[\da-f]{4}-[\da-f]{4}-[\da-f]{4}-[\da-f]{12}$/iu),t=RegExp.prototype.test.bind(/^(?:(?:25[0-5]|2[0-4]\d|1\d{2}|[1-9]\d|\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d{2}|[1-9]\d|\d)$/u);function s(p){let f="",g=0,_=0;for(_=0;_<p.length;_++)if(g=p[_].charCodeAt(0),g!==48){if(!(g>=48&&g<=57||g>=65&&g<=70||g>=97&&g<=102))return"";f+=p[_];break}for(_+=1;_<p.length;_++){if(g=p[_].charCodeAt(0),!(g>=48&&g<=57||g>=65&&g<=70||g>=97&&g<=102))return"";f+=p[_]}return f}const a=RegExp.prototype.test.bind(/[^!"$&'()*+,\-.;=_`a-z{}~]/u);function n(p){return p.length=0,!0}function r(p,f,g){if(p.length){const _=s(p);if(_!=="")f.push(_);else return g.error=!0,!1;p.length=0}return!0}function o(p){let f=0;const g={error:!1,address:"",zone:""},_=[],v=[];let m=!1,h=!1,b=r;for(let w=0;w<p.length;w++){const y=p[w];if(!(y==="["||y==="]"))if(y===":"){if(m===!0&&(h=!0),!b(v,_,g))break;if(++f>7){g.error=!0;break}w>0&&p[w-1]===":"&&(m=!0),_.push(":");continue}else if(y==="%"){if(!b(v,_,g))break;b=n}else{v.push(y);continue}}return v.length&&(b===n?g.zone=v.join(""):h?_.push(v.join("")):_.push(s(v))),g.address=_.join(""),g}function l(p){if(i(p,":")<2)return{host:p,isIPV6:!1};const f=o(p);if(f.error)return{host:p,isIPV6:!1};{let g=f.address,_=f.address;return f.zone&&(g+="%"+f.zone,_+="%25"+f.zone),{host:g,isIPV6:!0,escapedHost:_}}}function i(p,f){let g=0;for(let _=0;_<p.length;_++)p[_]===f&&g++;return g}function c(p){let f=p;const g=[];let _=-1,v=0;for(;v=f.length;){if(v===1){if(f===".")break;if(f==="/"){g.push("/");break}else{g.push(f);break}}else if(v===2){if(f[0]==="."){if(f[1]===".")break;if(f[1]==="/"){f=f.slice(2);continue}}else if(f[0]==="/"&&(f[1]==="."||f[1]==="/")){g.push("/");break}}else if(v===3&&f==="/.."){g.length!==0&&g.pop(),g.push("/");break}if(f[0]==="."){if(f[1]==="."){if(f[2]==="/"){f=f.slice(3);continue}}else if(f[1]==="/"){f=f.slice(2);continue}}else if(f[0]==="/"&&f[1]==="."){if(f[2]==="/"){f=f.slice(2);continue}else if(f[2]==="."&&f[3]==="/"){f=f.slice(3),g.length!==0&&g.pop();continue}}if((_=f.indexOf("/",1))===-1){g.push(f);break}else g.push(f.slice(0,_)),f=f.slice(_)}return g.join("")}function d(p,f){const g=f!==!0?escape:unescape;return p.scheme!==void 0&&(p.scheme=g(p.scheme)),p.userinfo!==void 0&&(p.userinfo=g(p.userinfo)),p.host!==void 0&&(p.host=g(p.host)),p.path!==void 0&&(p.path=g(p.path)),p.query!==void 0&&(p.query=g(p.query)),p.fragment!==void 0&&(p.fragment=g(p.fragment)),p}function u(p){const f=[];if(p.userinfo!==void 0&&(f.push(p.userinfo),f.push("@")),p.host!==void 0){let g=unescape(p.host);if(!t(g)){const _=l(g);_.isIPV6===!0?g=`[${_.escapedHost}]`:g=p.host}f.push(g)}return(typeof p.port=="number"||typeof p.port=="string")&&(f.push(":"),f.push(String(p.port))),f.length?f.join(""):void 0}return uo={nonSimpleDomain:a,recomposeAuthority:u,normalizeComponentEncoding:d,removeDotSegments:c,isIPv4:t,isUUID:e,normalizeIPv6:l,stringArrayToHexStripped:s},uo}var po,Zl;function tw(){if(Zl)return po;Zl=1;const{isUUID:e}=Yu(),t=/([\da-z][\d\-a-z]{0,31}):((?:[\w!$'()*+,\-.:;=@]|%[\da-f]{2})+)/iu,s=["http","https","ws","wss","urn","urn:uuid"];function a(y){return s.indexOf(y)!==-1}function n(y){return y.secure===!0?!0:y.secure===!1?!1:y.scheme?y.scheme.length===3&&(y.scheme[0]==="w"||y.scheme[0]==="W")&&(y.scheme[1]==="s"||y.scheme[1]==="S")&&(y.scheme[2]==="s"||y.scheme[2]==="S"):!1}function r(y){return y.host||(y.error=y.error||"HTTP URIs must have a host."),y}function o(y){const x=String(y.scheme).toLowerCase()==="https";return(y.port===(x?443:80)||y.port==="")&&(y.port=void 0),y.path||(y.path="/"),y}function l(y){return y.secure=n(y),y.resourceName=(y.path||"/")+(y.query?"?"+y.query:""),y.path=void 0,y.query=void 0,y}function i(y){if((y.port===(n(y)?443:80)||y.port==="")&&(y.port=void 0),typeof y.secure=="boolean"&&(y.scheme=y.secure?"wss":"ws",y.secure=void 0),y.resourceName){const[x,P]=y.resourceName.split("?");y.path=x&&x!=="/"?x:void 0,y.query=P,y.resourceName=void 0}return y.fragment=void 0,y}function c(y,x){if(!y.path)return y.error="URN can not be parsed",y;const P=y.path.match(t);if(P){const D=x.scheme||y.scheme||"urn";y.nid=P[1].toLowerCase(),y.nss=P[2];const T=`${D}:${x.nid||y.nid}`,k=w(T);y.path=void 0,k&&(y=k.parse(y,x))}else y.error=y.error||"URN can not be parsed.";return y}function d(y,x){if(y.nid===void 0)throw new Error("URN without nid cannot be serialized");const P=x.scheme||y.scheme||"urn",D=y.nid.toLowerCase(),T=`${P}:${x.nid||D}`,k=w(T);k&&(y=k.serialize(y,x));const S=y,O=y.nss;return S.path=`${D||x.nid}:${O}`,x.skipEscape=!0,S}function u(y,x){const P=y;return P.uuid=P.nss,P.nss=void 0,!x.tolerant&&(!P.uuid||!e(P.uuid))&&(P.error=P.error||"UUID is not valid."),P}function p(y){const x=y;return x.nss=(y.uuid||"").toLowerCase(),x}const f={scheme:"http",domainHost:!0,parse:r,serialize:o},g={scheme:"https",domainHost:f.domainHost,parse:r,serialize:o},_={scheme:"ws",domainHost:!0,parse:l,serialize:i},v={scheme:"wss",domainHost:_.domainHost,parse:_.parse,serialize:_.serialize},b={http:f,https:g,ws:_,wss:v,urn:{scheme:"urn",parse:c,serialize:d,skipNormalize:!0},"urn:uuid":{scheme:"urn:uuid",parse:u,serialize:p,skipNormalize:!0}};Object.setPrototypeOf(b,null);function w(y){return y&&(b[y]||b[y.toLowerCase()])||void 0}return po={wsIsSecure:n,SCHEMES:b,isValidSchemeName:a,getSchemeHandler:w},po}var ec;function sw(){if(ec)return pa.exports;ec=1;const{normalizeIPv6:e,removeDotSegments:t,recomposeAuthority:s,normalizeComponentEncoding:a,isIPv4:n,nonSimpleDomain:r}=Yu(),{SCHEMES:o,getSchemeHandler:l}=tw();function i(v,m){return typeof v=="string"?v=p(g(v,m),m):typeof v=="object"&&(v=g(p(v,m),m)),v}function c(v,m,h){const b=h?Object.assign({scheme:"null"},h):{scheme:"null"},w=d(g(v,b),g(m,b),b,!0);return b.skipEscape=!0,p(w,b)}function d(v,m,h,b){const w={};return b||(v=g(p(v,h),h),m=g(p(m,h),h)),h=h||{},!h.tolerant&&m.scheme?(w.scheme=m.scheme,w.userinfo=m.userinfo,w.host=m.host,w.port=m.port,w.path=t(m.path||""),w.query=m.query):(m.userinfo!==void 0||m.host!==void 0||m.port!==void 0?(w.userinfo=m.userinfo,w.host=m.host,w.port=m.port,w.path=t(m.path||""),w.query=m.query):(m.path?(m.path[0]==="/"?w.path=t(m.path):((v.userinfo!==void 0||v.host!==void 0||v.port!==void 0)&&!v.path?w.path="/"+m.path:v.path?w.path=v.path.slice(0,v.path.lastIndexOf("/")+1)+m.path:w.path=m.path,w.path=t(w.path)),w.query=m.query):(w.path=v.path,m.query!==void 0?w.query=m.query:w.query=v.query),w.userinfo=v.userinfo,w.host=v.host,w.port=v.port),w.scheme=v.scheme),w.fragment=m.fragment,w}function u(v,m,h){return typeof v=="string"?(v=unescape(v),v=p(a(g(v,h),!0),{...h,skipEscape:!0})):typeof v=="object"&&(v=p(a(v,!0),{...h,skipEscape:!0})),typeof m=="string"?(m=unescape(m),m=p(a(g(m,h),!0),{...h,skipEscape:!0})):typeof m=="object"&&(m=p(a(m,!0),{...h,skipEscape:!0})),v.toLowerCase()===m.toLowerCase()}function p(v,m){const h={host:v.host,scheme:v.scheme,userinfo:v.userinfo,port:v.port,path:v.path,query:v.query,nid:v.nid,nss:v.nss,uuid:v.uuid,fragment:v.fragment,reference:v.reference,resourceName:v.resourceName,secure:v.secure,error:""},b=Object.assign({},m),w=[],y=l(b.scheme||h.scheme);y&&y.serialize&&y.serialize(h,b),h.path!==void 0&&(b.skipEscape?h.path=unescape(h.path):(h.path=escape(h.path),h.scheme!==void 0&&(h.path=h.path.split("%3A").join(":")))),b.reference!=="suffix"&&h.scheme&&w.push(h.scheme,":");const x=s(h);if(x!==void 0&&(b.reference!=="suffix"&&w.push("//"),w.push(x),h.path&&h.path[0]!=="/"&&w.push("/")),h.path!==void 0){let P=h.path;!b.absolutePath&&(!y||!y.absolutePath)&&(P=t(P)),x===void 0&&P[0]==="/"&&P[1]==="/"&&(P="/%2F"+P.slice(2)),w.push(P)}return h.query!==void 0&&w.push("?",h.query),h.fragment!==void 0&&w.push("#",h.fragment),w.join("")}const f=/^(?:([^#/:?]+):)?(?:\/\/((?:([^#/?@]*)@)?(\[[^#/?\]]+\]|[^#/:?]*)(?::(\d*))?))?([^#?]*)(?:\?([^#]*))?(?:#((?:.|[\n\r])*))?/u;function g(v,m){const h=Object.assign({},m),b={scheme:void 0,userinfo:void 0,host:"",port:void 0,path:"",query:void 0,fragment:void 0};let w=!1;h.reference==="suffix"&&(h.scheme?v=h.scheme+":"+v:v="//"+v);const y=v.match(f);if(y){if(b.scheme=y[1],b.userinfo=y[3],b.host=y[4],b.port=parseInt(y[5],10),b.path=y[6]||"",b.query=y[7],b.fragment=y[8],isNaN(b.port)&&(b.port=y[5]),b.host)if(n(b.host)===!1){const D=e(b.host);b.host=D.host.toLowerCase(),w=D.isIPV6}else w=!0;b.scheme===void 0&&b.userinfo===void 0&&b.host===void 0&&b.port===void 0&&b.query===void 0&&!b.path?b.reference="same-document":b.scheme===void 0?b.reference="relative":b.fragment===void 0?b.reference="absolute":b.reference="uri",h.reference&&h.reference!=="suffix"&&h.reference!==b.reference&&(b.error=b.error||"URI is not a "+h.reference+" reference.");const x=l(h.scheme||b.scheme);if(!h.unicodeSupport&&(!x||!x.unicodeSupport)&&b.host&&(h.domainHost||x&&x.domainHost)&&w===!1&&r(b.host))try{b.host=URL.domainToASCII(b.host.toLowerCase())}catch(P){b.error=b.error||"Host's domain name can not be converted to ASCII: "+P}(!x||x&&!x.skipNormalize)&&(v.indexOf("%")!==-1&&(b.scheme!==void 0&&(b.scheme=unescape(b.scheme)),b.host!==void 0&&(b.host=unescape(b.host))),b.path&&(b.path=escape(unescape(b.path))),b.fragment&&(b.fragment=encodeURI(decodeURIComponent(b.fragment)))),x&&x.parse&&x.parse(b,h)}else b.error=b.error||"URI can not be parsed.";return b}const _={SCHEMES:o,normalize:i,resolve:c,resolveComponent:d,equal:u,serialize:p,parse:g};return pa.exports=_,pa.exports.default=_,pa.exports.fastUri=_,pa.exports}var tc;function aw(){if(tc)return Qa;tc=1,Object.defineProperty(Qa,"__esModule",{value:!0});const e=sw();return e.code='require("ajv/dist/runtime/uri").default',Qa.default=e,Qa}var sc;function nw(){return sc||(sc=1,(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.CodeGen=e.Name=e.nil=e.stringify=e.str=e._=e.KeywordCxt=void 0;var t=kr();Object.defineProperty(e,"KeywordCxt",{enumerable:!0,get:function(){return t.KeywordCxt}});var s=Te();Object.defineProperty(e,"_",{enumerable:!0,get:function(){return s._}}),Object.defineProperty(e,"str",{enumerable:!0,get:function(){return s.str}}),Object.defineProperty(e,"stringify",{enumerable:!0,get:function(){return s.stringify}}),Object.defineProperty(e,"nil",{enumerable:!0,get:function(){return s.nil}}),Object.defineProperty(e,"Name",{enumerable:!0,get:function(){return s.Name}}),Object.defineProperty(e,"CodeGen",{enumerable:!0,get:function(){return s.CodeGen}});const a=ii(),n=Pr(),r=Vu(),o=li(),l=Te(),i=Er(),c=rr(),d=Ee(),u=ew,p=aw(),f=(Y,H)=>new RegExp(Y,H);f.code="new RegExp";const g=["removeAdditional","useDefaults","coerceTypes"],_=new Set(["validate","serialize","parse","wrapper","root","schema","keyword","pattern","formats","validate$data","func","obj","Error"]),v={errorDataPath:"",format:"`validateFormats: false` can be used instead.",nullable:'"nullable" keyword is supported by default.',jsonPointers:"Deprecated jsPropertySyntax can be used instead.",extendRefs:"Deprecated ignoreKeywordsWithRef can be used instead.",missingRefs:"Pass empty schema with $id that should be ignored to ajv.addSchema.",processCode:"Use option `code: {process: (code, schemaEnv: object) => string}`",sourceCode:"Use option `code: {source: true}`",strictDefaults:"It is default now, see option `strict`.",strictKeywords:"It is default now, see option `strict`.",uniqueItems:'"uniqueItems" keyword is always validated.',unknownFormats:"Disable strict mode or pass `true` to `ajv.addFormat` (or `formats` option).",cache:"Map is used as cache, schema object as key.",serialize:"Map is used as cache, schema object as key.",ajvErrors:"It is default now."},m={ignoreKeywordsWithRef:"",jsPropertySyntax:"",unicode:'"minLength"/"maxLength" account for unicode characters by default.'},h=200;function b(Y){var H,X,K,A,$,U,B,G,j,Z,F,E,M,N,R,L,z,se,oe,ie,ae,ne,ee,ce,fe;const he=Y.strict,ve=(H=Y.code)===null||H===void 0?void 0:H.optimize,_e=ve===!0||ve===void 0?1:ve||0,Ie=(K=(X=Y.code)===null||X===void 0?void 0:X.regExp)!==null&&K!==void 0?K:f,Ve=(A=Y.uriResolver)!==null&&A!==void 0?A:p.default;return{strictSchema:(U=($=Y.strictSchema)!==null&&$!==void 0?$:he)!==null&&U!==void 0?U:!0,strictNumbers:(G=(B=Y.strictNumbers)!==null&&B!==void 0?B:he)!==null&&G!==void 0?G:!0,strictTypes:(Z=(j=Y.strictTypes)!==null&&j!==void 0?j:he)!==null&&Z!==void 0?Z:"log",strictTuples:(E=(F=Y.strictTuples)!==null&&F!==void 0?F:he)!==null&&E!==void 0?E:"log",strictRequired:(N=(M=Y.strictRequired)!==null&&M!==void 0?M:he)!==null&&N!==void 0?N:!1,code:Y.code?{...Y.code,optimize:_e,regExp:Ie}:{optimize:_e,regExp:Ie},loopRequired:(R=Y.loopRequired)!==null&&R!==void 0?R:h,loopEnum:(L=Y.loopEnum)!==null&&L!==void 0?L:h,meta:(z=Y.meta)!==null&&z!==void 0?z:!0,messages:(se=Y.messages)!==null&&se!==void 0?se:!0,inlineRefs:(oe=Y.inlineRefs)!==null&&oe!==void 0?oe:!0,schemaId:(ie=Y.schemaId)!==null&&ie!==void 0?ie:"$id",addUsedSchema:(ae=Y.addUsedSchema)!==null&&ae!==void 0?ae:!0,validateSchema:(ne=Y.validateSchema)!==null&&ne!==void 0?ne:!0,validateFormats:(ee=Y.validateFormats)!==null&&ee!==void 0?ee:!0,unicodeRegExp:(ce=Y.unicodeRegExp)!==null&&ce!==void 0?ce:!0,int32range:(fe=Y.int32range)!==null&&fe!==void 0?fe:!0,uriResolver:Ve}}class w{constructor(H={}){this.schemas={},this.refs={},this.formats={},this._compilations=new Set,this._loading={},this._cache=new Map,H=this.opts={...H,...b(H)};const{es5:X,lines:K}=this.opts.code;this.scope=new l.ValueScope({scope:{},prefixes:_,es5:X,lines:K}),this.logger=O(H.logger);const A=H.validateFormats;H.validateFormats=!1,this.RULES=(0,r.getRules)(),y.call(this,v,H,"NOT SUPPORTED"),y.call(this,m,H,"DEPRECATED","warn"),this._metaOpts=k.call(this),H.formats&&D.call(this),this._addVocabularies(),this._addDefaultMetaSchema(),H.keywords&&T.call(this,H.keywords),typeof H.meta=="object"&&this.addMetaSchema(H.meta),P.call(this),H.validateFormats=A}_addVocabularies(){this.addKeyword("$async")}_addDefaultMetaSchema(){const{$data:H,meta:X,schemaId:K}=this.opts;let A=u;K==="id"&&(A={...u},A.id=A.$id,delete A.$id),X&&H&&this.addMetaSchema(A,A[K],!1)}defaultMeta(){const{meta:H,schemaId:X}=this.opts;return this.opts.defaultMeta=typeof H=="object"?H[X]||H:void 0}validate(H,X){let K;if(typeof H=="string"){if(K=this.getSchema(H),!K)throw new Error(`no schema with key or ref "${H}"`)}else K=this.compile(H);const A=K(X);return"$async"in K||(this.errors=K.errors),A}compile(H,X){const K=this._addSchema(H,X);return K.validate||this._compileSchemaEnv(K)}compileAsync(H,X){if(typeof this.opts.loadSchema!="function")throw new Error("options.loadSchema should be a function");const{loadSchema:K}=this.opts;return A.call(this,H,X);async function A(Z,F){await $.call(this,Z.$schema);const E=this._addSchema(Z,F);return E.validate||U.call(this,E)}async function $(Z){Z&&!this.getSchema(Z)&&await A.call(this,{$ref:Z},!0)}async function U(Z){try{return this._compileSchemaEnv(Z)}catch(F){if(!(F instanceof n.default))throw F;return B.call(this,F),await G.call(this,F.missingSchema),U.call(this,Z)}}function B({missingSchema:Z,missingRef:F}){if(this.refs[Z])throw new Error(`AnySchema ${Z} is loaded but ${F} cannot be resolved`)}async function G(Z){const F=await j.call(this,Z);this.refs[Z]||await $.call(this,F.$schema),this.refs[Z]||this.addSchema(F,Z,X)}async function j(Z){const F=this._loading[Z];if(F)return F;try{return await(this._loading[Z]=K(Z))}finally{delete this._loading[Z]}}}addSchema(H,X,K,A=this.opts.validateSchema){if(Array.isArray(H)){for(const U of H)this.addSchema(U,void 0,K,A);return this}let $;if(typeof H=="object"){const{schemaId:U}=this.opts;if($=H[U],$!==void 0&&typeof $!="string")throw new Error(`schema ${U} must be string`)}return X=(0,i.normalizeId)(X||$),this._checkUnique(X),this.schemas[X]=this._addSchema(H,K,X,A,!0),this}addMetaSchema(H,X,K=this.opts.validateSchema){return this.addSchema(H,X,!0,K),this}validateSchema(H,X){if(typeof H=="boolean")return!0;let K;if(K=H.$schema,K!==void 0&&typeof K!="string")throw new Error("$schema must be a string");if(K=K||this.opts.defaultMeta||this.defaultMeta(),!K)return this.logger.warn("meta-schema not available"),this.errors=null,!0;const A=this.validate(K,H);if(!A&&X){const $="schema is invalid: "+this.errorsText();if(this.opts.validateSchema==="log")this.logger.error($);else throw new Error($)}return A}getSchema(H){let X;for(;typeof(X=x.call(this,H))=="string";)H=X;if(X===void 0){const{schemaId:K}=this.opts,A=new o.SchemaEnv({schema:{},schemaId:K});if(X=o.resolveSchema.call(this,A,H),!X)return;this.refs[H]=X}return X.validate||this._compileSchemaEnv(X)}removeSchema(H){if(H instanceof RegExp)return this._removeAllSchemas(this.schemas,H),this._removeAllSchemas(this.refs,H),this;switch(typeof H){case"undefined":return this._removeAllSchemas(this.schemas),this._removeAllSchemas(this.refs),this._cache.clear(),this;case"string":{const X=x.call(this,H);return typeof X=="object"&&this._cache.delete(X.schema),delete this.schemas[H],delete this.refs[H],this}case"object":{const X=H;this._cache.delete(X);let K=H[this.opts.schemaId];return K&&(K=(0,i.normalizeId)(K),delete this.schemas[K],delete this.refs[K]),this}default:throw new Error("ajv.removeSchema: invalid parameter")}}addVocabulary(H){for(const X of H)this.addKeyword(X);return this}addKeyword(H,X){let K;if(typeof H=="string")K=H,typeof X=="object"&&(this.logger.warn("these parameters are deprecated, see docs for addKeyword"),X.keyword=K);else if(typeof H=="object"&&X===void 0){if(X=H,K=X.keyword,Array.isArray(K)&&!K.length)throw new Error("addKeywords: keyword must be string or non-empty array")}else throw new Error("invalid addKeywords parameters");if(q.call(this,K,X),!X)return(0,d.eachItem)(K,$=>J.call(this,$)),this;Q.call(this,X);const A={...X,type:(0,c.getJSONTypes)(X.type),schemaType:(0,c.getJSONTypes)(X.schemaType)};return(0,d.eachItem)(K,A.type.length===0?$=>J.call(this,$,A):$=>A.type.forEach(U=>J.call(this,$,A,U))),this}getKeyword(H){const X=this.RULES.all[H];return typeof X=="object"?X.definition:!!X}removeKeyword(H){const{RULES:X}=this;delete X.keywords[H],delete X.all[H];for(const K of X.rules){const A=K.rules.findIndex($=>$.keyword===H);A>=0&&K.rules.splice(A,1)}return this}addFormat(H,X){return typeof X=="string"&&(X=new RegExp(X)),this.formats[H]=X,this}errorsText(H=this.errors,{separator:X=", ",dataVar:K="data"}={}){return!H||H.length===0?"No errors":H.map(A=>`${K}${A.instancePath} ${A.message}`).reduce((A,$)=>A+X+$)}$dataMetaSchema(H,X){const K=this.RULES.all;H=JSON.parse(JSON.stringify(H));for(const A of X){const $=A.split("/").slice(1);let U=H;for(const B of $)U=U[B];for(const B in K){const G=K[B];if(typeof G!="object")continue;const{$data:j}=G.definition,Z=U[B];j&&Z&&(U[B]=re(Z))}}return H}_removeAllSchemas(H,X){for(const K in H){const A=H[K];(!X||X.test(K))&&(typeof A=="string"?delete H[K]:A&&!A.meta&&(this._cache.delete(A.schema),delete H[K]))}}_addSchema(H,X,K,A=this.opts.validateSchema,$=this.opts.addUsedSchema){let U;const{schemaId:B}=this.opts;if(typeof H=="object")U=H[B];else{if(this.opts.jtd)throw new Error("schema must be object");if(typeof H!="boolean")throw new Error("schema must be object or boolean")}let G=this._cache.get(H);if(G!==void 0)return G;K=(0,i.normalizeId)(U||K);const j=i.getSchemaRefs.call(this,H,K);return G=new o.SchemaEnv({schema:H,schemaId:B,meta:X,baseId:K,localRefs:j}),this._cache.set(G.schema,G),$&&!K.startsWith("#")&&(K&&this._checkUnique(K),this.refs[K]=G),A&&this.validateSchema(H,!0),G}_checkUnique(H){if(this.schemas[H]||this.refs[H])throw new Error(`schema with key or id "${H}" already exists`)}_compileSchemaEnv(H){if(H.meta?this._compileMetaSchema(H):o.compileSchema.call(this,H),!H.validate)throw new Error("ajv implementation error");return H.validate}_compileMetaSchema(H){const X=this.opts;this.opts=this._metaOpts;try{o.compileSchema.call(this,H)}finally{this.opts=X}}}w.ValidationError=a.default,w.MissingRefError=n.default,e.default=w;function y(Y,H,X,K="error"){for(const A in Y){const $=A;$ in H&&this.logger[K](`${X}: option ${A}. ${Y[$]}`)}}function x(Y){return Y=(0,i.normalizeId)(Y),this.schemas[Y]||this.refs[Y]}function P(){const Y=this.opts.schemas;if(Y)if(Array.isArray(Y))this.addSchema(Y);else for(const H in Y)this.addSchema(Y[H],H)}function D(){for(const Y in this.opts.formats){const H=this.opts.formats[Y];H&&this.addFormat(Y,H)}}function T(Y){if(Array.isArray(Y)){this.addVocabulary(Y);return}this.logger.warn("keywords option as map is deprecated, pass array");for(const H in Y){const X=Y[H];X.keyword||(X.keyword=H),this.addKeyword(X)}}function k(){const Y={...this.opts};for(const H of g)delete Y[H];return Y}const S={log(){},warn(){},error(){}};function O(Y){if(Y===!1)return S;if(Y===void 0)return console;if(Y.log&&Y.warn&&Y.error)return Y;throw new Error("logger must implement log, warn and error methods")}const I=/^[a-z_$][a-z0-9_$:-]*$/i;function q(Y,H){const{RULES:X}=this;if((0,d.eachItem)(Y,K=>{if(X.keywords[K])throw new Error(`Keyword ${K} is already defined`);if(!I.test(K))throw new Error(`Keyword ${K} has invalid name`)}),!!H&&H.$data&&!("code"in H||"validate"in H))throw new Error('$data keyword must have "code" or "validate" function')}function J(Y,H,X){var K;const A=H?.post;if(X&&A)throw new Error('keyword with "post" flag cannot have "type"');const{RULES:$}=this;let U=A?$.post:$.rules.find(({type:G})=>G===X);if(U||(U={type:X,rules:[]},$.rules.push(U)),$.keywords[Y]=!0,!H)return;const B={keyword:Y,definition:{...H,type:(0,c.getJSONTypes)(H.type),schemaType:(0,c.getJSONTypes)(H.schemaType)}};H.before?W.call(this,U,B,H.before):U.rules.push(B),$.all[Y]=B,(K=H.implements)===null||K===void 0||K.forEach(G=>this.addKeyword(G))}function W(Y,H,X){const K=Y.rules.findIndex(A=>A.keyword===X);K>=0?Y.rules.splice(K,0,H):(Y.rules.push(H),this.logger.warn(`rule ${X} is not defined`))}function Q(Y){let{metaSchema:H}=Y;H!==void 0&&(Y.$data&&this.opts.$data&&(H=re(H)),Y.validateSchema=this.compile(H,!0))}const V={$ref:"https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#"};function re(Y){return{anyOf:[Y,V]}}})(ao)),ao}var Za={},en={},tn={},ac;function rw(){if(ac)return tn;ac=1,Object.defineProperty(tn,"__esModule",{value:!0});const e={keyword:"id",code(){throw new Error('NOT SUPPORTED: keyword "id", use "$id" for schema ID')}};return tn.default=e,tn}var cs={},nc;function ow(){if(nc)return cs;nc=1,Object.defineProperty(cs,"__esModule",{value:!0}),cs.callRef=cs.getValidate=void 0;const e=Pr(),t=Ot(),s=Te(),a=Es(),n=li(),r=Ee(),o={keyword:"$ref",schemaType:"string",code(c){const{gen:d,schema:u,it:p}=c,{baseId:f,schemaEnv:g,validateName:_,opts:v,self:m}=p,{root:h}=g;if((u==="#"||u==="#/")&&f===h.baseId)return w();const b=n.resolveRef.call(m,h,f,u);if(b===void 0)throw new e.default(p.opts.uriResolver,f,u);if(b instanceof n.SchemaEnv)return y(b);return x(b);function w(){if(g===h)return i(c,_,g,g.$async);const P=d.scopeValue("root",{ref:h});return i(c,(0,s._)`${P}.validate`,h,h.$async)}function y(P){const D=l(c,P);i(c,D,P,P.$async)}function x(P){const D=d.scopeValue("schema",v.code.source===!0?{ref:P,code:(0,s.stringify)(P)}:{ref:P}),T=d.name("valid"),k=c.subschema({schema:P,dataTypes:[],schemaPath:s.nil,topSchemaRef:D,errSchemaPath:u},T);c.mergeEvaluated(k),c.ok(T)}}};function l(c,d){const{gen:u}=c;return d.validate?u.scopeValue("validate",{ref:d.validate}):(0,s._)`${u.scopeValue("wrapper",{ref:d})}.validate`}cs.getValidate=l;function i(c,d,u,p){const{gen:f,it:g}=c,{allErrors:_,schemaEnv:v,opts:m}=g,h=m.passContext?a.default.this:s.nil;p?b():w();function b(){if(!v.$async)throw new Error("async schema referenced by sync schema");const P=f.let("valid");f.try(()=>{f.code((0,s._)`await ${(0,t.callValidateCode)(c,d,h)}`),x(d),_||f.assign(P,!0)},D=>{f.if((0,s._)`!(${D} instanceof ${g.ValidationError})`,()=>f.throw(D)),y(D),_||f.assign(P,!1)}),c.ok(P)}function w(){c.result((0,t.callValidateCode)(c,d,h),()=>x(d),()=>y(d))}function y(P){const D=(0,s._)`${P}.errors`;f.assign(a.default.vErrors,(0,s._)`${a.default.vErrors} === null ? ${D} : ${a.default.vErrors}.concat(${D})`),f.assign(a.default.errors,(0,s._)`${a.default.vErrors}.length`)}function x(P){var D;if(!g.opts.unevaluated)return;const T=(D=u?.validate)===null||D===void 0?void 0:D.evaluated;if(g.props!==!0)if(T&&!T.dynamicProps)T.props!==void 0&&(g.props=r.mergeEvaluated.props(f,T.props,g.props));else{const k=f.var("props",(0,s._)`${P}.evaluated.props`);g.props=r.mergeEvaluated.props(f,k,g.props,s.Name)}if(g.items!==!0)if(T&&!T.dynamicItems)T.items!==void 0&&(g.items=r.mergeEvaluated.items(f,T.items,g.items));else{const k=f.var("items",(0,s._)`${P}.evaluated.items`);g.items=r.mergeEvaluated.items(f,k,g.items,s.Name)}}}return cs.callRef=i,cs.default=o,cs}var rc;function iw(){if(rc)return en;rc=1,Object.defineProperty(en,"__esModule",{value:!0});const e=rw(),t=ow(),s=["$schema","$id","$defs","$vocabulary",{keyword:"$comment"},"definitions",e.default,t.default];return en.default=s,en}var sn={},an={},oc;function lw(){if(oc)return an;oc=1,Object.defineProperty(an,"__esModule",{value:!0});const e=Te(),t=e.operators,s={maximum:{okStr:"<=",ok:t.LTE,fail:t.GT},minimum:{okStr:">=",ok:t.GTE,fail:t.LT},exclusiveMaximum:{okStr:"<",ok:t.LT,fail:t.GTE},exclusiveMinimum:{okStr:">",ok:t.GT,fail:t.LTE}},a={message:({keyword:r,schemaCode:o})=>(0,e.str)`must be ${s[r].okStr} ${o}`,params:({keyword:r,schemaCode:o})=>(0,e._)`{comparison: ${s[r].okStr}, limit: ${o}}`},n={keyword:Object.keys(s),type:"number",schemaType:"number",$data:!0,error:a,code(r){const{keyword:o,data:l,schemaCode:i}=r;r.fail$data((0,e._)`${l} ${s[o].fail} ${i} || isNaN(${l})`)}};return an.default=n,an}var nn={},ic;function cw(){if(ic)return nn;ic=1,Object.defineProperty(nn,"__esModule",{value:!0});const e=Te(),s={keyword:"multipleOf",type:"number",schemaType:"number",$data:!0,error:{message:({schemaCode:a})=>(0,e.str)`must be multiple of ${a}`,params:({schemaCode:a})=>(0,e._)`{multipleOf: ${a}}`},code(a){const{gen:n,data:r,schemaCode:o,it:l}=a,i=l.opts.multipleOfPrecision,c=n.let("res"),d=i?(0,e._)`Math.abs(Math.round(${c}) - ${c}) > 1e-${i}`:(0,e._)`${c} !== parseInt(${c})`;a.fail$data((0,e._)`(${o} === 0 || (${c} = ${r}/${o}, ${d}))`)}};return nn.default=s,nn}var rn={},on={},lc;function dw(){if(lc)return on;lc=1,Object.defineProperty(on,"__esModule",{value:!0});function e(t){const s=t.length;let a=0,n=0,r;for(;n<s;)a++,r=t.charCodeAt(n++),r>=55296&&r<=56319&&n<s&&(r=t.charCodeAt(n),(r&64512)===56320&&n++);return a}return on.default=e,e.code='require("ajv/dist/runtime/ucs2length").default',on}var cc;function uw(){if(cc)return rn;cc=1,Object.defineProperty(rn,"__esModule",{value:!0});const e=Te(),t=Ee(),s=dw(),n={keyword:["maxLength","minLength"],type:"string",schemaType:"number",$data:!0,error:{message({keyword:r,schemaCode:o}){const l=r==="maxLength"?"more":"fewer";return(0,e.str)`must NOT have ${l} than ${o} characters`},params:({schemaCode:r})=>(0,e._)`{limit: ${r}}`},code(r){const{keyword:o,data:l,schemaCode:i,it:c}=r,d=o==="maxLength"?e.operators.GT:e.operators.LT,u=c.opts.unicode===!1?(0,e._)`${l}.length`:(0,e._)`${(0,t.useFunc)(r.gen,s.default)}(${l})`;r.fail$data((0,e._)`${u} ${d} ${i}`)}};return rn.default=n,rn}var ln={},dc;function pw(){if(dc)return ln;dc=1,Object.defineProperty(ln,"__esModule",{value:!0});const e=Ot(),t=Ee(),s=Te(),n={keyword:"pattern",type:"string",schemaType:"string",$data:!0,error:{message:({schemaCode:r})=>(0,s.str)`must match pattern "${r}"`,params:({schemaCode:r})=>(0,s._)`{pattern: ${r}}`},code(r){const{gen:o,data:l,$data:i,schema:c,schemaCode:d,it:u}=r,p=u.opts.unicodeRegExp?"u":"";if(i){const{regExp:f}=u.opts.code,g=f.code==="new RegExp"?(0,s._)`new RegExp`:(0,t.useFunc)(o,f),_=o.let("valid");o.try(()=>o.assign(_,(0,s._)`${g}(${d}, ${p}).test(${l})`),()=>o.assign(_,!1)),r.fail$data((0,s._)`!${_}`)}else{const f=(0,e.usePattern)(r,c);r.fail$data((0,s._)`!${f}.test(${l})`)}}};return ln.default=n,ln}var cn={},uc;function fw(){if(uc)return cn;uc=1,Object.defineProperty(cn,"__esModule",{value:!0});const e=Te(),s={keyword:["maxProperties","minProperties"],type:"object",schemaType:"number",$data:!0,error:{message({keyword:a,schemaCode:n}){const r=a==="maxProperties"?"more":"fewer";return(0,e.str)`must NOT have ${r} than ${n} properties`},params:({schemaCode:a})=>(0,e._)`{limit: ${a}}`},code(a){const{keyword:n,data:r,schemaCode:o}=a,l=n==="maxProperties"?e.operators.GT:e.operators.LT;a.fail$data((0,e._)`Object.keys(${r}).length ${l} ${o}`)}};return cn.default=s,cn}var dn={},pc;function hw(){if(pc)return dn;pc=1,Object.defineProperty(dn,"__esModule",{value:!0});const e=Ot(),t=Te(),s=Ee(),n={keyword:"required",type:"object",schemaType:"array",$data:!0,error:{message:({params:{missingProperty:r}})=>(0,t.str)`must have required property '${r}'`,params:({params:{missingProperty:r}})=>(0,t._)`{missingProperty: ${r}}`},code(r){const{gen:o,schema:l,schemaCode:i,data:c,$data:d,it:u}=r,{opts:p}=u;if(!d&&l.length===0)return;const f=l.length>=p.loopRequired;if(u.allErrors?g():_(),p.strictRequired){const h=r.parentSchema.properties,{definedProperties:b}=r.it;for(const w of l)if(h?.[w]===void 0&&!b.has(w)){const y=u.schemaEnv.baseId+u.errSchemaPath,x=`required property "${w}" is not defined at "${y}" (strictRequired)`;(0,s.checkStrictMode)(u,x,u.opts.strictRequired)}}function g(){if(f||d)r.block$data(t.nil,v);else for(const h of l)(0,e.checkReportMissingProp)(r,h)}function _(){const h=o.let("missing");if(f||d){const b=o.let("valid",!0);r.block$data(b,()=>m(h,b)),r.ok(b)}else o.if((0,e.checkMissingProp)(r,l,h)),(0,e.reportMissingProp)(r,h),o.else()}function v(){o.forOf("prop",i,h=>{r.setParams({missingProperty:h}),o.if((0,e.noPropertyInData)(o,c,h,p.ownProperties),()=>r.error())})}function m(h,b){r.setParams({missingProperty:h}),o.forOf(h,i,()=>{o.assign(b,(0,e.propertyInData)(o,c,h,p.ownProperties)),o.if((0,t.not)(b),()=>{r.error(),o.break()})},t.nil)}}};return dn.default=n,dn}var un={},fc;function mw(){if(fc)return un;fc=1,Object.defineProperty(un,"__esModule",{value:!0});const e=Te(),s={keyword:["maxItems","minItems"],type:"array",schemaType:"number",$data:!0,error:{message({keyword:a,schemaCode:n}){const r=a==="maxItems"?"more":"fewer";return(0,e.str)`must NOT have ${r} than ${n} items`},params:({schemaCode:a})=>(0,e._)`{limit: ${a}}`},code(a){const{keyword:n,data:r,schemaCode:o}=a,l=n==="maxItems"?e.operators.GT:e.operators.LT;a.fail$data((0,e._)`${r}.length ${l} ${o}`)}};return un.default=s,un}var pn={},fn={},hc;function ci(){if(hc)return fn;hc=1,Object.defineProperty(fn,"__esModule",{value:!0});const e=Ku();return e.code='require("ajv/dist/runtime/equal").default',fn.default=e,fn}var mc;function gw(){if(mc)return pn;mc=1,Object.defineProperty(pn,"__esModule",{value:!0});const e=rr(),t=Te(),s=Ee(),a=ci(),r={keyword:"uniqueItems",type:"array",schemaType:"boolean",$data:!0,error:{message:({params:{i:o,j:l}})=>(0,t.str)`must NOT have duplicate items (items ## ${l} and ${o} are identical)`,params:({params:{i:o,j:l}})=>(0,t._)`{i: ${o}, j: ${l}}`},code(o){const{gen:l,data:i,$data:c,schema:d,parentSchema:u,schemaCode:p,it:f}=o;if(!c&&!d)return;const g=l.let("valid"),_=u.items?(0,e.getSchemaTypes)(u.items):[];o.block$data(g,v,(0,t._)`${p} === false`),o.ok(g);function v(){const w=l.let("i",(0,t._)`${i}.length`),y=l.let("j");o.setParams({i:w,j:y}),l.assign(g,!0),l.if((0,t._)`${w} > 1`,()=>(m()?h:b)(w,y))}function m(){return _.length>0&&!_.some(w=>w==="object"||w==="array")}function h(w,y){const x=l.name("item"),P=(0,e.checkDataTypes)(_,x,f.opts.strictNumbers,e.DataType.Wrong),D=l.const("indices",(0,t._)`{}`);l.for((0,t._)`;${w}--;`,()=>{l.let(x,(0,t._)`${i}[${w}]`),l.if(P,(0,t._)`continue`),_.length>1&&l.if((0,t._)`typeof ${x} == "string"`,(0,t._)`${x} += "_"`),l.if((0,t._)`typeof ${D}[${x}] == "number"`,()=>{l.assign(y,(0,t._)`${D}[${x}]`),o.error(),l.assign(g,!1).break()}).code((0,t._)`${D}[${x}] = ${w}`)})}function b(w,y){const x=(0,s.useFunc)(l,a.default),P=l.name("outer");l.label(P).for((0,t._)`;${w}--;`,()=>l.for((0,t._)`${y} = ${w}; ${y}--;`,()=>l.if((0,t._)`${x}(${i}[${w}], ${i}[${y}])`,()=>{o.error(),l.assign(g,!1).break(P)})))}}};return pn.default=r,pn}var hn={},gc;function bw(){if(gc)return hn;gc=1,Object.defineProperty(hn,"__esModule",{value:!0});const e=Te(),t=Ee(),s=ci(),n={keyword:"const",$data:!0,error:{message:"must be equal to constant",params:({schemaCode:r})=>(0,e._)`{allowedValue: ${r}}`},code(r){const{gen:o,data:l,$data:i,schemaCode:c,schema:d}=r;i||d&&typeof d=="object"?r.fail$data((0,e._)`!${(0,t.useFunc)(o,s.default)}(${l}, ${c})`):r.fail((0,e._)`${d} !== ${l}`)}};return hn.default=n,hn}var mn={},bc;function _w(){if(bc)return mn;bc=1,Object.defineProperty(mn,"__esModule",{value:!0});const e=Te(),t=Ee(),s=ci(),n={keyword:"enum",schemaType:"array",$data:!0,error:{message:"must be equal to one of the allowed values",params:({schemaCode:r})=>(0,e._)`{allowedValues: ${r}}`},code(r){const{gen:o,data:l,$data:i,schema:c,schemaCode:d,it:u}=r;if(!i&&c.length===0)throw new Error("enum must have non-empty array");const p=c.length>=u.opts.loopEnum;let f;const g=()=>f??(f=(0,t.useFunc)(o,s.default));let _;if(p||i)_=o.let("valid"),r.block$data(_,v);else{if(!Array.isArray(c))throw new Error("ajv implementation error");const h=o.const("vSchema",d);_=(0,e.or)(...c.map((b,w)=>m(h,w)))}r.pass(_);function v(){o.assign(_,!1),o.forOf("v",d,h=>o.if((0,e._)`${g()}(${l}, ${h})`,()=>o.assign(_,!0).break()))}function m(h,b){const w=c[b];return typeof w=="object"&&w!==null?(0,e._)`${g()}(${l}, ${h}[${b}])`:(0,e._)`${l} === ${w}`}}};return mn.default=n,mn}var _c;function vw(){if(_c)return sn;_c=1,Object.defineProperty(sn,"__esModule",{value:!0});const e=lw(),t=cw(),s=uw(),a=pw(),n=fw(),r=hw(),o=mw(),l=gw(),i=bw(),c=_w(),d=[e.default,t.default,s.default,a.default,n.default,r.default,o.default,l.default,{keyword:"type",schemaType:["string","array"]},{keyword:"nullable",schemaType:"boolean"},i.default,c.default];return sn.default=d,sn}var gn={},qs={},vc;function Wu(){if(vc)return qs;vc=1,Object.defineProperty(qs,"__esModule",{value:!0}),qs.validateAdditionalItems=void 0;const e=Te(),t=Ee(),a={keyword:"additionalItems",type:"array",schemaType:["boolean","object"],before:"uniqueItems",error:{message:({params:{len:r}})=>(0,e.str)`must NOT have more than ${r} items`,params:({params:{len:r}})=>(0,e._)`{limit: ${r}}`},code(r){const{parentSchema:o,it:l}=r,{items:i}=o;if(!Array.isArray(i)){(0,t.checkStrictMode)(l,'"additionalItems" is ignored when "items" is not an array of schemas');return}n(r,i)}};function n(r,o){const{gen:l,schema:i,data:c,keyword:d,it:u}=r;u.items=!0;const p=l.const("len",(0,e._)`${c}.length`);if(i===!1)r.setParams({len:o.length}),r.pass((0,e._)`${p} <= ${o.length}`);else if(typeof i=="object"&&!(0,t.alwaysValidSchema)(u,i)){const g=l.var("valid",(0,e._)`${p} <= ${o.length}`);l.if((0,e.not)(g),()=>f(g)),r.ok(g)}function f(g){l.forRange("i",o.length,p,_=>{r.subschema({keyword:d,dataProp:_,dataPropType:t.Type.Num},g),u.allErrors||l.if((0,e.not)(g),()=>l.break())})}}return qs.validateAdditionalItems=n,qs.default=a,qs}var bn={},Vs={},yc;function Ju(){if(yc)return Vs;yc=1,Object.defineProperty(Vs,"__esModule",{value:!0}),Vs.validateTuple=void 0;const e=Te(),t=Ee(),s=Ot(),a={keyword:"items",type:"array",schemaType:["object","array","boolean"],before:"uniqueItems",code(r){const{schema:o,it:l}=r;if(Array.isArray(o))return n(r,"additionalItems",o);l.items=!0,!(0,t.alwaysValidSchema)(l,o)&&r.ok((0,s.validateArray)(r))}};function n(r,o,l=r.schema){const{gen:i,parentSchema:c,data:d,keyword:u,it:p}=r;_(c),p.opts.unevaluated&&l.length&&p.items!==!0&&(p.items=t.mergeEvaluated.items(i,l.length,p.items));const f=i.name("valid"),g=i.const("len",(0,e._)`${d}.length`);l.forEach((v,m)=>{(0,t.alwaysValidSchema)(p,v)||(i.if((0,e._)`${g} > ${m}`,()=>r.subschema({keyword:u,schemaProp:m,dataProp:m},f)),r.ok(f))});function _(v){const{opts:m,errSchemaPath:h}=p,b=l.length,w=b===v.minItems&&(b===v.maxItems||v[o]===!1);if(m.strictTuples&&!w){const y=`"${u}" is ${b}-tuple, but minItems or maxItems/${o} are not specified or different at path "${h}"`;(0,t.checkStrictMode)(p,y,m.strictTuples)}}}return Vs.validateTuple=n,Vs.default=a,Vs}var wc;function yw(){if(wc)return bn;wc=1,Object.defineProperty(bn,"__esModule",{value:!0});const e=Ju(),t={keyword:"prefixItems",type:"array",schemaType:["array"],before:"uniqueItems",code:s=>(0,e.validateTuple)(s,"items")};return bn.default=t,bn}var _n={},xc;function ww(){if(xc)return _n;xc=1,Object.defineProperty(_n,"__esModule",{value:!0});const e=Te(),t=Ee(),s=Ot(),a=Wu(),r={keyword:"items",type:"array",schemaType:["object","boolean"],before:"uniqueItems",error:{message:({params:{len:o}})=>(0,e.str)`must NOT have more than ${o} items`,params:({params:{len:o}})=>(0,e._)`{limit: ${o}}`},code(o){const{schema:l,parentSchema:i,it:c}=o,{prefixItems:d}=i;c.items=!0,!(0,t.alwaysValidSchema)(c,l)&&(d?(0,a.validateAdditionalItems)(o,d):o.ok((0,s.validateArray)(o)))}};return _n.default=r,_n}var vn={},Tc;function xw(){if(Tc)return vn;Tc=1,Object.defineProperty(vn,"__esModule",{value:!0});const e=Te(),t=Ee(),a={keyword:"contains",type:"array",schemaType:["object","boolean"],before:"uniqueItems",trackErrors:!0,error:{message:({params:{min:n,max:r}})=>r===void 0?(0,e.str)`must contain at least ${n} valid item(s)`:(0,e.str)`must contain at least ${n} and no more than ${r} valid item(s)`,params:({params:{min:n,max:r}})=>r===void 0?(0,e._)`{minContains: ${n}}`:(0,e._)`{minContains: ${n}, maxContains: ${r}}`},code(n){const{gen:r,schema:o,parentSchema:l,data:i,it:c}=n;let d,u;const{minContains:p,maxContains:f}=l;c.opts.next?(d=p===void 0?1:p,u=f):d=1;const g=r.const("len",(0,e._)`${i}.length`);if(n.setParams({min:d,max:u}),u===void 0&&d===0){(0,t.checkStrictMode)(c,'"minContains" == 0 without "maxContains": "contains" keyword ignored');return}if(u!==void 0&&d>u){(0,t.checkStrictMode)(c,'"minContains" > "maxContains" is always invalid'),n.fail();return}if((0,t.alwaysValidSchema)(c,o)){let b=(0,e._)`${g} >= ${d}`;u!==void 0&&(b=(0,e._)`${b} && ${g} <= ${u}`),n.pass(b);return}c.items=!0;const _=r.name("valid");u===void 0&&d===1?m(_,()=>r.if(_,()=>r.break())):d===0?(r.let(_,!0),u!==void 0&&r.if((0,e._)`${i}.length > 0`,v)):(r.let(_,!1),v()),n.result(_,()=>n.reset());function v(){const b=r.name("_valid"),w=r.let("count",0);m(b,()=>r.if(b,()=>h(w)))}function m(b,w){r.forRange("i",0,g,y=>{n.subschema({keyword:"contains",dataProp:y,dataPropType:t.Type.Num,compositeRule:!0},b),w()})}function h(b){r.code((0,e._)`${b}++`),u===void 0?r.if((0,e._)`${b} >= ${d}`,()=>r.assign(_,!0).break()):(r.if((0,e._)`${b} > ${u}`,()=>r.assign(_,!1).break()),d===1?r.assign(_,!0):r.if((0,e._)`${b} >= ${d}`,()=>r.assign(_,!0)))}}};return vn.default=a,vn}var fo={},Sc;function Tw(){return Sc||(Sc=1,(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.validateSchemaDeps=e.validatePropertyDeps=e.error=void 0;const t=Te(),s=Ee(),a=Ot();e.error={message:({params:{property:i,depsCount:c,deps:d}})=>{const u=c===1?"property":"properties";return(0,t.str)`must have ${u} ${d} when property ${i} is present`},params:({params:{property:i,depsCount:c,deps:d,missingProperty:u}})=>(0,t._)`{property: ${i},
    missingProperty: ${u},
    depsCount: ${c},
    deps: ${d}}`};const n={keyword:"dependencies",type:"object",schemaType:"object",error:e.error,code(i){const[c,d]=r(i);o(i,c),l(i,d)}};function r({schema:i}){const c={},d={};for(const u in i){if(u==="__proto__")continue;const p=Array.isArray(i[u])?c:d;p[u]=i[u]}return[c,d]}function o(i,c=i.schema){const{gen:d,data:u,it:p}=i;if(Object.keys(c).length===0)return;const f=d.let("missing");for(const g in c){const _=c[g];if(_.length===0)continue;const v=(0,a.propertyInData)(d,u,g,p.opts.ownProperties);i.setParams({property:g,depsCount:_.length,deps:_.join(", ")}),p.allErrors?d.if(v,()=>{for(const m of _)(0,a.checkReportMissingProp)(i,m)}):(d.if((0,t._)`${v} && (${(0,a.checkMissingProp)(i,_,f)})`),(0,a.reportMissingProp)(i,f),d.else())}}e.validatePropertyDeps=o;function l(i,c=i.schema){const{gen:d,data:u,keyword:p,it:f}=i,g=d.name("valid");for(const _ in c)(0,s.alwaysValidSchema)(f,c[_])||(d.if((0,a.propertyInData)(d,u,_,f.opts.ownProperties),()=>{const v=i.subschema({keyword:p,schemaProp:_},g);i.mergeValidEvaluated(v,g)},()=>d.var(g,!0)),i.ok(g))}e.validateSchemaDeps=l,e.default=n})(fo)),fo}var yn={},Ec;function Sw(){if(Ec)return yn;Ec=1,Object.defineProperty(yn,"__esModule",{value:!0});const e=Te(),t=Ee(),a={keyword:"propertyNames",type:"object",schemaType:["object","boolean"],error:{message:"property name must be valid",params:({params:n})=>(0,e._)`{propertyName: ${n.propertyName}}`},code(n){const{gen:r,schema:o,data:l,it:i}=n;if((0,t.alwaysValidSchema)(i,o))return;const c=r.name("valid");r.forIn("key",l,d=>{n.setParams({propertyName:d}),n.subschema({keyword:"propertyNames",data:d,dataTypes:["string"],propertyName:d,compositeRule:!0},c),r.if((0,e.not)(c),()=>{n.error(!0),i.allErrors||r.break()})}),n.ok(c)}};return yn.default=a,yn}var wn={},kc;function Xu(){if(kc)return wn;kc=1,Object.defineProperty(wn,"__esModule",{value:!0});const e=Ot(),t=Te(),s=Es(),a=Ee(),r={keyword:"additionalProperties",type:["object"],schemaType:["boolean","object"],allowUndefined:!0,trackErrors:!0,error:{message:"must NOT have additional properties",params:({params:o})=>(0,t._)`{additionalProperty: ${o.additionalProperty}}`},code(o){const{gen:l,schema:i,parentSchema:c,data:d,errsCount:u,it:p}=o;if(!u)throw new Error("ajv implementation error");const{allErrors:f,opts:g}=p;if(p.props=!0,g.removeAdditional!=="all"&&(0,a.alwaysValidSchema)(p,i))return;const _=(0,e.allSchemaProperties)(c.properties),v=(0,e.allSchemaProperties)(c.patternProperties);m(),o.ok((0,t._)`${u} === ${s.default.errors}`);function m(){l.forIn("key",d,x=>{!_.length&&!v.length?w(x):l.if(h(x),()=>w(x))})}function h(x){let P;if(_.length>8){const D=(0,a.schemaRefOrVal)(p,c.properties,"properties");P=(0,e.isOwnProperty)(l,D,x)}else _.length?P=(0,t.or)(..._.map(D=>(0,t._)`${x} === ${D}`)):P=t.nil;return v.length&&(P=(0,t.or)(P,...v.map(D=>(0,t._)`${(0,e.usePattern)(o,D)}.test(${x})`))),(0,t.not)(P)}function b(x){l.code((0,t._)`delete ${d}[${x}]`)}function w(x){if(g.removeAdditional==="all"||g.removeAdditional&&i===!1){b(x);return}if(i===!1){o.setParams({additionalProperty:x}),o.error(),f||l.break();return}if(typeof i=="object"&&!(0,a.alwaysValidSchema)(p,i)){const P=l.name("valid");g.removeAdditional==="failing"?(y(x,P,!1),l.if((0,t.not)(P),()=>{o.reset(),b(x)})):(y(x,P),f||l.if((0,t.not)(P),()=>l.break()))}}function y(x,P,D){const T={keyword:"additionalProperties",dataProp:x,dataPropType:a.Type.Str};D===!1&&Object.assign(T,{compositeRule:!0,createErrors:!1,allErrors:!1}),o.subschema(T,P)}}};return wn.default=r,wn}var xn={},Pc;function Ew(){if(Pc)return xn;Pc=1,Object.defineProperty(xn,"__esModule",{value:!0});const e=kr(),t=Ot(),s=Ee(),a=Xu(),n={keyword:"properties",type:"object",schemaType:"object",code(r){const{gen:o,schema:l,parentSchema:i,data:c,it:d}=r;d.opts.removeAdditional==="all"&&i.additionalProperties===void 0&&a.default.code(new e.KeywordCxt(d,a.default,"additionalProperties"));const u=(0,t.allSchemaProperties)(l);for(const v of u)d.definedProperties.add(v);d.opts.unevaluated&&u.length&&d.props!==!0&&(d.props=s.mergeEvaluated.props(o,(0,s.toHash)(u),d.props));const p=u.filter(v=>!(0,s.alwaysValidSchema)(d,l[v]));if(p.length===0)return;const f=o.name("valid");for(const v of p)g(v)?_(v):(o.if((0,t.propertyInData)(o,c,v,d.opts.ownProperties)),_(v),d.allErrors||o.else().var(f,!0),o.endIf()),r.it.definedProperties.add(v),r.ok(f);function g(v){return d.opts.useDefaults&&!d.compositeRule&&l[v].default!==void 0}function _(v){r.subschema({keyword:"properties",schemaProp:v,dataProp:v},f)}}};return xn.default=n,xn}var Tn={},Ac;function kw(){if(Ac)return Tn;Ac=1,Object.defineProperty(Tn,"__esModule",{value:!0});const e=Ot(),t=Te(),s=Ee(),a=Ee(),n={keyword:"patternProperties",type:"object",schemaType:"object",code(r){const{gen:o,schema:l,data:i,parentSchema:c,it:d}=r,{opts:u}=d,p=(0,e.allSchemaProperties)(l),f=p.filter(w=>(0,s.alwaysValidSchema)(d,l[w]));if(p.length===0||f.length===p.length&&(!d.opts.unevaluated||d.props===!0))return;const g=u.strictSchema&&!u.allowMatchingProperties&&c.properties,_=o.name("valid");d.props!==!0&&!(d.props instanceof t.Name)&&(d.props=(0,a.evaluatedPropsToName)(o,d.props));const{props:v}=d;m();function m(){for(const w of p)g&&h(w),d.allErrors?b(w):(o.var(_,!0),b(w),o.if(_))}function h(w){for(const y in g)new RegExp(w).test(y)&&(0,s.checkStrictMode)(d,`property ${y} matches pattern ${w} (use allowMatchingProperties)`)}function b(w){o.forIn("key",i,y=>{o.if((0,t._)`${(0,e.usePattern)(r,w)}.test(${y})`,()=>{const x=f.includes(w);x||r.subschema({keyword:"patternProperties",schemaProp:w,dataProp:y,dataPropType:a.Type.Str},_),d.opts.unevaluated&&v!==!0?o.assign((0,t._)`${v}[${y}]`,!0):!x&&!d.allErrors&&o.if((0,t.not)(_),()=>o.break())})})}}};return Tn.default=n,Tn}var Sn={},Cc;function Pw(){if(Cc)return Sn;Cc=1,Object.defineProperty(Sn,"__esModule",{value:!0});const e=Ee(),t={keyword:"not",schemaType:["object","boolean"],trackErrors:!0,code(s){const{gen:a,schema:n,it:r}=s;if((0,e.alwaysValidSchema)(r,n)){s.fail();return}const o=a.name("valid");s.subschema({keyword:"not",compositeRule:!0,createErrors:!1,allErrors:!1},o),s.failResult(o,()=>s.reset(),()=>s.error())},error:{message:"must NOT be valid"}};return Sn.default=t,Sn}var En={},Oc;function Aw(){if(Oc)return En;Oc=1,Object.defineProperty(En,"__esModule",{value:!0});const t={keyword:"anyOf",schemaType:"array",trackErrors:!0,code:Ot().validateUnion,error:{message:"must match a schema in anyOf"}};return En.default=t,En}var kn={},$c;function Cw(){if($c)return kn;$c=1,Object.defineProperty(kn,"__esModule",{value:!0});const e=Te(),t=Ee(),a={keyword:"oneOf",schemaType:"array",trackErrors:!0,error:{message:"must match exactly one schema in oneOf",params:({params:n})=>(0,e._)`{passingSchemas: ${n.passing}}`},code(n){const{gen:r,schema:o,parentSchema:l,it:i}=n;if(!Array.isArray(o))throw new Error("ajv implementation error");if(i.opts.discriminator&&l.discriminator)return;const c=o,d=r.let("valid",!1),u=r.let("passing",null),p=r.name("_valid");n.setParams({passing:u}),r.block(f),n.result(d,()=>n.reset(),()=>n.error(!0));function f(){c.forEach((g,_)=>{let v;(0,t.alwaysValidSchema)(i,g)?r.var(p,!0):v=n.subschema({keyword:"oneOf",schemaProp:_,compositeRule:!0},p),_>0&&r.if((0,e._)`${p} && ${d}`).assign(d,!1).assign(u,(0,e._)`[${u}, ${_}]`).else(),r.if(p,()=>{r.assign(d,!0),r.assign(u,_),v&&n.mergeEvaluated(v,e.Name)})})}}};return kn.default=a,kn}var Pn={},Mc;function Ow(){if(Mc)return Pn;Mc=1,Object.defineProperty(Pn,"__esModule",{value:!0});const e=Ee(),t={keyword:"allOf",schemaType:"array",code(s){const{gen:a,schema:n,it:r}=s;if(!Array.isArray(n))throw new Error("ajv implementation error");const o=a.name("valid");n.forEach((l,i)=>{if((0,e.alwaysValidSchema)(r,l))return;const c=s.subschema({keyword:"allOf",schemaProp:i},o);s.ok(o),s.mergeEvaluated(c)})}};return Pn.default=t,Pn}var An={},Lc;function $w(){if(Lc)return An;Lc=1,Object.defineProperty(An,"__esModule",{value:!0});const e=Te(),t=Ee(),a={keyword:"if",schemaType:["object","boolean"],trackErrors:!0,error:{message:({params:r})=>(0,e.str)`must match "${r.ifClause}" schema`,params:({params:r})=>(0,e._)`{failingKeyword: ${r.ifClause}}`},code(r){const{gen:o,parentSchema:l,it:i}=r;l.then===void 0&&l.else===void 0&&(0,t.checkStrictMode)(i,'"if" without "then" and "else" is ignored');const c=n(i,"then"),d=n(i,"else");if(!c&&!d)return;const u=o.let("valid",!0),p=o.name("_valid");if(f(),r.reset(),c&&d){const _=o.let("ifClause");r.setParams({ifClause:_}),o.if(p,g("then",_),g("else",_))}else c?o.if(p,g("then")):o.if((0,e.not)(p),g("else"));r.pass(u,()=>r.error(!0));function f(){const _=r.subschema({keyword:"if",compositeRule:!0,createErrors:!1,allErrors:!1},p);r.mergeEvaluated(_)}function g(_,v){return()=>{const m=r.subschema({keyword:_},p);o.assign(u,p),r.mergeValidEvaluated(m,u),v?o.assign(v,(0,e._)`${_}`):r.setParams({ifClause:_})}}}};function n(r,o){const l=r.schema[o];return l!==void 0&&!(0,t.alwaysValidSchema)(r,l)}return An.default=a,An}var Cn={},Rc;function Mw(){if(Rc)return Cn;Rc=1,Object.defineProperty(Cn,"__esModule",{value:!0});const e=Ee(),t={keyword:["then","else"],schemaType:["object","boolean"],code({keyword:s,parentSchema:a,it:n}){a.if===void 0&&(0,e.checkStrictMode)(n,`"${s}" without "if" is ignored`)}};return Cn.default=t,Cn}var Dc;function Lw(){if(Dc)return gn;Dc=1,Object.defineProperty(gn,"__esModule",{value:!0});const e=Wu(),t=yw(),s=Ju(),a=ww(),n=xw(),r=Tw(),o=Sw(),l=Xu(),i=Ew(),c=kw(),d=Pw(),u=Aw(),p=Cw(),f=Ow(),g=$w(),_=Mw();function v(m=!1){const h=[d.default,u.default,p.default,f.default,g.default,_.default,o.default,l.default,r.default,i.default,c.default];return m?h.push(t.default,a.default):h.push(e.default,s.default),h.push(n.default),h}return gn.default=v,gn}var On={},$n={},Nc;function Rw(){if(Nc)return $n;Nc=1,Object.defineProperty($n,"__esModule",{value:!0});const e=Te(),s={keyword:"format",type:["number","string"],schemaType:"string",$data:!0,error:{message:({schemaCode:a})=>(0,e.str)`must match format "${a}"`,params:({schemaCode:a})=>(0,e._)`{format: ${a}}`},code(a,n){const{gen:r,data:o,$data:l,schema:i,schemaCode:c,it:d}=a,{opts:u,errSchemaPath:p,schemaEnv:f,self:g}=d;if(!u.validateFormats)return;l?_():v();function _(){const m=r.scopeValue("formats",{ref:g.formats,code:u.code.formats}),h=r.const("fDef",(0,e._)`${m}[${c}]`),b=r.let("fType"),w=r.let("format");r.if((0,e._)`typeof ${h} == "object" && !(${h} instanceof RegExp)`,()=>r.assign(b,(0,e._)`${h}.type || "string"`).assign(w,(0,e._)`${h}.validate`),()=>r.assign(b,(0,e._)`"string"`).assign(w,h)),a.fail$data((0,e.or)(y(),x()));function y(){return u.strictSchema===!1?e.nil:(0,e._)`${c} && !${w}`}function x(){const P=f.$async?(0,e._)`(${h}.async ? await ${w}(${o}) : ${w}(${o}))`:(0,e._)`${w}(${o})`,D=(0,e._)`(typeof ${w} == "function" ? ${P} : ${w}.test(${o}))`;return(0,e._)`${w} && ${w} !== true && ${b} === ${n} && !${D}`}}function v(){const m=g.formats[i];if(!m){y();return}if(m===!0)return;const[h,b,w]=x(m);h===n&&a.pass(P());function y(){if(u.strictSchema===!1){g.logger.warn(D());return}throw new Error(D());function D(){return`unknown format "${i}" ignored in schema at path "${p}"`}}function x(D){const T=D instanceof RegExp?(0,e.regexpCode)(D):u.code.formats?(0,e._)`${u.code.formats}${(0,e.getProperty)(i)}`:void 0,k=r.scopeValue("formats",{key:i,ref:D,code:T});return typeof D=="object"&&!(D instanceof RegExp)?[D.type||"string",D.validate,(0,e._)`${k}.validate`]:["string",D,k]}function P(){if(typeof m=="object"&&!(m instanceof RegExp)&&m.async){if(!f.$async)throw new Error("async format in sync schema");return(0,e._)`await ${w}(${o})`}return typeof b=="function"?(0,e._)`${w}(${o})`:(0,e._)`${w}.test(${o})`}}}};return $n.default=s,$n}var Ic;function Dw(){if(Ic)return On;Ic=1,Object.defineProperty(On,"__esModule",{value:!0});const t=[Rw().default];return On.default=t,On}var Ms={},Bc;function Nw(){return Bc||(Bc=1,Object.defineProperty(Ms,"__esModule",{value:!0}),Ms.contentVocabulary=Ms.metadataVocabulary=void 0,Ms.metadataVocabulary=["title","description","default","deprecated","readOnly","writeOnly","examples"],Ms.contentVocabulary=["contentMediaType","contentEncoding","contentSchema"]),Ms}var Fc;function Iw(){if(Fc)return Za;Fc=1,Object.defineProperty(Za,"__esModule",{value:!0});const e=iw(),t=vw(),s=Lw(),a=Dw(),n=Nw(),r=[e.default,t.default,(0,s.default)(),a.default,n.metadataVocabulary,n.contentVocabulary];return Za.default=r,Za}var Mn={},fa={},zc;function Bw(){if(zc)return fa;zc=1,Object.defineProperty(fa,"__esModule",{value:!0}),fa.DiscrError=void 0;var e;return(function(t){t.Tag="tag",t.Mapping="mapping"})(e||(fa.DiscrError=e={})),fa}var Hc;function Fw(){if(Hc)return Mn;Hc=1,Object.defineProperty(Mn,"__esModule",{value:!0});const e=Te(),t=Bw(),s=li(),a=Pr(),n=Ee(),o={keyword:"discriminator",type:"object",schemaType:"object",error:{message:({params:{discrError:l,tagName:i}})=>l===t.DiscrError.Tag?`tag "${i}" must be string`:`value of tag "${i}" must be in oneOf`,params:({params:{discrError:l,tag:i,tagName:c}})=>(0,e._)`{error: ${l}, tag: ${c}, tagValue: ${i}}`},code(l){const{gen:i,data:c,schema:d,parentSchema:u,it:p}=l,{oneOf:f}=u;if(!p.opts.discriminator)throw new Error("discriminator: requires discriminator option");const g=d.propertyName;if(typeof g!="string")throw new Error("discriminator: requires propertyName");if(d.mapping)throw new Error("discriminator: mapping is not supported");if(!f)throw new Error("discriminator: requires oneOf keyword");const _=i.let("valid",!1),v=i.const("tag",(0,e._)`${c}${(0,e.getProperty)(g)}`);i.if((0,e._)`typeof ${v} == "string"`,()=>m(),()=>l.error(!1,{discrError:t.DiscrError.Tag,tag:v,tagName:g})),l.ok(_);function m(){const w=b();i.if(!1);for(const y in w)i.elseIf((0,e._)`${v} === ${y}`),i.assign(_,h(w[y]));i.else(),l.error(!1,{discrError:t.DiscrError.Mapping,tag:v,tagName:g}),i.endIf()}function h(w){const y=i.name("valid"),x=l.subschema({keyword:"oneOf",schemaProp:w},y);return l.mergeEvaluated(x,e.Name),y}function b(){var w;const y={},x=D(u);let P=!0;for(let S=0;S<f.length;S++){let O=f[S];if(O?.$ref&&!(0,n.schemaHasRulesButRef)(O,p.self.RULES)){const q=O.$ref;if(O=s.resolveRef.call(p.self,p.schemaEnv.root,p.baseId,q),O instanceof s.SchemaEnv&&(O=O.schema),O===void 0)throw new a.default(p.opts.uriResolver,p.baseId,q)}const I=(w=O?.properties)===null||w===void 0?void 0:w[g];if(typeof I!="object")throw new Error(`discriminator: oneOf subschemas (or referenced schemas) must have "properties/${g}"`);P=P&&(x||D(O)),T(I,S)}if(!P)throw new Error(`discriminator: "${g}" must be required`);return y;function D({required:S}){return Array.isArray(S)&&S.includes(g)}function T(S,O){if(S.const)k(S.const,O);else if(S.enum)for(const I of S.enum)k(I,O);else throw new Error(`discriminator: "properties/${g}" must have "const" or "enum"`)}function k(S,O){if(typeof S!="string"||S in y)throw new Error(`discriminator: "${g}" values must be unique strings`);y[S]=O}}}};return Mn.default=o,Mn}const zw="http://json-schema.org/draft-07/schema#",Hw="http://json-schema.org/draft-07/schema#",jw="Core schema meta-schema",Uw={schemaArray:{type:"array",minItems:1,items:{$ref:"#"}},nonNegativeInteger:{type:"integer",minimum:0},nonNegativeIntegerDefault0:{allOf:[{$ref:"#/definitions/nonNegativeInteger"},{default:0}]},simpleTypes:{enum:["array","boolean","integer","null","number","object","string"]},stringArray:{type:"array",items:{type:"string"},uniqueItems:!0,default:[]}},qw=["object","boolean"],Vw={$id:{type:"string",format:"uri-reference"},$schema:{type:"string",format:"uri"},$ref:{type:"string",format:"uri-reference"},$comment:{type:"string"},title:{type:"string"},description:{type:"string"},default:!0,readOnly:{type:"boolean",default:!1},examples:{type:"array",items:!0},multipleOf:{type:"number",exclusiveMinimum:0},maximum:{type:"number"},exclusiveMaximum:{type:"number"},minimum:{type:"number"},exclusiveMinimum:{type:"number"},maxLength:{$ref:"#/definitions/nonNegativeInteger"},minLength:{$ref:"#/definitions/nonNegativeIntegerDefault0"},pattern:{type:"string",format:"regex"},additionalItems:{$ref:"#"},items:{anyOf:[{$ref:"#"},{$ref:"#/definitions/schemaArray"}],default:!0},maxItems:{$ref:"#/definitions/nonNegativeInteger"},minItems:{$ref:"#/definitions/nonNegativeIntegerDefault0"},uniqueItems:{type:"boolean",default:!1},contains:{$ref:"#"},maxProperties:{$ref:"#/definitions/nonNegativeInteger"},minProperties:{$ref:"#/definitions/nonNegativeIntegerDefault0"},required:{$ref:"#/definitions/stringArray"},additionalProperties:{$ref:"#"},definitions:{type:"object",additionalProperties:{$ref:"#"},default:{}},properties:{type:"object",additionalProperties:{$ref:"#"},default:{}},patternProperties:{type:"object",additionalProperties:{$ref:"#"},propertyNames:{format:"regex"},default:{}},dependencies:{type:"object",additionalProperties:{anyOf:[{$ref:"#"},{$ref:"#/definitions/stringArray"}]}},propertyNames:{$ref:"#"},const:!0,enum:{type:"array",items:!0,minItems:1,uniqueItems:!0},type:{anyOf:[{$ref:"#/definitions/simpleTypes"},{type:"array",items:{$ref:"#/definitions/simpleTypes"},minItems:1,uniqueItems:!0}]},format:{type:"string"},contentMediaType:{type:"string"},contentEncoding:{type:"string"},if:{$ref:"#"},then:{$ref:"#"},else:{$ref:"#"},allOf:{$ref:"#/definitions/schemaArray"},anyOf:{$ref:"#/definitions/schemaArray"},oneOf:{$ref:"#/definitions/schemaArray"},not:{$ref:"#"}},Gw={$schema:zw,$id:Hw,title:jw,definitions:Uw,type:qw,properties:Vw,default:!0};var jc;function Kw(){return jc||(jc=1,(function(e,t){Object.defineProperty(t,"__esModule",{value:!0}),t.MissingRefError=t.ValidationError=t.CodeGen=t.Name=t.nil=t.stringify=t.str=t._=t.KeywordCxt=t.Ajv=void 0;const s=nw(),a=Iw(),n=Fw(),r=Gw,o=["/properties"],l="http://json-schema.org/draft-07/schema";class i extends s.default{_addVocabularies(){super._addVocabularies(),a.default.forEach(g=>this.addVocabulary(g)),this.opts.discriminator&&this.addKeyword(n.default)}_addDefaultMetaSchema(){if(super._addDefaultMetaSchema(),!this.opts.meta)return;const g=this.opts.$data?this.$dataMetaSchema(r,o):r;this.addMetaSchema(g,l,!1),this.refs["http://json-schema.org/schema"]=l}defaultMeta(){return this.opts.defaultMeta=super.defaultMeta()||(this.getSchema(l)?l:void 0)}}t.Ajv=i,e.exports=t=i,e.exports.Ajv=i,Object.defineProperty(t,"__esModule",{value:!0}),t.default=i;var c=kr();Object.defineProperty(t,"KeywordCxt",{enumerable:!0,get:function(){return c.KeywordCxt}});var d=Te();Object.defineProperty(t,"_",{enumerable:!0,get:function(){return d._}}),Object.defineProperty(t,"str",{enumerable:!0,get:function(){return d.str}}),Object.defineProperty(t,"stringify",{enumerable:!0,get:function(){return d.stringify}}),Object.defineProperty(t,"nil",{enumerable:!0,get:function(){return d.nil}}),Object.defineProperty(t,"Name",{enumerable:!0,get:function(){return d.Name}}),Object.defineProperty(t,"CodeGen",{enumerable:!0,get:function(){return d.CodeGen}});var u=ii();Object.defineProperty(t,"ValidationError",{enumerable:!0,get:function(){return u.default}});var p=Pr();Object.defineProperty(t,"MissingRefError",{enumerable:!0,get:function(){return p.default}})})(Ya,Ya.exports)),Ya.exports}var Yw=Kw();const Ww=Au(Yw),Jw={$id:"gameModeRules",type:"object",required:["betTypes","requiredBetTypes","maxBetsPerType","maxBetsTotal","minBetsTotal","stakeRule","stakeMin","allowPartialSubmit","allowBetModification","lockOnFirstBet","oneBetPerMatchPerType"],properties:{betTypes:{type:"array",items:{type:"string",enum:["SPREAD","MONEY","TOTAL","PROP","PARLAY"]},minItems:1,description:"Allowed bet types for this game mode"},requiredBetTypes:{type:"array",items:{type:"string",enum:["SPREAD","MONEY","TOTAL","PROP","PARLAY"]},description:"Bet types the user MUST place. Empty = no requirement."},maxBetsPerType:{type:"integer",minimum:-1,description:"Max bets per bet type per match. -1 = unlimited."},maxBetsTotal:{type:"integer",minimum:-1,description:"Max total bets across all matches. -1 = unlimited."},minBetsTotal:{type:"integer",minimum:0,description:"Min total bets required before submission. 0 = none."},stakeRule:{type:"string",enum:["FREE","SPEND_ALL","MIN_MAX"],description:"FREE = any amount | SPEND_ALL = must use entire TD$ | MIN_MAX = within range"},stakeMin:{type:["number","null"],minimum:0,description:"Min stake per bet. null = no minimum."},stakeMax:{type:["number","null"],minimum:0,description:"Max stake per bet. null = no maximum."},allowPartialSubmit:{type:"boolean",description:"Can user submit with incomplete lineup?"},allowBetModification:{type:"boolean",description:"Can user change/remove bets after placing?"},lockOnFirstBet:{type:"boolean",description:"Does placing first bet lock user into the tournament?"},oneBetPerMatchPerType:{type:"boolean",description:"Restrict to one bet per match per bet type?"}},additionalProperties:!1},Xw={$id:"gameModeScoring",type:"object",required:["method","rankBy","penalizeMissing"],properties:{method:{type:"string",enum:["PAYOUT_SUM","PROFIT","WIN_RATE","CUSTOM"],description:"Primary scoring method"},rankBy:{type:"array",items:{type:"string"},minItems:1,description:"Ordered tiebreaker fields"},bonuses:{type:"array",items:{type:"object",properties:{condition:{type:"string"},points:{type:"number"},label:{type:"string"}}},description:"Bonus scoring rules"},penalizeMissing:{type:"boolean",description:"Penalize users who did not place all required bets?"}},additionalProperties:!1},Qu=new Ww({allErrors:!0}),Uc=Qu.compile(Jw),qc=Qu.compile(Xw),Qw=e=>{const t=[];Uc(e.rules)||Uc.errors.forEach(r=>{t.push(`rules${r.instancePath}: ${r.message}`)}),qc(e.scoring)||qc.errors.forEach(r=>{t.push(`scoring${r.instancePath}: ${r.message}`)});const n=e.rules;return n.requiredBetTypes.forEach(r=>{n.betTypes.includes(r)||t.push(`requiredBetTypes contains "${r}" which is not in betTypes`)}),n.stakeRule==="MIN_MAX"&&n.stakeMin==null&&n.stakeMax==null&&t.push("stakeRule is MIN_MAX but neither stakeMin nor stakeMax is set"),n.minBetsTotal>0&&n.requiredBetTypes.length>n.minBetsTotal&&t.push(`requiredBetTypes (${n.requiredBetTypes.length}) exceeds minBetsTotal (${n.minBetsTotal})`),{valid:t.length===0,errors:t}},Zw=e=>{const t=e.rules,s=e.scoring;return{"mode.id":e.id,"mode.label":e.label,"mode.description":e.description,"rules.betTypes":t.betTypes.join(", "),"rules.requiredBetTypes":t.requiredBetTypes.length>0?t.requiredBetTypes.join(", "):"(none)","rules.maxBetsPerType":t.maxBetsPerType===-1?"Unlimited":String(t.maxBetsPerType),"rules.maxBetsTotal":t.maxBetsTotal===-1?"Unlimited":String(t.maxBetsTotal),"rules.minBetsTotal":String(t.minBetsTotal),"rules.stakeRule":t.stakeRule,"rules.stakeMin":t.stakeMin!=null?String(t.stakeMin):"(none)","rules.stakeMax":t.stakeMax!=null?String(t.stakeMax):"(none)","rules.allowPartialSubmit":String(t.allowPartialSubmit),"rules.allowBetModification":String(t.allowBetModification),"rules.lockOnFirstBet":String(t.lockOnFirstBet),"rules.oneBetPerMatchPerType":String(t.oneBetPerMatchPerType),"scoring.method":s.method,"scoring.rankBy":s.rankBy.join(", "),"scoring.bonuses":s.bonuses.length>0?JSON.stringify(s.bonuses):"(none)","scoring.penalizeMissing":String(s.penalizeMissing),"ui.badge":e.getBadge()?`${e.getBadge().label} (${e.getBadge().color})`:"(none)","ui.emptyStateText":e.getEmptyStateText()}},or={DEFAULT:new Cl,DEFAULT_FORMAT:new Cl,SET_IT_AND_FORGET_IT:new j1},Vc=e=>or[e]||or.DEFAULT,e2=()=>Object.keys(or),t2=()=>{const e={};return Object.entries(or).forEach(([t,s])=>{e[t]=Qw(s)}),e};typeof window<"u"&&(window.GameMode={get:Vc,modes:e2,validate:t2,dump:e=>Zw(Vc(e))});class s2 extends HTMLElement{constructor(){super()}connectedCallback(){this.attachShadow({mode:"open"}),this.render(),this._unsub=Me.subscribe(()=>this.render())}disconnectedCallback(){this._unsub&&this._unsub()}static get observedAttributes(){return["data-sync-theme","data-user-name","data-active-count","data-td-dollars"]}attributeChangedCallback(t,s,a){this.shadowRoot&&s!==a&&this.render()}handleLogoClick(t){t.preventDefault(),de.publish("WC.APP.HEAD_TOP.LOGO",JSON.stringify({timestamp:Date.now()}))}handleProfileClick(t){t.preventDefault(),de.publish("WC.APP.HEAD_TOP.USER_PROFILE",JSON.stringify({timestamp:Date.now()}))}handleCreateContestClick(t){t.preventDefault(),de.publish("WC.APP.HEAD_TOP.CREATE_CONTEST",JSON.stringify({timestamp:Date.now()}))}render(){const t=Me.isDark,s=this.getAttribute("data-user-name")||"Guest",a=this.getAttribute("data-active-count")||"0",n=parseFloat(this.getAttribute("data-td-dollars")||"0"),r=n>=1e3?`${Math.round(n/100)/10}K`:Math.round(n).toLocaleString();this.shadowRoot.innerHTML=`
      <style>
        ${He()}
        ${Ss()}
    ...
    `,i.forEach(f=>{const g=this.shadowRoot.querySelector(`[data-chip="${f.key}"]`);g&&g.addEventListener("click",()=>this.handleChipClick(f.key,f.group))});const d=this.shadowRoot.querySelector("#navPrev"),u=this.shadowRoot.querySelector("#navNext");d&&d.addEventListener("click",()=>this.scrollToPrev()),u&&u.addEventListener("click",()=>this.scrollToNext()),this.initDragScroll();const p=this.shadowRoot.querySelector(".chips-container");p&&(p.scrollLeft=0),requestAnimationFrame(()=>{p&&(p.scrollLeft=0),this.updateRailState()})}}customElements.define("bma-app-head-sports",n2);class r2 extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}static get observedAttributes(){return["data-matches","data-sync-theme"]}connectedCallback(){this._unsub=Me.subscribe(()=>this.render()),this.render()}disconnectedCallback(){this._unsub&&this._unsub()}attributeChangedCallback(t,s,a){s!==a&&this.render()}get matches(){const t=this.getAttribute("data-matches");if(!t)return[];try{return JSON.parse(t)}catch{return[]}}_sportGroup(t){return Ge.find(a=>a.key===t)?.group||"default"}_parseScoreboard(t){const s=t.scoreboard_data;if(!s)return null;try{return typeof s=="string"?JSON.parse(s):s}catch{return null}}_getMatchDisplay(t){const s=this._parseScoreboard(t)||{},a=parseInt(s.home_score||0),n=parseInt(s.away_score||0),r=s.period||0,o=String(s.time_remaining||"").trim(),l=o.toLowerCase(),i=a>0||n>0||r>0,c=String(t.status||"").toUpperCase()==="COMPLETED"||l==="final",d=t.scheduled_at||t.start_time||"";let u=!1;if(d){const h=d.includes("Z")||/[+-]\d{2}:\d{2}$/.test(d),b=new Date(h?d:d+"Z").getTime();isNaN(b)||(u=b<=Date.now())}const f=!c&&(i||o&&l!=="scheduled"&&l!=="final"||u),g=t.home_team_id||t.home_team||"Home",_=t.away_team_id||t.away_team||"Away";if(c)return{homeName:g,awayName:_,homeScore:a,awayScore:n,statusLabel:"FINAL",statusClass:"final",showScores:!0};if(f)return{homeName:g,awayName:_,homeScore:a,awayScore:n,statusLabel:o&&l!=="in progress"?o:"LIVE",statusClass:"live",showScores:!0};const v=t.scheduled_at||t.start_time||t.status_time;let m="UPCOMING";if(v)try{const h=v.includes("Z")||/[+-]\d{2}:\d{2}$/.test(v),b=new Date(h?v:v+"Z");isNaN(b.getTime())||(m=b.toLocaleString(void 0,{weekday:"short",hour:"numeric",minute:"2-digit"}))}catch{}return{homeName:g,awayName:_,homeScore:0,awayScore:0,statusLabel:m,statusClass:"upcoming",showScores:!1}}render(){const t=Date.now(),s=720*60*1e3,a=1440*60*1e3,r=this.matches.map(c=>({match:c,display:this._getMatchDisplay(c)})).filter(c=>c.display!==null).filter(c=>{const d=c.display.statusClass;if(d==="live")return!0;const u=new Date(c.match.scheduled_at||c.match.status_time||0).getTime();return u?d==="final"?t-u<=s:d==="upcoming"?u-t<=a&&u>=t:!1:!1}),o={live:0,final:1,upcoming:2};r.sort((c,d)=>{const u=o[c.display.statusClass]??9,p=o[d.display.statusClass]??9;if(u!==p)return u-p;const f=new Date(c.match.scheduled_at||c.match.status_time||0).getTime(),g=new Date(d.match.scheduled_at||d.match.status_time||0).getTime();return c.display.statusClass==="upcoming"?f-g:g-f});const l=r.slice(0,40);if(l.length===0){this.shadowRoot.innerHTML="";return}const i=l.map(({match:c,display:d})=>{const u=this._sportGroup(c.sport_id),p=f=>d.showScores?`<span class="score-pill__score">${f}</span>`:"";return`
        ...
        `;const s=this.shadowRoot.querySelector(".foot-logout");s&&s.addEventListener("click",()=>this._doLogout())}}customElements.define("bma-app-foot-branded",o2);const i2='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><polyline points="12 7 12 12 15 14"/></svg>',l2='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="5 12 10 17 19 7"/></svg>',c2='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><line x1="6" y1="6" x2="18" y2="18"/><line x1="18" y1="6" x2="6" y2="18"/></svg>',d2='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/></svg>';class u2 extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}static get observedAttributes(){return["data-corebetslip"]}attributeChangedCallback(t,s,a){s!==a&&this.render()}get betSlipData(){const t=this.getAttribute("data-corebetslip");if(!t)return null;try{return JSON.parse(t)}catch(s){return console.error("[bma-bet-existing] Failed to parse data-corebetslip:",s),null}}render(){const t=this.betSlipData;if(!t){this.shadowRoot.innerHTML="<div>Invalid bet data</div>";return}const s=t.bet||[];if(s.length===0){this.shadowRoot.innerHTML="<div>No bet data</div>";return}const a=s[0],n=a.short_title||"Match Info N/A",o=Object.keys(a).filter(k=>k!=="short_title")[0]||"Unknown Team",l=a[o]||{},i=l.odds??"N/A",c=(l.type||"N/A").toUpperCase(),d=parseFloat(l.stake||0),u=parseFloat(l.payout||0),p=l.reconciled!==!1,f=.01;let g,_,v;p?u>d+f?(g="won",_="Won",v=l2):u<d-f?(g="lost",_="Lost",v=c2):(g="push",_="Push",v=d2):(g="pending",_="Pending",v=i2);let m=o;if(l.type==="spread"&&l.point!==void 0){const k=parseFloat(l.point),S=k>0?`+${k}`:`${k}`;m=`${o} ${S}`}else l.type==="total"&&l.point!==void 0&&(m=`${l.team==="over"?"Over":"Under"} ${l.point}`);const h=k=>`TD$ ${k.toFixed(2)}`,b=u-d;let w,y;switch(g){case"pending":w=b>0?`+${h(b)}`:h(0),y="To win";break;case"won":w=`+${h(b)}`,y="Profit";break;case"lost":w=`-${h(d)}`,y="Lost";break;case"push":w=h(d),y="Returned";break}const x=parseInt(i,10),P=Number.isFinite(x)&&x>0?`+${x}`:`${i}`,D=t.status_time?aa.formatDateLocal(t.status_time):"",T=g==="pending"?"Placed":"Settled";this.shadowRoot.innerHTML=`
      <style>
        ${He()}
      ...
      <div class="card ${g}">
        ...
        <div class="body">
          ...
          <div class="footer">
            <div class="hero">${w}</div>
            <div class="footer-meta">
              <div class="hero-sublabel">${y}</div>
              <div class="timestamp">${T} · ${D}</div>
            </div>
          </div>
        </div>
      </div>
    `}}customElements.define("bma-bet-existing",u2);sa.init();window.BrandManager=sa;const Gc=`
